...
namespace CoFAS_MES.CORE.Function
{
    ...
    public class DBManager : IDisposable
    {
        ...
        private static string _strDatabaseServer = "m.coever.co.kr";
        private static string _strDatabaseName = "coever_mes";
        private static string _strDatabaseID = "dbmes";
        private static string _strDatabasePass = "0we11Passw0rd!@#dbmes";


        /*
        public static string Set_connectionString(DBManagerType enPro, string strIP, string strDB, string strID, string strPass)
        {
            ...
            switch (enPro)
            {
                ...
                case DBManagerType.CSV:
                    ...
                    break;
                case DBManagerType.Sybase:
                    strConn = string.Format("Provider=ASEOLEDB;Data Source={0};Catalog={1};User Id={2};Password={3};CharSet=cp949", strIP, strDB, strID, strPass);
