...
namespace CoFAS_MES.CORE.Function
{
    ...
    {
        //private static CoFASLog log = new CoFASLog(Application.StartupPath + "\\LOG\\_Socket", "sp", 30, true);
        ...
        public bool Open()
        {
            ...
            {
                //log.WLog_Exception("Open : Exception", ex);
                return false;
                //throw ex;
            }
        }
        ...
        private void ReceiveThread(IAsyncResult ar)
        {
            ...
            catch (Exception ex)
            {
                ...
                //log.WLog_Exception("ReceiveThread : Exception", ex);
                return;
            }
        }
