...
{
    public partial class ucCommonCodePopup_BadCode : UserControl
    {
        ...
        public ucCommonCodePopup_BadCode()
        {
            InitializeComponent();
        ...
        private void ucCommonCodePopup_BadCode_Load(object sender, EventArgs e)
        {
            try
            {
