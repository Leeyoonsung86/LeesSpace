...
{
    public partial class ucCommonCodePopup_Equipment : UserControl
    {
        ...
        public ucCommonCodePopup_Equipment()
        {
            InitializeComponent();
        ...
        private void ucCommonCodePopup_Equipment_Load(object sender, EventArgs e)
        {
            try
            {
