...
{
    public partial class ucCommonCodePopup_ProcessGroup : UserControl
    {
        ...
        public ucCommonCodePopup_ProcessGroup()
        {
            InitializeComponent();
        ...
        private void ucCommonCodePopup_ProcessGroup_Load(object sender, EventArgs e)
        {
            try
            {
