...
{
    public partial class ucCommonCodePopup_StopCode : UserControl
    {
        ...
        public ucCommonCodePopup_StopCode()
        {
            InitializeComponent();
        ...
        private void ucCommonCodePopup_StopCode_Load(object sender, EventArgs e)
        {
            try
            {
