...
{
    public partial class ucCommonCodePopup_Terminal : UserControl
    {
        ...
        public ucCommonCodePopup_Terminal()
        {
            InitializeComponent();
        ...
        private void ucCommonCodePopup_Terminal_Load(object sender, EventArgs e)
        {
            try
            {
