...
{
    public partial class ucCommonCodePopup_Tool : UserControl
    {
        ...
        private void ucCommonCodePopup_Tool_Load(object sender, EventArgs e)
        {
            try
            {
