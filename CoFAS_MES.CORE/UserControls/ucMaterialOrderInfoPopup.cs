...
{
    public partial class ucMaterialOrderInfoPopup : UserControl
    {
        ...
        public ucMaterialOrderInfoPopup()
        {
            InitializeComponent();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pCRUD = "R";
                _dtList = new MaterialOrderInfoPopupBusiness().MaterialOrderInfoPopup_Return(_pCRUD, FromDATE, ToDATE, strCODE, strNAME).Tables[0];
