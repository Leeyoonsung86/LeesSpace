...
{
    public partial class ucNoticeDetailPopup : UserControl
    {
        #region ○ 기본 전역변수 영역
        ...
        #region ○ 폼 로드 이벤트
        private void ucNoticeDetail_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                _luTITLE.Text = _pARRAY_CODE[0].ToString();
                _luCONTENTS.Text = _pARRAY_CODE[1].ToString();
                _luUSER.Text = _pARRAY_CODE[2].ToString();
                _luDATE.Text = _pARRAY_CODE[3].ToString();
        ...
        private void InitializeControl()
        {
            try
            {
                _luTITLE.ReadOnly = true;
                _luCONTENTS.ReadOnly = true;
                _luUSER.ReadOnly = true;
                _luDATE.ReadOnly = true;
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
