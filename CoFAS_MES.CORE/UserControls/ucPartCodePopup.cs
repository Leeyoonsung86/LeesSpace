...
{
    public partial class ucPartCodePopup : UserControl
    {
        ...
        private void ucCommonCodePopup_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                _luPART_CODE.Text = _pPART_CODE;
                _luPART_NAME.Text = _pPART_NAME;
        ...
        {
            _pCRUD = "R";
            _pVEND_PART_CODE = _luPART_CODE.Text;
            _pPART_NAME = _luPART_NAME.Text;
            MainFind_DisplayData(); //Dev Grid 데이터소스 로 바인딩 작업 처리 할 경우에는 최초 빈 데이터 테이블을 바인딩 해야 됨.
        }
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new PartCodePopUpBusiness().PartCodePopUp_Return(_pCRUD, _pLANGUAGE_TYPE, _pSERVICE_NAME, _pPART_CODE, _pVEND_PART_CODE, _pPART_NAME, _pPART_TYPE).Tables[0];
