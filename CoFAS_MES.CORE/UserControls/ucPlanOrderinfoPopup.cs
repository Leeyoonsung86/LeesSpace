...
{
    public partial class ucPlanOrderinfoPopup : UserControl
    {
        ...
        private ucPlanOrderinfoPopup_Entity _pucPlanOrderinfoPopup_Entity = null;
        ...
        private void ucPlanOrderinfoPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            _pucPlanOrderinfoPopup_Entity = new ucPlanOrderinfoPopup_Entity();
            _pucPlanOrderinfoPopup_Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucPlanOrderinfoPopup_Entity.CRUD = "R";
                _pucPlanOrderinfoPopup_Entity.DATE_FROM = _ucFROMDATE.FromDateTime.ToString("yyyyMMdd");
                _pucPlanOrderinfoPopup_Entity.DATE_TO = _ucFROMDATE.ToDateTime.ToString("yyyyMMdd");
                _pucPlanOrderinfoPopup_Entity.PART_CODE = _luPART_ALL.CodeText;
                _pucPlanOrderinfoPopup_Entity.PART_NAME = _luPART_ALL.NameText;
                _pucPlanOrderinfoPopup_Entity.PLAN_ORDER_ID = _luPLAN_ORDER.Text;
                //_pucPlanOrderinfoPopup_Entity.VEND_NAME = _luPART_ALL.NameText;

                _dtList = new pucPlanOrderinfoPopupBusiness().ucPlanOrderinfoPopup_Select(_pucPlanOrderinfoPopup_Entity).Tables[0];

                if (_pucPlanOrderinfoPopup_Entity.CRUD == "")
                    _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucPlanOrderinfoPopup_Entity.CRUD == ""))
                {
