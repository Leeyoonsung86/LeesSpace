...
{
    public partial class ucPlanOrderinfoPopup_T50 : UserControl
    {
        ...
        private ucPlanOrderinfoPopup_T50_Entity _pucPlanOrderinfoPopup_T50_Entity = null;
        ...
        public ucPlanOrderinfoPopup_T50()
        {
            InitializeComponent();
        ...
        private void ucPlanOrderinfoPopup_T50_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            _pucPlanOrderinfoPopup_T50_Entity = new ucPlanOrderinfoPopup_T50_Entity();
            _pucPlanOrderinfoPopup_T50_Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            ...
            _ucFROMDATE.FromDateTime = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1);  //조회 시작일, 매월 초 날짜로 설정
            _ucFROMDATE.ToDateTime = DateTime.Today;  //조회 종료일
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucPlanOrderinfoPopup_T50_Entity.CRUD = "R";
                _pucPlanOrderinfoPopup_T50_Entity.DATE_FROM = _ucFROMDATE.FromDateTime.ToString("yyyyMMdd");
                _pucPlanOrderinfoPopup_T50_Entity.DATE_TO = _ucFROMDATE.ToDateTime.ToString("yyyyMMdd");
                _pucPlanOrderinfoPopup_T50_Entity.PART_CODE = _luPART_ALL.CodeText;
                _pucPlanOrderinfoPopup_T50_Entity.PART_NAME = _luPART_ALL.NameText;
                _pucPlanOrderinfoPopup_T50_Entity.PLAN_ORDER_ID = _luPLAN_ORDER.Text;
                //_pucPlanOrderinfoPopup_T50_Entity.VEND_NAME = _luPART_ALL.NameText;
                _pucPlanOrderinfoPopup_T50_Entity.CONFIGURATION_MST_NAME = _luT_CONFIGURATION_MST_NAME.Text;
                _pucPlanOrderinfoPopup_T50_Entity.CONFIGURATION_NAME = _luT_CONFIGURATION_NAME.Text;
                _dtList = new pucPlanOrderinfoPopup_T50Business().ucPlanOrderinfoPopup_T50_Select(_pucPlanOrderinfoPopup_T50_Entity).Tables[0];

                if (_pucPlanOrderinfoPopup_T50_Entity.CRUD == "")
                    _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucPlanOrderinfoPopup_T50_Entity.CRUD == ""))
                {
        ...
        private void _luPART_ALL__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                frmCommonPopup.ARRAY = new object[2] { "Product_Code", _luPART_ALL.CodeText }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
