...
{
    public partial class ucProductPlanInfoPopup : UserControl
    {
        ...
        private ProductPlanInfoPopupEntity _pProductPlanInfoPopupEntity = null;
        ...
        private void InitializeSetting()
        {
            ...
            _pProductPlanInfoPopupEntity = new ProductPlanInfoPopupEntity();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductPlanInfoPopupBusiness().ProductPlanInfoPopup_Return(_pCRUD, pPART_CODE).Tables[0];
                if (_pCRUD == "")
                    _dtList.Rows.Clear();
