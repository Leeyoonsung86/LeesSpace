...
namespace CoFAS_MES.CORE.UserControls
{
    ...
    등록일 : 2018.06.21 
    수정일 : 2018.06.21
    기존 : ucContractInfoPopup
    내용 : 수주정보를 조회하는 팝업
    수정자 : 김기환
*/

    public partial class ucProductionOrderInfoPopup_T01 : UserControl
    {
        ...
        public ucProductionOrderInfoPopup_T01()
        {
            InitializeComponent();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                //ucProductionOrderInfoPopup_T01으로 생성할것 !!


                // _dtList = new CodePopUpBusiness().CodePopUp_Return(_pCRUD, _pARRAY[0].ToString(), _pARRAY[1].ToString(), strCODE, strNAME, "", "", "", "").Tables[0];
                //
