...
{
    public partial class ucProductionOrderInfoPopup_T02 : UserControl
    {
        //180712_1
        ...
        private ucProductionOrderInfoPopup_T02_Entity _pucProductionOrderInfoPopup_T02_Entity = null;
        ...
        public ucProductionOrderInfoPopup_T02()
        {
            InitializeComponent();
        ...
        private void ucProductionOrderInfoPopup_T02_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            _pucProductionOrderInfoPopup_T02_Entity = new ucProductionOrderInfoPopup_T02_Entity();
            _pucProductionOrderInfoPopup_T02_Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucProductionOrderInfoPopup_T02_Entity.CRUD = "R";
                _pucProductionOrderInfoPopup_T02_Entity.DATE_FROM = _ucFROMDATE.FromDateTime.ToString("yyyyMMdd");
                _pucProductionOrderInfoPopup_T02_Entity.DATE_TO = _ucFROMDATE.ToDateTime.ToString("yyyyMMdd");
                _pucProductionOrderInfoPopup_T02_Entity.PART_CODE = _luPART.CodeText;
                _pucProductionOrderInfoPopup_T02_Entity.PART_NAME = _luPART.NameText;
                _pucProductionOrderInfoPopup_T02_Entity.VEND_CODE = _luVEND.CodeText;
                _pucProductionOrderInfoPopup_T02_Entity.VEND_NAME = _luVEND.NameText;

                _dtList = new ucProductionOrderInfoPopup_T02Business().ucProductionOrderInfoPopup_T02_Select(_pucProductionOrderInfoPopup_T02_Entity).Tables[0];

                if (_pucProductionOrderInfoPopup_T02_Entity.CRUD == "")
                    _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucProductionOrderInfoPopup_T02_Entity.CRUD == ""))
                {
