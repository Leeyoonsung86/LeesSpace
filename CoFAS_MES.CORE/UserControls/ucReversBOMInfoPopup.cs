...
namespace CoFAS_MES.CORE.UserControls
{
    /*  
        등록일 : 2018.06.21 
        수정일 : 2018.06.21
        기존 : ucReversBOMInfoPopup
        내용 : 역전개
        수정자 : 김기환
    */

    public partial class ucReversBOMInfoPopup : UserControl
    {
        ...
        private static string _pPART_CODE = string.Empty;   // 시스템 언어
        ...
        private void ucPartCodeInfoPopup_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    _pPART_CODE = ARRAY_CODE[0].ToString();
        ...
        private void InitializeSetting()
        {
            ...
            //luPART_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "PART_TYPE_PRODUCT_T01", "", "", "").Tables[0], 0, 0, "");
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                //ucReversBOMInfoPopup로 생성할것!!

                // _dtList = new CodePopUpBusiness().CodePopUp_Return(_pCRUD, _pLANGUAGE_TYPE, _pARRAY[0].ToString(), _pARRAY[1].ToString(), "", "", "", "", "", "").Tables[0];
                _dtList = new ucReversBOMInfoPopupBusiness().ucReversBOMInfoPopup_Return(_pCRUD, _pLANGUAGE_TYPE, _pARRAY[0].ToString(), _pARRAY[1].ToString(), "", "","").Tables[0];
