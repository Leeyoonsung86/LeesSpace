...
{
    public partial class ucTabletBasedSensorInfoPopup : UserControl
    {
        ...
        public ucTabletBasedSensorInfoPopup()
        {
            InitializeComponent();
        ...
        private void ucTabletBasedSensorInfoPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            _gdMAIN_VIEW.Click += _gdMAIN_VIEW_Click; //그리드 로우 마우스 선택으로 값 넘길경우 필수

            //그리드 설정 ==고정==
        }

        public static event OnClickEventHandler _OnClick; //그리드 로우 마우스 선택으로 값 넘길경우 필수
        //public delegate void OnDoubleClickEventHandler(object sender, EventArgs e); //그리드 로우 마우스 선택으로 값 넘길경우 필수

        private void _gdMAIN_VIEW_Click(object sender, EventArgs e)
        {
            if (_OnClick != null)
                _OnClick(sender, e);
        }
