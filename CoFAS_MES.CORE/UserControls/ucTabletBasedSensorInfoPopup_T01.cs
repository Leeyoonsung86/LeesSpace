...
{
    public partial class ucTabletBasedSensorInfoPopup_T01 : UserControl
    {
        ...
        public ucTabletBasedSensorInfoPopup_T01()
        {
            InitializeComponent();
        ...
        private void ucTabletBasedSensorInfoPopup_T01_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            _ucFROMDATE.FromDateTime = pFirstDateTime;
            _ucFROMDATE.ToDateTime = DateTime.MaxValue;
            _luCD.Text = "";
            _luCD_NM.Text = "";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                string strFROM_DATE = _ucFROMDATE.FromDateTime.ToString("yyyyMMdd");
                string strTO_DATE = _ucFROMDATE.ToDateTime.ToString("yyyyMMdd");
                string strCODE = _luCD.Text.ToString();
                string strNAME = _luCD_NM.Text.ToString();

                _dtList = new CodePopUpBusiness().CodePopUp_Return(_pCRUD, _pLANGUAGE_TYPE, _pARRAY[0].ToString(), _pARRAY[1].ToString(), strCODE, strNAME, strFROM_DATE, strTO_DATE, "","").Tables[0];
