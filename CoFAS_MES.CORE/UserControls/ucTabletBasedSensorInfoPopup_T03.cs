...
{
    public partial class ucTabletBasedSensorInfoPopup_T03 : UserControl
    {
        ...
        private TabletBasedSensorInfoPopup_T02Entity _pTabletBasedSensorInfoPopup_T02Entity = null; // 엔티티 생성
        ...
        private DataTable _dtList_Sub = new DataTable(); //조회 데이터 리스트
        ...
        public ucTabletBasedSensorInfoPopup_T03()
        {
            InitializeComponent();
        ...
        private void ucTabletBasedSensorInfoPopup_T03_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pTabletBasedSensorInfoPopup_T02Entity = new TabletBasedSensorInfoPopup_T02Entity();
            //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
            _pTabletBasedSensorInfoPopup_T02Entity.USER_CODE = _pUSER_CODE;
            _pTabletBasedSensorInfoPopup_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            _pTabletBasedSensorInfoPopup_T02Entity.WINDOW_NAME = _pWINDOW_NAME;
        ...
        private void InputData_Save()
        {
            try
            {
                ...
                _pTabletBasedSensorInfoPopup_T02Entity.COLLECTION_DATE = DateTime.Now.ToString("yyyyMMddHHmmss");

                _dtList_Sub = new TabletBasedSensorInfoPopup_T02Business().TabletBasedSensorInfoPopup_T02_Save(_pTabletBasedSensorInfoPopup_T02Entity, sheet_0);

                if (_dtList_Sub != null && _dtList_Sub.Rows.Count > 0)//&& _dtList_Sub.Rows.Count > 0) )|| (_dtList_Sub != null && _pNoticeRegisterEntity.CRUD == ""))
                {
                    CoFAS_DevExpressManager.BindGridControl(_gdMAIN, _gdMAIN_VIEW, _dtList_Sub); //데이터 필드에 맞춰 자동 바인딩
                }
            }
            catch (ExceptionManager pExceptionManager)
            {
