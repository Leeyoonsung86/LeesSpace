...
{
    public partial class ucVendCodeInfoPopup : UserControl
    {
        ...
        private void InitializeSetting()
        {
            ...
            switch (ARRAY[0].ToString())
            {
                ...
                case "Vend_Out_Code":
                    ...
                    break;
                default:
                    _luVEND_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "COMMON_CODE", "CD03", "", "").Tables[0], 0, 0, "",true);
                    break;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                string strTYPE = _luVEND_TYPE.GetValue();
                string strCRUD = "R";
                //_dtList = new VendCodeInfoPopupBusiness().VendCodeInfoPopup_Return(_pCRUD, _pARRAY[0].ToString(), _pARRAY[1].ToString(), strCODE, strNAME, "", "", "", "").Tables[0];
                _dtList = new VendCodeInfoPopupBusiness().VendCodeInfoPopup_Return(strCRUD,strCODE, strNAME, strTYPE).Tables[0];
