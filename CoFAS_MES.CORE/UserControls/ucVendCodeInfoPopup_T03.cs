...
namespace CoFAS_MES.CORE.UserControls
{
    /*  
        등록일 : 2018.12.28 
        수정일 : 2018.12.28
        기존 : ucVendCodeInfoPopup_T03
        내용 : 전체품목을 조회하는 팝업
        수정자 : YMS
    */

    public partial class ucVendCodeInfoPopup_T03 : UserControl
    {
        ...
        public ucVendCodeInfoPopup_T03()
        {
        ...
        private void InitializeSetting()
        {
            ...
            {
                 _luPART_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, ARRAY[0].ToString(), "", "", "").Tables[0], 0, 0, "");
                // _luPART_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "PART_TYPE_PRODUCT_T01", "", "", "").Tables[0], 0, 0, "");
                 //_luPART_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "Material_CD", "", "", "").Tables[0], 0, 0, "");
            ...
            else
            {
                if (ARRAY.Length > 2)
                {
                    _luPART_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "Material_CD_T01", "", "", "").Tables[0], 0, 0, "");
                }
                else
                {
                    _luPART_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "Material_CD", "", "", "").Tables[0], 0, 0, "");
