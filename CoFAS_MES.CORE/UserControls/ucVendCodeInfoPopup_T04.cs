...
{
    public partial class ucVendCodeInfoPopup_T04 : UserControl
    {
        ...
        public ucVendCodeInfoPopup_T04()
        {
        ...
        private void ucPartCodeInfoPopup_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_pARRAY_CODE != null && _pARRAY_CODE.Length > 1)
                {
                    ...
                    //_luCD.Text    = _pARRAY_CODE[2].ToString();
                    //_luCD_NM.Text = _pARRAY_CODE[3].ToString();
                }
            }
