...
{
    public partial class ucWorkOrderInfoPopup : UserControl
    {
        ...
        private WorkOrderInfoPopupEntity _pWorkOrderInfoPopupEntity = null;
        ...
        private void InitializeSetting()
        {
            ...
            _pWorkOrderInfoPopupEntity = new WorkOrderInfoPopupEntity();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new WorkOrderInfoPopupBusiness().WorkOrderInfoPopup_Return(_pCRUD, pPLAN_ORDER, pPART_CODE, _pWorkOrderInfoPopupEntity).Tables[0];
                if (_pCRUD == "")
                    _dtList.Rows.Clear();
        ...
        private void _luCONTRACT_ID__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                try
                {
                    ...
                    frmCommonPopup.ARRAY = new object[2] { "PlanOrderInfo_Popup", _luTPART_NAME.Text }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
                    frmCommonPopup.ARRAY_CODE = new object[2] { _luTPART_CODE.Text, _luTPART_NAME.Text };
        ...
        private void ucWorkOrderInfoPopup_ControlRemoved(object sender, ControlEventArgs e)
        {
