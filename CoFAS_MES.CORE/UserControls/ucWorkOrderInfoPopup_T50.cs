...
{
    public partial class ucWorkOrderInfoPopup_T50 : UserControl
    {
        ...
        private ucWorkOrderInfoPopup_T50Entity _pucWorkOrderInfoPopup_T50Entity = null;
        ...
        private DataTable _dtList2 = null; //출력물 조회 데이터 리스트
        private DataTable _dtList3 = null; //출력물 조회 데이터 리스트
        ...
        public ucWorkOrderInfoPopup_T50()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            ...
            //추가
            //_pFTP_ID = Properties.Settings.Default.FTP_ID;
            ...
            _pFTP_ID = "ftpadmin";
            _pFTP_PATH = "db2.coever.co.kr:8500/";//
            _pFTP_PW = "Ftp89897788!#%";
            ...
            _pucWorkOrderInfoPopup_T50Entity = new ucWorkOrderInfoPopup_T50Entity();
            _pucWorkOrderInfoPopup_T50Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _luT_CONFIGURATION_MST_NAME.ReadOnly = true;

                _luT_CONFIGURATION_NAME.Text = "";
                _luT_CONFIGURATION_NAME.ReadOnly = true;
        ...
        private void InputData_Save(DataTable pDataTable)
        {
            try
            {
                ...
                bool isError = false;
                _pucWorkOrderInfoPopup_T50Entity.CRUD = "C";
                _pucWorkOrderInfoPopup_T50Entity.USER_CODE = _pUSER_CODE;
                _pucWorkOrderInfoPopup_T50Entity.REFERENCE_ID = _luPLAN_ORDER_ID.Text;  //계획정보를 레퍼런스에 담음
                _pucWorkOrderInfoPopup_T50Entity.CARVE = _luCARVE.Text;
                _pucWorkOrderInfoPopup_T50Entity.MESSAGE = _luMESSAGE.Text;

                isError = new ucWorkOrderInfoPopup_T50Business().ucWorkOrderInfoPopup_T50_Save(_pucWorkOrderInfoPopup_T50Entity, pDataTable);
                ...
                else
                {
                    ...
                    //  CoFAS_DevExpressManager.ShowInformationMessage(_pucWorkOrderInfoPopup_T50Entity.RTN_KEY);
                    SheetFind_DisplayData();

                    Sheet_Info_Sheet_Data(_gdMAIN_VIEW.GridControl.DataSource as DataTable, _pucWorkOrderInfoPopup_T50Entity.RTN_KEY);
                    DataTable PTTD = _gdMAIN_VIEW.GridControl.DataSource as DataTable;

                    string _pPART_CODE = PTTD.Rows[0]["PART_CODE"].ToString();
                    string _pFTP_IP = "";
                    // 도면 preview
        ...
        private void _btAPPLY_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (_pucWorkOrderInfoPopup_T50Entity.RTN_KEY == null)
                    {
                        CoFAS_DevExpressManager.ShowInformationMessage("저장 후 발행이 가능합니다.");
                        return;
                    }
                    SheetFind_DisplayData();

                    Sheet_Info_Sheet_Data(_gdMAIN_VIEW.GridControl.DataSource as DataTable, "");
        ...
        private void _luCONTRACT_ID__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                try
                {
                    ...
                    frmCommonPopup.ARRAY = new object[2] { "PlanOrderInfo_Popup_T50", "" }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
