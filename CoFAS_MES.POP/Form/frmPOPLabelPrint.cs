...
{
    public partial class frmPOPLabelPrint : frmBaseSingle
    {
        ...
        private POPLabelPrintEntity _pPOPLabelPrintEntity = null; // 엔티티 생성
        ...
        public string _pPartName = "";
        public string _pPartCode = "";
        ...
        public frmPOPLabelPrint(UserEntity pUserEntity)
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pPOPLabelPrintEntity = new POPLabelPrintEntity();
                _pPOPLabelPrintEntity.CORP_CODE = _pUserEntity.CORP_CODE;
                _pPOPLabelPrintEntity.USER_CODE = _pUserEntity.USER_CODE;
                _pPOPLabelPrintEntity.LANGUAGE_TYPE = _pUserEntity.LANGUAGE_TYPE;
                _pPOPLabelPrintEntity.PROCESS_CODE = _pUserEntity.PROCESS_CODE;
                _pPOPLabelPrintEntity.RESOURCE_CODE = _pUserEntity.RESOURCE_CODE;
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _luTSEQ.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
                _luTSEQ.Appearance.TextOptions.VAlignment = DevExpress.Utils.VertAlignment.Center;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                if (_pPOPLabelPrintEntity.CRUD == "") _dtList.Rows.Clear();
        ...
        private void btnCmd_Click(object pSender, EventArgs pEventArgs)
        {
            ...
            switch (sCls)
            {
                ...
                case "30":
                    ...
                    _pPartName = _luTPART_NAME.Text;
                    _pPartCode = _luTPART_CODE.Text;                   
                    _pPrintQTY = _luTSEQ.Text;
        ...
        private void _luTSEQ_Click(object sender, EventArgs e)
        {
            frmPopupKeypad_T01 key = new frmPopupKeypad_T01();
            string PopupValue = string.Empty;
            if (key.ShowDialog() == DialogResult.OK)
            {

                _luTSEQ.Text = key.ReturnValue1;
