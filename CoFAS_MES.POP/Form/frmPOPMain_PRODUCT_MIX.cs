...
{
    public partial class frmPOPMain_PRODUCT_MIX : frmBasePOP
    {
        ...
        public frmPOPMain_PRODUCT_MIX(UserEntity pUserEntity, string termial_code)
        {
            InitializeComponent();
        ...
        private void _ucbtWORK_ORDER_Click(object sender, EventArgs e)
        {
            ...
            if (frmOr.dtReturn != null && frmOr.dtReturn.Rows.Count > 0)
            {
                ...
                _pORDER_ID = frmOr.dtReturn.Rows[0]["PRODUCTION_ORDER_ID"].ToString();
            }
        ...
        #region ○ 래시피 관리 버튼
        private void _ucbtRECPIE_REG_Click(object sender, EventArgs e)
        {
            try
            {
                //작지 선택 여부
                ...
                frmPopbom.titleName = _luORDER_ID.Text + "_" + _luPART_NAME.Text + " 래시피 관리";
