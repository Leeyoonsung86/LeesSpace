...
{
    public partial class frmPOPMain_RAWMATERIAL_COSMETICS : frmBasePOP
    {
        ...
        private frmPOPMain_RAWMATERIAL_COSMETICSEntity _pfrmPOPMain_RAWMATERIAL_COSMETICSEntity = null; // 엔티티 생성
        ...
        public frmPOPMain_RAWMATERIAL_COSMETICS(UserEntity pUserEntity)
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
               ...
               // tableLayoutPanel2.BackColor = Color.White;
                ...
                _pfrmPOPMain_RAWMATERIAL_COSMETICSEntity = new frmPOPMain_RAWMATERIAL_COSMETICSEntity();
                _pfrmPOPMain_RAWMATERIAL_COSMETICSEntity.CORP_CODE = _pCORP_CDDE;
                _pfrmPOPMain_RAWMATERIAL_COSMETICSEntity.USER_CODE = _pUSER_CODE;
                _pfrmPOPMain_RAWMATERIAL_COSMETICSEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pfrmPOPMain_RAWMATERIAL_COSMETICSEntity.TERMINAL_CODE = "TP010002";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
              ...
              //  _pfrmPOPMain_RAWMATERIAL_COSMETICSEntity = new frmPOPMain_RAWMATERIAL_COSMETICSEntity();
                ...
                _dtList = new frmPOPMain_RAWMATERIAL_COSMETICSBusiness().frmPOPMain_RAWMATERIAL_COSMETICS_Info(_pfrmPOPMain_RAWMATERIAL_COSMETICSEntity);
              //  _dtList = new frmPOPMain_RAWMATERIAL_COSMETICSBusiness().frmPOPMain_RAWMATERIAL_COSMETICS_Info(_pCRUD, FromDATE, ToDATE, strCODE, strNAME).Tables[0];
                if (_pfrmPOPMain_RAWMATERIAL_COSMETICSEntity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pfrmPOPMain_RAWMATERIAL_COSMETICSEntity.CRUD == ""))
                {
        ...
        private void GetBarcodeComPort()
        {
            try
            {
                ...
                _dtList = new BarcodeLabelPrintBusiness().BarcodeLabelPrint_COM_Info(_pfrmPOPMain_RAWMATERIAL_COSMETICSEntity.LANGUAGE_TYPE, _pfrmPOPMain_RAWMATERIAL_COSMETICSEntity.TERMINAL_CODE);
                _rt_dtList = _dtList;
                COM_PORT = "";
