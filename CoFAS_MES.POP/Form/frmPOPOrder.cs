...
{
    public partial class frmPOPOrder : frmBaseSingle
    {
        ...
        public static string PROCESS_MST_CODE_COSMETICS
        {
            get { return _pPROCESS_MST_CODE_COSMETICS; }
            set { _pPROCESS_MST_CODE_COSMETICS = value; }
        }
        ...
        public frmPOPOrder(UserEntity pUserEntity)
        {
            InitializeComponent();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                //lookupedit에서 가져오기
                _pPOPProductionOrderEntity.PROCESS_CODE = _luIPROCESS_CODE_MST.GetValue();
        ...
        private void btnCmd_Click(object pSender, EventArgs pEventArgs)
        {
            ...
            switch (sCls)
            {
                ...
                case "30":
                    ...
                    _dtreturn.Columns.Add("RESULT_QTY", typeof(string));
                    _dtreturn.Columns.Add("OK_QTY", typeof(string));
                    _dtreturn.Columns.Add("NG_QTY", typeof(string));
                    _dtreturn.Columns.Add("INSPECT_STATUS", typeof(string));
                    _dtreturn.Columns.Add("ORDER_FILE", typeof(string));
                    _dtreturn.Columns.Add("PROCESS_CODE_MST", typeof(string));
                    _dtreturn.Columns.Add("PROCESS_NAME", typeof(string));
                    _dtreturn.Columns.Add("REQUEST_FILE", typeof(string));
                    _dtreturn.Columns.Add("PRODUCTION_STATUS_PACKING", typeof(string));
                    ...
                    _dtreturn.Rows.Add(new Object[] {
                        ...
                        _gdMAIN_VIEW.GetFocusedRowCellValue("PRODUCTION_RESULT_QTY").ToString(),
                        ...
                        _gdMAIN_VIEW.GetFocusedRowCellValue("INSPECT_STATUS").ToString(),
                        _gdMAIN_VIEW.GetFocusedRowCellValue("ORDER_FILE").ToString(),
                        _gdMAIN_VIEW.GetFocusedRowCellValue("PROCESS_CODE_MST").ToString(),
                        _gdMAIN_VIEW.GetFocusedRowCellValue("PROCESS_NAME").ToString(),
                        _gdMAIN_VIEW.GetFocusedRowCellValue("REQUEST_FILE").ToString(),
                        _gdMAIN_VIEW.GetFocusedRowCellValue("PRODUCTION_STATUS_PACKING").ToString()
        ...
        private void _luIPROCESS_CODE_MST_ValueChanged(object sender, EventArgs e)
        {
