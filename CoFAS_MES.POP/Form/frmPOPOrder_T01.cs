...
{
    public partial class frmPOPOrder_T01 : frmBaseSingle
    {
        ...
        public frmPOPOrder_T01(UserEntity pUserEntity)
        {
            InitializeComponent();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new POPProductionOrderCommonBusiness().POPProductionOrderCommon_Info(_pPOPProductionOrderCommonEntity);
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _dtreturn.Columns.Add("CODE_UNIT", typeof(string));
                ...
                _dtreturn.Rows.Add(new Object[] {
                        ...
                        _gdMAIN_VIEW.GetFocusedRowCellValue("CODE_UNIT").ToString(),
