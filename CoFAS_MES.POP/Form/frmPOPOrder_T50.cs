...
{
    public partial class frmPOPOrder_T50 : frmBaseSingle
    {
        ...
        public frmPOPOrder_T50(UserEntity pUserEntity)
        {
            InitializeComponent();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new POPProductionOrder_T50Business().POPProductionOrder_Info(_pPOPProductionOrder_T50Entity);

                if (_pPOPProductionOrder_T50Entity.CRUD == "") _dtList.Rows.Clear();
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pPOPProductionOrder_T50Entity.CRUD == ""))
                {
                    ...
                    _gdMAIN_VIEW.Columns[0].Visible = false;
                    _gdMAIN_VIEW.Columns[1].Width = 100;
                    _gdMAIN_VIEW.Columns[2].Width = 80;
                    _gdMAIN_VIEW.Columns[3].Width = 60;
                    //_gdMAIN_VIEW.Columns[4].Width = 70;
                    _gdMAIN_VIEW.Columns[4].Width = 150;
                    _gdMAIN_VIEW.Columns[5].Width = 200; //품목명칭
                    _gdMAIN_VIEW.Columns[6].Width = 80;
                    _gdMAIN_VIEW.Columns[7].Width = 80;
                    _gdMAIN_VIEW.Columns[8].Width = 80;
                    _gdMAIN_VIEW.Columns[9].Width = 80;
                    _gdMAIN_VIEW.Columns[10].Width = 80;
                    _gdMAIN_VIEW.Columns[11].Width = 80;
                    _gdMAIN_VIEW.Columns[12].Width = 80;
                    _gdMAIN_VIEW.Columns[13].Width = 80;
                    _gdMAIN_VIEW.Columns[14].Visible = false;
                   // _gdMAIN_VIEW.Columns[15].Visible = false;
        ...
        private void btnCmd_Click(object pSender, EventArgs pEventArgs)
        {
            ...
            switch (sCls)
            {
                ...
                case "30":
                    ...
                    _dtreturn.Columns.Add("PRODUCTION_ORDER_SEQ", typeof(string));
                    _dtreturn.Columns.Add("PRODUCTION_ORDER_STATUS", typeof(string));
                    ...
                    _dtreturn.Columns.Add("SEQ", typeof(string));
       //             _dtreturn.Columns.Add("PROCESS_CODE_MST", typeof(string));
                    _dtreturn.Columns.Add("PROCESS_CODE", typeof(string));
                    _dtreturn.Columns.Add("PROCESS_NAME", typeof(string));
                    _dtreturn.Columns.Add("PROCESS_GUBUN", typeof(string));
                    _dtreturn.Columns.Add("REMARK", typeof(string));
                    _dtreturn.Columns.Add("EQUIPMENT_CODE", typeof(string));
                    ...
                    _dtreturn.Columns.Add("PROCESS_CODE2", typeof(string));
                    _dtreturn.Columns.Add("PROCESS_NAME2", typeof(string));
                    _dtreturn.Columns.Add("PROCESS_GUBUN2", typeof(string));
                    _dtreturn.Columns.Add("PART_STANDARD", typeof(string));
                    ...
                    if (_dtreturn != null)
                    {
                        ...
                        _gdMAIN_VIEW.GetFocusedRowCellValue("PRODUCTION_ORDER_SEQ").ToString(),
                        _gdMAIN_VIEW.GetFocusedRowCellValue("PRODUCTION_ORDER_STATUS").ToString(),
                        ...
                        _gdMAIN_VIEW.GetFocusedRowCellValue("SEQ").ToString(),
        //                _gdMAIN_VIEW.GetFocusedRowCellValue("PROCESS_CODE_MST").ToString(),
                        _gdMAIN_VIEW.GetFocusedRowCellValue("PROCESS_CODE").ToString(),
                        _gdMAIN_VIEW.GetFocusedRowCellValue("PROCESS_NAME").ToString(),
                        _gdMAIN_VIEW.GetFocusedRowCellValue("PROCESS_GUBUN").ToString(),
                        _gdMAIN_VIEW.GetFocusedRowCellValue("REMARK").ToString(),
                        _gdMAIN_VIEW.GetFocusedRowCellValue("EQUIPMENT_CODE").ToString(),
                        ...
                        _gdMAIN_VIEW.GetFocusedRowCellValue("PROCESS_CODE2").ToString(),
                        _gdMAIN_VIEW.GetFocusedRowCellValue("PROCESS_NAME2").ToString(),
                        _gdMAIN_VIEW.GetFocusedRowCellValue("PROCESS_GUBUN2").ToString(),
                        _gdMAIN_VIEW.GetFocusedRowCellValue("PART_STANDARD").ToString()
