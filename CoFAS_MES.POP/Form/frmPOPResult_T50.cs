...
{
    public partial class frmPOPResult_T50 : frmBaseSingle
    {
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                CoFAS_DevExpressManager.ShowInformationMessage("실적을 넣어주십시요.");
                return;
            }
            else if (CoFAS_DevExpressManager.ShowQuestionMessage("실적을 등록하시겠습니까?") == DialogResult.Yes)
            {
