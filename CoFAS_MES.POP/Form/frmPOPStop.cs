...
{
    public partial class frmPOPStop : frmBaseSingle
    {
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _luT_StopCode.Font = new Font("굴림", 20);
                _luT_StopSubCode.Font = new Font("굴림", 20);

                _luT_StopCode.ValueChanged += new EventHandler(_luT_StopCode_ValueChanged);
                _luT_StopCode.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("", _pLANGUAGE_TYPE, "POP_STOP1_CODE", "", "", "").Tables[0], 0, 0, "", false);
