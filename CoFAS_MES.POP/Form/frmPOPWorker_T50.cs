...
{
    public partial class frmPOPWorker_T50 : frmBaseSingle
    {
        ...
        public frmPOPWorker_T50(UserEntity pUserEntity)
        {
            InitializeComponent();
        ...
        private void btnCmd_Click(object pSender, EventArgs pEventArgs)
        {
            ...
            switch (sCls)
            {
                ...
                case "30":
                    ...
                    _dtreturn.Columns.Add("USER_ACCOUNT", typeof(string));
                    _dtreturn.Columns.Add("USER_NAME", typeof(string));
                   

                    if (_dtreturn != null)
                    {
                        _dtreturn.Rows.Add(new Object[] {
                        _gdMAIN_VIEW.GetFocusedRowCellValue("USER_ACCOUNT").ToString(),
                        _gdMAIN_VIEW.GetFocusedRowCellValue("USER_NAME").ToString()                     
                    });
