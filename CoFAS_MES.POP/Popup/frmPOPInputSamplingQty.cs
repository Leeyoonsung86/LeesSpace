...
{
    public partial class frmPOPInputSamplingQty : frmBaseSingle
    {
        ...
        private void InitializeControl()
        {
            try
            {
                ucDateEdit1.Font= new Font(ucDateEdit1.Font.Name, 20,
                ucDateEdit1.Font.Style, ucDateEdit1.Font.Unit);
                ucDateEdit1.DateTime=DateTime.Today;  //조회 종료일
                //조회조건 영역 
