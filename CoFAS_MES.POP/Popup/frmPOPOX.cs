...
{
    public partial class frmPOPOX : frmBaseSingle
    {
        ...
        public static string button_title
        {
            get { return button_title; }
        ...
        private void btnCmd10_Click(object sender, EventArgs e)
        {
            ...
            else if(checkButton2.Checked)
            {
                ...
                {
                    CoFAS_DevExpressManager.ShowErrorMessage("점검 불가 사유를 선택해 주세요.");
                }
                
            }
            else
            {
                CoFAS_DevExpressManager.ShowErrorMessage("점검 결과를 선택해 주세요.");
            }
        ...
        private void checkButton2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            //점검 불가 사유 콤보박스 채우기
            DataTable dt = new POPEquipmentCheckBusiness().POPEquipmentCheck_Info_R20();
