...
{
    public partial class frmPopupKeypad_T02 : frmBaseSingle
    {
        ...
        private void Initialize()
        {
            try
            {
               ...
               (
                ...
                ucTextKeypad.Font = new Font("Meiryo UI", 30, FontStyle.Bold);
        ...
        private void btnCmd_Click(object pSender, EventArgs pEventArgs)
        {
            ...
            switch (sCls)
            {
                case "20":
                    ...
                    //검사등록
                    if (CoFAS_DevExpressManager.ShowQuestionMessage("データを登録しますか？") == DialogResult.Yes)
                    {
                        ...
                        {
                            if (Convert.ToInt32(ucTextKeypad.Text) >= 0 && Convert.ToInt32(ucTextKeypad.Text) < 24)
                            {
                                ucTextKeypad.Text = ucTextKeypad.Text.ToString();
                            ...
                            {
                                CoFAS_DevExpressManager.ShowInformationMessage("0〜23の間の数字を入力してください。");
                                ucTextKeypad.Text = "";
                                return;
                            }
                        }
