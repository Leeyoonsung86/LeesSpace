...
{
    public partial class frmPopupKeypad_T03 : frmBaseSingle
    {
            ...
            switch (sCls)
            {
                case "20":
                    ...
                    if (CoFAS_DevExpressManager.ShowQuestionMessage("データを登録しますか？") == DialogResult.Yes)
                    {
                        ...
                        {
                            if (Convert.ToInt32(ucTextKeypad.Text) >= 0 && Convert.ToInt32(ucTextKeypad.Text) < 60)
                            {
                            ...
                            {
                                CoFAS_DevExpressManager.ShowInformationMessage("0〜59の間の数字を入力してください。");
                                ucTextKeypad.Text = "";
                                return;
                            }
                        }
