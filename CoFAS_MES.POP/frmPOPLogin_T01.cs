...
{
    public partial class frmPOPLogin_T01 : Form
    {
        ...
        private void frmPOPLogin_T01_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeControl()
        {
            try
            {
                _luT_PROCESS_LIST.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", pUserEntity.LANGUAGE_TYPE, "POP_LIST", "", "", "").Tables[0], 0, 0, "");
                _luT_PROCESS_LIST.ItemIndex = Properties.Settings.Default.PROCESS_POP;
                _luT_PROCESS_LIST.ReadOnly = false;

                _luT_WEIGHING_LIST.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", pUserEntity.LANGUAGE_TYPE, "POP_WEIGHING_LIST", "", "", "").Tables[0], 0, 0, "");
        ...
        private void _luT_PROCESS_LIST_ValueChanged(object sender, EventArgs e)
        {
            if (_luT_PROCESS_LIST.GetValue() == "frmPOPMain_WEIGHING_COSMETICS")
            {
                _luT_WEIGHING_LIST.ReadOnly = false;
            }
            else
            {
                _luT_WEIGHING_LIST.ReadOnly = true;
            }
        }
    }
}
