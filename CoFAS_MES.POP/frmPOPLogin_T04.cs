...
{
    public partial class frmPOPLogin_T04 : Form
    {
        ...
        private void frmPOPLogin_T04_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeControl()
        {
            try
            {
                _luT_PROCESS_LIST.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R","日本", "POP_LIST_GATHERING", "", "", "").Tables[0], 0, 0, "");  ///pUserEntity.LANGUAGE_TYPE
        ...
        private void _btLoginOk_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //{
                //    case "frmGatheringMain":       //부자재실 단말기코드 : TP010001
                //        frmGatheringMain pMain1 = new frmGatheringMain();
                //        pMain1.Show();
                //        break;
                //}
