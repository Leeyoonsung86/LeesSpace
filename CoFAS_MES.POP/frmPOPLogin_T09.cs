...
{
    public partial class frmPOPLogin_T09 : Form
    {
        ...
        private void frmPOPLogin_T09_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeControl()
        {
            try
            {
                _luT_PROCESS_LIST.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", pUserEntity.LANGUAGE_TYPE, "PROCESS_MST_CODE_COSMETICS_Lookup", "", "", "").Tables[0], 0, 0,"", false);  ///pUserEntity.LANGUAGE_TYPE
