...
{
    public partial class ucEquipmentDocumentListPopup : UserControl
    {
        ...
        private static string _pFTP_IP_PORT = string.Empty;
        ...
        private ucEquipmentDocumentListPopupEntity _pucEquipmentDocumentListPopupEntity = null; // 엔티티 생성
        ...
        public ucEquipmentDocumentListPopup()
        {
            InitializeComponent();
        ...
        private void ucEquipmentDocumentListPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void CoFAS_DevExpressManager__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                case "EQUIPMENT_DOCUMENT_VIEW_MAIN_BTN":
                    ...
                    break;
                case "EQUIPMENT_DOCUMENT_VIEW_SUB_BTN":
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucEquipmentDocumentListPopupEntity.CRUD = "R";
                _pucEquipmentDocumentListPopupEntity.EQUIPMENT_MST_CODE = _luEQUIPMENT_STOP_MST_CODE2.Text.ToString();
                _pucEquipmentDocumentListPopupEntity.EQUIPMENT_CODE = _luEQUIPMENT_CODE.Text.ToString();
                _pucEquipmentDocumentListPopupEntity.USE_YN = _luUSE_YN.GetValue();

                _dtList = new ucEquipmentDocumentListPopupBusiness().ucEquipmentDocumentListPopup_Info_Main(_pucEquipmentDocumentListPopupEntity);

                if (_pucEquipmentDocumentListPopupEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucEquipmentDocumentListPopupEntity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _pucEquipmentDocumentListPopupEntity.CRUD = "R";
                _pucEquipmentDocumentListPopupEntity.EQUIPMENT_MST_CODE = _luEQUIPMENT_STOP_MST_CODE2.Text.ToString();
                _pucEquipmentDocumentListPopupEntity.EQUIPMENT_CODE = _luEQUIPMENT_CODE2.Text.ToString();
                _pucEquipmentDocumentListPopupEntity.DOCUMENT_TYPE = _luDOCUMENT_TYPE.GetValue();
                _pucEquipmentDocumentListPopupEntity.DOCUMENT_NAME = _luDOCUMENT_NAME.Text.ToString();
                _pucEquipmentDocumentListPopupEntity.DOCUMENT_VER = _luDOCUMENT_VER.Text.ToString();
                _pucEquipmentDocumentListPopupEntity.USE_YN = _luDOCUMENT_USE_YN.GetValue();

                _dtList = new ucEquipmentDocumentListPopupBusiness().ucEquipmentDocumentListPopup_Info_Sub(_pucEquipmentDocumentListPopupEntity);
        ...
        private void InputDataMain_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ucEquipmentDocumentListPopupBusiness().ucEquipmentDocumentListPopup_Info_Save(_pucEquipmentDocumentListPopupEntity, dtSave);
        ...
        private void _btSAVE_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    _pucEquipmentDocumentListPopupEntity.EQUIPMENT_MST_CODE = _luEQUIPMENT_MST_CODE.Text.ToString();
                    _pucEquipmentDocumentListPopupEntity.EQUIPMENT_CODE = _luEQUIPMENT_CODE.Text.ToString();
