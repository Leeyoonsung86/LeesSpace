...
{
    public partial class EquipmentCheck_T01 : frmBaseNone
    {
        ...
        private EquipmentCheck_T01Entity _pEquipmentCheck_T01Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pEquipmentCheck_T01Entity = new EquipmentCheck_T01Entity();
                //_pEquipmentCheck_T01Entity.CORP_CODE = _pCORP_CODE;
                _pEquipmentCheck_T01Entity.USER_CODE = _pUSER_CODE;
                _pEquipmentCheck_T01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pEquipmentCheck_T01Entity.CRUD = "";

                if (_pFirstYN)
                {
                    //MainFind_DisplayData(); //Dev Grid 데이터소스 로 바인딩 작업 처리 할 경우에는 최초 빈 데이터 테이블을 바인딩 해야 됨.
                    // Form_SearchButtonClicked(null, null);
                    //_pEquipmentCheck_T01Entity.PART_CODE = _luTPART_ALL.CodeText;
                    //_pEquipmentCheck_T01Entity.PART_NAME = _luTPART_ALL.NameText;
                    _pEquipmentCheck_T01Entity.CHECK_CYCLE = _luCHECK_CYCLE.GetValue();
                    _pEquipmentCheck_T01Entity.EQUIPMENT_CODE = _luEQUIPMENT_CODE.GetValue();
                    //_pEquipmentCheck_T01Entity.VEND_PART_CODE = _luTVEND_PART_CODE.Text;
                    _pFirstYN = false;
                }
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pEquipmentCheck_T01Entity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new EquipmentCheck_T01Business().Sample_Info(_pEquipmentCheck_T01Entity);

                if (_pEquipmentCheck_T01Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pEquipmentCheck_T01Entity.CRUD == ""))
                {
        ...
        private void InputData_Save(DataTable pDataTable)
        {
            try
            {
                ...
                bool isError = false;
                _pEquipmentCheck_T01Entity.CRUD = "C";
                _pEquipmentCheck_T01Entity.USER_CODE = _pUSER_CODE;               
                           
                
                isError = new EquipmentCheck_T01Business().Sample_Info_Save(_pEquipmentCheck_T01Entity, pDataTable);
        ...
        private void _luRESULT_DATA__OnKeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
