...
{
    public partial class EquipmentHistory : frmBaseNone
    {
        ...
        private EquipmentHistoryEntity _pEquipmentHistoryEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pEquipmentHistoryEntity = new EquipmentHistoryEntity();
                //_pProductMonitoring_T01Entity.CORP_CODE = _pCORP_CODE;
                _pEquipmentHistoryEntity.USER_CODE = _pUSER_CODE;
                _pEquipmentHistoryEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pEquipmentHistoryEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new EquipmentHistoryBusiness().EquipmentHistory_Mst(_pEquipmentHistoryEntity); //Entity에 WINDOW_NAME 추가

                if (_pEquipmentHistoryEntity.CRUD == "")
                    _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pEquipmentHistoryEntity.CRUD == ""))
                {
