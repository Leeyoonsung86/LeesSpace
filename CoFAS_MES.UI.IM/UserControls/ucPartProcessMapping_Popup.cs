...
{
    public partial class ucPartProcessMapping_Popup : UserControl
    {
        ...
        private ucPartProcessMapping_PopUpEntity _pucPartProcessMapping_PopUpEntity = null; // 엔티티 생성
        ...
        public ucPartProcessMapping_Popup()
        {
            InitializeComponent();
        ...
        private void ucPartProcessMapping_Popup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ucPartProcessMapping_PopUpBusiness().PartProcessMapping_Info_MST(_pucPartProcessMapping_PopUpEntity);

                if (_pucPartProcessMapping_PopUpEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucPartProcessMapping_PopUpEntity.CRUD == ""))
                {
        ...
        private void Part_Process_Mapping_Save(DataTable dtMapping)
        {
            try
            {
                ...
                bool isError = new ucPartProcessMapping_PopUpBusiness().PartProcessMapping_Info_Save(_pucPartProcessMapping_PopUpEntity, dtMapping);
        ...
        {
            _pucPartProcessMapping_PopUpEntity.CRUD = "R";
            _pucPartProcessMapping_PopUpEntity.PART_CODE = _luPART_CODE.Text.ToString();
            _pucPartProcessMapping_PopUpEntity.PART_NAME = _luPART_NAME.Text.ToString();
            _pucPartProcessMapping_PopUpEntity.CONFIGURATION_MST_CODE = _luCONFIGURATION_MST_CODE.Text.ToString();
