...
{
    public partial class ucProRoutingDocumentListPopup : UserControl
    {
        ...
        private ucProRoutingDocumentListPopupEntity _pucProRoutingDocumentListPopupEntity = null; // 엔티티 생성
        ...
        public ucProRoutingDocumentListPopup()
        {
            InitializeComponent();
        ...
        private void ucProRoutingDocumentListPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pucProRoutingDocumentListPopupEntity = new ucProRoutingDocumentListPopupEntity();
            _pucProRoutingDocumentListPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucProRoutingDocumentListPopupEntity.USER_CODE = _pUSER_CODE;
            _pucProRoutingDocumentListPopupEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            ...
            _luCONFIGURATION_MST_CODE.Text = ARRAY_CODE[0].ToString();
            _luCONFIGURATION_SEQ.Text = ARRAY_CODE[1].ToString();
            _luCONFIGURATION_CODE.Text = ARRAY_CODE[2].ToString();
        ...
        private void CoFAS_DevExpressManager__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                case "PROROUTING_DOCUMENT_VIEW_MAIN_BTN":
                    ...
                    break;
                case "PROROUTING_DOCUMENT_VIEW_SUB_BTN":
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucProRoutingDocumentListPopupEntity.CRUD = "R";
                _pucProRoutingDocumentListPopupEntity.CONFIGURATION_MST_CODE = _luCONFIGURATION_MST_CODE.Text.ToString();
                _pucProRoutingDocumentListPopupEntity.CONFIGURATION_SEQ = _luCONFIGURATION_SEQ.Text.ToString();
                _pucProRoutingDocumentListPopupEntity.CONFIGURATION_CODE = _luCONFIGURATION_CODE.Text.ToString();
                _pucProRoutingDocumentListPopupEntity.USE_YN = _luUSE_YN.GetValue();

                _dtList = new ucProRoutingDocumentListPopupBusiness().ucProRoutingDocumentListPopup_Info_Main(_pucProRoutingDocumentListPopupEntity);

                if (_pucProRoutingDocumentListPopupEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucProRoutingDocumentListPopupEntity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _pucProRoutingDocumentListPopupEntity.CRUD = "R";
                _pucProRoutingDocumentListPopupEntity.DOCUMENT_TYPE = _luDOCUMENT_TYPE.GetValue();
                _pucProRoutingDocumentListPopupEntity.DOCUMENT_NAME = _luDOCUMENT_NAME.Text.ToString();
                _pucProRoutingDocumentListPopupEntity.DOCUMENT_VER = _luDOCUMENT_VER.Text.ToString();
                _pucProRoutingDocumentListPopupEntity.DOCUMENT_FILE_NAME = _luDOCUMENT_FILE_NAME.Text.ToString();
                _pucProRoutingDocumentListPopupEntity.USE_YN = _luDOCUMENT_USE_YN.GetValue();

                _dtList = new ucProRoutingDocumentListPopupBusiness().ucProRoutingDocumentListPopup_Info_Sub(_pucProRoutingDocumentListPopupEntity);
        ...
        private void InputDataMain_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ucProRoutingDocumentListPopupBusiness().ucProRoutingDocumentListPopup_Info_Save(_pucProRoutingDocumentListPopupEntity, dtSave);
