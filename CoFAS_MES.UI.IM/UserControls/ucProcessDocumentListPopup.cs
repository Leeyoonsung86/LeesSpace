...
{
    public partial class ucProcessDocumentListPopup : UserControl
    {
        ...
        private ucProcessDocumentListPopupEntity _pucProcessDocumentListPopupEntity = null; // 엔티티 생성
        ...
        public ucProcessDocumentListPopup()
        {
            InitializeComponent();
        ...
        private void ucProcessDocumentListPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void CoFAS_DevExpressManager__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                case "PROCESS_DOCUMENT_VIEW_MAIN_BTN":
                    ...
                    break;
                case "PROCESS_DOCUMENT_VIEW_SUB_BTN":
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucProcessDocumentListPopupEntity.CRUD = "R";
                _pucProcessDocumentListPopupEntity.PROCESS_CODE = _luPROCESS_CODE.Text.ToString();
                _pucProcessDocumentListPopupEntity.USE_YN = _luUSE_YN.GetValue();

                _dtList = new ucProcessDocumentListPopupBusiness().ucProcessDocumentListPopup_Info_Main(_pucProcessDocumentListPopupEntity);

                if (_pucProcessDocumentListPopupEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucProcessDocumentListPopupEntity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _pucProcessDocumentListPopupEntity.CRUD = "R";
                _pucProcessDocumentListPopupEntity.DOCUMENT_TYPE = _luDOCUMENT_TYPE.GetValue();
                _pucProcessDocumentListPopupEntity.DOCUMENT_NAME = _luDOCUMENT_NAME.Text.ToString();
                _pucProcessDocumentListPopupEntity.DOCUMENT_VER = _luDOCUMENT_VER.Text.ToString();
                _pucProcessDocumentListPopupEntity.DOCUMENT_FILE_NAME = _luDOCUMENT_FILE_NAME.Text.ToString();
                _pucProcessDocumentListPopupEntity.USE_YN = _luDOCUMENT_USE_YN.GetValue();

                _dtList = new ucProcessDocumentListPopupBusiness().ucProcessDocumentListPopup_Info_Sub(_pucProcessDocumentListPopupEntity);
        ...
        private void InputDataMain_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ucProcessDocumentListPopupBusiness().ucProcessDocumentListPopup_Info_Save(_pucProcessDocumentListPopupEntity, dtSave);
