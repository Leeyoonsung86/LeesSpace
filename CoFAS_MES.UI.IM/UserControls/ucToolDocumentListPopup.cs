...
{
    public partial class ucToolDocumentListPopup : UserControl
    {
        ...
        private ucToolDocumentListPopupEntity _pucToolDocumentListPopupEntity = null; // 엔티티 생성
        ...
        public ucToolDocumentListPopup()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pucToolDocumentListPopupEntity = new ucToolDocumentListPopupEntity();
            _pucToolDocumentListPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucToolDocumentListPopupEntity.USER_CODE = _pUSER_CODE;
            _pucToolDocumentListPopupEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            ...
            _luTOOL_CODE.Text = ARRAY_CODE[0].ToString();
            _luTOOL_NAME.Text = ARRAY_CODE[1].ToString();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucToolDocumentListPopupEntity.USE_YN = _luUSE_YN.GetValue();

                _dtList = new ucToolDocumentListPopupBusiness().ucToolDocumentListPopup_Info_Main(_pucToolDocumentListPopupEntity);
        ...
        private void InputDataMain_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ucToolDocumentListPopupBusiness().ucToolDocumentListPopup_Info_Save(_pucToolDocumentListPopupEntity, dtSave);
