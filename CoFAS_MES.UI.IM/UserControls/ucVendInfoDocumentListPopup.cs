...
{
    public partial class ucVendInfoDocumentListPopup : UserControl
    {
        ...
        private ucVendDocumentListPopupEntity _pucVendDocumentListPopupEntity = null; // 엔티티 생성
        ...
        public ucVendInfoDocumentListPopup()
        {
            InitializeComponent();
        ...
        private void ucVendInfoDocumentListPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pucVendDocumentListPopupEntity = new ucVendDocumentListPopupEntity();
            _pucVendDocumentListPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucVendDocumentListPopupEntity.USER_CODE = _pUSER_CODE;
            _pucVendDocumentListPopupEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            ...
            _luVEND_CODE.Text = ARRAY_CODE[0].ToString();
            _luVEND_NAME.Text = ARRAY_CODE[1].ToString();
        ...
        private void CoFAS_DevExpressManager__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                case "VEND_DOCUMENT_VIEW_MAIN_BTN":
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucVendDocumentListPopupEntity.CRUD = "R";
                _pucVendDocumentListPopupEntity.VEND_CODE = _luVEND_CODE.Text.ToString();
                _pucVendDocumentListPopupEntity.USE_YN = _luUSE_YN.GetValue();

                _dtList = new ucVendDocumentListPopupBusiness().ucVendDocumentListPopup_Info_Main(_pucVendDocumentListPopupEntity);

                if (_pucVendDocumentListPopupEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucVendDocumentListPopupEntity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _pucVendDocumentListPopupEntity.CRUD = "R";
                _pucVendDocumentListPopupEntity.DOCUMENT_TYPE = _luDOCUMENT_TYPE.GetValue();
                _pucVendDocumentListPopupEntity.DOCUMENT_NAME = _luDOCUMENT_NAME.Text.ToString();
                _pucVendDocumentListPopupEntity.DOCUMENT_VER = _luDOCUMENT_VER.Text.ToString();
                _pucVendDocumentListPopupEntity.DOCUMENT_FILE_NAME = _luDOCUMENT_FILE_NAME.Text.ToString();
                _pucVendDocumentListPopupEntity.USE_YN = _luDOCUMENT_USE_YN.GetValue();

                _dtList = new ucVendDocumentListPopupBusiness().ucVendDocumentListPopup_Info_Sub(_pucVendDocumentListPopupEntity);
        ...
        private void InputDataMain_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ucVendDocumentListPopupBusiness().ucVendDocumentListPopup_Info_Save(_pucVendDocumentListPopupEntity, dtSave);
