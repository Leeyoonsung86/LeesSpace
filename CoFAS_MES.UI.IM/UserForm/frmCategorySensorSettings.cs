...
{
    public partial class frmCategorySensorSettings : frmBaseSingle
    {
        ...
        private frmCategorySensorSettingsEntity _pfrmCategorySensorSettingsEntity = null;
        ...
        public frmCategorySensorSettings()
        {
            InitializeComponent();
        }

        private void frmCategorySensorSettings_Load(object sender, EventArgs e)
        {
            try
            {
                InitializeSetting();
        ...
        {
            _luRESOURCE_CODE.Text = ARRAY_CODE[0].ToString();
            _luRESOURCE_NAME.Text = ARRAY_CODE[1].ToString();
            ...
            //메뉴 화면 엔티티 설정
            _pfrmCategorySensorSettingsEntity = new frmCategorySensorSettingsEntity();
            //_pfrmCategorySensorSettingsEntity.CORP_CODE = _pCORP_CODE;
            _pfrmCategorySensorSettingsEntity.USER_CODE = _pUSER_CODE;
            _pfrmCategorySensorSettingsEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                //데이터 영역
                _pfrmCategorySensorSettingsEntity.CRUD = "R";
                _pfrmCategorySensorSettingsEntity.RESOURCE_CODE = _luRESOURCE_CODE.Text.ToString();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new frmCategorySensorSettingsBusiness().frmCategorySensorSettings_Info(_pfrmCategorySensorSettingsEntity);

                if (_pfrmCategorySensorSettingsEntity.CRUD == "") _dtList.Rows.Clear();
        ...
        private void InputData_Save(DataTable dtSave)//DataTable dtSave)
        {
            try
            {
                ...
                isError = new frmCategorySensorSettingsBusiness().frmCategorySensorSettings_Info_Save(_pfrmCategorySensorSettingsEntity, dtSave);
