...
{
    public partial class CommentInfoRegister : frmBaseNone
    {
        ...
        private CommentInfoRegisterEntity _pCommentInfoRegisterEntity = null;   // 엔티티 생성
        ...
        private void Form_FormClosed(object pSender, FormClosedEventArgs pFormClosedEventArgs)
        {
            try
            {
                ...
                _luT_COMMENT._OnOpenClick -= _luT_COMMENT_OnOpenClick;
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pCommentInfoRegisterEntity = new CommentInfoRegisterEntity();
                //_pCommentInfoRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pCommentInfoRegisterEntity.USER_CODE = _pUSER_CODE;
                _pCommentInfoRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                //_pCommentInfoRegisterEntity.NOTICE_ID = "";
                //화면 설정 언어 & 명칭 변경.
                ...
                _pCommentInfoRegisterEntity.CRUD = "";
        ...
        private void InitializeControl()
        {
            try
            {
                //데이터 영역
                //T언어타입
                _luT_LANGUAGE_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "COMMON_CODE", "MM11", "", "").Tables[0], 0, 0, "", false);
                _luT_LANGUAGE_TYPE.ItemIndex = 0;
                ...
                //언어타입
                _luLANGUAGE_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "COMMON_CODE", "MM11", "", "").Tables[0], 0, 0, "", false);
                ...
                _luT_COMMENT.CodeText = "";
                _luT_COMMENT.NameText = "";

                _luT_LANGUAGE_TYPE.Text = "";
                _luT_USE_YN.Text = "";
                _luCOM_CODE.Text = "";
                _luLANGUAGE_TYPE.Text = "";
                _luUSE_YN.Text = "";
                _luCOM_DESCRIPTION.Text = "";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pCommentInfoRegisterEntity.CRUD = "R";
                _pCommentInfoRegisterEntity.USE_YN = _luT_USE_YN.GetValue();
                _pCommentInfoRegisterEntity.LANGUAGE_TYPE = _luT_LANGUAGE_TYPE.GetValue();
                _pCommentInfoRegisterEntity.COMMENT_ID = _luT_COMMENT.CodeText.ToString();
                _pCommentInfoRegisterEntity.COMMENT_DETAIL = _luT_COMMENT.NameText.ToString();
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luCOM_DESCRIPTION.Text.Length < 1)
                {
                    return;
                }
                ...
                if (_luCOM_CODE.Text != "")
                {
                    _pCommentInfoRegisterEntity.CRUD = "U";
                }
                else
                {
                    _pCommentInfoRegisterEntity.CRUD = "C";
                }

                _pCommentInfoRegisterEntity.COMMENT_ID = _luCOM_CODE.Text.ToString();
                _pCommentInfoRegisterEntity.COMMENT_DETAIL = _luCOM_DESCRIPTION.Text.ToString();
                _pCommentInfoRegisterEntity.LANGUAGE_TYPE = _luLANGUAGE_TYPE.GetValue();
                _pCommentInfoRegisterEntity.USE_YN = _luUSE_YN.GetValue();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new CommentInfoRegisterBusiness().CommentInfoRegister_Info_Mst(_pCommentInfoRegisterEntity);

                if (_pCommentInfoRegisterEntity.CRUD == "") _dtList.Rows.Clear();

                if (_dtList != null && _dtList.Rows.Count > 0)//&& _dtList.Rows.Count > 0) )|| (_dtList != null && _pCommentInfoRegisterEntity.CRUD == ""))
                {
        ...
        private void InputData_Save()
        {
            try
            {
                ...
                isError = new CommentInfoRegisterBusiness().CommentInfoRegister_Info_Save(_pCommentInfoRegisterEntity);
                ...
                else
                {
                    ...
                    // 화면 갱신
                    _pCommentInfoRegisterEntity.CRUD = "R";
                    _pCommentInfoRegisterEntity.COMMENT_ID = "";
                    _pCommentInfoRegisterEntity.COMMENT_DETAIL = "";
                    _pCommentInfoRegisterEntity.LANGUAGE_TYPE = "";
                    _pCommentInfoRegisterEntity.USE_YN = _luT_USE_YN.GetValue();

                    _pLocation_Code = _pCommentInfoRegisterEntity.RTN_KEY;  //저장 위치 
                    MainFind_DisplayData();
        ...
        #region ○ 조회 서치박스 - _luT_COMMENT_OnOpenClick(object sender, EventArgs e)
        private void _luT_COMMENT_OnOpenClick(object sender, EventArgs e)
        {
            try
            {
                ...
                frmCommonPopup.ARRAY = new object[2] { "comment_code", "" };
                frmCommonPopup.ARRAY_CODE = new object[2] { _luT_COMMENT.CodeText.ToString(), _luT_COMMENT.NameText.ToString() };
                ...
                {
                    _luT_COMMENT.CodeText = xfrmCommonPopup.dtReturn.Rows[0]["CD"].ToString();
                    _luT_COMMENT.NameText = xfrmCommonPopup.dtReturn.Rows[0]["CD_NM"].ToString();
                }
