...
{
    public partial class DataDictionary : frmBaseNone
    {
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                if (_pFirstYN)
                {
                    //_pRuleGeneratorEntity.CORP_CODE = _pCORP_CODE;
                    _pRuleGeneratorEntity.CRUD = "";  // CRUD
                    _pRuleGeneratorEntity.RESOURCE_CODE = "";  //  컴포넌트 코뜨
                    _pRuleGeneratorEntity.RULE_OPTION = "";  // 룰 OPTION 정보
                    _pRuleGeneratorEntity.IF_RULE_OPTION = ""; // 전체 룰 데이터
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _luIFOPERATOR.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R",_pLANGUAGE_TYPE, "COMMON_CODE", "RG02", "", "").Tables[0], 0, 0, "");
        ...
        private void SubFind_DisplayData(string strRESOURCE_CODE, string strRULE_OPTION)
        {
            ...
            try
            {
                ...
                _pRuleGeneratorEntity.RESOURCE_CODE = strRESOURCE_CODE;
                _pRuleGeneratorEntity.RULE_OPTION = strRULE_OPTION;

                _dtList = new RuleGeneratorBusiness().Dictionary_Info_Sub(_pRuleGeneratorEntity);
