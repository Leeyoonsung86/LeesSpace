...
{
    public partial class InspectPartMappingRegister : frmBaseNone
    {
        #region ○ 전역변수
        ...
        private InspectPartMappingRegisterEntity _pInspectPartMappingRegisterEntity = null;
        ...
        public InspectPartMappingRegister()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pInspectPartMappingRegisterEntity = new InspectPartMappingRegisterEntity();
                _pInspectPartMappingRegisterEntity.USER_CODE = _pUSER_CODE;
                _pInspectPartMappingRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                {
                    //조회조건 영역 
                    _luTPART_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "PART_TYPE", "", "", "").Tables[0], 0, 0, "");
                    _luTPART_TYPE.ItemIndex = 2;
        ...
        private void InputData_Save(DataTable pDataTable)
        {
            try
            {
                ...
                {
                    isReturn = new InspectPartMappingRegisterBusiness().InspectPart_Info_Save(_pInspectPartMappingRegisterEntity, pDataTable);
