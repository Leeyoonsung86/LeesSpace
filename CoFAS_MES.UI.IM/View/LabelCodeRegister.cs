...
{
    public partial class LabelCodeRegister : frmBaseNone
    {
        ...
        private LabelCodeRegisterEntity _pLabelCodeRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pLabelCodeRegisterEntity = new LabelCodeRegisterEntity();
                //_pLabelCodeRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pLabelCodeRegisterEntity.USER_CODE = _pUSER_CODE;
                _pLabelCodeRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pLabelCodeRegisterEntity.CRUD = "";
                ...
                if (_pFirstYN)
                {
                    ...
                    _luTPROCESS._OnOpenClick += _luTPROCESS_OnOpenClick;
                    _luTTERMINAL._OnOpenClick += _luTTERMINAL_OnOpenClick;
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _luTTERMINAL.CodeText = "";
                _luTTERMINAL.NameText = "";
                ...
                _luTERMINAL_CODE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "TERMINAL", "", "", "").Tables[0], 0, 0, "");
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pLabelCodeRegisterEntity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void _luTPROCESS_OnOpenClick(object sender, EventArgs e)
        {
            try
            {
                ...
                frmCommonPopup.ARRAY = new object[2] { "WORKCENTER", "" };
        ...
        private void _luTTERMINAL_OnOpenClick(object sender, EventArgs e)
        {
            try
            {
                ...
                frmCommonPopup.ARRAY_CODE = new object[2] { _luTTERMINAL.CodeText.ToString(), _luTTERMINAL.NameText.ToString() };
                frmCommonPopup xfrmCommonPopup = new CORE.UserForm.frmCommonPopup("CommonCode"); //유저컨트롤러 설정 부분
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _pLabelCodeRegisterEntity.LABEL_CODE = _luTLABEL_CODE.Text;
                _pLabelCodeRegisterEntity.LABEL_NAME = _luTLABEL_NAME.Text;
                _pLabelCodeRegisterEntity.PROCESS_CODE = _luTPROCESS.CodeText.ToString();
                _pLabelCodeRegisterEntity.PROCESS_NAME = _luTPROCESS.NameText.ToString();
                _pLabelCodeRegisterEntity.TERMINAL_CODE = _luTTERMINAL.CodeText.ToString();
                _pLabelCodeRegisterEntity.TERMINAL_NAME = _luTTERMINAL.NameText.ToString();
                _pLabelCodeRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
                
                _dtList = new LabelCodeRegisterBusiness().LabelCodeRegister_Info_Mst(_pLabelCodeRegisterEntity);

                if (_pLabelCodeRegisterEntity.CRUD == "") _dtList.Rows.Clear();
                
                if (_dtList != null && _dtList.Rows.Count > 0)//&& _dtList.Rows.Count > 0) )|| (_dtList != null && _pLabelCodeRegisterEntity.CRUD == ""))
                {
                    CoFAS_DevExpressManager.BindGridControl(_gdMAIN, _gdMAIN_VIEW, _dtList); //데이터 필드에 맞춰 자동 바인딩

                    if (_pLocation_Code != "" && _pLocation_YN)
                    {
                        int rowHandle = _gdMAIN_VIEW.LocateByValue("LABEL_CODE", _pLocation_Code);
        ...
        private void InputData_Save()
        {
            try
            {
                ...
                isError = new LabelCodeRegisterBusiness().LabelCodeRegister_Info_Save(_pLabelCodeRegisterEntity);
                ...
                else
                {
                    ...
                    // 화면 갱신
                    _pLabelCodeRegisterEntity.CRUD = "R";
                    _pLabelCodeRegisterEntity.LABEL_CODE = "";
                    _pLabelCodeRegisterEntity.LABEL_NAME = "";
                    _pLabelCodeRegisterEntity.PROCESS_CODE = "";
                    _pLabelCodeRegisterEntity.PROCESS_NAME = "";
                    _pLabelCodeRegisterEntity.TERMINAL_CODE = "";
                    _pLabelCodeRegisterEntity.TERMINAL_NAME = "";
                    _pLabelCodeRegisterEntity.USE_YN = _luTUSE_YN.GetValue();

                    _pLocation_Code = _pLabelCodeRegisterEntity.RTN_KEY;  //저장 위치 
