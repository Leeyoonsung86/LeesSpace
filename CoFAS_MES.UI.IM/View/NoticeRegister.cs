...
{
    public partial class NoticeRegister : frmBaseNone
    {
        ...
        private NoticeRegisterEntity _pNoticeRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pNoticeRegisterEntity = new NoticeRegisterEntity();
                //_pNoticeRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pNoticeRegisterEntity.USER_CODE = _pUSER_CODE;
                _pNoticeRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pNoticeRegisterEntity.NOTICE_ID = "";
                //화면 설정 언어 & 명칭 변경.
        ...
        private void InitializeControl()
        {
            ...
            {
                //데이터 영역
                _luTNOTICE_DATE.FromDateTime = Convert.ToDateTime("2000-01-01"); // new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1);  //조회 시작일, 매월 초 날짜로 설정
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pNoticeRegisterEntity.CRUD = "R";
                _pNoticeRegisterEntity.NOTICE_ID = gv.GetFocusedRowCellValue("NOTICE_ID").ToString();
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pNoticeRegisterEntity.CRUD = "R";
                _pNoticeRegisterEntity.DATE_FROM = DateTime.Parse(_luTNOTICE_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.FromDateTime).Replace("-", "").Substring(0, 8);//
                _pNoticeRegisterEntity.DATE_TO = DateTime.Parse(_luTNOTICE_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Replace("-", "").Substring(0, 8);//
                _pNoticeRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                //확인
                if (_pNoticeRegisterEntity.NOTICE_ID.Length > 0)
                {
                    _pNoticeRegisterEntity.CRUD = "U";
                }
                else
                {
                    _pNoticeRegisterEntity.CRUD = "C";
                }

                _pNoticeRegisterEntity.NOTICE_NAME = _luNOTICE_NAME.Text.ToString();
                _pNoticeRegisterEntity.NOTICE_DETAIL = _luNOTICE_DETAIL.Text.ToString();
                _pNoticeRegisterEntity.NOTICE_DATE = _luNOTICE_DATE.DateTime.ToString();
                _pNoticeRegisterEntity.USE_YN = _luUSE_YN.GetValue();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new NoticeRegisterBusiness().NoticeRegister_Info_Mst(_pNoticeRegisterEntity);

                if (_pNoticeRegisterEntity.CRUD == "") _dtList.Rows.Clear();
        ...
        private void InputData_Save()
        {
            try
            {
                ...
                isError = new NoticeRegisterBusiness().NoticeRegister_Info_Save(_pNoticeRegisterEntity);
                ...
                else
                {
                    ...
                    _pNoticeRegisterEntity.CRUD = "R";
                    _pNoticeRegisterEntity.NOTICE_ID = "";
                    _pNoticeRegisterEntity.NOTICE_NAME = "";
                    _pNoticeRegisterEntity.NOTICE_DETAIL = "";
                    _pNoticeRegisterEntity.USE_YN = _luTUSE_YN.GetValue();

                    _pLocation_Code = _pNoticeRegisterEntity.RTN_KEY;  //저장 위치 
                    _pNoticeRegisterEntity.DATE_FROM = DateTime.Parse(_luTNOTICE_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                    _pNoticeRegisterEntity.DATE_TO = DateTime.Parse(_luTNOTICE_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                    MainFind_DisplayData();
