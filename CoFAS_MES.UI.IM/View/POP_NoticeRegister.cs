...
{
    public partial class POP_NoticeRegister : frmBaseNone
    {
        ...
        private POP_NoticeRegisterEntity _pPOP_NoticeRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pPOP_NoticeRegisterEntity = new POP_NoticeRegisterEntity();
                //_pNoticeRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pPOP_NoticeRegisterEntity.USER_CODE = _pUSER_CODE;
                _pPOP_NoticeRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pPOP_NoticeRegisterEntity.NOTICE_ID = "";
                //화면 설정 언어 & 명칭 변경.
                ...
                _pPOP_NoticeRegisterEntity.CRUD = "";
        ...
        private void InitializeControl()
        {
            ...
            {
                //데이터 영역
                _luTNOTICE_DATE.FromDateTime = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1);  //조회 시작일, 매월 초 날짜로 설정
                _luTNOTICE_DATE.ToDateTime = DateTime.Today;  //조회 종료일, 당일 설정
                ...
                _luNOTICE_NAME.Text = "";
                _luNOTICE_DETAIL.Text = "";

                _luNOTICE_DATE.DateTime = DateTime.Today;  //조회 종료일, 당일 설정
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pPOP_NoticeRegisterEntity.CRUD = "R";
                _pPOP_NoticeRegisterEntity.NOTICE_ID = gv.GetFocusedRowCellValue("NOTICE_ID").ToString();
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pPOP_NoticeRegisterEntity.CRUD = "R";
                _pPOP_NoticeRegisterEntity.DATE_FROM = DateTime.Parse(_luTNOTICE_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.FromDateTime).Replace("-", "").Substring(0, 8);//
                _pPOP_NoticeRegisterEntity.DATE_TO = DateTime.Parse(_luTNOTICE_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Replace("-", "").Substring(0, 8);//
                _pPOP_NoticeRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luNOTICE_NAME.Text.Length < 1)
                {
                    return;
                }

                //확인
                if (_pPOP_NoticeRegisterEntity.NOTICE_ID.Length > 0)
                {
                    _pPOP_NoticeRegisterEntity.CRUD = "U";
                }
                else
                {
                    _pPOP_NoticeRegisterEntity.CRUD = "C";
                }

                _pPOP_NoticeRegisterEntity.NOTICE_NAME = _luNOTICE_NAME.Text.ToString();
                _pPOP_NoticeRegisterEntity.NOTICE_DETAIL = _luNOTICE_DETAIL.Text.ToString();
                _pPOP_NoticeRegisterEntity.NOTICE_DATE = _luNOTICE_DATE.DateTime.ToString();
                _pPOP_NoticeRegisterEntity.USE_YN = _luUSE_YN.GetValue();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new POP_NoticeRegisterBusiness().POP_NoticeRegister_Info_Mst(_pPOP_NoticeRegisterEntity);

                if (_pPOP_NoticeRegisterEntity.CRUD == "") _dtList.Rows.Clear();
        ...
        private void InputData_Save()
        {
            try
            {
                ...
                isError = new POP_NoticeRegisterBusiness().POP_NoticeRegister_Info_Save(_pPOP_NoticeRegisterEntity);
                ...
                else
                {
                    ...
                    _pPOP_NoticeRegisterEntity.CRUD = "R";
                    _pPOP_NoticeRegisterEntity.NOTICE_ID = "";
                    _pPOP_NoticeRegisterEntity.NOTICE_NAME = "";
                    _pPOP_NoticeRegisterEntity.NOTICE_DETAIL = "";
                    _pPOP_NoticeRegisterEntity.USE_YN = _luTUSE_YN.GetValue();

                    _pLocation_Code = _pPOP_NoticeRegisterEntity.RTN_KEY;  //저장 위치 
                    _pPOP_NoticeRegisterEntity.DATE_FROM = DateTime.Parse(_luTNOTICE_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                    _pPOP_NoticeRegisterEntity.DATE_TO = DateTime.Parse(_luTNOTICE_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                    MainFind_DisplayData();
