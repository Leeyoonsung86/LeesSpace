...
{
    public partial class ProcessConfigurationRegister_T50 : frmBaseNone
    {
        ...
        private ProcessConfigurationRegister_T50Entity _pProcessConfigurationRegister_T50Entity = null; // 엔티티 생성
        ...
        public ProcessConfigurationRegister_T50()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProcessConfigurationRegister_T50Entity = new ProcessConfigurationRegister_T50Entity();
                _pProcessConfigurationRegister_T50Entity.CORP_CODE = _pCORP_CODE;
                _pProcessConfigurationRegister_T50Entity.USER_CODE = _pUSER_CODE;
                _pProcessConfigurationRegister_T50Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pProcessConfigurationRegister_T50Entity.CRUD = "R";

                // _pProcessConfigurationRegister_T50Entity.CONFIGURATION_MST_CODE = _luT_CONFIGURATION_MST_CODE.Text.ToString();
                _pProcessConfigurationRegister_T50Entity.CONFIGURATION_MST_NAME = _luT_CONFIGURATION_MST_NAME.Text.ToString();
                _pProcessConfigurationRegister_T50Entity.USE_YN = _luT_USE_YN.GetValue();
                MainFind_DisplayData(); //10

                _pProcessConfigurationRegister_T50Entity.CRUD = "";
                SubFind_DisplayData();
                ...
                _pProcessConfigurationRegister_T50Entity.CRUD = "C";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void _gdSUB_VIEW_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            if (e.RowHandle != 0 || e.Column.Name != "REMARK")
            {
                return;
            }
            else
            {
                if (CoFAS_DevExpressManager.ShowQuestionMessage("비고 전부 동일하게 적용하시겠습니까 ?") == DialogResult.Yes)
                {

                    string str = e.Value.ToString();

                    for (int i = 1; i < _gdSUB_VIEW.RowCount - 1; i++)
                    {
                        _gdSUB_VIEW.SetRowCellValue(i, "REMARK", str);
        ...
        private void _gdSUB_VIEW_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            try
            {
                ...
                */
                view.SetRowCellValue(e.RowHandle, view.Columns["CONFIGURATION_MST_CODE"], "");
                view.SetRowCellValue(e.RowHandle, view.Columns["CONFIGURATION_SEQ"], "");
                view.SetRowCellValue(e.RowHandle, view.Columns["SEQ"], "");
                view.SetRowCellValue(e.RowHandle, view.Columns["PROCESS_GROUP"], "");
                view.SetRowCellValue(e.RowHandle, view.Columns["PROCESS_GUBUN"], "");
                view.SetRowCellValue(e.RowHandle, view.Columns["PROCESS_NAME"], "");
                view.SetRowCellValue(e.RowHandle, view.Columns["EQUIPMENT_GROUP"], "");
        ...
        private void InitializeGrid()
        {
            try
            {
                ...
                if (_pFirstYN)
                {
                    ...
                    _gdSUB_VIEW = _TempSubGridView.Grid_Setting(_gdSUB, _gdSUB_VIEW, _pFONT_SETTING, _pLANGUAGE_TYPE, new DevGridSettingBusiness().DevGrid_Info(_pLANGUAGE_TYPE, _pWINDOW_NAME, _gdSUB.Name.ToString()));
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _luTPART.CodeText = "";
                _luTPART.NameText = "";
                _luTPART.CodeReadOnly = true;
                _luTPART.NameReadOnly = true;

                _luCONFIGURATION_MST_CODE.Text = "";
                _luCONFIGURATION_MST_NAME.Text = "";
                _luCONFIGURATION_NAME.Text = "";
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _luCONFIGURATION_MST_CODE.Text = gv.GetFocusedRowCellValue("CONFIGURATION_MST_CODE").ToString();
                _luCONFIGURATION_MST_NAME.Text = gv.GetFocusedRowCellValue("CONFIGURATION_MST_NAME").ToString();
                _luCONFIGURATION_NAME.Text = gv.GetFocusedRowCellValue("CONFIGURATION_NAME").ToString();
                _luTPART.CodeText = gv.GetFocusedRowCellValue("PART_CODE").ToString();
                _luTPART.NameText = gv.GetFocusedRowCellValue("PART_NAME").ToString();
                _pProcessConfigurationRegister_T50Entity.CRUD = "R";
                _pProcessConfigurationRegister_T50Entity.CONFIGURATION_MST_CODE = gv.GetFocusedRowCellValue("CONFIGURATION_MST_CODE").ToString();
                //_pProcessConfigurationRegister_T50Entity.CONFIGURATION_NAME = gv.GetFocusedRowCellValue("CONFIGURATION_NAME").ToString();
                _pProcessConfigurationRegister_T50Entity.USE_YN = gv.GetFocusedRowCellValue("USE_YN").ToString();
                _luCONFIGURATION_NAME.ReadOnly = true;
                SubFind_DisplayData();
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                {
                    _pProcessConfigurationRegister_T50Entity.CRUD = "U";
                }
                else
                {
                    _pProcessConfigurationRegister_T50Entity.CRUD = "C";
                }
                _pProcessConfigurationRegister_T50Entity.RTN_KEY = "";
                _pProcessConfigurationRegister_T50Entity.CONFIGURATION_MST_CODE = _luCONFIGURATION_MST_CODE.Text;
                _pProcessConfigurationRegister_T50Entity.PART_CODE = _luTPART.CodeText.ToString();
                _pProcessConfigurationRegister_T50Entity.CONFIGURATION_MST_NAME = _luCONFIGURATION_MST_NAME.Text.ToString();
                _pProcessConfigurationRegister_T50Entity.CONFIGURATION_NAME = _luCONFIGURATION_NAME.Text.ToString();
                _pProcessConfigurationRegister_T50Entity.USE_YN = _luUSE_YN.GetValue();
        ...
        private void Form_InitialButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                // _luCONFIGURATION_VEND_CODE.Text = "";
                _luUSE_YN.ItemIndex = 0;
                _luCONFIGURATION_NAME.ReadOnly = false;

                _dtRoutingCheckList = null;

                _pProcessConfigurationRegister_T50Entity.CRUD = "R"; //R
                MainFind_DisplayData();
                _pProcessConfigurationRegister_T50Entity.CRUD = "";
                SubFind_DisplayData();
                _pProcessConfigurationRegister_T50Entity.CRUD = "C";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pProcessConfigurationRegister_T50Entity.CONFIGURATION_MST_NAME = _luT_CONFIGURATION_MST_NAME.Text.ToString();
                _pProcessConfigurationRegister_T50Entity.CONFIGURATION_NAME = _luT_CONFIGURATION_MST_NAME.Text.ToString();
                _pProcessConfigurationRegister_T50Entity.USE_YN = _luT_USE_YN.GetValue();

                _dtList = new ProcessConfigurationRegister_T50Business().ProcessConfigurationRegister_T50_Info_Main(_pProcessConfigurationRegister_T50Entity);

                if (_pProcessConfigurationRegister_T50Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProcessConfigurationRegister_T50Entity.CRUD == ""))
                {
                    CoFAS_DevExpressManager.BindGridControl(_gdMAIN, _gdMAIN_VIEW, _dtList); //데이터 필드에 맞춰 자동 바인딩
                    rowhandle = _gdMAIN_VIEW.GetFocusedDataSourceRowIndex();
                    if (_pLocation_Code != "" && _pLocation_YN)
                    {
                        int rowHandle = _gdMAIN_VIEW.LocateByValue("CONFIGURATION_MST_CODE", _pLocation_Code);
                        if (rowHandle != DevExpress.XtraGrid.GridControl.InvalidRowHandle)
                            _gdMAIN_VIEW.FocusedRowHandle = rowHandle;
                        // _gdMAIN_VIEW.RowClick = rowHandle;
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProcessConfigurationRegister_T50Business().ProcessConfigurationRegister_T50_Info_Routing_MST(_pProcessConfigurationRegister_T50Entity);
        ...
        private void InputData_Save()
        {
            try
            {
                ...
                _pProcessConfigurationRegister_T50Entity.CONFIGURATION_MST_CODE = _luCONFIGURATION_MST_CODE.Text.ToString();
                _pProcessConfigurationRegister_T50Entity.CONFIGURATION_MST_NAME = _luCONFIGURATION_MST_NAME.Text.ToString();
                //    _pProcessConfigurationRegister_T50Entity.CONFIGURATION_VEND_CODE = _luCONFIGURATION_VEND_CODE.Text.ToString();
                //    _pProcessConfigurationRegister_T50Entity.REVISION_NO = _luREVISION_NO.Text.ToString();
                _pProcessConfigurationRegister_T50Entity.USE_YN = _luUSE_YN.GetValue();

                isError = new ProcessConfigurationRegister_T50Business().ProcessConfigurationRegister_T50_Info_MST_Save(_pProcessConfigurationRegister_T50Entity);
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                bool isError = false;
                isError = new ProcessConfigurationRegister_T50Business().ProcessConfigurationRegister_T50_Info_Save(_pProcessConfigurationRegister_T50Entity, dtSave);
                ...
                else
                {
                    ...
                    // 화면 갱신
                    _pProcessConfigurationRegister_T50Entity.CRUD = "R";
                    _pProcessConfigurationRegister_T50Entity.CONFIGURATION_MST_NAME = "";
                    _pProcessConfigurationRegister_T50Entity.CONFIGURATION_NAME = "";
                    _pProcessConfigurationRegister_T50Entity.USE_YN = _luT_USE_YN.GetValue();

                    _pLocation_Code = _pProcessConfigurationRegister_T50Entity.RTN_KEY;  //저장 위치 
                    CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_SAVE);
        ...
        private bool CheckInputData()
        {
            ...
            try
            {
                ...
                if (_luCONFIGURATION_MST_NAME.Text == "")
                    pErrName += _lciCONFIGURATION_MST_NAME.Text + ". ";
                if (_luTPART.CodeText == "")
                    pErrName += _lciTPART_CODE.Text + ". ";
                if (_luCONFIGURATION_NAME.Text == "")
                    pErrName += _lciCONFIGURATION_NAME.Text + ". ";
        ...
        private void _gdMAIN_VIEW_RowChange(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            try
            {
                ...
                _pProcessConfigurationRegister_T50Entity.CRUD = "R";
                _pProcessConfigurationRegister_T50Entity.CONFIGURATION_MST_NAME = gv.GetFocusedRowCellValue("CONFIGURATION_MST_NAME").ToString();
                _pProcessConfigurationRegister_T50Entity.CONFIGURATION_NAME = gv.GetFocusedRowCellValue("CONFIGURATION_NAME").ToString();
                _pProcessConfigurationRegister_T50Entity.USE_YN = gv.GetFocusedRowCellValue("USE_YN").ToString();
        ...
        private void _luTPART__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            CORE.UserForm.frmCommonPopup.USER_CODE = _pUSER_CODE;
            CORE.UserForm.frmCommonPopup.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            CORE.UserForm.frmCommonPopup.FONT_TYPE = _pFONT_SETTING;

            CORE.UserForm.frmCommonPopup.ARRAY = new object[2] { "Product_Code", _luTPART.NameText }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
            CORE.UserForm.frmCommonPopup.ARRAY_CODE = new object[2] { _luTPART.CodeText, _luTPART.NameText };
            CORE.UserForm.frmCommonPopup xfrmcommonPopup = new CORE.UserForm.frmCommonPopup("PartCodeInfo"); //유저컨트롤러 설정 부분
            ...
            {
                _luTPART.CodeText = xfrmcommonPopup.dtReturn.Rows[0]["PART_CODE"].ToString();        // 제품코드 : 자재명
                _luTPART.NameText = xfrmcommonPopup.dtReturn.Rows[0]["PART_NAME"].ToString();
                _luCONFIGURATION_MST_NAME.Text = xfrmcommonPopup.dtReturn.Rows[0]["PART_NAME"].ToString();
            }
