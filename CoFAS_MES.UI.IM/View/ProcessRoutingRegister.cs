...
{
    public partial class ProcessRoutingRegister : frmBaseNone
    {
        ...
        private string _pMSG_CONFIGURED_INFORMATION = string.Empty; //구성된 정보 입니다.


        //알림창메시지 복사 끝

        private ProcessRoutingRegisterEntity _pProcessRoutingRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                if (dtMessage != null && dtMessage.Rows[0][0].ToString() != "")
                {
                    ...
                    _pMSG_CONFIGURED_INFORMATION = dtMessage.Rows[0]["MSG_CONFIGURED_INFORMATION"].ToString();

                }


                //메뉴 화면 엔티티 설정
                _pProcessRoutingRegisterEntity = new ProcessRoutingRegisterEntity();
                _pProcessRoutingRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pProcessRoutingRegisterEntity.USER_CODE = _pUSER_CODE;
                _pProcessRoutingRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pProcessRoutingRegisterEntity.CRUD = "";
                ...
                _pProcessRoutingRegisterEntity.CRUD = "R";
        ...
        private void grid_DragDrop(object sender, System.Windows.Forms.DragEventArgs e)
        {
            ...
            if (row != null && table != null && row.Table != table)
            {
                ...
                {
                    CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_CONFIGURED_INFORMATION);
                }
            }
        }
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProcessRoutingRegisterEntity.CRUD = "R";
                _pProcessRoutingRegisterEntity.CONFIGURATION_MST_CODE = gv.GetFocusedRowCellValue("CONFIGURATION_MST_CODE").ToString();
                _pProcessRoutingRegisterEntity.REVISION_NO = gv.GetFocusedRowCellValue("REVISION_NO").ToString();
                _pProcessRoutingRegisterEntity.USE_YN = gv.GetFocusedRowCellValue("USE_YN").ToString();
        ...
        private void _gdSUB01_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProcessRoutingRegisterEntity.CRUD = "R";
                _pProcessRoutingRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pProcessRoutingRegisterEntity.PROCESS_MST_CODE = gv.GetFocusedRowCellValue("PROCESS_MST_CODE").ToString();
        ...
        private void _gdROUTING_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                if (e.RowHandle < 0) return;
                _pProcessRoutingRegisterEntity.CRUD = "R";
                _pProcessRoutingRegisterEntity.ROUTING_MST_CODE = gv.GetFocusedRowCellValue("CONFIGURATION_CODE").ToString();
                _pProcessRoutingRegisterEntity.ROUTING_REVISION_NO = gv.GetFocusedRowCellValue("ROUTING_REVISION_NO").ToString();
                _pProcessRoutingRegisterEntity.USE_YN = gv.GetFocusedRowCellValue("USE_YN").ToString();

                RoutingProcessMST_DisplayData();
                RoutingTreeFind_DisplayData();

                _pProcessRoutingRegisterEntity.CRUD = "U";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProcessRoutingRegisterEntity.CRUD = "R";
                _pProcessRoutingRegisterEntity.CONFIGURATION_MST_CODE = _luT_CONFIGURATION_MST_CODE.Text.ToString();
                _pProcessRoutingRegisterEntity.CONFIGURATION_MST_NAME = _luT_CONFIGURATION_MST_NAME.Text.ToString();
                _pProcessRoutingRegisterEntity.USE_YN = _luT_USE_YN.GetValue();
        ...
        private void Form_InitialButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProcessRoutingRegisterEntity.CRUD = "C";
                _pProcessRoutingRegisterEntity.REVISION_NO = "";
        ...
        private void MainFind_DisplayData() //int iRowIndex
        {
            try
            {
                ...
                _dtList = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Info_Main(_pProcessRoutingRegisterEntity);


                if (_pProcessRoutingRegisterEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProcessRoutingRegisterEntity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Info_SUB01(_pProcessRoutingRegisterEntity);
                ...
                _dtList = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Info_SUB02(_pProcessRoutingRegisterEntity);
                ...
                _dtList = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Info_SUB03(_pProcessRoutingRegisterEntity);
                ...
                _dtList = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Info_SUB04(_pProcessRoutingRegisterEntity);
                ...
                _dtList = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Info_SUB05(_pProcessRoutingRegisterEntity);
                ...
                _dtList = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Info_SUB06(_pProcessRoutingRegisterEntity);
        ...
        private void SubFind_WorkCenter_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Info_WorkCenter_SUB02(_pProcessRoutingRegisterEntity);
        ...
        private void RoutingProcessFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Info_Process(_pProcessRoutingRegisterEntity);
        ...
        private void RoutingProcessMST_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Routing_Mst(_pProcessRoutingRegisterEntity);

                _pProcessRoutingRegisterEntity.ROUTING_REVISION_NO = _dtList.Rows[0]["R_REVISION_NO"].ToString();
        ...
        private void RoutingTreeFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Routing_Tree(_pProcessRoutingRegisterEntity);
            ...
            finally
            {
                // _gdSUB_VIEW.BestFitColumns();
                _pProcessRoutingRegisterEntity.CRUD = "U";
                _pProcessRoutingRegisterEntity.ROUTING_MST_CODE = "";
        ...
        private void Routing_MST_Find_DisplayData() // 40
        {
            try
            {
                ...
                _dtList = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Info_Routing_MST(_pProcessRoutingRegisterEntity);
        ...
        private void Routing_Configuration_Find_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Info_Routing_DETAIL(_pProcessRoutingRegisterEntity);
            ...
            try
            {
                ...
                if (treeList1.AllNodesCount > 0)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (!CoFAS_ConvertManager.DataTables_isEquals(_dtRoutingCheckList, dtTL))
                            {
                                ...
                                //{
                                    _pProcessRoutingRegisterEntity.CRUD = "D";
                                    //기존 리비젼 정보와 같으면 안됨.
                                    //if (_pProcessRoutingRegisterEntity.ROUTING_REVISION_NO == strRev)
                                    //{
                                    //    CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_REVISION_CHECK);
                                    //    return;
                                    //}

                                    _pProcessRoutingRegisterEntity.USE_YN = "Y"; // _luR_USE_YN.GetValue();
                                    isError = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Info_Save(_pProcessRoutingRegisterEntity, dtTL);
                                //}
                                //else
                                //{
                                //    _pProcessRoutingRegisterEntity.CRUD = "U";
                    ...
                    else
                    {
                        ...
                        _pProcessRoutingRegisterEntity.CONFIGURATION_MST_CODE = _luT_CONFIGURATION_MST_CODE.Text;
                        _pProcessRoutingRegisterEntity.CONFIGURATION_MST_NAME = _luT_CONFIGURATION_MST_NAME.Text;
        ...
        private void RoutingData_Delete_Save()
        {
            try
            {
                ...
                isError = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Info_Enable(_pProcessRoutingRegisterEntity);
        ...
        private void Configuration_Sort_Save(DataTable dtConfiguration)
        {
            try
            {
                ...
                bool isError = new ProcessRoutingRegisterBusiness().ProcessRoutingRegister_Configuration_Save(_pProcessRoutingRegisterEntity, dtConfiguration);
                ...
                else
                {
                    ...
                    _pProcessRoutingRegisterEntity.CONFIGURATION_MST_CODE = "";
                    _pProcessRoutingRegisterEntity.CONFIGURATION_MST_NAME = "";
        ...
        private void _ucbtPROCESS_SAVE_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (_luPROCESS_MST_CODE.Text.ToString().Length > 0 )
                    {
                        _pProcessRoutingRegisterEntity.CRUD = "E";
                        _pProcessRoutingRegisterEntity.ROUTING_MST_CODE = _luPROCESS_MST_CODE.Text.ToString();
                        _pProcessRoutingRegisterEntity.ROUTING_REVISION_NO = "1.0";
                        _pProcessRoutingRegisterEntity.USE_YN = _luR_USE_YN.GetValue();
        ...
        private void _ucbtROUTING_SAVE_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dtRouting_MST != null && dtRouting_MST.Rows.Count > 0)
                {
                    ...
                    _pProcessRoutingRegisterEntity.RTN_KEY = "";

                    _pProcessRoutingRegisterEntity.CONFIGURATION_MST_CODE = _luCONFIGURATION_MST_CODE.Text.ToString();
                    _pProcessRoutingRegisterEntity.CONFIGURATION_MST_NAME = _luCONFIGURATION_MST_NAME.Text.ToString();
                    _pProcessRoutingRegisterEntity.CONFIGURATION_VEND_CODE = _luCONFIGURATION_VEND_CODE.Text.ToString();
                    _pProcessRoutingRegisterEntity.REVISION_NO = "1.0";
                    _pProcessRoutingRegisterEntity.USE_YN = _luUSE_YN.GetValue();
        ...
        public void SetUpTreeList()
        {
            ...
            switch (_pProcessRoutingRegisterEntity.LANGUAGE_TYPE)
            {
                case "한국어":
        ...
        private void treeList_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (row != null)
            {
                ...
                if (treeList.AllNodesCount == 0)
                {
                    ...
                    if (CoFAS_ConvertManager.obj2int(row.ItemArray[3]) > 1)
                    {
        ...
        private void _ucbtPART_MAPPING_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (_luCONFIGURATION_MST_CODE.Text.ToString().Length > 0)
                {
                    ...
                    UI.IM.UserForm.frmCommonPopup.ARRAY_CODE = new object[3] { _luCONFIGURATION_MST_CODE.Text.ToString(), _luCONFIGURATION_MST_NAME.Text.ToString(), "1.0" };
