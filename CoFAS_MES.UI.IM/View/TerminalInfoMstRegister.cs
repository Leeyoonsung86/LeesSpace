...
{
    public partial class TerminalInfoMstRegister : frmBaseNone
    {
        ...
        private TerminalInfoMstRegisterEntity _pTerminalInfoMstRegisterEntity = null; // 엔티티 생성
        ...
        public TerminalInfoMstRegister()
        {
            InitializeComponent();
        ...
        private void Form_FormClosed(object pSender, FormClosedEventArgs pFormClosedEventArgs)
        {
            try
            {
                ...
                _luT_TERMINAL_MST._OnOpenClick -= _luT_PROCESS_OnOpenClick;
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pTerminalInfoMstRegisterEntity = new TerminalInfoMstRegisterEntity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pTerminalInfoMstRegisterEntity.USER_CODE = _pUSER_CODE;
                _pTerminalInfoMstRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pTerminalInfoMstRegisterEntity.CRUD = "";
                ...
                if (_pFirstYN)
                {
                    ...
                    _luT_TERMINAL_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "TERMINAL_TYPE", "", "", "").Tables[0], 0, 0, "", true);
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _luTERMINAL_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "TERMINAL_TYPE", "", "", "").Tables[0], 0, 0, "");

                _luTERMINAL_MST_CODE.Text = "";
                _luTERMINAL_MST_NAME.Text = "";
                _luT_TERMINAL_MST.CodeText = "";
                _luT_TERMINAL_MST.NameText = "";
                _luREMARK.Text = "";
                _luT_USE_YN.ItemIndex = 1;
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                string strTERMINAL_CODE = gv.GetFocusedRowCellValue("TERMINAL_MST_CODE").ToString();

                _pTerminalInfoMstRegisterEntity.CRUD = "R";
                _pTerminalInfoMstRegisterEntity.TERMINAL_MST_CODE = gv.GetFocusedRowCellValue("TERMINAL_MST_CODE").ToString();
        ...
        //    //if (bEdit != null)
        //    //{
        //    //    if (bEdit.Text.Trim().Length >= 0)
        //    //    {
        //    //        var gridControl = bEdit.Parent as DevExpress.XtraGrid.GridControl;
        //    //        if (gridControl == null)
        //    //            return;
        ...
        //    //        if (gridView == null)
        //    //            return;
        //    //        strT_CODE = gridView.GetFocusedRowCellValue("TERMINAL_CODE").ToString();
        ...
        //    {
        //        case "TERMINAL_BUTTON": //해당 그리드에 필드명 // 2개 이상 그리드의 버튼 항목들은 버튼 타입에 필드 명칭이 모두 다르게 설정 되어야됨.
        ...
        //            UI.IM.UserForm.frmCommonPopup.ARRAY_CODE = new object[1] { dr["TERMINAL_CODE"].ToString() };
        //            UI.IM.UserForm.frmCommonPopup xfrmCommonPopup = new UI.IM.UserForm.frmCommonPopup("TerminalDetailInfo");
        ...
        private void _TempGridView__OnButtonPressed(object sender, ButtonPressedEventArgs e)
        {
            switch (e.Button.Caption.ToString())
            {
                case "TERMINAL_BUTTON": //해당 그리드에 필드명 // 2개 이상 그리드의 버튼 항목들은 버튼 타입에 필드 명칭이 모두 다르게 설정 되어야됨.
        ...
        private void _luT_PROCESS_OnOpenClick(object sender, EventArgs e)
        {
            try
            {
                ...
                frmCommonPopup.ARRAY = new object[2] { "TERMINAL", "" };
                frmCommonPopup.ARRAY_CODE = new object[2] { _luT_TERMINAL_MST.CodeText.ToString(), _luT_TERMINAL_MST.NameText.ToString() };
                ...
                frmCommonPopup xfrmCommonPopup = new CORE.UserForm.frmCommonPopup("CommonCode_Terminal"); //유저컨트롤러 설정 부분
                xfrmCommonPopup.ShowDialog();
                ...
                {
                    _luT_TERMINAL_MST.CodeText = xfrmCommonPopup.dtReturn.Rows[0]["CD"].ToString();
                    _luT_TERMINAL_MST.NameText = xfrmCommonPopup.dtReturn.Rows[0]["CD_NM"].ToString();
                }
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luTERMINAL_MST_NAME.Text.Length < 1)
                {
                    return;
                }

                //확인
                if (_luTERMINAL_MST_CODE.Text.Length > 0)
                {
                    _pTerminalInfoMstRegisterEntity.CRUD = "U";
                }
                else
                {
                    _pTerminalInfoMstRegisterEntity.CRUD = "C";
                }
                _pTerminalInfoMstRegisterEntity.RTN_KEY = "";
                _pTerminalInfoMstRegisterEntity.TERMINAL_MST_CODE = _luTERMINAL_MST_CODE.Text.ToString();
                _pTerminalInfoMstRegisterEntity.TERMINAL_MST_NAME = _luTERMINAL_MST_NAME.Text.ToString();
                _pTerminalInfoMstRegisterEntity.TERMINAL_TYPE = _luTERMINAL_TYPE.GetValue();
                _pTerminalInfoMstRegisterEntity.REMARK = _luREMARK.Text.ToString();
                _pTerminalInfoMstRegisterEntity.USE_YN = _luUSE_YN.GetValue();
        ...
        private void Form_InitialButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _luT_TERMINAL_TYPE.ItemIndex = 0;
                _luT_USE_YN.ItemIndex = 1;

                _luT_TERMINAL_MST.CodeText = "";
                _luT_TERMINAL_MST.NameText = "";

                _luTERMINAL_TYPE.ItemIndex = 0;
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _pTerminalInfoMstRegisterEntity.TERMINAL_MST_CODE = _luT_TERMINAL_MST.CodeText.ToString();
                _pTerminalInfoMstRegisterEntity.TERMINAL_MST_NAME = _luT_TERMINAL_MST.NameText.ToString();
                _pTerminalInfoMstRegisterEntity.TERMINAL_TYPE = _luT_TERMINAL_TYPE.GetValue();
                _pTerminalInfoMstRegisterEntity.USE_YN = _luT_USE_YN.GetValue();


                _dtList = new TerminalInfoMstRegisterBusiness().Terminal_Info_Mst(_pTerminalInfoMstRegisterEntity);

                if (_pTerminalInfoMstRegisterEntity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pTerminalInfoMstRegisterEntity.CRUD == ""))
                {
                   ...
                   // CoFAS_DevExpressManager.BindGridControl(_gdMAIN, _gdMAIN_VIEW, _dtList); //데이터 필드에 맞춰 자동 바인딩
                    ...
                    {
                        int rowHandle = _gdMAIN_VIEW.LocateByValue("TERMINAL_MST_CODE", _pLocation_Code);
        ...
        private void MainBindingFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new TerminalInfoMstRegisterBusiness().Terminal_Info_Mst_Binding(_pTerminalInfoMstRegisterEntity);
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new TerminalInfoMstRegisterBusiness().Terminal_Info_Detail(_pTerminalInfoMstRegisterEntity);
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new TerminalInfoMstRegisterBusiness().Terminal_Info_Save(_pTerminalInfoMstRegisterEntity, dtSave);
                ...
                else
                {
                    ...
                    // 화면 갱신
                    _pTerminalInfoMstRegisterEntity.CRUD = "R";
                    _pTerminalInfoMstRegisterEntity.TERMINAL_MST_CODE = "";
                    _pTerminalInfoMstRegisterEntity.TERMINAL_MST_NAME = "";
                    _pTerminalInfoMstRegisterEntity.USE_YN = _luT_USE_YN.GetValue();

                    _pLocation_Code = _pTerminalInfoMstRegisterEntity.RTN_KEY;  //저장 위치 
