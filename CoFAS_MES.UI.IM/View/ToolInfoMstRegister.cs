...
{
    public partial class ToolInfoMstRegister : frmBaseNone
    {
        ...
        private ToolInfoMstRegisterEntity _pToolInfoMstRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pToolInfoMstRegisterEntity = new ToolInfoMstRegisterEntity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pToolInfoMstRegisterEntity.USER_CODE = _pUSER_CODE;
                _pToolInfoMstRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pToolInfoMstRegisterEntity.CRUD = "";
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pToolInfoMstRegisterEntity.CRUD = "R";
                _pToolInfoMstRegisterEntity.TOOL_MST_CODE = gv.GetFocusedRowCellValue("TOOL_MST_CODE").ToString();
        ...
        private void _luT_PROCESS_OnOpenClick(object sender, EventArgs e)
        {
            try
            {
                ...
                frmCommonPopup xfrmCommonPopup = new CORE.UserForm.frmCommonPopup("CommonCode_Tool"); //유저컨트롤러 설정 부분
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                {
                    _pToolInfoMstRegisterEntity.CRUD = "U";
                }
                else
                {
                    _pToolInfoMstRegisterEntity.CRUD = "C";
                }
                _pToolInfoMstRegisterEntity.RTN_KEY = "";
                _pToolInfoMstRegisterEntity.TOOL_MST_CODE = _luTOOL_MST_CODE.Text.ToString();
                _pToolInfoMstRegisterEntity.TOOL_MST_NAME = _luTOOL_MST_NAME.Text.ToString();
                _pToolInfoMstRegisterEntity.TOOL_TYPE = _luTOOL_TYPE.GetValue();
                _pToolInfoMstRegisterEntity.REMARK = _luREMARK.Text.ToString();
                _pToolInfoMstRegisterEntity.USE_YN = _luUSE_YN.GetValue();
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _pToolInfoMstRegisterEntity.TOOL_MST_CODE = _luT_TOOL_MST.CodeText.ToString();
                _pToolInfoMstRegisterEntity.TOOL_MST_NAME = _luT_TOOL_MST.NameText.ToString();
                _pToolInfoMstRegisterEntity.TOOL_TYPE = _luT_TOOL_TYPE.GetValue();
                _pToolInfoMstRegisterEntity.USE_YN = _luT_USE_YN.GetValue();


                _dtList = new ToolInfoMstRegisterBusiness().Tool_Info_Mst(_pToolInfoMstRegisterEntity);

                if (_pToolInfoMstRegisterEntity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pToolInfoMstRegisterEntity.CRUD == ""))
                {
        ...
        private void MainBindingFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ToolInfoMstRegisterBusiness().Tool_Info_Mst_Binding(_pToolInfoMstRegisterEntity);
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ToolInfoMstRegisterBusiness().Tool_Info_Detail(_pToolInfoMstRegisterEntity);
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ToolInfoMstRegisterBusiness().Tool_Info_Save(_pToolInfoMstRegisterEntity, dtSave);
                ...
                else
                {
                    ...
                    // 화면 갱신
                    _pToolInfoMstRegisterEntity.CRUD = "R";
                    _pToolInfoMstRegisterEntity.TOOL_MST_CODE = "";
                    _pToolInfoMstRegisterEntity.TOOL_MST_NAME = "";
                    _pToolInfoMstRegisterEntity.USE_YN = _luT_USE_YN.GetValue();

                    _pLocation_Code = _pToolInfoMstRegisterEntity.RTN_KEY;  //저장 위치 
