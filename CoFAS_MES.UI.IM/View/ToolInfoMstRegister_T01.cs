...
{
    public partial class ToolInfoMstRegister_T01 : frmBaseNone
    {
        ...
        private ToolInfoMstRegister_T01Entity _pToolInfoMstRegister_T01Entity = null; // 엔티티 생성
        ...
        public ToolInfoMstRegister_T01()
        {
            InitializeComponent();
        ...
        private void Form_FormClosed(object pSender, FormClosedEventArgs pFormClosedEventArgs)
        {
            try
            {
                ...
                _luT_TOOL_MST._OnOpenClick -= _luT_PROCESS_OnOpenClick;
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pToolInfoMstRegister_T01Entity = new ToolInfoMstRegister_T01Entity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pToolInfoMstRegister_T01Entity.USER_CODE = _pUSER_CODE;
                _pToolInfoMstRegister_T01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pToolInfoMstRegister_T01Entity.CRUD = "";
                ...
                if (_pFirstYN)
                {
                    ...
                    _luT_TOOL_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "TOOL_TYPE", "", "", "").Tables[0], 0, 0, "", true);
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _luTOOL_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "TOOL_TYPE", "", "", "").Tables[0], 0, 0, "");

                _luTOOL_MST_CODE.Text = "";
                _luTOOL_MST_NAME.Text = "";
                _luT_TOOL_MST.CodeText = "";
                _luT_TOOL_MST.NameText = "";
                _luREMARK.Text = "";
                _luT_USE_YN.ItemIndex = 1;
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                string strTOOL_CODE = gv.GetFocusedRowCellValue("TOOL_MST_CODE").ToString();

                _pToolInfoMstRegister_T01Entity.CRUD = "R";
                _pToolInfoMstRegister_T01Entity.TOOL_MST_CODE = gv.GetFocusedRowCellValue("TOOL_MST_CODE").ToString();
        ...
        private void CoFAS_DevExpressManager__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                case "TOOL_DOCUMENT_BTN": //해당 그리드에 필드명 // 2개 이상 그리드의 버튼 항목들은 버튼 타입에 필드 명칭이 모두 다르게 설정 되어야됨.
                    if (dr["TOOL_CODE"].ToString() == "") return;
                    ...
                    UserForm.frmCommonPopup.ARRAY_CODE = new object[2] { dr["TOOL_CODE"].ToString(), dr["TOOL_NAME"].ToString() };// dr["CONTRACT_ID"].ToString(), dr["CONTRACT_NUMBER"].ToString() }; //넘기는 파라메터 에 따라 설정

                    UserForm.frmCommonPopup xfrmcommonPopup = new UserForm.frmCommonPopup("ucToolDocumentListPopup"); //유저컨트롤러 설정 부분
        ...
        private void _luT_PROCESS_OnOpenClick(object sender, EventArgs e)
        {
            try
            {
                ...
                //frmCommonPopup.ARRAY = new object[2] { "TOOL_CODE", "" };
                frmCommonPopup.ARRAY = new object[2] { "TOOL_CODE", "" };
                frmCommonPopup.ARRAY_CODE = new object[2] { _luT_TOOL_MST.CodeText.ToString(), _luT_TOOL_MST.NameText.ToString() };
                frmCommonPopup xfrmCommonPopup = new CORE.UserForm.frmCommonPopup("CommonCode"); //유저컨트롤러 설정 부분
                ...
                if (xfrmCommonPopup.dtReturn != null && xfrmCommonPopup.dtReturn.Rows.Count > 0)
                {
                    _luT_TOOL_MST.CodeText = xfrmCommonPopup.dtReturn.Rows[0]["CD"].ToString();
                    _luT_TOOL_MST.NameText = xfrmCommonPopup.dtReturn.Rows[0]["CD_NM"].ToString();
                }
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luTOOL_MST_NAME.Text.Length < 1)
                {
                    return;
                }

                //확인
                if (_luTOOL_MST_CODE.Text.Length > 0)
                {
                    _pToolInfoMstRegister_T01Entity.CRUD = "U";
                }
                else
                {
                    _pToolInfoMstRegister_T01Entity.CRUD = "C";
                }
                _pToolInfoMstRegister_T01Entity.RTN_KEY = "";
                _pToolInfoMstRegister_T01Entity.TOOL_MST_CODE = _luTOOL_MST_CODE.Text.ToString();
                _pToolInfoMstRegister_T01Entity.TOOL_MST_NAME = _luTOOL_MST_NAME.Text.ToString();
                _pToolInfoMstRegister_T01Entity.TOOL_TYPE = _luTOOL_TYPE.GetValue();
                _pToolInfoMstRegister_T01Entity.REMARK = _luREMARK.Text.ToString();
                _pToolInfoMstRegister_T01Entity.USE_YN = _luUSE_YN.GetValue();
        ...
        private void Form_InitialButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _luT_TOOL_TYPE.ItemIndex = 0;
                _luT_USE_YN.ItemIndex = 1;

                _luT_TOOL_MST.CodeText = "";
                _luT_TOOL_MST.NameText = "";

                _luTOOL_TYPE.ItemIndex = 0;
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _pToolInfoMstRegister_T01Entity.TOOL_MST_CODE = _luT_TOOL_MST.CodeText.ToString();
                _pToolInfoMstRegister_T01Entity.TOOL_MST_NAME = _luT_TOOL_MST.NameText.ToString();
                _pToolInfoMstRegister_T01Entity.TOOL_TYPE = _luT_TOOL_TYPE.GetValue();
                _pToolInfoMstRegister_T01Entity.USE_YN = _luT_USE_YN.GetValue();


                _dtList = new ToolInfoMstRegister_T01Business().Tool_Info_Mst(_pToolInfoMstRegister_T01Entity);

                if (_pToolInfoMstRegister_T01Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pToolInfoMstRegister_T01Entity.CRUD == ""))
                {
                    CoFAS_DevExpressManager.BindGridControl(_gdMAIN, _gdMAIN_VIEW, _dtList); //데이터 필드에 맞춰 자동 바인딩

                    if (_pLocation_Code != "" && _pLocation_YN)
                    {
                        int rowHandle = _gdMAIN_VIEW.LocateByValue("TOOL_MST_CODE", _pLocation_Code);
        ...
        private void MainBindingFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ToolInfoMstRegister_T01Business().Tool_Info_Mst_Binding(_pToolInfoMstRegister_T01Entity);
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ToolInfoMstRegister_T01Business().Tool_Info_Detail(_pToolInfoMstRegister_T01Entity);
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ToolInfoMstRegister_T01Business().Tool_Info_Save(_pToolInfoMstRegister_T01Entity, dtSave);
                ...
                else
                {
                    ...
                    // 화면 갱신
                    _pToolInfoMstRegister_T01Entity.CRUD = "R";
                    _pToolInfoMstRegister_T01Entity.TOOL_MST_CODE = "";
                    _pToolInfoMstRegister_T01Entity.TOOL_MST_NAME = "";
                    _pToolInfoMstRegister_T01Entity.USE_YN = _luT_USE_YN.GetValue();

                    _pLocation_Code = _pToolInfoMstRegister_T01Entity.RTN_KEY;  //저장 위치 
