...
{
    public partial class MaterialCollectAndPay_Detail : UserControl
    {
        ...
        private MaterialCollectAndPay_DetailEntity _pMaterialCollectAndPay_DetailEntity = null; // 엔티티 생성
        ...
        public MaterialCollectAndPay_Detail()
        {
            InitializeComponent();
        ...
        private void MaterialCollectAndPay_Detail_Load(object sender, EventArgs e)
        {
            try
            {
    ...
    //    }
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                //    _pMaterialCollectAndPay_DetailEntity.CRUD = "R";
                //    _pMaterialCollectAndPay_DetailEntity.VEND_PART_CODE = _luVEND_PART_CODE.Text.ToString();
                //    _pMaterialCollectAndPay_DetailEntity.PART_NAME = _luPART_NAME.Text.ToString();
                //    _pMaterialCollectAndPay_DetailEntity.PART_REVISION_NO = _luPART_REVISION_NO.Text.ToString();
                //    _pMaterialCollectAndPay_DetailEntity.PART_HIGH = _luPART_HIGH.Text.ToString();
                //    _pMaterialCollectAndPay_DetailEntity.PART_MIDDLE = _luPART_MIDDLE.Text.ToString();
                //    _pMaterialCollectAndPay_DetailEntity.PART_LOW = _luPART_LOW.Text.ToString();
                //_dtList = new MaterialCollectAndPay_DetailBusiness().MaterialCollectAndPay_Detail_Info_Return(_pMaterialCollectAndPay_DetailEntity);
                _dtList = new MaterialCollectAndPay_DetailBusiness().Sample_Info(_pMaterialCollectAndPay_DetailEntity);

                if (_pMaterialCollectAndPay_DetailEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMaterialCollectAndPay_DetailEntity.CRUD == ""))
                {
