...
{
    public partial class ucMaterialPartListPopup_T01 : UserControl
    {
        ...
        private ucMaterialPartListPopup_T01Entity _pucMaterialPartListPopup_T01Entity = null; // 엔티티 생성
        ...
        public ucMaterialPartListPopup_T01()
        {
            InitializeComponent();
        ...
        public ucMaterialPartListPopup_T01(DataTable dt)
        {
            InitializeComponent();
            _dtreturn = dt;
            _pWINDOW_NAME = this.Name.ToString();
        ...
        private void ucMaterialPartListPopup_T01_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pucMaterialPartListPopup_T01Entity = new ucMaterialPartListPopup_T01Entity();
            _pucMaterialPartListPopup_T01Entity.CORP_CODE = _pCORP_CODE;
            _pucMaterialPartListPopup_T01Entity.USER_CODE = _pUSER_CODE;
            _pucMaterialPartListPopup_T01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            ...
            _pucMaterialPartListPopup_T01Entity.CRUD = "R";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucMaterialPartListPopup_T01Entity.CRUD = "R";
                _pucMaterialPartListPopup_T01Entity.VEND_PART_CODE = _luVEND_PART_CODE.Text.ToString();
                _pucMaterialPartListPopup_T01Entity.PART_NAME = _luPART_NAME.Text.ToString();
                _pucMaterialPartListPopup_T01Entity.PART_REVISION_NO = _luPART_REVISION_NO.Text.ToString();
                _pucMaterialPartListPopup_T01Entity.PART_HIGH = _luPART_HIGH.Text.ToString();
                _pucMaterialPartListPopup_T01Entity.PART_MIDDLE = _luPART_MIDDLE.Text.ToString();
                _pucMaterialPartListPopup_T01Entity.PART_LOW = _luPART_LOW.Text.ToString();

                _dtList = new ucMaterialPartListPopup_T01Business().ucMaterialPartListPopup_T01_Info_Return(_pucMaterialPartListPopup_T01Entity);

                if (_pucMaterialPartListPopup_T01Entity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucMaterialPartListPopup_T01Entity.CRUD == ""))
                {
        ...
        private void _ucbtCLEAR_Click(object sender, EventArgs e)
        {
            ...
            //  _pucProductionPartListPopupEntity.CRUD = "";
        ...
        private void _ucbtCANCLE_Click(object sender, EventArgs e)
        {
            ...
            {
                MM.UserForm.frmCommonPopup._DataTable = null;
