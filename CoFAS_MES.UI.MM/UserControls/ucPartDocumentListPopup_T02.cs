...
{
    public partial class ucPartDocumentListPopup_T02 : UserControl
    {
        #region ○기본전역변수
        ...
        private ucPartDocumentListPopup_T02Entity _pucPartDocumentListPopup_T02Entity = null; // 엔티티 생성
        ...
        #region ○ 생성자
        public ucPartDocumentListPopup_T02()
        {
            InitializeComponent();
        ...
        private void ucPartDocumentListPopup_T02_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            _pucPartDocumentListPopup_T02Entity = new ucPartDocumentListPopup_T02Entity();
            _pFTP_ID = ARRAY_CODE[3].ToString();
            _pFTP_PW = ARRAY_CODE[4].ToString();
            _pFTP_PATH = ARRAY_CODE[6].ToString();

            _pucPartDocumentListPopup_T02Entity.FTP_ID = _pFTP_ID;
            _pucPartDocumentListPopup_T02Entity.FTP_PW = _pFTP_PW;
            _pucPartDocumentListPopup_T02Entity.CORP_CODE = _pCORP_CODE;
            _pucPartDocumentListPopup_T02Entity.USER_CODE = _pUSER_CODE;
            _pucPartDocumentListPopup_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            _pucPartDocumentListPopup_T02Entity.FTP_PATH = _pFTP_PATH;
            _pucPartDocumentListPopup_T02Entity.FILE_FLAG = _pFILE_FLAG;
            ...
            _luPART_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "PART_TYPE_MATERIAL_T01", "", "", "").Tables[0], 0, 1, "", true);
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucPartDocumentListPopup_T02Entity.CRUD = "R";
                _pucPartDocumentListPopup_T02Entity.PART_CODE = _luPART_CODE.Text.ToString();
                _pucPartDocumentListPopup_T02Entity.PART_NAME = _luPART_NAME.Text.ToString();
                _pucPartDocumentListPopup_T02Entity.VEND_PART_CODE = _luVEND_PART_CODE.Text.ToString();
                _pucPartDocumentListPopup_T02Entity.USE_YN = _luUSE_YN.GetValue();
                _pucPartDocumentListPopup_T02Entity.PART_TYPE = _luPART_TYPE.GetValue();

                _dtList = new ucPartDocumentListPopup_T02Business().ucPartDocumentListPopup_T02_Info_Main(_pucPartDocumentListPopup_T02Entity);

                if (_pucPartDocumentListPopup_T02Entity.CRUD == "") _dtList.Rows.Clear();
                        ...
                        case 0: //오픈
                            try
                            {
                                ...
                                if (ofd.ShowDialog() == DialogResult.OK)
                                {
                                    ...
                                    _pucPartDocumentListPopup_T02Entity.FILE_FLAG = "F";
