...
{
    public partial class MaterialExpirationDateStatus : frmBaseNone
    {
        ...
        private MaterialExpirationDateStatusEntity _pMaterialExpirationDateStatusEntity = null; // 엔티티 생성
        ...
        public MaterialExpirationDateStatus()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialExpirationDateStatusEntity = new MaterialExpirationDateStatusEntity();
                //_pMaterialExpirationDateStatusEntity.CORP_CODE = _pCORP_CODE;
                _pMaterialExpirationDateStatusEntity.USER_CODE = _pUSER_CODE;
                _pMaterialExpirationDateStatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pMaterialExpirationDateStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pMaterialExpirationDateStatusEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMaterialExpirationDateStatusEntity.CRUD = "R";
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new MaterialExpirationDateStatusBusiness().MaterialExpirationDateStatus_Info_Filename(_pMaterialExpirationDateStatusEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pMaterialExpirationDateStatusEntity.WINDOW_NAME);
                ...
                // xml의 parameter 설정
                dashboard.Parameters[0].Value = _pMaterialExpirationDateStatusEntity.CRUD;
                dashboard.Parameters[1].Value = _luTPART.CodeText;
                dashboard.Parameters[2].Value = _luTPART.NameText;
                dashboard.Parameters[3].Value = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//_luTORDER_DATE.FromDateTime.ToString().Substring(0, 10).Replace("-", "");
                dashboard.Parameters[4].Value = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//_luTORDER_DATE.ToDateTime.ToString().Substring(0, 10).Replace("-", "");
