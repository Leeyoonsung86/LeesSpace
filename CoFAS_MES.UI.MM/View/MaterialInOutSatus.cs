...
{
    public partial class MaterialInOutStatus : frmBaseNone
    {
        ...
        private MaterialInOutStatusEntity _pMaterialInOutStatusEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialInOutStatusEntity = new MaterialInOutStatusEntity();
                //_pMaterialInOutStatusEntity.CORP_CODE = _pCORP_CODE;
                _pMaterialInOutStatusEntity.USER_CODE = _pUSER_CODE;
                ...
                _pMaterialInOutStatusEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMaterialInOutStatusEntity.CRUD = "R";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                if (_pMaterialInOutStatusEntity.CRUD == "") _dtList.Rows.Clear();
        ...
        private void SubFind_DisplayData(string strWINDOW_NAME, string strGRID_NAME)
        {
            try
            {
                ...
                _dtList = new MaterialInOutStatusBusiness().Sample_Info_Sub(_pMaterialInOutStatusEntity);
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new MaterialInOutStatusBusiness().Sample_Info_Save(_pMaterialInOutStatusEntity, dtSave);
