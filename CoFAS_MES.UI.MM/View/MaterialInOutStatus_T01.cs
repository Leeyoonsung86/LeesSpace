...
{
    public partial class MaterialInOutStatus_T01 : frmBaseNone
    {
        ...
        private MaterialInOutStatus_T01Entity _pMaterialInOutStatus_T01Entity = null; // 엔티티 생성
        ...
        public MaterialInOutStatus_T01()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialInOutStatus_T01Entity = new MaterialInOutStatus_T01Entity();
                //_pMaterialInOutStatus_T01Entity.CORP_CODE = _pCORP_CODE;
                _pMaterialInOutStatus_T01Entity.USER_CODE = _pUSER_CODE;
                _pMaterialInOutStatus_T01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pMaterialInOutStatus_T01Entity.CRUD = "";

                if (_pFirstYN)
                {
                    //MainFind_DisplayData(); //Dev Grid 데이터소스 로 바인딩 작업 처리 할 경우에는 최초 빈 데이터 테이블을 바인딩 해야 됨.
                    // Form_SearchButtonClicked(null, null);
                    _pMaterialInOutStatus_T01Entity.PART_CODE = _luTPART_ALL.CodeText;
                    _pMaterialInOutStatus_T01Entity.PART_NAME = _luTPART_ALL.NameText;
                    _pMaterialInOutStatus_T01Entity.PART_TYPE = _luTPART_TYPE.GetValue();
                    _pMaterialInOutStatus_T01Entity.VEND_PART_CODE = _luTVEND_PART_CODE.Text;
                    _pMaterialInOutStatus_T01Entity.INOUT_TYPE = _luTINOUT_TYPE.GetValue();
                    _pMaterialInOutStatus_T01Entity.VEND_CODE = _luTVEND.CodeText;
                    _pMaterialInOutStatus_T01Entity.VEND_NAME = _luTVEND.NameText;
                    _pMaterialInOutStatus_T01Entity.DATE_FROM = _luTINOUT_DATE.FromDateTime.ToString();
                    _pMaterialInOutStatus_T01Entity.DATE_TO = _luTINOUT_DATE.ToDateTime.ToString();
                    _pFirstYN = false;
                }
        ...
        private void InitializeControl(bool bSearch)
        {
            try
            {
                ...
                if (bSearch)
                {
                    ...
                    // _luPART_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "common_code_MR", "MR03", "", "").Tables[0], 0, 0, "", true);
                ...
                //_luPART_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "PART_TYPE_MATERIAL_T02", "", "", "").Tables[0], 0, 0, "", true);
                _luTPART_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "PART_TYPE_MATERIAL_T01", "", "", "").Tables[0], 0, 0, "");
                _luTPART_TYPE.ItemIndex = 0;

                _luTINOUT_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "I_O", "", "", "").Tables[0], 0, 0, "",true);
                _luTINOUT_TYPE.ItemIndex = 0;
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMaterialInOutStatus_T01Entity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pMaterialInOutStatus_T01Entity.PART_TYPE = _luTPART_TYPE.GetValue();
                _pMaterialInOutStatus_T01Entity.VEND_PART_CODE = _luTVEND_PART_CODE.Text;
                _pMaterialInOutStatus_T01Entity.DATE_FROM = _luTINOUT_DATE.FromDateTime.ToString("yyyyMMdd");                
                _pMaterialInOutStatus_T01Entity.DATE_TO = _luTINOUT_DATE.ToDateTime.ToString("yyyyMMdd");
                _pMaterialInOutStatus_T01Entity.VEND_CODE = _luTVEND.CodeText;
                _pMaterialInOutStatus_T01Entity.VEND_NAME = _luTVEND.NameText;
                _pMaterialInOutStatus_T01Entity.INOUT_TYPE = _luTINOUT_TYPE.GetValue();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new MaterialInOutStatus_T01Business().Sample_Info(_pMaterialInOutStatus_T01Entity);

                if (_pMaterialInOutStatus_T01Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMaterialInOutStatus_T01Entity.CRUD == ""))
                {
        ...
        private void InputData_Save(MaterialInOutStatus_T01Entity _pMaterialInOutStatus_T01Entity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
