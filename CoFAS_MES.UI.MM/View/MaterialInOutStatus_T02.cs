...
{
    public partial class MaterialInOutStatus_T02 : frmBaseNone
    {
        ...
        private MaterialInOutStatus_T02Entity _pMaterialInOutStatus_T02Entity = null; // 엔티티 생성
        ...
        public MaterialInOutStatus_T02()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialInOutStatus_T02Entity = new MaterialInOutStatus_T02Entity();
                //_pMaterialInOutStatus_T01Entity.CORP_CODE = _pCORP_CODE;
                _pMaterialInOutStatus_T02Entity.USER_CODE = _pUSER_CODE;
                _pMaterialInOutStatus_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pMaterialInOutStatus_T02Entity.CRUD = "";

                if (_pFirstYN)
                {
                    //MainFind_DisplayData(); //Dev Grid 데이터소스 로 바인딩 작업 처리 할 경우에는 최초 빈 데이터 테이블을 바인딩 해야 됨.
                    // Form_SearchButtonClicked(null, null);
                    _pMaterialInOutStatus_T02Entity.PART_CODE = _luTPART_ALL.CodeText;
                    _pMaterialInOutStatus_T02Entity.PART_NAME = _luTPART_ALL.NameText;
                    _pMaterialInOutStatus_T02Entity.DATE_FROM = _luTINOUT_DATE.FromDateTime.ToString();
                    _pMaterialInOutStatus_T02Entity.DATE_TO = _luTINOUT_DATE.ToDateTime.ToString();
                    _pFirstYN = false;
                }
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMaterialInOutStatus_T02Entity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pMaterialInOutStatus_T02Entity.PART_CODE = _luTPART_ALL.CodeText;
                _pMaterialInOutStatus_T02Entity.PART_NAME = _luTPART_ALL.NameText;
                _pMaterialInOutStatus_T02Entity.DATE_FROM = _luTINOUT_DATE.FromDateTime.ToString("yyyyMMdd");
                _pMaterialInOutStatus_T02Entity.DATE_TO = _luTINOUT_DATE.ToDateTime.ToString("yyyyMMdd");
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new MaterialInOutStatus_T02Business().Sample_Info(_pMaterialInOutStatus_T02Entity);

                if (_pMaterialInOutStatus_T02Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMaterialInOutStatus_T02Entity.CRUD == ""))
                {
