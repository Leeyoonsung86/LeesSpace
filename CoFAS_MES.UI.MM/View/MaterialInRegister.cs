...
{
    public partial class MaterialInRegister : frmBaseNone
    {
        ...
        private MaterialInRegisterEntity _pMaterialInRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialInRegisterEntity = new MaterialInRegisterEntity();
                _pMaterialInRegisterEntity.USER_CODE = _pUSER_CODE;
                _pMaterialInRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pMaterialInRegisterEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMaterialInRegisterEntity.CRUD = "R";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pMaterialInRegisterEntity.CRUD = "R";
                    _pMaterialInRegisterEntity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.FromDateTime).Replace("-", "").Substring(0, 8);//
                    _pMaterialInRegisterEntity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Replace("-", "").Substring(0, 8);//
                    _pMaterialInRegisterEntity.VEND_NAME = _luTVEND.NameText;
                    _pMaterialInRegisterEntity.VEND_CODE = _luTVEND.CodeText;
                    _pMaterialInRegisterEntity.PART_NAME = _luTPART.NameText;
                    _pMaterialInRegisterEntity.PART_CODE = _luTPART.CodeText;
                    
                    _pMaterialInRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
                    _pMaterialInRegisterEntity.INOUT_CODE = _luTINOUT_CODE.GetValue();
...

        {
            try
            {
                ...
                if (_luINOUT_ID.Text.ToString() != "")
                    _pMaterialInRegisterEntity.CRUD = "U";
                else
                    _pMaterialInRegisterEntity.CRUD = "C";


                _pMaterialInRegisterEntity.INOUT_TYPE = "I";
                _pMaterialInRegisterEntity.INOUT_ID = _luINOUT_ID.Text.ToString();
                _pMaterialInRegisterEntity.INOUT_DATE = _luINOUT_DATE.DateTime.ToString("yyyyMMdd");
                _pMaterialInRegisterEntity.INOUT_SEQ = "000000";
                _pMaterialInRegisterEntity.INOUT_CODE = _luINOUT_CODE.GetValue(); //  INOUT_CODE -> TYPE
                _pMaterialInRegisterEntity.VEND_CODE = _luVEND.CodeText;
                _pMaterialInRegisterEntity.PART_CODE = _luPART.CodeText;
                _pMaterialInRegisterEntity.INOUT_QTY = _luINOUT_QTY.Text.ToString().ToString() == "" ? "0" : _luINOUT_QTY.Text.ToString();
                _pMaterialInRegisterEntity.PART_UNIT = _luPART_UNIT.GetValue();
                _pMaterialInRegisterEntity.UNITCOST = _luUNITCOST.Text.ToString() == "" ? "0" : _luUNITCOST.Text.ToString().ToString();
                _pMaterialInRegisterEntity.COST = _luCOST.Text.ToString() == "" ? "0" : _luCOST.Text.ToString().ToString();
                _pMaterialInRegisterEntity.REFERENCE_ID = _luREFERENCE_ID.Text.ToString();
                _pMaterialInRegisterEntity.REMARK = _luREMARK.Text.ToString();
                _pMaterialInRegisterEntity.USE_YN = _luUSE_YN.GetValue();

                if (_p_Saved_YN == "Y")
                {
                    if (_pMaterialInRegisterEntity.USE_YN == "N")
                        _pMaterialInRegisterEntity.CRUD = "D";
                }
                if (_p_Saved_YN == "N")
                {
                    if (_pMaterialInRegisterEntity.USE_YN == "Y")
                        _pMaterialInRegisterEntity.CRUD = "U";
                }
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pMaterialInRegisterEntity.REFERENCE_ID = _luREFERENCE_ID.Text.ToString();
                _pMaterialInRegisterEntity.REMARK = _luREMARK.Text.ToString();
                _pMaterialInRegisterEntity.USE_YN = "N";
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new MaterialInRegisterBusiness().Material_In_Mst(_pMaterialInRegisterEntity);

                if (_pMaterialInRegisterEntity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMaterialInRegisterEntity.CRUD == ""))
                {
        ...
        private void InputData_Save(MaterialInRegisterEntity _pMaterialInRegisterEntity)
        {
            try
            {
                bool chk = true;
                ...
                if (!chk)
                {
                    if (_pMaterialInRegisterEntity.CRUD == "C" && Convert.ToDecimal(_luINOUT_QTY.Text.ToString()) > Convert.ToDecimal(_luNIN_QTY.Text == "" ? "0" : _luNIN_QTY.Text))
                    {
              ...
              else if (_pMaterialInRegisterEntity.CRUD == "U" && Convert.ToDecimal(_luINOUT_QTY.Text.ToString()) > in_qty + Convert.ToDecimal(_luNIN_QTY.Text == "" ? "0" : _luNIN_QTY.Text))//Convert.ToDecimal(_luNIN_QTY.Text == "" ? "0" : _luNIN_QTY.Text))
                    {
                ...
                {
                    isError = new MaterialInRegisterBusiness().MaterialInRegister_Info_Save(_pMaterialInRegisterEntity);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        _pLocation_Code = _pMaterialInRegisterEntity.RTN_KEY;  //저장 위치

                        _pMaterialInRegisterEntity.CRUD = "R";
                        _pMaterialInRegisterEntity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");// Convert.ToString(_luTORDER_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                        _pMaterialInRegisterEntity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
                        _pMaterialInRegisterEntity.VEND_CODE = _luVEND.CodeText;
                        _pMaterialInRegisterEntity.PART_CODE = _luPART.CodeText;
                        _pMaterialInRegisterEntity.REFERENCE_ID = _luREFERENCE_ID.Text;
                        _pMaterialInRegisterEntity.INOUT_ID = _luINOUT_ID.Text;
                        _pMaterialInRegisterEntity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                        _pMaterialInRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
