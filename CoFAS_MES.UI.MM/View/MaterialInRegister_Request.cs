...
{
    public partial class MaterialInRegister_Request : frmBaseNone
    {
        ...
        private MaterialInRegister_RequestEntity _pMaterialInRegister_RequestEntity = null; // 엔티티 생성
        ...
        public MaterialInRegister_Request()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialInRegister_RequestEntity = new MaterialInRegister_RequestEntity();
                _pMaterialInRegister_RequestEntity.USER_CODE = _pUSER_CODE;
                _pMaterialInRegister_RequestEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pMaterialInRegister_RequestEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void InitializeControl(bool bSearch)
        {
            try
            {
                ...
                if (bSearch)
                {
                    ...
                    _luINOUT_CODE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "COMMON_CODE", "MR04", "", "").Tables[0], 0, 0, "");
                    ...
                    _luTOTAL_RESULT.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "COMMON_CODE", "QC03", "", "").Tables[0], 0, 0, "", true);
                ...
                _luEND_DATE.Text = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMaterialInRegister_RequestEntity.CRUD = "R";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pMaterialInRegister_RequestEntity.CRUD = "R";
                    _pMaterialInRegister_RequestEntity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.FromDateTime).Replace("-", "").Substring(0, 8);//
                    _pMaterialInRegister_RequestEntity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Replace("-", "").Substring(0, 8);//
                    _pMaterialInRegister_RequestEntity.VEND_NAME = _luTVEND.NameText;
                    _pMaterialInRegister_RequestEntity.VEND_CODE = _luTVEND.CodeText;
                    _pMaterialInRegister_RequestEntity.PART_NAME = _luTPART.NameText;
                    _pMaterialInRegister_RequestEntity.PART_CODE = _luTPART.CodeText;
                    _pMaterialInRegister_RequestEntity.USE_YN = _luTUSE_YN.GetValue();
                    _pMaterialInRegister_RequestEntity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                    _pMaterialInRegister_RequestEntity.TOTAL_RESULT = _luTOTAL_RESULT.GetValue();
                    _pMaterialInRegister_RequestEntity.VEND_PART_CODE = _luTVEND_PART_CODE.Text.ToString();
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luINOUT_ID.Text.ToString() != "")
                    _pMaterialInRegister_RequestEntity.CRUD = "U";
                else
                    _pMaterialInRegister_RequestEntity.CRUD = "C";

                _pMaterialInRegister_RequestEntity.INOUT_TYPE = "I";
                _pMaterialInRegister_RequestEntity.INOUT_ID = _luINOUT_ID.Text.ToString();
                _pMaterialInRegister_RequestEntity.INOUT_DATE = _luINOUT_DATE.DateTime.ToString("yyyyMMdd");
                _pMaterialInRegister_RequestEntity.INOUT_SEQ = "000000";
                _pMaterialInRegister_RequestEntity.INOUT_CODE = _luINOUT_CODE.GetValue(); //  INOUT_CODE -> TYPE
                _pMaterialInRegister_RequestEntity.VEND_CODE = _luVEND.CodeText;
                _pMaterialInRegister_RequestEntity.PART_CODE = _luPART.CodeText;
                _pMaterialInRegister_RequestEntity.INOUT_QTY = _luINOUT_QTY.Text.ToString().ToString() == "" ? "0" : _luINOUT_QTY.Text.ToString();
                _pMaterialInRegister_RequestEntity.PART_UNIT = _luPART_UNIT.GetValue();
                _pMaterialInRegister_RequestEntity.UNITCOST = _luUNITCOST.Text.ToString() == "" ? "0" : _luUNITCOST.Text.ToString().ToString();
                _pMaterialInRegister_RequestEntity.COST = _luCOST.Text.ToString() == "" ? "0" : _luCOST.Text.ToString().ToString();
                _pMaterialInRegister_RequestEntity.REFERENCE_ID = _luREFERENCE_ID.Text.ToString();
                _pMaterialInRegister_RequestEntity.REMARK = _luREMARK.Text.ToString();
                _pMaterialInRegister_RequestEntity.USE_YN = _luUSE_YN.GetValue();
                _pMaterialInRegister_RequestEntity.END_DATE = _luEND_DATE.Text;


                if (_p_Saved_YN == "Y")
                {
                    if (_pMaterialInRegister_RequestEntity.USE_YN == "N")
                        _pMaterialInRegister_RequestEntity.CRUD = "D";
                }
                if (_p_Saved_YN == "N")
                {
                    if (_pMaterialInRegister_RequestEntity.USE_YN == "Y")
                        _pMaterialInRegister_RequestEntity.CRUD = "Y";
                }


                InputData_Save(_pMaterialInRegister_RequestEntity);
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pMaterialInRegister_RequestEntity.REFERENCE_ID = _luREFERENCE_ID.Text.ToString();
                _pMaterialInRegister_RequestEntity.REMARK = _luREMARK.Text.ToString();
                _pMaterialInRegister_RequestEntity.USE_YN = "N";
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new MaterialInRegister_RequestBusiness().Material_In_Mst(_pMaterialInRegister_RequestEntity);
                _luINOUT_CODE.ReadOnly = false;
                _luINOUT_CODE.ItemIndex = 0;                                                        // 타입 : 발주입고
                if (_pMaterialInRegister_RequestEntity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMaterialInRegister_RequestEntity.CRUD == ""))
                {
        ...
        private void InputData_Save(MaterialInRegister_RequestEntity _pMaterialInRegister_RequestEntity)
        {
            try
            {
                bool chk = true;
                ...
                if (!chk)
                {
                    //초과하여 입고할 수 있게
                    /*
                    if (_pMaterialInRegister_RequestEntity.CRUD == "C" && Convert.ToDecimal(_luINOUT_QTY.Text.ToString()) > Convert.ToDecimal(_luNIN_QTY.Text == "" ? "0" : _luNIN_QTY.Text))
                    {
                    ...
                    else if (_pMaterialInRegister_RequestEntity.CRUD == "U" && Convert.ToDecimal(_luINOUT_QTY.Text.ToString()) > in_qty + Convert.ToDecimal(_luNIN_QTY.Text == "" ? "0" : _luNIN_QTY.Text))//Convert.ToDecimal(_luNIN_QTY.Text == "" ? "0" : _luNIN_QTY.Text))
                    {
                ...
                {
                    isError = new MaterialInRegister_RequestBusiness().MaterialInRegister_Request_Info_Save(_pMaterialInRegister_RequestEntity);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        _pLocation_Code = _pMaterialInRegister_RequestEntity.RTN_KEY;  //저장 위치

                        _pMaterialInRegister_RequestEntity.CRUD = "R";
                        _pMaterialInRegister_RequestEntity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");// Convert.ToString(_luTORDER_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                        _pMaterialInRegister_RequestEntity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
                        _pMaterialInRegister_RequestEntity.VEND_CODE = _luVEND.CodeText;
                        _pMaterialInRegister_RequestEntity.PART_CODE = _luPART.CodeText;
                        _pMaterialInRegister_RequestEntity.REFERENCE_ID = _luREFERENCE_ID.Text;
                        _pMaterialInRegister_RequestEntity.INOUT_ID = _luINOUT_ID.Text;
                        _pMaterialInRegister_RequestEntity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                        _pMaterialInRegister_RequestEntity.USE_YN = _luTUSE_YN.GetValue();

                        _pMaterialInRegister_RequestEntity.VEND_PART_CODE = _luTVEND_PART_CODE.Text;
                        _luINOUT_CODE.ReadOnly = false;
                        Form_SearchButtonClicked(null, null);
        ...
        private void _luREFERENCE_ID__OnButtonPressed(object pSender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs pButtonPressedEventArgs)
        {
            try
            {
                ...
                // 
                // CoFAS_MES.UI.MM.UserForm.frmCommonPopup.ARRAY = new object[2] { "order_id", "" }; //넘기는 파라메터 에 따라 설정
                // CoFAS_MES.UI.MM.UserForm.frmCommonPopup.ARRAY_CODE = new object[1] { "material_request" };
                // CoFAS_MES.UI.MM.UserForm.frmCommonPopup xfrmcommonPopup = new CoFAS_MES.UI.MM.UserForm.frmCommonPopup("MaterialOrder_Request"); //유저컨트롤러 설정 부분
                //180918
                //기존 시험상태가 완료인거를 입고를 시켰지만, 지금은 발주된거 바로 입고가능하게
                frmCommonPopup.USER_CODE = _pUSER_CODE;
                frmCommonPopup.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                frmCommonPopup.FONT_TYPE = _pFONT_SETTING;
                ...
                if (xfrmcommonPopup.dtReturn != null && xfrmcommonPopup.dtReturn.Rows.Count > 0)
                {
                    ...
                    _luINOUT_CODE.ItemIndex = 0;                                                        // 타입 : 발주입고
                    //_luINOUT_CODE.ReadOnly = true;
                    _luINOUT_CODE.SetValue("MR040011"); //MR040011 =  발주입고
                    //발주입고 구분없이 변경가능하게
        ...
        private void _ucbtINSPECT_REQUEST_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < tDataTable.Rows.Count; i++)
            {
                if (tDataTable.Rows[i]["CRUD"].ToString() == "Y")
                {
                    ...
                    {
                        CoFAS_DevExpressManager.ShowInformationMessage("이미 시험의뢰를 맡긴 자재입고가 있습니다.");
                        return;
                    }
                    cnt++;
                }
            ...
            if (cnt == 0)
            {
                CoFAS_DevExpressManager.ShowInformationMessage("하나 이상의 자재입고를 선택하세요");
                return;
            }
            ...
            CoFAS_MES.UI.MM.UserForm.frmCommonPopup.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            CoFAS_MES.UI.MM.UserForm.frmCommonPopup.FONT_TYPE = _pFONT_SETTING;
            CoFAS_MES.UI.MM.UserForm.frmCommonPopup._DataTable = tTempData;



            // 0 서비스네임 1 공통코드경우 CODE_TYPE 으로구분자 올린다.
            CoFAS_MES.UI.MM.UserForm.frmCommonPopup.ARRAY = new object[2] { "InputSamplingReseult", "" };
            ...
            CoFAS_MES.UI.MM.UserForm.frmCommonPopup xfrmCommonPopup = new CoFAS_MES.UI.MM.UserForm.frmCommonPopup("InputSamplingReseult"); //유저컨트롤러 설정 부분
            xfrmCommonPopup.ShowDialog();
            ...
            if (CoFAS_DevExpressManager.ShowQuestionMessage(reutrn_dtable.Rows.Count.ToString() + "건의 시험의뢰를 하시겠습니까?") == DialogResult.Yes)
            {
                _pMaterialInRegister_RequestEntity.CRUD = "U";
                bool isError;
                isError = new MaterialInRegister_RequestBusiness().MaterialInRegister_Request_Info_Check_Save(_pMaterialInRegister_RequestEntity, reutrn_dtable);
