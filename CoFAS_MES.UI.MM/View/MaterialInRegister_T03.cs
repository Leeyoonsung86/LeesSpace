...
{
    public partial class MaterialInRegister_T03 : frmBaseNone
    {
        ...
        private MaterialInRegister_T03Entity _pMaterialInRegister_T03Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialInRegister_T03Entity = new MaterialInRegister_T03Entity();
                _pMaterialInRegister_T03Entity.USER_CODE = _pUSER_CODE;
                _pMaterialInRegister_T03Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pMaterialInRegister_T03Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMaterialInRegister_T03Entity.CRUD = "R";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pMaterialInRegister_T03Entity.CRUD = "R";
                    _pMaterialInRegister_T03Entity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.FromDateTime).Replace("-", "").Substring(0, 8);//
                    _pMaterialInRegister_T03Entity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Replace("-", "").Substring(0, 8);//
                    _pMaterialInRegister_T03Entity.VEND_NAME = _luTVEND.NameText;
                    _pMaterialInRegister_T03Entity.VEND_CODE = _luTVEND.CodeText;
                    _pMaterialInRegister_T03Entity.PART_NAME = _luTPART.NameText;
                    _pMaterialInRegister_T03Entity.PART_CODE = _luTPART.CodeText;
                    
                    _pMaterialInRegister_T03Entity.USE_YN = _luTUSE_YN.GetValue();
                    _pMaterialInRegister_T03Entity.INOUT_CODE = _luTINOUT_CODE.GetValue();
...

        {
            try
            {
                ...
                if (_luINOUT_ID.Text.ToString() != "")
                    _pMaterialInRegister_T03Entity.CRUD = "U";
                else
                    _pMaterialInRegister_T03Entity.CRUD = "C";


                _pMaterialInRegister_T03Entity.INOUT_TYPE = "I";
                _pMaterialInRegister_T03Entity.INOUT_ID = _luINOUT_ID.Text.ToString();
                _pMaterialInRegister_T03Entity.INOUT_DATE = _luINOUT_DATE.DateTime.ToString("yyyyMMdd");
                _pMaterialInRegister_T03Entity.INOUT_SEQ = "000000";
                _pMaterialInRegister_T03Entity.INOUT_CODE = _luINOUT_CODE.GetValue(); //  INOUT_CODE -> TYPE
                _pMaterialInRegister_T03Entity.VEND_CODE = _luVEND.CodeText;
                _pMaterialInRegister_T03Entity.PART_CODE = _luPART.CodeText;
                _pMaterialInRegister_T03Entity.INOUT_QTY = _luINOUT_QTY.Text.ToString().ToString() == "" ? "0" : _luINOUT_QTY.Text.ToString();
                _pMaterialInRegister_T03Entity.PART_UNIT = _luPART_UNIT.GetValue();
                _pMaterialInRegister_T03Entity.LOCATION = _luLOCATION.GetValue();
                _pMaterialInRegister_T03Entity.UNITCOST = _luUNITCOST.Text.ToString() == "" ? "0" : _luUNITCOST.Text.ToString().ToString();
                _pMaterialInRegister_T03Entity.COST = _luCOST.Text.ToString() == "" ? "0" : _luCOST.Text.ToString().ToString();
                _pMaterialInRegister_T03Entity.REFERENCE_ID = _luREFERENCE_ID.Text.ToString();
                _pMaterialInRegister_T03Entity.REMARK = _luREMARK.Text.ToString();
                _pMaterialInRegister_T03Entity.USE_YN = _luUSE_YN.GetValue();

                if (_p_Saved_YN == "Y")
                {
                    if (_pMaterialInRegister_T03Entity.USE_YN == "N")
                        _pMaterialInRegister_T03Entity.CRUD = "D";
                }
                if (_p_Saved_YN == "N")
                {
                    if (_pMaterialInRegister_T03Entity.USE_YN == "Y")
                        _pMaterialInRegister_T03Entity.CRUD = "Y";
                }


                InputData_Save(_pMaterialInRegister_T03Entity);
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pMaterialInRegister_T03Entity.REFERENCE_ID = _luREFERENCE_ID.Text.ToString();
                _pMaterialInRegister_T03Entity.REMARK = _luREMARK.Text.ToString();
                _pMaterialInRegister_T03Entity.USE_YN = "N";
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new MaterialInRegister_T03Business().Material_In_Mst(_pMaterialInRegister_T03Entity);

                if (_pMaterialInRegister_T03Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMaterialInRegister_T03Entity.CRUD == ""))
                {
        ...
        private void InputData_Save(MaterialInRegister_T03Entity _pMaterialInRegister_T03Entity)
        {
            try
            {
                bool chk = true;
                ...
                if (!chk)
                {
                    if (_pMaterialInRegister_T03Entity.CRUD == "C" && Convert.ToDecimal(_luINOUT_QTY.Text.ToString()) > Convert.ToDecimal(_luNIN_QTY.Text == "" ? "0" : _luNIN_QTY.Text))
                    {
              ...
              else if (_pMaterialInRegister_T03Entity.CRUD == "U" && Convert.ToDecimal(_luINOUT_QTY.Text.ToString()) > in_qty + Convert.ToDecimal(_luNIN_QTY.Text == "" ? "0" : _luNIN_QTY.Text))//Convert.ToDecimal(_luNIN_QTY.Text == "" ? "0" : _luNIN_QTY.Text))
                    {
                ...
                {
                    isError = new MaterialInRegister_T03Business().MaterialInRegister_T03_Info_Save(_pMaterialInRegister_T03Entity);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        _pLocation_Code = _pMaterialInRegister_T03Entity.RTN_KEY;  //저장 위치

                        _pMaterialInRegister_T03Entity.CRUD = "R";
                        _pMaterialInRegister_T03Entity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");// Convert.ToString(_luTORDER_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                        _pMaterialInRegister_T03Entity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
                        _pMaterialInRegister_T03Entity.VEND_CODE = _luVEND.CodeText;
                        _pMaterialInRegister_T03Entity.PART_CODE = _luPART.CodeText;
                        _pMaterialInRegister_T03Entity.REFERENCE_ID = _luREFERENCE_ID.Text;
                        _pMaterialInRegister_T03Entity.INOUT_ID = _luINOUT_ID.Text;
                        _pMaterialInRegister_T03Entity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                        _pMaterialInRegister_T03Entity.USE_YN = _luTUSE_YN.GetValue();
