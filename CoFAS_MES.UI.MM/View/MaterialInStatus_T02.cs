...
{
    public partial class MaterialInStatus_T02 : frmBaseNone
    {
        ...
        private MaterialInStatus_T02Entity _pMaterialInStatus_T02Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialInStatus_T02Entity = new MaterialInStatus_T02Entity();
                //_pMaterialInStatusEntity.CORP_CODE = _pCORP_CODE;
                _pMaterialInStatus_T02Entity.USER_CODE = _pUSER_CODE;
                _pMaterialInStatus_T02Entity.WINDOW_NAME = _pWINDOW_NAME;
                _pMaterialInStatus_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                //화면 설정 언어 & 명칭 변경.
                ...
                _pMaterialInStatus_T02Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMaterialInStatus_T02Entity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pMaterialInStatus_T02Entity.CRUD = "R";
                _pMaterialInStatus_T02Entity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                _pMaterialInStatus_T02Entity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd"); //Convert.ToString(_luTORDER_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
                _pMaterialInStatus_T02Entity.INOUT_ID = _luTINOUT_ID.Text;
                _pMaterialInStatus_T02Entity.PART_CODE = _luTPART.CodeText;
                _pMaterialInStatus_T02Entity.PART_NAME = _luTPART.NameText;
                _pMaterialInStatus_T02Entity.VEND_CODE = _luTVEND.CodeText;
                _pMaterialInStatus_T02Entity.VEND_NAME = _luTVEND.NameText;
                _pMaterialInStatus_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        //        _dtList = new MaterialInStatusBusiness().MaterialInStatus_Info_Filename(_pMaterialInStatusEntity); //Entity에 WINDOW_NAME 추가
        ...
        //        strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pMaterialInStatusEntity.WINDOW_NAME);
        ...
        //        // xml의 parameter 설정
        //        dashboard.Parameters[0].Value = _pMaterialInStatusEntity.CRUD;
        ...
        //        dashboard.Parameters[8].Value = _pLANGUAGE_TYPE;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new MaterialInStatus_T02Business().MaterialInStatus_T02_Info(_pMaterialInStatus_T02Entity);

                if (_pMaterialInStatus_T02Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMaterialInStatus_T02Entity.CRUD == ""))
                {
        ...
        //        isError = new MaterialInStatusBusiness().Sample_Info_Save(_pMaterialInStatusEntity, dtSave);
        ...
        private void _luTPART__OnOpenClick(object sender, EventArgs e)
        {
            ...
            frmCommonPopup.ARRAY = new object[2] { "Material_Code", _luTPART.NameText }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
