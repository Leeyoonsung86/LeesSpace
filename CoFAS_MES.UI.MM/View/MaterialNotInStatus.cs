...
{
    public partial class MaterialNotInStatus : frmBaseNone
    {
        ...
        private MaterialNotInStatusEntity _pMaterialNotInStatusEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialNotInStatusEntity = new MaterialNotInStatusEntity();
                //_pMaterialNotInStatusEntity.CORP_CODE = _pCORP_CODE;
                _pMaterialNotInStatusEntity.USER_CODE = _pUSER_CODE;
                _pMaterialNotInStatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pMaterialNotInStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pMaterialNotInStatusEntity.CRUD = "";
                if (_pFirstYN)
                {
                    _pMaterialNotInStatusEntity.CRUD = "";
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMaterialNotInStatusEntity.CRUD = "R";
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new MaterialNotInStatusBusiness().MaterialNotInStatus_Info_Filename(_pMaterialNotInStatusEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pMaterialNotInStatusEntity.WINDOW_NAME);
                ...
                // xml의 parameter 설정
                dashboard.Parameters[0].Value = _pMaterialNotInStatusEntity.CRUD;
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new MaterialNotInStatusBusiness().Sample_Info_Save(_pMaterialNotInStatusEntity, dtSave);
