...
{
    public partial class MaterialOrderRegister_T01 : frmBaseNone
    {
        #region ○ 변수선언
        ...
        private MaterialOrderRegister_T01Entity _pMaterialOrderRegister_T01Entity = null; // 엔티티 생성
        ...
        public MaterialOrderRegister_T01()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialOrderRegister_T01Entity = new MaterialOrderRegister_T01Entity();
                //_pMaterialOrderRegister_T01Entity.CORP_CODE = _pCORP_CODE;
                _pMaterialOrderRegister_T01Entity.USER_CODE = _pUSER_CODE;
                _pMaterialOrderRegister_T01Entity.WINDOW_NAME = _pWINDOW_NAME;
                _pMaterialOrderRegister_T01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                {
                    _pMaterialOrderRegister_T01Entity.CRUD = "U";
                }
                else
                {
                    _pMaterialOrderRegister_T01Entity.CRUD = "C";
                }

           
                _pMaterialOrderRegister_T01Entity.USER_CODE = _pUSER_CODE;
                _pMaterialOrderRegister_T01Entity.ORDER_ID = _luORDER_ID.Text;
                //_pMaterialOrderRegister_T01Entity.ORDER_DATE = _luORDER_DATE.DateTime.ToString().Substring(0,10).Replace("-", "").ToString();
                _pMaterialOrderRegister_T01Entity.ORDER_DATE = DateTime.Parse(_luORDER_DATE.DateTime.ToString()).ToString("yyyyMMdd");

                _pMaterialOrderRegister_T01Entity.ORDER_SEQ = "";
                _pMaterialOrderRegister_T01Entity.VEND_CODE = _luVEND.CodeText;
                _pMaterialOrderRegister_T01Entity.PART_CODE = _luPART.CodeText;
                _pMaterialOrderRegister_T01Entity.ORDER_QTY = _luORDER_QTY.Text;
                //_pMaterialOrderRegister_T01Entity.REQUEST_DATE = _luREQUEST_DATE.DateTime.ToString().Substring(0, 10).Replace("-", "").ToString();
                _pMaterialOrderRegister_T01Entity.REQUEST_DATE = DateTime.Parse(_luREQUEST_DATE.DateTime.ToString()).ToString("yyyyMMdd");
                _pMaterialOrderRegister_T01Entity.REQUEST_LOCATION = _luREQUEST_LOCATION.Text;
                _pMaterialOrderRegister_T01Entity.UNIT_CODE = _luUNIT_CODE.GetValue();
                _pMaterialOrderRegister_T01Entity.UNITCODT_CURRENCY_CODE = _luREQUEST_LOCATION.Text; 
                _pMaterialOrderRegister_T01Entity.UNITCOST = _luUNIT_COST.Text;
                _pMaterialOrderRegister_T01Entity.COST = _luCOST.Text;
                _pMaterialOrderRegister_T01Entity.CONTRACT_ID = _luREFERENCE_ID.Text;
                _pMaterialOrderRegister_T01Entity.REMARK = _luREMARK.Text;
                _pMaterialOrderRegister_T01Entity.USE_YN = _luUSE_YN.GetValue();


                InputData_Save(_pMaterialOrderRegister_T01Entity);
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luORDER_ID.Text.ToString() != "")
                {
                    _pMaterialOrderRegister_T01Entity.CRUD = "D";
                }
                else
                {
                ...
                _pMaterialOrderRegister_T01Entity.CONTRACT_ID = _luREFERENCE_ID.Text;
                _pMaterialOrderRegister_T01Entity.REMARK = _luREMARK.Text;
                _pMaterialOrderRegister_T01Entity.USE_YN = "Y";
        ...
        private void Form_PrintButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pINOUT_CODE_LIST = "AND A.order_id IN (";
                ...
                for (int i = 0; i < tDataTable.Rows.Count; i++)
                {
                    if (tDataTable.Rows[i]["CRUD"].ToString() == "Y")
                    {
                        ...
                        _pINOUT_CODE_LIST = _pINOUT_CODE_LIST + "'" + tDataTable.Rows[i]["ORDER_ID"].ToString() + "'";
                        if (i + 1 < tDataTable.Rows.Count)
                        {
                            if (tDataTable.Rows[i + 1]["ORDER_ID"].ToString() != null || tDataTable.Rows[i + 1]["ORDER_ID"].ToString() != "")
                            {
                ...
                MM.UserForm.frmCommonPopup.strFile_NAME = "MaterialOrderRegister_T01.xlsx";
        ...
        private void Form_SettingButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                //xfrmPageSetting.PASS_CORP_CODE = _pMaterialOrderRegister_T01Entity.CORP_CODE;
        ...
        private void MainFind_DisplayData(string pCRUD)
        {
            try
            {
                ...
                _pMaterialOrderRegister_T01Entity.CRUD = pCRUD;
                //_pMaterialOrderRegister_T01Entity.DATE_FROM = Convert.ToString(_luT_ORDER_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                //_pMaterialOrderRegister_T01Entity.DATE_TO = Convert.ToString(_luT_ORDER_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
                _pMaterialOrderRegister_T01Entity.DATE_FROM = DateTime.Parse(_luT_ORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _pMaterialOrderRegister_T01Entity.DATE_TO   = DateTime.Parse(_luT_ORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");

                _pMaterialOrderRegister_T01Entity.ORDER_ID = _luTORDER_ID.Text;
                _pMaterialOrderRegister_T01Entity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                _pMaterialOrderRegister_T01Entity.VEND_PART_CDOE = _luTVEND_PART_CODE.Text;
                _pMaterialOrderRegister_T01Entity.USE_YN = _luTUSE_YN.GetValue();
                _pMaterialOrderRegister_T01Entity.VEND_CODE = _luT_VEND_CODE.CodeText.ToString() ;
                _pMaterialOrderRegister_T01Entity.VEND_NAME = _luT_VEND_CODE.NameText.ToString();
                _pMaterialOrderRegister_T01Entity.PART_CODE = _luT_PART_CODE.CodeText.ToString();
                _pMaterialOrderRegister_T01Entity.PART_NAME = _luT_PART_CODE.NameText.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    _dtList = new MaterialOrderRegister_T01Provider(pDBManager).MaterialOrderRegister_T01_R10(_pMaterialOrderRegister_T01Entity);
        ...
        private void SheetFind_DisplayData()   //추가
        {
            try
            {
                ...
                _dtList = new MaterialOrderRegister_T01Business().Sheet_Info_Sheet(_pMaterialOrderRegister_T01Entity);
        ...
        private void InputData_Save(MaterialOrderRegister_T01Entity _pMaterialOrderRegister_T01Entityt)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    if (CoFAS_DevExpressManager.ShowQuestionMessage(_pMSG_SAVE_QUESTION) == DialogResult.Yes)
                    {
                        ...
                        isError = new MaterialOrderRegister_T01Business().MaterialOrderRegister_T01_Info_Save(_pMaterialOrderRegister_T01Entity);
                    ...
                    else
                    {
                            ...
                            _pLocation_Code = _pMaterialOrderRegister_T01Entity.RTN_KEY;  //저장 위치 
                            MainFind_DisplayData("R");
                        }
                    }
                    else
        ...
        private void _luT_PART_CODE__OnOpenClick(object sender, EventArgs e)
        {
            ...
            frmCommonPopup.ARRAY = new object[3] { "Material_Code", _luPART.NameText, _pWINDOW_NAME }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
