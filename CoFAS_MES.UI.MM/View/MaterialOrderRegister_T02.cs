...
{
    public partial class MaterialOrderRegister_T02 : frmBaseNone
    {
        #region ○ 변수선언
        ...
        private MaterialOrderRegister_T02Entity MaterialOrderRegister_T02Entity = null; // 엔티티 생성
        ...
        MaterialOrderRegister_T02Entity _MaterialOrderRegister_T02Entity;
        ...
        public MaterialOrderRegister_T02()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _MaterialOrderRegister_T02Entity = new MaterialOrderRegister_T02Entity();
                //_MaterialOrderRegister_T02Entity.CORP_CODE = _pCORP_CODE;
                _MaterialOrderRegister_T02Entity.USER_CODE = _pUSER_CODE;
                _MaterialOrderRegister_T02Entity.WINDOW_NAME = _pWINDOW_NAME;
                _MaterialOrderRegister_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                {
                    _MaterialOrderRegister_T02Entity.CRUD = "U";
                }
                else
                {
                    _MaterialOrderRegister_T02Entity.CRUD = "C";
                }

           
                _MaterialOrderRegister_T02Entity.USER_CODE = _pUSER_CODE;
                _MaterialOrderRegister_T02Entity.ORDER_ID = _luORDER_ID.Text;
                //_MaterialOrderRegister_T02Entity.ORDER_DATE = _luORDER_DATE.DateTime.ToString().Substring(0,10).Replace("-", "").ToString();
                _MaterialOrderRegister_T02Entity.ORDER_DATE = DateTime.Parse(_luORDER_DATE.DateTime.ToString()).ToString("yyyyMMdd");

                _MaterialOrderRegister_T02Entity.ORDER_SEQ = "";
                _MaterialOrderRegister_T02Entity.VEND_CODE = _luVEND.CodeText;
                _MaterialOrderRegister_T02Entity.PART_CODE = _luPART.CodeText;
                _MaterialOrderRegister_T02Entity.ORDER_QTY = _luORDER_QTY.Text;
                //_MaterialOrderRegister_T02Entity.REQUEST_DATE = _luREQUEST_DATE.DateTime.ToString().Substring(0, 10).Replace("-", "").ToString();
                _MaterialOrderRegister_T02Entity.REQUEST_DATE = DateTime.Parse(_luREQUEST_DATE.DateTime.ToString()).ToString("yyyyMMdd");
                _MaterialOrderRegister_T02Entity.REQUEST_LOCATION = _luREQUEST_LOCATION.Text;
                _MaterialOrderRegister_T02Entity.UNIT_CODE = _luUNIT_CODE.GetValue();
                _MaterialOrderRegister_T02Entity.UNITCODT_CURRENCY_CODE = _luREQUEST_LOCATION.Text; 
                _MaterialOrderRegister_T02Entity.UNITCOST = _luUNIT_COST.Text;
                _MaterialOrderRegister_T02Entity.COST = _luCOST.Text;
                //_MaterialOrderRegister_T02Entity.CONTRACT_ID = _luREFERENCE_ID.Text;
                _MaterialOrderRegister_T02Entity.REMARK = _luREMARK.Text;
                _MaterialOrderRegister_T02Entity.USE_YN = _luUSE_YN.GetValue();


                InputData_Save(_MaterialOrderRegister_T02Entity);
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luORDER_ID.Text.ToString() != "")
                {
                    _MaterialOrderRegister_T02Entity.CRUD = "D";
                }
                else
                {
                ...
                //_MaterialOrderRegister_T02Entity.CONTRACT_ID = _luREFERENCE_ID.Text;
                _MaterialOrderRegister_T02Entity.REMARK = _luREMARK.Text;
                _MaterialOrderRegister_T02Entity.USE_YN = "Y";
        ...
        private void Form_PrintButtonClicked(object pSender, EventArgs pEventArgs)  
        {
          ...
          finally
          {
              CoFAS_DevExpressManager.SetCursor(this, Cursors.Default);
                ...
                MaterialOrderRegister_T02.LANGUAGE_TYPE = _pLANGUAGE_TYPE;

                //check_yn : false = 개별
                //check_yn: : true = 합계
                _MaterialOrderRegister_T02Entity.check_yn = true;
                bool isError = false;
                ...
                //먼저 초기화
                _MaterialOrderRegister_T02Entity.CRUD = "D";
                isError = new ucBOM_SpendQtyCalcPopBusiness().MaterialOrderRegister_T02_Save2(_MaterialOrderRegister_T02Entity, tDataTable);
                ...
                if (!isError)
                {
                    ...
                    if (!isError)
                    {
                        ...
                        //체크하기
                        _MaterialOrderRegister_T02Entity.CRUD = "R";

                        //_dtList = new ucBOM_SpendQtyCalcPopBusiness().VendCost_Sub_Return2(_ucBOM_SpendQtyCalcPopEntity, tDataTable);
                        //_dtList = new ucBOM_SpendQtyCalcPopBusiness().VendCost_Sub_Return_T02(_MaterialOrderRegister_T02Entity, tDataTable);
                        //CoFAS_DevExpressManager.ShowInformationMessage("인쇄준비가 되었습니다.  ");
                        //_Close_Click(null, null);
                        //여기다 엑셀 넣을거임

                        if (_MaterialOrderRegister_T02Entity.ORDER_ID == "")
                        {
                            string strFTP_PATH = "";
                            string strUSE_TYPE = "";
                            string strFILE_NAME = "";

                            _dtList = new MaterialOrderRegister_T02Business().Sheet_Info_Sheet(_MaterialOrderRegister_T02Entity);
        ...
        private void Form_SettingButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                //xfrmPageSetting.PASS_CORP_CODE = _MaterialOrderRegister_T02Entity.CORP_CODE;
        ...
        private void MainFind_DisplayData(string pCRUD)
        {
            try
            {
                ...
                _MaterialOrderRegister_T02Entity.CRUD = pCRUD;
                //_MaterialOrderRegister_T02Entity.DATE_FROM = Convert.ToString(_luT_ORDER_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                //_MaterialOrderRegister_T02Entity.DATE_TO = Convert.ToString(_luT_ORDER_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
                _MaterialOrderRegister_T02Entity.DATE_FROM = DateTime.Parse(_luT_ORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _MaterialOrderRegister_T02Entity.DATE_TO   = DateTime.Parse(_luT_ORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");

                _MaterialOrderRegister_T02Entity.ORDER_ID = _luTORDER_ID.Text;
                _MaterialOrderRegister_T02Entity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                _MaterialOrderRegister_T02Entity.VEND_PART_CDOE = _luTVEND_PART_CODE.Text;
                _MaterialOrderRegister_T02Entity.USE_YN = _luTUSE_YN.GetValue();
                _MaterialOrderRegister_T02Entity.VEND_CODE = _luT_VEND_CODE.CodeText.ToString() ;
                _MaterialOrderRegister_T02Entity.VEND_NAME = _luT_VEND_CODE.NameText.ToString();
                _MaterialOrderRegister_T02Entity.PART_CODE = _luT_PART_CODE.CodeText.ToString();
                _MaterialOrderRegister_T02Entity.PART_NAME = _luT_PART_CODE.NameText.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    _dtList = new MaterialOrderRegister_T02Provider(pDBManager).MaterialOrderRegister_T02_R10(_MaterialOrderRegister_T02Entity);
        ...
        private void InputData_Save(MaterialOrderRegister_T02Entity _MaterialOrderRegister_T02Entity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    if (CoFAS_DevExpressManager.ShowQuestionMessage(_pMSG_SAVE_QUESTION) == DialogResult.Yes)
                    {
                        ...
                        isError = new MaterialOrderRegister_T02Business().MaterialOrderRegister_T02_Info_Save(_MaterialOrderRegister_T02Entity);
                    ...
                    else
                    {
                            ...
                            _pLocation_Code = _MaterialOrderRegister_T02Entity.RTN_KEY;  //저장 위치 
                            MainFind_DisplayData("R");
                        }
                    }
                    else
