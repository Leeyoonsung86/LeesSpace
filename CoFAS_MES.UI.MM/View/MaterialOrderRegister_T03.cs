...
{
    public partial class MaterialOrderRegister_T03 : frmBaseNone 
    {
        #region ○ 변수선언
        ...
        private MaterialOrderRegister_T03Entity MaterialOrderRegister_T03Entity = null; // 엔티티 생성
        private MaterialOrderRegisterEntity_Request _pMaterialOrderRegister_RequestEntity = null;
        private DataTable _dtList = null; //조회 데이터 리스트
        private Object _ojList = null;    //엑셀파일  //추가
        private DataSet _stList = null;   //DataSet  //추가
        private string _pFTP_DOWNLOAD_PATH = ""; // 엑셀파일 저장
        ...
        public static string LANGUAGE_TYPE { get; private set; }
        private string _pCRUD = ""; //CRUD
        ucBOM_SpendQtyCalcPopEntity _ucBOM_SpendQtyCalcPopEntity;
        MaterialOrderRegister_T03Entity _MaterialOrderRegister_T03Entity;
        ucOrderExcelView _ucOrderExcelView;
        ...
        public MaterialOrderRegister_T03()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _MaterialOrderRegister_T03Entity = new MaterialOrderRegister_T03Entity();
                //_MaterialOrderRegister_T03Entity.CORP_CODE = _pCORP_CODE;
                _MaterialOrderRegister_T03Entity.USER_CODE = _pUSER_CODE;
                _MaterialOrderRegister_T03Entity.WINDOW_NAME = _pWINDOW_NAME;
                _MaterialOrderRegister_T03Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _MaterialOrderRegister_T03Entity.USER_NAME = _pUSER_NAME;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                {
                    _MaterialOrderRegister_T03Entity.CRUD = "U";
                }
                else
                {
                    _MaterialOrderRegister_T03Entity.CRUD = "C";
                }

           
                _MaterialOrderRegister_T03Entity.USER_CODE = _pUSER_CODE;
                _MaterialOrderRegister_T03Entity.ORDER_ID = _luORDER_ID.Text;
                //_MaterialOrderRegister_T03Entity.ORDER_DATE = _luORDER_DATE.DateTime.ToString().Substring(0,10).Replace("-", "").ToString();
                _MaterialOrderRegister_T03Entity.ORDER_DATE = DateTime.Parse(_luORDER_DATE.DateTime.ToString()).ToString("yyyyMMdd");

                _MaterialOrderRegister_T03Entity.ORDER_SEQ = "";
                _MaterialOrderRegister_T03Entity.VEND_CODE = _luVEND.CodeText;
                _MaterialOrderRegister_T03Entity.PART_CODE = _luPART.CodeText;
                _MaterialOrderRegister_T03Entity.ORDER_QTY = _luORDER_QTY.Text;
                //_MaterialOrderRegister_T03Entity.REQUEST_DATE = _luREQUEST_DATE.DateTime.ToString().Substring(0, 10).Replace("-", "").ToString();
                _MaterialOrderRegister_T03Entity.REQUEST_DATE = DateTime.Parse(_luREQUEST_DATE.DateTime.ToString()).ToString("yyyyMMdd");
                _MaterialOrderRegister_T03Entity.REQUEST_LOCATION = _luREQUEST_LOCATION.Text;
                _MaterialOrderRegister_T03Entity.UNIT_CODE = _luUNIT_CODE.GetValue();
                _MaterialOrderRegister_T03Entity.UNITCODT_CURRENCY_CODE = _luREQUEST_LOCATION.Text; 
                _MaterialOrderRegister_T03Entity.UNITCOST = _luUNIT_COST.Text;
                _MaterialOrderRegister_T03Entity.COST = _luCOST.Text;
                //_MaterialOrderRegister_T03Entity.CONTRACT_ID = _luREFERENCE_ID.Text;
                _MaterialOrderRegister_T03Entity.REMARK = _luREMARK.Text;
                _MaterialOrderRegister_T03Entity.USE_YN = _luUSE_YN.GetValue();


                InputData_Save(_MaterialOrderRegister_T03Entity);
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luORDER_ID.Text.ToString() != "")
                {
                    _MaterialOrderRegister_T03Entity.CRUD = "D";
                }
                else
                {
                ...
                //_MaterialOrderRegister_T03Entity.CONTRACT_ID = _luREFERENCE_ID.Text;
                _MaterialOrderRegister_T03Entity.REMARK = _luREMARK.Text;
                _MaterialOrderRegister_T03Entity.USE_YN = "Y";
        ...
        private void Form_PrintButtonClicked(object pSender, EventArgs pEventArgs)  
        {
          ...
          finally
          {
              CoFAS_DevExpressManager.SetCursor(this, Cursors.Default);
                ...
                MaterialOrderRegister_T03.LANGUAGE_TYPE = _pLANGUAGE_TYPE;

                //check_yn : false = 개별
                //check_yn: : true = 합계
                _MaterialOrderRegister_T03Entity.check_yn = true;
                bool isError = false;
                ...
                //먼저 초기화
                _MaterialOrderRegister_T03Entity.CRUD = "D";
                isError = new ucBOM_SpendQtyCalcPopBusiness().MaterialOrderRegister_T03_Save2(_MaterialOrderRegister_T03Entity, tDataTable);
                ...
                if (!isError)
                {
                    ...
                    if (!isError)
                    {
                        ...
                        //체크하기
                        _MaterialOrderRegister_T03Entity.CRUD = "R";

                        //_dtList = new ucBOM_SpendQtyCalcPopBusiness().VendCost_Sub_Return2(_ucBOM_SpendQtyCalcPopEntity, tDataTable);
                        //_dtList = new ucBOM_SpendQtyCalcPopBusiness().VendCost_Sub_Return_T02(_MaterialOrderRegister_T03Entity, tDataTable);
                        //CoFAS_DevExpressManager.ShowInformationMessage("인쇄준비가 되었습니다.  ");
                        //_Close_Click(null, null);
                        //여기다 엑셀 넣을거임

                        if (_MaterialOrderRegister_T03Entity.ORDER_ID == "")
                        {
                            string strFTP_PATH = "";
                            string strUSE_TYPE = "";
                            string strFILE_NAME = "";

                            _dtList = new MaterialOrderRegister_T03Business().Sheet_Info_Sheet(_MaterialOrderRegister_T03Entity);
                           ...
                           // string strFILE_NAME = "MaterialOrderRegister_Request_T01_Report.xlsx";
                            ...
                            MM.UserForm.frmCommonPopup.ARRAY_CODE = new object[5] { _pWINDOW_NAME, "", "Y", 30, 0 };
                            MM.UserForm.frmCommonPopup xfrmCommonPopup = new MM.UserForm.frmCommonPopup("ucOrderExcelView");  // new CORE.UserForm.frmCommonPopup("CommonCode"); //유저컨트롤러 설정 부분

                            xfrmCommonPopup.ShowDialog();
                            
                            /*if (MessageBox.Show("선택하신 발주서를 저장하시겠습니까?", "저장", MessageBoxButtons.YesNo) == DialogResult.Yes)
                            {
                                if(strFILE_NAME != "")
                                {
                                    ...
                                    {
                                        case "PRINT":
                                            _pFTP_PATH = string.Format(@"{0}{1}/{2}/", _pFTP_PATH, "ORDER_FORM", "MaterialOrderRegister_T03");
                                            break;
                                        case "VIEW":
                                            _pFTP_PATH = string.Format(@"{0}{1}/", _pFTP_PATH, "PROGRAM_VIEW");
                                            break;
                                    }
                                    if(saveFile.ShowDialog() == DialogResult.OK)
                                    {
                                        _pFTP_DOWNLOAD_PATH = saveFile.FileName;
                                        CoFAS_FTPManager.FTPDownLoad(_pFTP_PATH, strFILE_NAME, _pFTP_ID, _pFTP_PW, _pFTP_DOWNLOAD_PATH);
            ...
            finally
            {
                ...
                //ucExcelViewPopup fo = new ucExcelViewPopup();
                //fo.Show();
        ...
        private void Form_SettingButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                //xfrmPageSetting.PASS_CORP_CODE = _MaterialOrderRegister_T03Entity.CORP_CODE;
        ...
        private void MainFind_DisplayData(string pCRUD)
        {
            try
            {
                ...
                _MaterialOrderRegister_T03Entity.CRUD = pCRUD;
                //_MaterialOrderRegister_T03Entity.DATE_FROM = Convert.ToString(_luT_ORDER_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                //_MaterialOrderRegister_T03Entity.DATE_TO = Convert.ToString(_luT_ORDER_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
                _MaterialOrderRegister_T03Entity.DATE_FROM = DateTime.Parse(_luT_ORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _MaterialOrderRegister_T03Entity.DATE_TO   = DateTime.Parse(_luT_ORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");

                _MaterialOrderRegister_T03Entity.ORDER_ID = _luTORDER_ID.Text;
                _MaterialOrderRegister_T03Entity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                _MaterialOrderRegister_T03Entity.VEND_PART_CDOE = _luTVEND_PART_CODE.Text;
                _MaterialOrderRegister_T03Entity.USE_YN = _luTUSE_YN.GetValue();
                _MaterialOrderRegister_T03Entity.VEND_CODE = _luT_VEND_CODE.CodeText.ToString() ;
                _MaterialOrderRegister_T03Entity.VEND_NAME = _luT_VEND_CODE.NameText.ToString();
                _MaterialOrderRegister_T03Entity.PART_CODE = _luT_PART_CODE.CodeText.ToString();
                _MaterialOrderRegister_T03Entity.PART_NAME = _luT_PART_CODE.NameText.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    _dtList = new MaterialOrderRegister_T03Provider(pDBManager).MaterialOrderRegister_T03_R30(_MaterialOrderRegister_T03Entity);
        ...
        private void InputData_Save(MaterialOrderRegister_T03Entity _MaterialOrderRegister_T03Entity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    if (CoFAS_DevExpressManager.ShowQuestionMessage(_pMSG_SAVE_QUESTION) == DialogResult.Yes)
                    {
                        ...
                        isError = new MaterialOrderRegister_T03Business().MaterialOrderRegister_T03_Info_Save(_MaterialOrderRegister_T03Entity);
                    ...
                    else
                    {
                            ...
                            _pLocation_Code = _MaterialOrderRegister_T03Entity.RTN_KEY;  //저장 위치 
                            MainFind_DisplayData("R");
                        }
                    }
                    else
          ...
          /*
            ...
            */
            try
            {
                ...
                frmCommonPopup.ARRAY_CODE = new object[2] { _luT_VEND_CODE.CodeText, _luT_VEND_CODE.NameText };
