...
{
    public partial class MaterialOrderStatus_T02 : frmBaseNone
    {
        ...
        private MaterialOrderStatusEntity _pMaterialOrderStatusEntity = null; // 엔티티 생성
        ...
        public MaterialOrderStatus_T02()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialOrderStatusEntity = new MaterialOrderStatusEntity();
                //_pMaterialOrderStatusEntity.CORP_CODE = _pCORP_CODE;
                _pMaterialOrderStatusEntity.USER_CODE = _pUSER_CODE;
                _pMaterialOrderStatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pMaterialOrderStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pMaterialOrderStatusEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMaterialOrderStatusEntity.CRUD = "R";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pMaterialOrderStatusEntity.CRUD = "R";
                _pMaterialOrderStatusEntity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _pMaterialOrderStatusEntity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                _pMaterialOrderStatusEntity.ORDER_ID = _luTORDER_ID.Text;
                _pMaterialOrderStatusEntity.PART_CODE = _luTPART.CodeText.ToString();
                _pMaterialOrderStatusEntity.PART_NAME = _luTPART.NameText.ToString();
                _pMaterialOrderStatusEntity.VEND_CODE = _luTVEND.CodeText.ToString();
                _pMaterialOrderStatusEntity.VEND_NAME = _luTVEND.NameText.ToString();
                _pMaterialOrderStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new MaterialOrderStatus_T02Business().MaterialOrderStatus_Info_Filename(_pMaterialOrderStatusEntity);

                if (_dtList != null && _dtList.Rows.Count > 0)
                {
                    if (_pMaterialOrderStatusEntity.CRUD == "")
                        _dtList.Rows.Clear();
        ...
        #region ○ Dashboard 조회 - Dashboard_DisplayData() 사용X
        ...
        //        _dtList = new MaterialOrderStatusBusiness().MaterialOrderStatus_Info_Filename(_pMaterialOrderStatusEntity); //Entity에 WINDOW_NAME 추가
        ...
        //        strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pMaterialOrderStatusEntity.WINDOW_NAME);
        ...
        //        // xml의 parameter 설정
        //        dashboard.Parameters[0].Value = _pMaterialOrderStatusEntity.CRUD;
        ...
        //        dashboard.Parameters[3].Value = _luTORDER_ID.Text;
