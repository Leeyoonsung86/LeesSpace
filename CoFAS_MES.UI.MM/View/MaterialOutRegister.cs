...
{
    public partial class MaterialOutRegister : frmBaseNone
    {
        ...
        private MaterialOutRegisterEntity _pMaterialOutRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialOutRegisterEntity = new MaterialOutRegisterEntity();
                //_pMaterialOutRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pMaterialOutRegisterEntity.USER_CODE = _pUSER_CODE;
                _pMaterialOutRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pMaterialOutRegisterEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                { _luPART_UNIT.ReadOnly = true; }
                _luPART_UNIT.ReadOnly = false;
                _pMaterialOutRegisterEntity.CRUD = "R";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pMaterialOutRegisterEntity.CRUD = "R";
                    _pMaterialOutRegisterEntity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.FromDateTime).Replace("-", "").Substring(0, 8);//
                    _pMaterialOutRegisterEntity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Replace("-", "").Substring(0, 8);//
                    _pMaterialOutRegisterEntity.VEND_CODE = _luTVEND_ALL.CodeText;
                    _pMaterialOutRegisterEntity.VEND_NAME = _luTVEND_ALL.NameText;
                    _pMaterialOutRegisterEntity.PART_CODE = _luTPART_ALL.CodeText;
                    _pMaterialOutRegisterEntity.PART_NAME = _luTPART_ALL.NameText;
                    _pMaterialOutRegisterEntity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                    _pMaterialOutRegisterEntity.INOUT_ID = _luTINOUT_ID.Text;
                    _pMaterialOutRegisterEntity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                    _pMaterialOutRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luINOUT_ID.Text != "")
                {
                    _pMaterialOutRegisterEntity.CRUD = "U";
                }
                else
                {
                    _pMaterialOutRegisterEntity.CRUD = "C";
                }

                _pMaterialOutRegisterEntity.INOUT_ID = _luINOUT_ID.Text;
                _pMaterialOutRegisterEntity.INOUT_DATE = _luINOUT_DATE.DateTime.ToString("yyyyMMdd");
                _pMaterialOutRegisterEntity.INOUT_TYPE = "O";  //무조건 입력
                _pMaterialOutRegisterEntity.INOUT_CODE = _luINOUT_CODE.GetValue();
                _pMaterialOutRegisterEntity.REFERENCE_ID = _luREFERENCE_ID.Text;
                _pMaterialOutRegisterEntity.PART_CODE = _luPART_ALL.CodeText;
                _pMaterialOutRegisterEntity.PART_NAME = _luPART_ALL.NameText;
                _pMaterialOutRegisterEntity.VEND_CODE = _luVEND_ALL.CodeText;
                _pMaterialOutRegisterEntity.VEND_NAME = _luVEND_ALL.NameText;

                _pMaterialOutRegisterEntity.INOUT_QTY = _luINOUT_QTY.Text;

                _pMaterialOutRegisterEntity.UNITCOST_CURRENCY_CODE = _luPART_UNIT.GetValue();

                _pMaterialOutRegisterEntity.UNITCOST = _luUNITCOST.Text;

                _pMaterialOutRegisterEntity.COST = _luCOST.Text;

                _pMaterialOutRegisterEntity.REMARK = _luREMARK.Text;
                _pMaterialOutRegisterEntity.USE_YN = _luUSE_YN.GetValue();

                if (_p_Saved_YN == "Y")
                {
                    if (_pMaterialOutRegisterEntity.USE_YN == "N")
                        _pMaterialOutRegisterEntity.CRUD = "D";
                }
                if (_p_Saved_YN == "N")
                {
                    if (_pMaterialOutRegisterEntity.USE_YN == "Y")
                        _pMaterialOutRegisterEntity.CRUD = "U";
                }

                InputData_Save(_pMaterialOutRegisterEntity);
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pMaterialOutRegisterEntity.REMARK = _luREMARK.Text;
                _pMaterialOutRegisterEntity.USE_YN = "N";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new MaterialOutRegisterBusiness().MaterialOutRegister_Info(_pMaterialOutRegisterEntity);

                if (_pMaterialOutRegisterEntity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMaterialOutRegisterEntity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData(string strWINDOW_NAME, string strGRID_NAME)
        {
            try
            {
                ...
                _dtList = new MaterialOutRegisterBusiness().MaterialOutRegister_Info_Sub(_pMaterialOutRegisterEntity);
        ...
        private void InputData_Save(MaterialOutRegisterEntity _pMaterialOutRegisterEntity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                ...
                isError = new MaterialOutRegisterBusiness().MaterialOutRegister_Info_Save(_pMaterialOutRegisterEntity);
                _pLocation_Code = _pMaterialOutRegisterEntity.RTN_KEY;  //저장 위치 
                if (isError)
                {
                    //오류 발생.
        ...
        private void _btTVEND_Click(object sender, EventArgs e)
        {
            ...
            frmCommonPopup.ARRAY_CODE = new object[2] { _luVEND_ALL.CodeText.ToString(), _luVEND_ALL.NameText.ToString() };
            frmCommonPopup xfrmCommonPopup = new CORE.UserForm.frmCommonPopup("VendInfo"); //유저컨트롤러 설정 부분
            //frmCommonPopup xfrmCommonPopup = new CORE.UserForm.frmCommonPopup("CommonCode"); //공통코드팝업 유저컨트롤러 설정 부분
