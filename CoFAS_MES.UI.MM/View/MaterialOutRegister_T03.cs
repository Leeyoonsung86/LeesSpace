...
{
    public partial class MaterialOutRegister_T03 : frmBaseNone
    {
        ...
        private MaterialOutRegister_T03Entity _pMaterialOutRegister_T03Entity = null; // 엔티티 생성
        ...
        public MaterialOutRegister_T03()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialOutRegister_T03Entity = new MaterialOutRegister_T03Entity();
                //_pMaterialOutRegister_T03Entity.CORP_CODE = _pCORP_CODE;
                _pMaterialOutRegister_T03Entity.USER_CODE = _pUSER_CODE;
                _pMaterialOutRegister_T03Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pMaterialOutRegister_T03Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                { _luPART_UNIT.ReadOnly = true; }
                _luPART_UNIT.ReadOnly = false;
                _pMaterialOutRegister_T03Entity.CRUD = "R";
                _luPART_ALL.CodeReadOnly = false;
                _luPART_ALL.NameReadOnly = false;
                _luVEND_ALL.CodeReadOnly = false;
                _luVEND_ALL.NameReadOnly = false;
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pMaterialOutRegister_T03Entity.CRUD = "R";
                    _pMaterialOutRegister_T03Entity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.FromDateTime).Replace("-", "").Substring(0, 8);//
                    _pMaterialOutRegister_T03Entity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Replace("-", "").Substring(0, 8);//
                    _pMaterialOutRegister_T03Entity.VEND_CODE = _luTVEND_ALL.CodeText;
                    _pMaterialOutRegister_T03Entity.VEND_NAME = _luTVEND_ALL.NameText;
                    _pMaterialOutRegister_T03Entity.PART_CODE = _luTPART_ALL.CodeText;
                    _pMaterialOutRegister_T03Entity.PART_NAME = _luTPART_ALL.NameText;
                    _pMaterialOutRegister_T03Entity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                    _pMaterialOutRegister_T03Entity.INOUT_ID = _luTINOUT_ID.Text;
                    _pMaterialOutRegister_T03Entity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                    _pMaterialOutRegister_T03Entity.USE_YN = _luTUSE_YN.GetValue();
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luINOUT_ID.Text != "")
                {
                    _pMaterialOutRegister_T03Entity.CRUD = "U";
                }
                else
                {
                    _pMaterialOutRegister_T03Entity.CRUD = "C";
                }

                _pMaterialOutRegister_T03Entity.INOUT_ID = _luINOUT_ID.Text;
                _pMaterialOutRegister_T03Entity.INOUT_DATE = _luINOUT_DATE.DateTime.ToString("yyyyMMdd");
                _pMaterialOutRegister_T03Entity.INOUT_TYPE = "O";  //무조건 입력
                _pMaterialOutRegister_T03Entity.INOUT_CODE = _luINOUT_CODE.GetValue();
                _pMaterialOutRegister_T03Entity.REFERENCE_ID = _luREFERENCE_ID.Text;
                _pMaterialOutRegister_T03Entity.PART_CODE = _luPART_ALL.CodeText;
                _pMaterialOutRegister_T03Entity.PART_NAME = _luPART_ALL.NameText;
                _pMaterialOutRegister_T03Entity.VEND_CODE = _luVEND_ALL.CodeText;
                _pMaterialOutRegister_T03Entity.VEND_NAME = _luVEND_ALL.NameText;

                _pMaterialOutRegister_T03Entity.INOUT_QTY = _luINOUT_QTY.Text;

                _pMaterialOutRegister_T03Entity.UNITCOST_CURRENCY_CODE = _luPART_UNIT.GetValue();

                _pMaterialOutRegister_T03Entity.LOCATION = _luLOCATION.GetValue();

                _pMaterialOutRegister_T03Entity.UNITCOST = _luUNITCOST.Text;

                _pMaterialOutRegister_T03Entity.COST = _luCOST.Text;

                _pMaterialOutRegister_T03Entity.REMARK = _luREMARK.Text;
                _pMaterialOutRegister_T03Entity.USE_YN = _luUSE_YN.GetValue();

                if (_p_Saved_YN == "Y")
                {
                    if (_pMaterialOutRegister_T03Entity.USE_YN == "N")
                        _pMaterialOutRegister_T03Entity.CRUD = "D";
                }
                if (_p_Saved_YN == "N")
                {
                    if (_pMaterialOutRegister_T03Entity.USE_YN == "Y")
                        _pMaterialOutRegister_T03Entity.CRUD = "Y";
                }

                InputData_Save(_pMaterialOutRegister_T03Entity);
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                */
                ...
                _pMaterialOutRegister_T03Entity.REMARK = _luREMARK.Text;
                _pMaterialOutRegister_T03Entity.USE_YN = "N";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new MaterialOutRegister_T03Business().MaterialOutRegister_T03_Info(_pMaterialOutRegister_T03Entity);

                if (_pMaterialOutRegister_T03Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMaterialOutRegister_T03Entity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData(string strWINDOW_NAME, string strGRID_NAME)
        {
            try
            {
                ...
                _dtList = new MaterialOutRegister_T03Business().MaterialOutRegister_T03_Info_Sub(_pMaterialOutRegister_T03Entity);
        ...
        private void InputData_Save(MaterialOutRegister_T03Entity _pMaterialOutRegister_T03Entity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                ...
                isError = new MaterialOutRegister_T03Business().MaterialOutRegister_T03_Info_Save(_pMaterialOutRegister_T03Entity);
                _pLocation_Code = _pMaterialOutRegister_T03Entity.RTN_KEY;  //저장 위치 
                if (isError)
                {
                    //오류 발생.
        ...
        private void _btPART_Click(object sender, EventArgs e)
        {
            ...
            frmCommonPopup.ARRAY = new object[2] { "Material_Code", _luPART_ALL.NameText }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
        ...
        private void _btTPART_Click(object sender, EventArgs e)
        {
            ...
            frmCommonPopup.ARRAY = new object[2] { "Material_Code", _luTPART_ALL.NameText }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
