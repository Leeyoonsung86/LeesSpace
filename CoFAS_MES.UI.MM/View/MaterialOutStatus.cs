...
{
    public partial class MaterialOutStatus : frmBaseNone
    {
        ...
        private MaterialOutStatusEntity _pMaterialOutStatusEntity = null; // 엔티티 생성
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pMaterialOutStatusEntity.CRUD = "R";
                _pMaterialOutStatusEntity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); //Convert.ToString(_luTORDER_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                _pMaterialOutStatusEntity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd"); //Convert.ToString(_luTORDER_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
                _pMaterialOutStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                //_pMaterialOutStatusEntity.PART_CODE = _luTINOUT_ID.Text;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                //_dtList = new MaterialOutStatusBusiness().MaterialOutStatus_Info_Filename(_pMaterialOutStatusEntity);

                //if (_pMaterialOutStatusEntity.CRUD == "") _dtList.Rows.Clear();


                //if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMaterialOutStatusEntity.CRUD == ""))
                //{
