...
{
    public partial class MaterialOutStatus_T02 : frmBaseNone
    {
        ...
        private MaterialOutStatus_T02Entity _pMaterialOutStatus_T02Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialOutStatus_T02Entity = new MaterialOutStatus_T02Entity();
                //_pMaterialOutStatusEntity.CORP_CODE = _pCORP_CODE;
                _pMaterialOutStatus_T02Entity.USER_CODE = _pUSER_CODE;
                _pMaterialOutStatus_T02Entity.WINDOW_NAME = _pWINDOW_NAME;
                _pMaterialOutStatus_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pMaterialOutStatus_T02Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMaterialOutStatus_T02Entity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pMaterialOutStatus_T02Entity.CRUD = "R";
                _pMaterialOutStatus_T02Entity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); //Convert.ToString(_luTORDER_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                _pMaterialOutStatus_T02Entity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd"); //Convert.ToString(_luTORDER_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
                _pMaterialOutStatus_T02Entity.INOUT_ID = _luTINOUT_ID.Text;
                _pMaterialOutStatus_T02Entity.PART_CODE = _luTPART.CodeText;
                _pMaterialOutStatus_T02Entity.PART_NAME = _luTPART.NameText;
                _pMaterialOutStatus_T02Entity.VEND_CODE = _luTVEND.CodeText;
                _pMaterialOutStatus_T02Entity.VEND_NAME = _luTVEND.NameText;
                _pMaterialOutStatus_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        //        strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pMaterialOutStatus_T02Entity.WINDOW_NAME);
        ...
        //        // xml의 parameter 설정
        //        dashboard.Parameters[0].Value = _pMaterialOutStatus_T02Entity.CRUD;
        ...
        //        dashboard.Parameters[8].Value = _pMaterialOutStatus_T02Entity.LANGUAGE_TYPE;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new MaterialOutStatus_T02Business().MaterialOutStatus_T02_Info(_pMaterialOutStatus_T02Entity);

                if (_pMaterialOutStatus_T02Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMaterialOutStatus_T02Entity.CRUD == ""))
                {
        ...
        //        isError = new MaterialOutStatusBusiness().Sample_Info_Save(_pMaterialOutStatusEntity, dtSave);
