...
{
    public partial class MaterialStockStatus : frmBaseDesign
    {
        ...
        private MaterialStockStatusEntity _pMaterialStockStatusEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialStockStatusEntity = new MaterialStockStatusEntity();
                _pMaterialStockStatusEntity.USER_CODE = _pUSER_CODE;
                _pMaterialStockStatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pMaterialStockStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                if (_pFirstYN)
                {
                    ...
                    _luPART.CodeText = "";
                    _luPART.NameText = "";
                    _luPART_TYPE.TabIndex = 1;
                    _pMaterialStockStatusEntity.CRUD = "";
        ...
        private void InitializeControl()
        {
            ...
            {
                //조회조건 영역 
                _luPART_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R",_pLANGUAGE_TYPE, "MATERIAL_CHECK", "", "", "").Tables[0], 0, 0, "",true);
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMaterialStockStatusEntity.CRUD = "R";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new MaterialStockStatusBusiness().Sample_Info(_pMaterialStockStatusEntity);

                //_pMaterialStockStatusEntity.PART_TYPE = _luPART_TYPE.GetValue();
                //_pMaterialStockStatusEntity.PART_CODE = _luPART_CODE.Text;
                //_pMaterialStockStatusEntity.PART_NAME = _luPART_NAME.Text;

                //_dtList = new MaterialStockStatusBusiness().Sample_Info(_pMaterialStockStatusEntity);

                //if (_pMaterialStockStatusEntity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMaterialStockStatusEntity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData(string strWINDOW_NAME, string strGRID_NAME)
        {
            try
            {
                ...
                _dtList = new MaterialStockStatusBusiness().Sample_Info_Sub(_pMaterialStockStatusEntity);
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new MaterialStockStatusBusiness().MaterialStockStatus_Info_Filename(_pMaterialStockStatusEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pMaterialStockStatusEntity.WINDOW_NAME);
                ...
                // xml의 parameter 설정
                dashboard.Parameters[0].Value = _pMaterialStockStatusEntity.CRUD;
                dashboard.Parameters[1].Value = _luPART_TYPE.GetValue();
                dashboard.Parameters[2].Value = _luPART.CodeText.ToString();
                dashboard.Parameters[3].Value = _luPART.NameText.ToString();
                dashboard.Parameters[4].Value = _pLANGUAGE_TYPE;
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new MaterialStockStatusBusiness().Sample_Info_Save(_pMaterialStockStatusEntity, dtSave);
