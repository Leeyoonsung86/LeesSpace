...
{
    public partial class MaterialStockStatus_T01 : frmBaseNone
    {
        ...
        private MaterialStockStatus_T01Entity _pMaterialStockStatus_T01Entity = null; // 엔티티 생성
        ...
        public MaterialStockStatus_T01()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialStockStatus_T01Entity = new MaterialStockStatus_T01Entity();
                //_pMaterialStockStatus_T01Entity.CORP_CODE = _pCORP_CODE;
                _pMaterialStockStatus_T01Entity.USER_CODE = _pUSER_CODE;
                _pMaterialStockStatus_T01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pMaterialStockStatus_T01Entity.CRUD = "";

                if (_pFirstYN)
                {
                    //MainFind_DisplayData(); //Dev Grid 데이터소스 로 바인딩 작업 처리 할 경우에는 최초 빈 데이터 테이블을 바인딩 해야 됨.
                    // Form_SearchButtonClicked(null, null);
                    _pMaterialStockStatus_T01Entity.PART_CODE = _luTPART_ALL.CodeText;
                    _pMaterialStockStatus_T01Entity.PART_NAME = _luTPART_ALL.NameText;
                    _pMaterialStockStatus_T01Entity.PART_TYPE = _luPART_TYPE.GetValue();
        ...
        private void InitializeControl(bool bSearch)
        {
            try
            {
                ...
                _luPART_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "PART_TYPE_MATERIAL_T03", "", "", "").Tables[0], 0, 0, "", true);
                _luPART_TYPE.ItemIndex = 0;
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMaterialStockStatus_T01Entity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new MaterialStockStatus_T01Business().Sample_Info(_pMaterialStockStatus_T01Entity);

                if (_pMaterialStockStatus_T01Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMaterialStockStatus_T01Entity.CRUD == ""))
                {
        ...
        private void InputData_Save(MaterialStockStatus_T01Entity _pMaterialStockStatus_T01Entity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
