...
{
    public partial class ucInputSamplingResult : UserControl
    {
       ...
       //private static DataTable _pDATATABLE_VALUE = null;
        ...
        public ucInputSamplingResult(DataTable pDataTable)
        {
            InitializeComponent();
        ...
        private void _ucInputSamplingResult_DoubleClick(object sender, EventArgs e)
        {
        ...
        public static event OnClickEventHandler _Request_Click;
