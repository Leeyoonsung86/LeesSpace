...
{
    public partial class ucMaterialContractinfoPopup : UserControl
    {
        ...
        private ucMaterialContractInfoPopupEntity _pucMaterialContractInfoPopupEntity = null; // 엔티티 생성
        ...
        public ucMaterialContractinfoPopup()
        {
            InitializeComponent();
        ...
        private void ucContractInfoPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pucMaterialContractInfoPopupEntity = new ucMaterialContractInfoPopupEntity();
            _pucMaterialContractInfoPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucMaterialContractInfoPopupEntity.USER_CODE = _pUSER_CODE;
            _pucMaterialContractInfoPopupEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        {
            //if (_luCONTRACT_DATE.FromDateTime > _luCONTRACT_DATE.ToDateTime)
            //{
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucMaterialContractInfoPopupEntity.CRUD = "R";
                _pucMaterialContractInfoPopupEntity.CONTRACT_NUMBER = _luCONTRACT_NUMBER.Text.ToString();
                _pucMaterialContractInfoPopupEntity.CONTRACT_DATE_FROM = _luCONTRACT_DATE.FromDateTime.ToString("yyyyMMdd");
                _pucMaterialContractInfoPopupEntity.CONTRACT_DATE_TO = _luCONTRACT_DATE.ToDateTime.ToString("yyyyMMdd");

                _dtList = new ucMaterialContractInfoPopupBusiness().ucMaterialContractInfoPopup_Info_Return(_pucMaterialContractInfoPopupEntity);

                if (_pucMaterialContractInfoPopupEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucMaterialContractInfoPopupEntity.CRUD == ""))
                {
