...
{
    public partial class ucMaterialPartDocumentListPopup : UserControl
    {
        ...
        private ucMaterialPartDocumentListPopupEntity _pucMaterialPartDocumentListPopupEntity = null; // 엔티티 생성
        ...
        public ucMaterialPartDocumentListPopup()
        {
            InitializeComponent();
        ...
        private void ucPartDocumentListPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pucMaterialPartDocumentListPopupEntity = new ucMaterialPartDocumentListPopupEntity();
            _pucMaterialPartDocumentListPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucMaterialPartDocumentListPopupEntity.USER_CODE = _pUSER_CODE;
            _pucMaterialPartDocumentListPopupEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            ...
            _luCONTRACT_ID.Text = ARRAY_CODE[4].ToString();
            _luCONTRACT_NUMBER.Text = ARRAY_CODE[5].ToString();
        ...
        private void CoFAS_DevExpressManager__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                case "MATERIAL_DOCUMENT_VIEW_MAIN_BTN":
                    ...
                    break;
                case "MATERIAL_DOCUMENT_VIEW_SUB_BTN":
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucMaterialPartDocumentListPopupEntity.CRUD = "R";
                _pucMaterialPartDocumentListPopupEntity.PART_CODE = _luPART_CODE.Text.ToString();
                _pucMaterialPartDocumentListPopupEntity.PART_REVISION_NO = _luPART_REVISION_NO.Text.ToString();
                _pucMaterialPartDocumentListPopupEntity.USE_YN = _luUSE_YN.GetValue();

                _dtList = new ucMaterialPartDocumentListPopupBusiness().ucMaterialPartDocumentListPopup_Info_Main(_pucMaterialPartDocumentListPopupEntity);

                if (_pucMaterialPartDocumentListPopupEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucMaterialPartDocumentListPopupEntity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _pucMaterialPartDocumentListPopupEntity.CRUD = "R";
                _pucMaterialPartDocumentListPopupEntity.CONTRACT_ID = _luCONTRACT_ID.Text.ToString();
                _pucMaterialPartDocumentListPopupEntity.CONTRACT_NUMBER = _luCONTRACT_NUMBER.Text.ToString();
                _pucMaterialPartDocumentListPopupEntity.DOCUMENT_TYPE = _luDOCUMENT_TYPE.GetValue();
                _pucMaterialPartDocumentListPopupEntity.DOCUMENT_NAME = _luDOCUMENT_NAME.Text.ToString();
                _pucMaterialPartDocumentListPopupEntity.DOCUMENT_VER = _luDOCUMENT_VER.Text.ToString();
                _pucMaterialPartDocumentListPopupEntity.USE_YN = _luDOCUMENT_USE_YN.GetValue();

                _dtList = new ucMaterialPartDocumentListPopupBusiness().ucMaterialPartDocumentListPopup_Info_Sub(_pucMaterialPartDocumentListPopupEntity);
        ...
        private void InputDataMain_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ucMaterialPartDocumentListPopupBusiness().ucMaterialPartDocumentListPopup_Info_Save(_pucMaterialPartDocumentListPopupEntity, dtSave);
