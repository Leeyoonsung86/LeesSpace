...
{
    public partial class ucMaterialStockInfoPopup_T01 : UserControl
    {
        ...
        private ucMaterialStockInfoPopup_T01Entity _pucMaterialStockInfoPopup_T01Entity = null; // 엔티티 생성
        ...
        public ucMaterialStockInfoPopup_T01()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            ...
            _pucMaterialStockInfoPopup_T01Entity = new ucMaterialStockInfoPopup_T01Entity();
            //그리드 설정 ==고정==
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pCRUD = "R";
                _dtList = new ucMaterialStockInfoPopup_T01Business().ucInspectRequeestInfo_Return(_pCRUD,strCODE, strNAME).Tables[0];
        ...
        private void _btCancle_Click(object sender, EventArgs e)
        {
            ...
            //if (CoFAS_DevExpressManager.ShowQuestionMessage("선택된 자재정보로 출고적용 하시겠습니까?") == DialogResult.Yes)
            //{
            //    dtReturn = new DataTable();
            //    dtReturn = tDataTable.Copy();
            //    if (_Close_Click != null)
            //        _Close_Click(sender, e);
            //}
