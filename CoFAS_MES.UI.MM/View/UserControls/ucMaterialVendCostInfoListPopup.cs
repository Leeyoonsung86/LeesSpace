...
{
    public partial class ucMaterialVendCostInfoListPopup : UserControl
    {
        ...
        private ucMaterialVendCostInfoListPopupEntity _pucMaterialVendCostInfoListPopupEntity = null; // 엔티티 생성
        ...
        public ucMaterialVendCostInfoListPopup()
        {
            InitializeComponent();
        ...
        private void ucMaterialVendCostInfoListPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pucMaterialVendCostInfoListPopupEntity = new ucMaterialVendCostInfoListPopupEntity();
            _pucMaterialVendCostInfoListPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucMaterialVendCostInfoListPopupEntity.USER_CODE = _pUSER_CODE;
            _pucMaterialVendCostInfoListPopupEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                if (_pucMaterialVendCostInfoListPopupEntity.CRUD == "") _dtList.Rows.Clear();
        ...
        private void InputDataMain_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ucMaterialVendCostInfoListPopupBusiness().ucMaterialVendCostInfoListPopup_Info_Save(_pucMaterialVendCostInfoListPopupEntity, dtSave);
