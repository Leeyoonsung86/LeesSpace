...
{
    public partial class WasherOutRegister : frmBaseNone
    {
        ...
        private WasherOutRegisterEntity _pWasherOutRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pWasherOutRegisterEntity = new WasherOutRegisterEntity();
                _pWasherOutRegisterEntity.USER_CODE = _pUSER_CODE;
                _pWasherOutRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pWasherOutRegisterEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pWasherOutRegisterEntity.CRUD = "R";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pWasherOutRegisterEntity.CRUD = "R";
                    _pWasherOutRegisterEntity.DATE_FROM = DateTime.Parse(_luT_WASHER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.FromDateTime).Replace("-", "").Substring(0, 8);//
                    _pWasherOutRegisterEntity.DATE_TO = DateTime.Parse(_luT_WASHER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Replace("-", "").Substring(0, 8);//
                    _pWasherOutRegisterEntity.WASHER_NAME = _luT_WASHER.NameText;
                    _pWasherOutRegisterEntity.WASHER_CODE = _luT_WASHER.CodeText;
                    _pWasherOutRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luINOUT_ID.Text.ToString() != "")
                    _pWasherOutRegisterEntity.CRUD = "U";
                else
                    _pWasherOutRegisterEntity.CRUD = "C";


                _pWasherOutRegisterEntity.INOUT_TYPE = "O";
                _pWasherOutRegisterEntity.INOUT_ID = _luINOUT_ID.Text.ToString();
                _pWasherOutRegisterEntity.INOUT_DATE = _luINOUT_DATE.DateTime.ToString("yyyyMMdd");
                _pWasherOutRegisterEntity.INOUT_SEQ = "000000";
                _pWasherOutRegisterEntity.WASHER_CODE = _luWASHER_CODE.Text;
                _pWasherOutRegisterEntity.INOUT_QTY = _luINOUT_QTY.Text.ToString().ToString() == "" ? "0" : _luINOUT_QTY.Text.ToString();
                _pWasherOutRegisterEntity.PART_UNIT = _luPART_UNIT.GetValue();
                _pWasherOutRegisterEntity.UNITCOST = _luUNITCOST.Text.ToString() == "" ? "0" : _luUNITCOST.Text.ToString().ToString();
                _pWasherOutRegisterEntity.COST = _luCOST.Text.ToString() == "" ? "0" : _luCOST.Text.ToString().ToString();
                _pWasherOutRegisterEntity.REFERENCE_ID = _luREFERENCE_ID.Text.ToString();
                _pWasherOutRegisterEntity.REMARK = _luREMARK.Text.ToString();
                _pWasherOutRegisterEntity.USE_YN = _luUSE_YN.GetValue();

                InputData_Save(_pWasherOutRegisterEntity);
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luINOUT_ID.Text.ToString() != "")
                {
                    _pWasherOutRegisterEntity.CRUD = "D";
                }
                else
                {
                ...
                _pWasherOutRegisterEntity.INOUT_TYPE = "I";
                _pWasherOutRegisterEntity.INOUT_ID = _luINOUT_ID.Text.ToString();
                _pWasherOutRegisterEntity.INOUT_DATE = _luINOUT_DATE.DateTime.ToString("yyyyMMdd");
                _pWasherOutRegisterEntity.INOUT_SEQ = "000000";
                _pWasherOutRegisterEntity.WASHER_CODE = _luWASHER_CODE.Text;
                ...
                _pWasherOutRegisterEntity.COST = _luCOST.Text.ToString() == "" ? "0" : _luCOST.Text.ToString().ToString();
                _pWasherOutRegisterEntity.REMARK = _luREMARK.Text.ToString();
                _pWasherOutRegisterEntity.USE_YN = "N";
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new WasherOutRegisterBusiness().Material_In_Mst(_pWasherOutRegisterEntity);

                if (_pWasherOutRegisterEntity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pWasherOutRegisterEntity.CRUD == ""))
                {
        ...
        private void InputData_Save(WasherOutRegisterEntity _pWasherOutRegisterEntity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                ...
                {
                    isError = new WasherOutRegisterBusiness().WasherOutRegister_Info_Save(_pWasherOutRegisterEntity);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        _pLocation_Code = _pWasherOutRegisterEntity.RTN_KEY;  //저장 위치

                        _pWasherOutRegisterEntity.CRUD = "R";
                        _pWasherOutRegisterEntity.DATE_FROM = DateTime.Parse(_luT_WASHER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");// Convert.ToString(_luTORDER_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                        _pWasherOutRegisterEntity.DATE_TO = DateTime.Parse(_luT_WASHER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
                        _pWasherOutRegisterEntity.WASHER_CODE = _luWASHER_CODE.Text;
                        _pWasherOutRegisterEntity.INOUT_ID = _luINOUT_ID.Text;
                        _pWasherOutRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
