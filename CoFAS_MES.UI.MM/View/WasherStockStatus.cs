...
{
    public partial class WasherStockStatus : frmBaseDesign
    {
        ...
        private WasherStockStatusEntity _pWasherStockStatusEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pWasherStockStatusEntity = new WasherStockStatusEntity();
                _pWasherStockStatusEntity.USER_CODE = _pUSER_CODE;
                _pWasherStockStatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pWasherStockStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                if (_pFirstYN)
                {
                    ...
                    _luWASHER.CodeText = "";
                    _luWASHER.NameText = "";
                    _pWasherStockStatusEntity.CRUD = "";
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pWasherStockStatusEntity.CRUD = "R";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new WasherStockStatusBusiness().Sample_Info(_pWasherStockStatusEntity);

                //_pWasherStockStatusEntity.PART_TYPE = _luPART_TYPE.GetValue();
                //_pWasherStockStatusEntity.PART_CODE = _luPART_CODE.Text;
                //_pWasherStockStatusEntity.PART_NAME = _luPART_NAME.Text;

                //_dtList = new WasherStockStatusBusiness().Sample_Info(_pWasherStockStatusEntity);

                //if (_pWasherStockStatusEntity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pWasherStockStatusEntity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData(string strWINDOW_NAME, string strGRID_NAME)
        {
            try
            {
                ...
                _dtList = new WasherStockStatusBusiness().Sample_Info_Sub(_pWasherStockStatusEntity);
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new WasherStockStatusBusiness().WasherStockStatus_Info_Filename(_pWasherStockStatusEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pWasherStockStatusEntity.WINDOW_NAME);
                ...
                // xml의 parameter 설정
                dashboard.Parameters[0].Value = _pWasherStockStatusEntity.CRUD;
                dashboard.Parameters[1].Value = _luWASHER.CodeText.ToString();
                dashboard.Parameters[2].Value = _luWASHER.NameText.ToString();
                dashboard.Parameters[3].Value = _pLANGUAGE_TYPE;
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new WasherStockStatusBusiness().Sample_Info_Save(_pWasherStockStatusEntity, dtSave);
        ...
        private void _luPART__OnOpenClick(object sender, EventArgs e)
        {
            ...
            //검색조건 전달 0 코드 1 명칭
            frmCommonPopup.ARRAY_CODE = new object[2] { _luWASHER.CodeText.ToString(), _luWASHER.NameText.ToString() };
