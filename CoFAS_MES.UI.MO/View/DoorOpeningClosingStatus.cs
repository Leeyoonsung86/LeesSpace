...
{
    public partial class DoorOpeningClosingStatus : frmBaseNone
    {
        ...
        private DoorOpeningClosingStatusEntity _pDoorOpeningClosingStatusEntity = null; // 엔티티 생성
        ...
        public DoorOpeningClosingStatus()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pDoorOpeningClosingStatusEntity = new DoorOpeningClosingStatusEntity();
                //_pDoorOpeningClosingStatusEntity.CORP_CODE = _pCORP_CODE;
                _pDoorOpeningClosingStatusEntity.USER_CODE = _pUSER_CODE;
                _pDoorOpeningClosingStatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pDoorOpeningClosingStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pDoorOpeningClosingStatusEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _luT_RESOURCE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "SENSOR_DATA_HISTORY_T01", "", "", "").Tables[0], 0, 0, "", false);
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pDoorOpeningClosingStatusEntity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luT_RESOURCE.GetValue() == "")
                {
                    _pDoorOpeningClosingStatusEntity.RESOURCE_CODE = null;
                }
                else
                {
                    _pDoorOpeningClosingStatusEntity.RESOURCE_CODE = _luT_RESOURCE.GetValue();
                }
                _pDoorOpeningClosingStatusEntity.FROM_DATE = _luT_DATE.FromDateTime.ToString().Substring(0, 18);
                _pDoorOpeningClosingStatusEntity.TO_DATE = _luT_DATE.ToDateTime.ToString().Substring(0, 18);
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                if (_pDoorOpeningClosingStatusEntity.CRUD == "") _dtList.Rows.Clear();
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new DoorOpeningClosingStatusBusiness().Sample_Info_Save(_pDoorOpeningClosingStatusEntity, dtSave);
