...
{
    public partial class SensorDataSearch : frmBaseNone
    {
        ...
        private void rb_blood_CheckedChanged(object sender, EventArgs e)
        {
            ...
            switch (rbtn.Text)
            {
                ...
                case "Minute": check = "Minute";

                        break;

                case "Hour": check = "Hour";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pSensorDataSearchEntity.RESOURCE_CODE = _luT_RESOURCE.GetValue();
                ...
                _pSensorDataSearchEntity.INTERVAL = check;
