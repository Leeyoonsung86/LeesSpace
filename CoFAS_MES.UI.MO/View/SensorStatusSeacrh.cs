...
{
    public partial class SensorStatusSeacrh : frmBaseNone
    {
        ...
        private SensorStatusSeacrhEntity _pSensorStatusSeacrhEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pSensorStatusSeacrhEntity = new SensorStatusSeacrhEntity();
                //_pSensorStatusSeacrhEntity.CORP_CODE = _pCORP_CODE;
                _pSensorStatusSeacrhEntity.USER_CODE = _pUSER_CODE;
                _pSensorStatusSeacrhEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pSensorStatusSeacrhEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pSensorStatusSeacrhEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _luT_RESOURCE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "SENSOR_DATA_HISTORY", "", "", "").Tables[0], 0, 0, "",false);
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pSensorStatusSeacrhEntity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pSensorStatusSeacrhEntity.RESOURCE_CODE = _luT_RESOURCE.GetValue();
                _pSensorStatusSeacrhEntity.FROM_DATE = _luT_DATE.FromDateTime.ToString().Substring(0, 10);
                _pSensorStatusSeacrhEntity.TO_DATE = _luT_DATE.ToDateTime.ToString().Substring(0, 10);
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new SensorStatusSeacrhBusiness().SensorStatusSeacrh_Info_Filename(_pSensorStatusSeacrhEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pSensorStatusSeacrhEntity.WINDOW_NAME);
                ...
                ////_pSensorStatusSeacrhEntity.RESOURCE_CODE;
                // xml의 parameter 설정
                dashboard.Parameters[0].Value = _pSensorStatusSeacrhEntity.RESOURCE_CODE;
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new SensorStatusSeacrhBusiness().Sample_Info_Save(_pSensorStatusSeacrhEntity, dtSave);
