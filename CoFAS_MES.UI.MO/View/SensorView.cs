...
{
    public partial class SenserView : frmBaseDesign
    {
       ...
       private SensorViewEntity _pSensorViewEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pSensorViewEntity = new SensorViewEntity();
                //_pResultStatusDataEntity.CORP_CODE = _pCORP_CODE;
                _pSensorViewEntity.USER_CODE = _pUSER_CODE;
                _pSensorViewEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pSensorViewEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new SensorViewBusiness().SensorView_Info_Filename(_pSensorViewEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", this.Name);
