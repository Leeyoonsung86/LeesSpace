...
{
    public partial class ProductInStatus_T02 : frmBaseNone
    {
        ...
        private ProductInStatus_T02Entity _pProductInStatus_T02Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductInStatus_T02Entity = new ProductInStatus_T02Entity();
                //_pProductInStatus_T02Entity.CORP_CODE = _pCORP_CODE;
                _pProductInStatus_T02Entity.USER_CODE = _pUSER_CODE;
                _pProductInStatus_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pProductInStatus_T02Entity.CRUD = "";

                if (_pFirstYN)
                {
                    //MainFind_DisplayData(); //Dev Grid 데이터소스 로 바인딩 작업 처리 할 경우에는 최초 빈 데이터 테이블을 바인딩 해야 됨.
                    // Form_SearchButtonClicked(null, null);
                    _pProductInStatus_T02Entity.PART_CODE = _luTPART_ALL.CodeText;
                    _pProductInStatus_T02Entity.PART_NAME = _luTPART_ALL.NameText;
                    _pProductInStatus_T02Entity.PART_TYPE = _luTPART_TYPE.GetValue();
                    _pProductInStatus_T02Entity.VEND_PART_CODE = _luTVEND_PART_CODE.Text;
                    _pProductInStatus_T02Entity.INOUT_TYPE = _luTINOUT_TYPE.GetValue();
                    _pProductInStatus_T02Entity.VEND_CODE = _luTVEND.CodeText;
                    _pProductInStatus_T02Entity.VEND_NAME = _luTVEND.NameText;
                    _pProductInStatus_T02Entity.DATE_FROM = _luTINOUT_DATE.FromDateTime.ToString();
                    _pProductInStatus_T02Entity.DATE_TO = _luTINOUT_DATE.ToDateTime.ToString();
                    _pFirstYN = false;
                }
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductInStatus_T02Entity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductInStatus_T02Entity.PART_TYPE = _luTPART_TYPE.GetValue();
                _pProductInStatus_T02Entity.VEND_PART_CODE = _luTVEND_PART_CODE.Text;
                _pProductInStatus_T02Entity.DATE_FROM = _luTINOUT_DATE.FromDateTime.ToString("yyyyMMdd");
                _pProductInStatus_T02Entity.DATE_TO = _luTINOUT_DATE.ToDateTime.ToString("yyyyMMdd");
                _pProductInStatus_T02Entity.VEND_CODE = _luTVEND.CodeText;
                _pProductInStatus_T02Entity.VEND_NAME = _luTVEND.NameText;
                _pProductInStatus_T02Entity.INOUT_TYPE = _luTINOUT_TYPE.GetValue();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductInStatus_T02Business().Sample_Info(_pProductInStatus_T02Entity);

                if (_pProductInStatus_T02Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductInStatus_T02Entity.CRUD == ""))
                {
        ...
        private void InputData_Save(ProductInStatus_T02Entity _pProductInStatus_T02Entity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
