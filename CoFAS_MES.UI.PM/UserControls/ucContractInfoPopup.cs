...
{
    public partial class ucContractInfoPopup : UserControl
    {
        ...
        private ucContractInfoPopupEntity _pucContractInfoPopupEntity = null; // 엔티티 생성
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucContractInfoPopupEntity.CRUD = "R";
                _pucContractInfoPopupEntity.CONTRACT_NUMBER = _luCONTRACT_NUMBER.Text.ToString();
                _pucContractInfoPopupEntity.CONTRACT_DATE_FROM = _luCONTRACT_DATE.FromDateTime.ToString("yyyyMMdd");
                _pucContractInfoPopupEntity.CONTRACT_DATE_TO = _luCONTRACT_DATE.ToDateTime.ToString("yyyyMMdd");

                _dtList = new ucContractInfoPopupBusiness().ucContractInfoPopup_Info_Return(_pucContractInfoPopupEntity);

                if (_pucContractInfoPopupEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucContractInfoPopupEntity.CRUD == ""))
                {
