...
{
    public partial class ucExcelViewPopup : UserControl
    {
        ...
        public ucExcelViewPopup(DataTable dt)
        {
            InitializeComponent();
        ...
        private void ucExcelViewPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void _luORDER_NUMBER__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            //    CoFAS_MES.UI.PM.UserForm.frmCommonPopup.FONT_TYPE = fntPARENT_FONT;

            //    CoFAS_MES.UI.PM.UserForm.frmCommonPopup.ARRAY = new object[2] { "", "" }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
            //    CoFAS_MES.UI.PM.UserForm.frmCommonPopup.ARRAY_CODE = new object[2] { "", "" };
            //    CoFAS_MES.UI.PM.UserForm.frmCommonPopup xfrmCommonPopup = new CoFAS_MES.UI.PM.UserForm.frmCommonPopup("ordernumberinfo_popup"); //유저컨트롤러 설정 부분
