...
{
    public partial class ucPartDocumentListPopup : UserControl
    {
        ...
        private ucPartDocumentListPopupEntity _pucPartDocumentListPopupEntity = null; // 엔티티 생성
        ...
        public ucPartDocumentListPopup()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pucPartDocumentListPopupEntity = new ucPartDocumentListPopupEntity();
            _pucPartDocumentListPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucPartDocumentListPopupEntity.USER_CODE = _pUSER_CODE;
            _pucPartDocumentListPopupEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucPartDocumentListPopupEntity.CRUD = "R";
                _pucPartDocumentListPopupEntity.PART_CODE = _luPART_CODE.Text.ToString();
                _pucPartDocumentListPopupEntity.PART_REVISION_NO = _luPART_REVISION_NO.Text.ToString();
                _pucPartDocumentListPopupEntity.USE_YN = _luUSE_YN.GetValue();

                _dtList = new ucPartDocumentListPopupBusiness().ucPartDocumentListPopup_Info_Main(_pucPartDocumentListPopupEntity);

                if (_pucPartDocumentListPopupEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucPartDocumentListPopupEntity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _pucPartDocumentListPopupEntity.CRUD = "R";
                _pucPartDocumentListPopupEntity.CONTRACT_ID = _luCONTRACT_ID.Text.ToString();
                _pucPartDocumentListPopupEntity.CONTRACT_NUMBER = _luCONTRACT_NUMBER.Text.ToString();
                _pucPartDocumentListPopupEntity.DOCUMENT_TYPE = _luDOCUMENT_TYPE.GetValue();
                _pucPartDocumentListPopupEntity.DOCUMENT_NAME = _luDOCUMENT_NAME.Text.ToString();
                _pucPartDocumentListPopupEntity.DOCUMENT_VER = _luDOCUMENT_VER.Text.ToString();
                _pucPartDocumentListPopupEntity.USE_YN = _luDOCUMENT_USE_YN.GetValue();

                _dtList = new ucPartDocumentListPopupBusiness().ucPartDocumentListPopup_Info_Sub(_pucPartDocumentListPopupEntity);
        ...
        private void InputDataMain_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ucPartDocumentListPopupBusiness().ucPartDocumentListPopup_Info_Save(_pucPartDocumentListPopupEntity, dtSave);
