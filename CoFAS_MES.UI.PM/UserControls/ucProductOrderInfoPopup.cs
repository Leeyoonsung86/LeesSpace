...
{
    public partial class ucProductOrderInfoPopup : UserControl
    {
        ...
        public ucProductOrderInfoPopup()
        {
            InitializeComponent();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pCRUD = "R";
                _dtList = new ucProductOrderInfoPopupBusiness().ucProductOrderInfoPopup_Return(_pCRUD, FromDATE, ToDATE, strCODE, strNAME).Tables[0];
