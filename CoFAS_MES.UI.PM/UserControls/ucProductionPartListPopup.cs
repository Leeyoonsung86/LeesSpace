...
{
    public partial class ucProductionPartListPopup : UserControl
    {
        ...
        private ucProductionPartListPopupEntity _pucProductionPartListPopupEntity = null; // 엔티티 생성
        ...
        public ucProductionPartListPopup()
        {
            InitializeComponent();
        ...
        private void ucProductionPartListPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pucProductionPartListPopupEntity = new ucProductionPartListPopupEntity();
            _pucProductionPartListPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucProductionPartListPopupEntity.USER_CODE = _pUSER_CODE;
            _pucProductionPartListPopupEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            ...
            _pucProductionPartListPopupEntity.CRUD = "R";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucProductionPartListPopupEntity.CRUD = "R";
                _pucProductionPartListPopupEntity.VEND_PART_CODE = _luVEND_PART_CODE.Text.ToString();
                _pucProductionPartListPopupEntity.PART_NAME = _luPART_NAME.Text.ToString();
                _pucProductionPartListPopupEntity.PART_REVISION_NO = _luPART_REVISION_NO.Text.ToString();
                _pucProductionPartListPopupEntity.PART_HIGH = _luPART_HIGH.Text.ToString();
                _pucProductionPartListPopupEntity.PART_MIDDLE = _luPART_MIDDLE.Text.ToString();
                _pucProductionPartListPopupEntity.PART_LOW = _luPART_LOW.Text.ToString();

                _dtList = new ucProductionPartListPopupBusiness().ucProductionPartListPopup_Info_Return(_pucProductionPartListPopupEntity);

                if (_pucProductionPartListPopupEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucProductionPartListPopupEntity.CRUD == ""))
                {
