...
{
    public partial class ProductBOMRegister : frmBaseNone
    {
        ...
        private ProductBOMRegisterEntity _pProductBOMRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductBOMRegisterEntity = new ProductBOMRegisterEntity();
                _pProductBOMRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pProductBOMRegisterEntity.USER_CODE = _pUSER_CODE;
                _pProductBOMRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                //_pProductBOMRegisterEntity.CRUD = "";
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                //{
                    _pProductBOMRegisterEntity.CRUD = "R";
                    _pProductBOMRegisterEntity.PART_CODE = gv.GetFocusedRowCellValue("PART_CODE").ToString();
                    _pProductBOMRegisterEntity.REVISION_NO = gv.GetFocusedRowCellValue("REVISION_NO").ToString();
                    _pProductBOMRegisterEntity.USE_YN = gv.GetFocusedRowCellValue("USE_YN").ToString();
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                MainFind_DisplayData();
                if  (DBManager.InitDatabaseName == "coever_mes_hpnc")
                {
                    new SystemLogInfoBusiness().SystemEventLog_Info_Save("C", _pUSER_CODE, this.Text, _pWINDOW_NAME, "Search Event", "Form_FormSearchButton", "Button event is executed " + _pProductBOMRegisterEntity.PART_CODE + " / " + _pProductBOMRegisterEntity.PART_NAME);
                }
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (DBManager.InitDatabaseName == "coever_mes_hpnc")
                {
                    new SystemLogInfoBusiness().SystemEventLog_Info_Save("C", _pUSER_CODE, this.Text, _pWINDOW_NAME, "Save Event", "Form_FormSaveButton", "Button event is executed " + _pProductBOMRegisterEntity.PART_CODE + " / " + _pProductBOMRegisterEntity.PART_NAME);
                }
            }
            catch (ExceptionManager pExceptionManager)
            {
        ...
        private void Form_InitialButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
               ...
               // _luMAIN_PART.NameText = "";
                ...
                _pProductBOMRegisterEntity.CRUD = "C";
                _pProductBOMRegisterEntity.REVISION_NO = "";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void MainFind_DisplayData() //int iRowIndex
        {
            try
            {
                ...
                _dtList = new ProductBOMRegisterBusiness().ProductBOMRegister_Info_Left(_pProductBOMRegisterEntity);

                if (_pProductBOMRegisterEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductBOMRegisterEntity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegisterBusiness().ProductBOMRegister_Info_SUB01(_pProductBOMRegisterEntity);
                ...
                _dtList = new ProductBOMRegisterBusiness().ProductBOMRegister_Info_SUB02(_pProductBOMRegisterEntity);
                ...
                _dtList = new ProductBOMRegisterBusiness().ProductBOMRegister_Info_SUB03(_pProductBOMRegisterEntity);
                ...
                _dtList = new ProductBOMRegisterBusiness().ProductBOMRegister_Info_SUB04(_pProductBOMRegisterEntity);
                ...
                _dtList = new ProductBOMRegisterBusiness().ProductBOMRegister_Info_SUB05(_pProductBOMRegisterEntity);
        ...
        private void BOM_MST_Find_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegisterBusiness().ProductBOMRegister_Info_Main(_pProductBOMRegisterEntity);

                _pProductBOMRegisterEntity.REVISION_NO = _dtList.Rows[0]["REVISION_NO"].ToString();
        ...
        private void BOMFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegisterBusiness().ProductBOMRegister_Info_BOM(_pProductBOMRegisterEntity);
                ...
                //    _dtList = new ProductBOMRegisterBusiness().ProductBOMRegister_Info_Main_Sub(_pProductBOMRegisterEntity);
            ...
            finally
            {
                ...
                _pProductBOMRegisterEntity.CRUD = "U";
                _pProductBOMRegisterEntity.PART_CODE = "";
        ...
        private DataTable BOM_Configuration_FindData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegisterBusiness().ProductBOMRegister_Configuration_Info(_pProductBOMRegisterEntity);
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                if (treeList1.AllNodesCount > 0)
                {
                        ...
                        else
                        {
                            if (!CoFAS_ConvertManager.DataTables_isEquals(_dtBOMCheckList, dtTL))
                            {
                                if (_dtBOMCheckList.Rows.Count != dtTL.Rows.Count)
                                {
                                    _pProductBOMRegisterEntity.CRUD = "C";
                                    //기존 리비젼 정보와 같으면 안됨.
                                    if (_pProductBOMRegisterEntity.REVISION_NO == strRev)
                                    {
                    ...
                    // DataTable dt = dtTL;
                    //_pProductBOMRegisterEntity.CRUD = "C";
                    _pProductBOMRegisterEntity.USE_YN = _luUSE_YN.GetValue();
                    ...
                    temp_T = new ProductBOMRegisterBusiness().ProductBOMRegister_Info_Duplicate_chk(_pProductBOMRegisterEntity, dtTL);
                    {
                    ...
                    isError = new ProductBOMRegisterBusiness().ProductBOMRegister_Info_Save(_pProductBOMRegisterEntity, dtTL);
        ...
        private void BOMData_Delete_Save()
        {
            ...
            finally
            {
                ...
                _pProductBOMRegisterEntity.PART_CODE_MST = "";
                _pProductBOMRegisterEntity.REVISION_NO = "";
                CoFAS_DevExpressManager.SetCursor(this, Cursors.Default);
            }
        }
        ...
        private void _luPART_MST__OnOpenClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                frmCommonPopup.ARRAY = new object[2] { "Product_Code", _luPART_MST.NameText }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
                frmCommonPopup.ARRAY_CODE = new object[2] { _luPART_MST.CodeText, _luPART_MST.NameText };
                ...
                {
                    _luPART_MST.CodeText = xfrmCommonPopup.dtReturn.Rows[0]["PART_CODE"].ToString();
        ...
        public void SetUpTreeList()
        {
            ...
            switch (_pProductBOMRegisterEntity.LANGUAGE_TYPE)
            {
                case "한국어" :
                ...
                case "日本":
                    treeList1.Columns[0].Caption = "製品コード"; //기존 製品コード
                    treeList1.Columns[1].Caption = "製品名"; //기존 商品名
                    treeList1.Columns[2].Caption = "部品数"; //기존  パート数
                    treeList1.Columns[3].Caption = "部品数の単位"; //기존 部品数の単位
                    break;
        ...
        private void treeList_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (row != null)
            {
                ...
                if (treeList.AllNodesCount == 0)
                {
                    ...
                    if (row["part_type"].ToString() != "CD901001")
                    {
                ...
                else
                {
                    ...
                    //하위 품목 있는지 확인 필요.
                    _pProductBOMRegisterEntity.PART_CODE = row.ItemArray[0].ToString();
