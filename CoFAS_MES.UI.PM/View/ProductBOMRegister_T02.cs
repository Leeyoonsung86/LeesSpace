...
{
    public partial class ProductBOMRegister_T02 : frmBaseNone
    {
        ...
        private ProductBOMRegister_T02Entity _pProductBOMRegister_T02Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductBOMRegister_T02Entity = new ProductBOMRegister_T02Entity();
                _pProductBOMRegister_T02Entity.CORP_CODE = _pCORP_CODE;
                _pProductBOMRegister_T02Entity.USER_CODE = _pUSER_CODE;
                _pProductBOMRegister_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                //_pProductBOMRegister_T02Entity.CRUD = "";
                //MainFind_DisplayData();


                _pProductBOMRegister_T02Entity.CRUD = "R";
                SubFind_DisplayData();
                ...
                _pProductBOMRegister_T02Entity.CRUD = "C";
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                //{
                _pProductBOMRegister_T02Entity.CRUD = "R";
                _pProductBOMRegister_T02Entity.PART_CODE = gv.GetFocusedRowCellValue("PART_CODE").ToString();
                _pProductBOMRegister_T02Entity.REVISION_NO = gv.GetFocusedRowCellValue("REVISION_NO").ToString();
                _pProductBOMRegister_T02Entity.USE_YN = gv.GetFocusedRowCellValue("USE_YN").ToString();

                BOM_MST_Find_DisplayData();
                BOMFind_DisplayData();

                _pProductBOMRegister_T02Entity.CRUD = "U";
                //}
                //else
                //{
                //    _pProductBOMRegister_T02Entity.CRUD = "R";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductBOMRegister_T02Entity.PART_CODE = _luPART_CODE.Text;
                _pProductBOMRegister_T02Entity.PART_NAME = _luPART_NAME.Text;

                _pProductBOMRegister_T02Entity.USE_YN = _luT_USE_YN.GetValue();
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luUSE_YN.GetValue() == "N")
                {
                    ...
                    {
                        _pProductBOMRegister_T02Entity.CRUD = "E";
                        _pProductBOMRegister_T02Entity.PART_CODE_MST = _luPART_MST.CodeText.ToString();
                        _pProductBOMRegister_T02Entity.REVISION_NO = _luREVISION_NO.Text.ToString();
        ...
        private void Form_InitialButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductBOMRegister_T02Entity.CRUD = "C";
                _pProductBOMRegister_T02Entity.REVISION_NO = "";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void MainFind_DisplayData() //int iRowIndex
        {
            try
            {
                ...
                _dtList = new ProductBOMRegister_T02Business().ProductBOMRegister_T02_Info_Left(_pProductBOMRegister_T02Entity);

                if (_pProductBOMRegister_T02Entity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductBOMRegister_T02Entity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegister_T02Business().ProductBOMRegister_T02_Info_SUB01(_pProductBOMRegister_T02Entity);
                ...
                _dtList = new ProductBOMRegister_T02Business().ProductBOMRegister_T02_Info_SUB02(_pProductBOMRegister_T02Entity);
                ...
                _dtList = new ProductBOMRegister_T02Business().ProductBOMRegister_T02_Info_SUB03(_pProductBOMRegister_T02Entity);
                ...
                _dtList = new ProductBOMRegister_T02Business().ProductBOMRegister_T02_Info_SUB04(_pProductBOMRegister_T02Entity);
                ...
                _dtList = new ProductBOMRegister_T02Business().ProductBOMRegister_T02_Info_SUB05(_pProductBOMRegister_T02Entity);
        ...
        private void BOM_MST_Find_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegister_T02Business().ProductBOMRegister_T02_Info_Main(_pProductBOMRegister_T02Entity);

                _pProductBOMRegister_T02Entity.REVISION_NO = _dtList.Rows[0]["REVISION_NO"].ToString();
        ...
        private void BOMFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegister_T02Business().ProductBOMRegister_T02_Info_BOM(_pProductBOMRegister_T02Entity);
                    ...
                    for (int i = 0; _dtList.Rows.Count > i; i++)
                    {
                        if (treeList1.AllNodesCount == 0)
                        {
                            treeList1.AppendNode(
                                new object[] {
                                _dtList.Rows[i]["ID"].ToString(),
                                _dtList.Rows[i]["vend_part_code"],
                                _dtList.Rows[i]["part_name"],                                
                                _dtList.Rows[i]["part_qty"],
                                _dtList.Rows[i]["part_unit_name"], "0",
                                _dtList.Rows[i]["part_dsp_seq"], "",
                                _dtList.Rows[i]["ParentID"],
                                _dtList.Rows[i]["use_yn"],
                                _dtList.Rows[i]["used_configuration"],
                                _dtList.Rows[i]["part_code2"],
                                _dtList.Rows[i]["p_part_code2"] }, null);
                        }
                        else
                        {
                            treeList1.AppendNode(new object[] {
                                ...
                                _dtList.Rows[i]["part_name"],                                
                                _dtList.Rows[i]["part_qty"],
                                _dtList.Rows[i]["part_unit_name"],
                                _dtList.Rows[i]["part_lvl"],
                                _dtList.Rows[i]["part_dsp_seq"],
                                _dtList.Rows[i]["cur_path"].ToString(),
                                _dtList.Rows[i]["ParentID"].ToString(),
                                _dtList.Rows[i]["use_yn"],
                                _dtList.Rows[i]["used_configuration"],
                                _dtList.Rows[i]["part_code2"],
                                _dtList.Rows[i]["p_part_code2"] },
                                treeList1.FindNodeByFieldValue("part_code2", 
                                _dtList.Rows[i]["p_part_code2"]));
                        }
                    }
                ...
                //    _dtList = new ProductBOMRegister_T02Business().ProductBOMRegister_T02_Info_Main_Sub(_pProductBOMRegister_T02Entity);
            ...
            finally
            {
                ...
                _pProductBOMRegister_T02Entity.CRUD = "U";
                _pProductBOMRegister_T02Entity.PART_CODE = "";
        ...
        private DataTable BOM_Configuration_FindData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegister_T02Business().ProductBOMRegister_T02_Configuration_Info(_pProductBOMRegister_T02Entity);
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                if (treeList1.AllNodesCount > 0)
                {
                        ...
                        else
                        {
                            if (!CoFAS_ConvertManager.DataTables_isEquals(_dtBOMCheckList, dtTL))
                            {
                                if (_dtBOMCheckList.Rows.Count != dtTL.Rows.Count)
                                {
                                    _pProductBOMRegister_T02Entity.CRUD = "C";
                                    //기존 리비젼 정보와 같으면 안됨.
                                    if (_pProductBOMRegister_T02Entity.REVISION_NO == strRev)
                                    {
                    ...
                    // DataTable dt = dtTL;
                    //_pProductBOMRegister_T02Entity.CRUD = "C";
                    _pProductBOMRegister_T02Entity.USE_YN = _luUSE_YN.GetValue();
                    //isError = new ProductBOMRegister_T02Business().ProductBOMRegister_T02_Info_Save(_pProductBOMRegister_T02Entity, dtSave);
                    isError = new ProductBOMRegister_T02Business().ProductBOMRegister_T02_Info_Save(_pProductBOMRegister_T02Entity, dtTL);
        ...
        private void BOMData_Delete_Save()
        {
            try
            {
                ...
                isError = new ProductBOMRegister_T02Business().ProductBOMRegister_T02_Info_Enable(_pProductBOMRegister_T02Entity);
            ...
            finally
            {
                ...
                _pProductBOMRegister_T02Entity.PART_CODE_MST = "";
                _pProductBOMRegister_T02Entity.REVISION_NO = "";
                CoFAS_DevExpressManager.SetCursor(this, Cursors.Default);
            }
        }
        ...
        private void CreateDataTable()
        {
            ...
            dtTL.Columns.Add(new DataColumn("VEND_PART_CODE", typeof(string)));
        ...
        private void DataRowADD(TreeListNode node, string strPART_CODE_MST, string strREVISION_NO)
        {
            ...
            drTL["VEND_PART_CODE"] = node.GetDisplayText(vend_part_code);
            ...
            //["VEND_PART_CODE"] = node.GetDisplayText(vend_part_code);
            dtTL.Rows.Add(drTL);
        }
        ...
        public void SetUpTreeList()
        {
            ...
            switch (_pProductBOMRegister_T02Entity.LANGUAGE_TYPE)
            {
                case "한국어":
                    treeList1.Columns[0].Caption = "품목코드";
                    treeList1.Columns[1].Caption = "업체코드";
                    treeList1.Columns[2].Caption = "품목명";
                    treeList1.Columns[3].Caption = "파트 수량";
                    treeList1.Columns[4].Caption = "품목 단위";
                    break;

                case "日本":
                    treeList1.Columns[0].Caption = "商品番号";
                    treeList1.Columns[1].Caption = "業體番号";
                    treeList1.Columns[2].Caption = "商品名";
                    treeList1.Columns[3].Caption = "パート数";
                    treeList1.Columns[4].Caption = "アイテム単位";
                    break;
        ...
        private void treeList_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (row != null)
            {
                ...
                if (treeList.AllNodesCount == 0)
                {
                    ...
                    treeList.AppendNode(new object[] { row.ItemArray[0].ToString(), row.ItemArray[4].ToString(), row.ItemArray[1].ToString(), "0", "", "0", "0", "", "", "Y", row.ItemArray[3].ToString() }, null);
                ...
                else
                {
                    ...
                    if (targetNode.GetDisplayText("use_yn").ToString() == "N")
                    {
                        ...
                        CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_BOM_DISABLE);
                    ...
                    //하위 품목 있는지 확인 필요.
                    _pProductBOMRegister_T02Entity.PART_CODE = row.ItemArray[0].ToString();
                    DataTable dtCheck = BOM_Configuration_FindData();
                    string str_P_NODE = "";
                    if (dtCheck != null && dtCheck.Rows.Count > 0)
                    {
                        treeList.AppendNode(new object[] { dtCheck.Rows[0]["part_code"].ToString(),
                                                           dtCheck.Rows[0]["vend_part_code"].ToString(),
                                                           dtCheck.Rows[0]["part_name"].ToString(),
                                                           dtCheck.Rows[0]["part_qty"].ToString(),
                                                           "",
                                                           (targetNode.Level + 1).ToString(),
                                                           (targetNode.Id + 1).ToString(),
                                                           "",
                                                           "",
                                                           "Y",
                                                           "",
                                                           "",
                                                           dtCheck.Rows[0]["used_configuration"].ToString() },targetNode);
                    ...
                    else
                    {
                        treeList.AppendNode(new object[] {
                            ...
                            , ""
                            , "Y"
                            , row.ItemArray[3].ToString(), }, targetNode);
                    }
                }
