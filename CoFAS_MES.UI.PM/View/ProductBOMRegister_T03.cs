...
{
    public partial class ProductBOMRegister_T03 : frmBaseNone
    {
        ...
        private ProductBOMRegister_T03Entity _pProductBOMRegister_T03Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //반제품 : 원료만등로 가능하고 부자재/기타는 안보이게
                //layoutControlItem7 = _gdSUB04 부자재 그리드
                layoutControlItem7.Visibility= DevExpress.XtraLayout.Utils.LayoutVisibility.Never;

                //layoutControlItem8 = _gdSUB05 기타 그리드
                layoutControlItem8.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;

                //부자재/기타 row 숨기기
                treeList1.CustomRowFilter += TreeList1_CustomRowFilter;
                ...
                //메뉴 화면 엔티티 설정
                _pProductBOMRegister_T03Entity = new ProductBOMRegister_T03Entity();
                _pProductBOMRegister_T03Entity.CORP_CODE = _pCORP_CODE;
                _pProductBOMRegister_T03Entity.USER_CODE = _pUSER_CODE;
                _pProductBOMRegister_T03Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                //_pProductBOMRegister_T03Entity.CRUD = "";
                //MainFind_DisplayData();


                _pProductBOMRegister_T03Entity.CRUD = "R";
                SubFind_DisplayData();
                ...
                _pProductBOMRegister_T03Entity.CRUD = "C";
        ...
        private void TreeList1_CustomRowFilter(object sender, CustomRowFilterEventArgs e)
        {
            ...
            string p_part_type = treeList.GetRowCellDisplayText(e.Node, treeList.Columns["part_code"]);
            //3 : 반제품
            //5 : 원료
            //4 : 부자재
            //9 : 기타
            if (p_part_type.Substring(0,1) == "4" || p_part_type.Substring(0, 1) == "9")
            {
                e.Visible = false;
                e.Handled = true;
            }
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                //{
                    _pProductBOMRegister_T03Entity.CRUD = "R";
                    _pProductBOMRegister_T03Entity.PART_CODE = gv.GetFocusedRowCellValue("PART_CODE").ToString();
                    _pProductBOMRegister_T03Entity.REVISION_NO = gv.GetFocusedRowCellValue("REVISION_NO").ToString();
                    _pProductBOMRegister_T03Entity.USE_YN = gv.GetFocusedRowCellValue("USE_YN").ToString();

                    BOM_MST_Find_DisplayData();
                    BOMFind_DisplayData();

                    _pProductBOMRegister_T03Entity.CRUD = "U";

                new SystemLogInfoBusiness().SystemEventLog_Info_Save("C", _pUSER_CODE, _pMENU_NAME, _pWINDOW_NAME, "Menu Search Event", "Form_FormSearchButton", "Button event is executed" + "품목코드 : " + _gdMAIN_VIEW.GetFocusedRowCellDisplayText("PART_CODE").ToString());
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductBOMRegister_T03Entity.PART_CODE = _luPART_CODE.Text;
                _pProductBOMRegister_T03Entity.PART_NAME = _luPART_NAME.Text;

                _pProductBOMRegister_T03Entity.USE_YN = _luT_USE_YN.GetValue();

                MainFind_DisplayData();
                new SystemLogInfoBusiness().SystemEventLog_Info_Save("C", _pUSER_CODE, this.Text, _pWINDOW_NAME, "Search Event", "Form_FormSearchButton", "Button event is executed " + _pProductBOMRegister_T03Entity.PART_CODE + " / " + _pProductBOMRegister_T03Entity.PART_NAME);
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luUSE_YN.GetValue() == "N")
                {
                    ...
                    {
                        _pProductBOMRegister_T03Entity.CRUD = "E";
                        _pProductBOMRegister_T03Entity.PART_CODE_MST = _luPART_MST.CodeText.ToString();
                        _pProductBOMRegister_T03Entity.REVISION_NO = _luREVISION_NO.Text.ToString();
                ...
                new SystemLogInfoBusiness().SystemEventLog_Info_Save("C", _pUSER_CODE, this.Text, _pWINDOW_NAME, "Save Event", "Form_FormSaveButton", "Button event is executed " + _pProductBOMRegister_T03Entity.PART_CODE + " / " + _pProductBOMRegister_T03Entity.PART_NAME);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_InitialButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
               ...
               // _luMAIN_PART.NameText = "";
                ...
                _pProductBOMRegister_T03Entity.CRUD = "C";
                _pProductBOMRegister_T03Entity.REVISION_NO = "";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void MainFind_DisplayData() //int iRowIndex
        {
            try
            {
                ...
                _dtList = new ProductBOMRegister_T03Business().ProductBOMRegister_T03_Info_Left(_pProductBOMRegister_T03Entity);

                if (_pProductBOMRegister_T03Entity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductBOMRegister_T03Entity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegister_T03Business().ProductBOMRegister_T03_Info_SUB01(_pProductBOMRegister_T03Entity);
                ...
                _dtList = new ProductBOMRegister_T03Business().ProductBOMRegister_T03_Info_SUB02(_pProductBOMRegister_T03Entity);
                ...
                _dtList = new ProductBOMRegister_T03Business().ProductBOMRegister_T03_Info_SUB03(_pProductBOMRegister_T03Entity);
                ...
                _dtList = new ProductBOMRegister_T03Business().ProductBOMRegister_T03_Info_SUB04(_pProductBOMRegister_T03Entity);
                ...
                _dtList = new ProductBOMRegister_T03Business().ProductBOMRegister_T03_Info_SUB05(_pProductBOMRegister_T03Entity);
        ...
        private void BOM_MST_Find_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegister_T03Business().ProductBOMRegister_T03_Info_Main(_pProductBOMRegister_T03Entity);

                _pProductBOMRegister_T03Entity.REVISION_NO = _dtList.Rows[0]["REVISION_NO"].ToString();
        ...
        private void BOMFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegister_T03Business().ProductBOMRegister_T03_Info_BOM(_pProductBOMRegister_T03Entity);
                ...
                //    _dtList = new ProductBOMRegister_T03Business().ProductBOMRegister_T03_Info_Main_Sub(_pProductBOMRegister_T03Entity);
            ...
            finally
            {
                ...
                _pProductBOMRegister_T03Entity.CRUD = "U";
                _pProductBOMRegister_T03Entity.PART_CODE = "";
        ...
        private DataTable BOM_Configuration_FindData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegister_T03Business().ProductBOMRegister_T03_Configuration_Info(_pProductBOMRegister_T03Entity);
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                if (treeList1.AllNodesCount > 0)
                {
                        ...
                        else
                        {
                            if (!CoFAS_ConvertManager.DataTables_isEquals(_dtBOMCheckList, dtTL))
                            {
                                if (_dtBOMCheckList.Rows.Count != dtTL.Rows.Count)
                                {
                                    _pProductBOMRegister_T03Entity.CRUD = "C";
                                    //기존 리비젼 정보와 같으면 안됨.
                                   // if (_pProductBOMRegister_T03Entity.REVISION_NO == strRev)
                                   // {
                    ...
                    // DataTable dt = dtTL;
                    //_pProductBOMRegister_T03Entity.CRUD = "C";
                    _pProductBOMRegister_T03Entity.USE_YN = _luUSE_YN.GetValue();
                    //isError = new ProductBOMRegister_T03Business().ProductBOMRegister_T03_Info_Save(_pProductBOMRegister_T03Entity, dtSave);
                    isError = new ProductBOMRegister_T03Business().ProductBOMRegister_T03_Info_Save(_pProductBOMRegister_T03Entity, dtTL);
                    ...
                    else
                    {
                        ...
                        new SystemLogInfoBusiness().SystemEventLog_Info_Save("C", _pUSER_CODE, _pMENU_NAME, _pWINDOW_NAME, "Menu Save Event", "Form_FormSaveButton", "Button event is executed"+"품목코드 : " + _gdMAIN_VIEW.GetFocusedRowCellDisplayText("PART_CODE").ToString());
        ...
        private void BOMData_Delete_Save()
        {
            try
            {
                ...
                isError = new ProductBOMRegister_T03Business().ProductBOMRegister_T03_Info_Enable(_pProductBOMRegister_T03Entity);
            ...
            finally
            {
                ...
                _pProductBOMRegister_T03Entity.PART_CODE_MST = "";
                _pProductBOMRegister_T03Entity.REVISION_NO = "";
                CoFAS_DevExpressManager.SetCursor(this, Cursors.Default);
            }
        }
        ...
        private void CreateDataTable()
        {
            ...
            dtTL.Columns.Add(new DataColumn("PROCESS_SEQ", typeof(string)));
        ...
        private void DataRowADD(TreeListNode node, string strPART_CODE_MST, string strREVISION_NO)
        {
            ...
            drTL["PROCESS_SEQ"] = node.GetValue(process_seq); 
        ...
        public void SetUpTreeList()
        {
            ...
            switch (_pProductBOMRegister_T03Entity.LANGUAGE_TYPE)
            {
                case "한국어" :
        ...
        private void treeList_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (row != null)
            {
                ...
                if (treeList.AllNodesCount == 0)
                {
                    ...
                    //                                 품목코드(part_code)          업체품번(part_name)           수량  단위 lvl seq  path 부모yn              
                    //treeList.AppendNode(new object[] { row.ItemArray[0].ToString(), row.ItemArray[1].ToString(), "0", "", "0", "0", "", "", "Y", row.ItemArray[3].ToString()}, null);
                    //                                 품목코드(part_code)          품목명(part_name)           수량  단위 lvl seq  path 부모yn              
                    treeList.AppendNode(new object[] { row.ItemArray[0].ToString(), row.ItemArray[2].ToString(), "0", "", "0", "0", "", "", "Y", row.ItemArray[3].ToString() }, null);
                ...
                else
                {
                   ...
                   // if ( targetNode.GetDisplayText("part_code").Substring(0, 1) == "2" && targetNode.GetDisplayText("used_configuration") == "Y" && !_ckCOPY.Checked)
                   // {
                    ...
                    if (targetNode.Nodes.Count != 0)
                    {
                        for (int a = 0; a < targetNode.Nodes.Count; a++)
                        {
                            if (targetNode.Nodes[a].GetDisplayText("part_code") == row.ItemArray[0].ToString())
                            {
                                //CRH0001
                                //정제수
                                //if((row.ItemArray[1].ToString() == "CRH0001") || (row.ItemArray[2].ToString() == "정제수"))
                                if ((row.ItemArray[1].ToString().Contains("CRH0001")) || (row.ItemArray[2].ToString() == "정제수"))
                                {
                                }
                                else
                                {
                   ...
                   */
                    ...
                    //하위 품목 있는지 확인 필요.
                    _pProductBOMRegister_T03Entity.PART_CODE = row.ItemArray[0].ToString();
                    DataTable dtCheck = BOM_Configuration_FindData();
                    string str_P_NODE = "";
                    if (dtCheck != null && dtCheck.Rows.Count > 0)
                    {
                        treeList.AppendNode(new object[] { dtCheck.Rows[0]["part_code"].ToString(), dtCheck.Rows[0]["part_name"].ToString(), dtCheck.Rows[0]["part_qty"].ToString(), "", (targetNode.Level + 1).ToString(), (targetNode.Id + 1).ToString(), "", "", "Y", "", "", dtCheck.Rows[0]["used_configuration"].ToString() }, targetNode);
                    ...
                    {
                        //treeList.AppendNode(new object[] { row.ItemArray[0].ToString(), row.ItemArray[1].ToString(), "0", "", (targetNode.Level + 1).ToString(), (targetNode.Id + 1).ToString(), "", "", "Y", row.ItemArray[3].ToString() ,  }, targetNode);
                        treeList.AppendNode(new object[] { row.ItemArray[0].ToString(), row.ItemArray[2].ToString(), "0", "", (targetNode.Level + 1).ToString(), (targetNode.Id + 1).ToString(), "", "", "Y", row.ItemArray[3].ToString(), }, targetNode);
                    }
                }
