...
{
    public partial class ProductBOMRegister_T04 : frmBaseNone
    {
        ...
        private ProductBOMRegister_T04Entity _pProductBOMRegister_T04Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //반제품 : 원료만 가능하고 부자재/기타는 안보이게
                //layoutControlItem5 = _gdSUB02 반제품 그리드
                layoutControlItem5.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;

                //layoutControlItem6 = _gdSUB03 원료 그리드
                layoutControlItem6.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;

                treeList1.CustomRowFilter += TreeList1_CustomRowFilter;

                _gdSUB04.Dock = DockStyle.Left;
                _gdSUB05.Dock = DockStyle.Left;
                ...
                //메뉴 화면 엔티티 설정
                _pProductBOMRegister_T04Entity = new ProductBOMRegister_T04Entity();
                _pProductBOMRegister_T04Entity.CORP_CODE = _pCORP_CODE;
                _pProductBOMRegister_T04Entity.USER_CODE = _pUSER_CODE;
                _pProductBOMRegister_T04Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                //_pProductBOMRegister_T04Entity.CRUD = "";
                //MainFind_DisplayData();


                _pProductBOMRegister_T04Entity.CRUD = "R";
                SubFind_DisplayData();
                ...
                _pProductBOMRegister_T04Entity.CRUD = "C";
        ...
        private void TreeList1_CustomRowFilter(object sender, CustomRowFilterEventArgs e)
        {
            ...
            //4 : 부자재
            //9 : 기타
            if (p_part_type.Substring(0, 1) == "2" || p_part_type.Substring(0, 1) == "3")
            {
                e.Visible = false;
                e.Handled = true;
            }
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                //{
                    _pProductBOMRegister_T04Entity.CRUD = "R";
                    _pProductBOMRegister_T04Entity.PART_CODE = gv.GetFocusedRowCellValue("PART_CODE").ToString();
                    _pProductBOMRegister_T04Entity.REVISION_NO = gv.GetFocusedRowCellValue("REVISION_NO").ToString();
                    _pProductBOMRegister_T04Entity.USE_YN = gv.GetFocusedRowCellValue("USE_YN").ToString();

                    BOM_MST_Find_DisplayData();
                    BOMFind_DisplayData();

                    _pProductBOMRegister_T04Entity.CRUD = "U";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductBOMRegister_T04Entity.PART_CODE = _luPART_CODE.Text;
                _pProductBOMRegister_T04Entity.PART_NAME = _luPART_NAME.Text;

                _pProductBOMRegister_T04Entity.USE_YN = _luT_USE_YN.GetValue();

                MainFind_DisplayData();
                new SystemLogInfoBusiness().SystemEventLog_Info_Save("C", _pUSER_CODE, this.Text, _pWINDOW_NAME, "Search Event", "Form_FormSearchButton", "Button event is executed " + _pProductBOMRegister_T04Entity.PART_CODE + " / " + _pProductBOMRegister_T04Entity.PART_NAME);
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luUSE_YN.GetValue() == "N")
                {
                    ...
                    {
                        _pProductBOMRegister_T04Entity.CRUD = "E";
                        _pProductBOMRegister_T04Entity.PART_CODE_MST = _luPART_MST.CodeText.ToString();
                        _pProductBOMRegister_T04Entity.REVISION_NO = _luREVISION_NO.Text.ToString();
                ...
                new SystemLogInfoBusiness().SystemEventLog_Info_Save("C", _pUSER_CODE, this.Text, _pWINDOW_NAME, "Save Event", "Form_FormSaveButton", "Button event is executed " + _pProductBOMRegister_T04Entity.PART_CODE + " / " + _pProductBOMRegister_T04Entity.PART_NAME);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_InitialButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
               ...
               // _luMAIN_PART.NameText = "";
                ...
                _pProductBOMRegister_T04Entity.CRUD = "C";
                _pProductBOMRegister_T04Entity.REVISION_NO = "";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void MainFind_DisplayData() //int iRowIndex
        {
            try
            {
                ...
                _dtList = new ProductBOMRegister_T04Business().ProductBOMRegister_T04_Info_Left(_pProductBOMRegister_T04Entity);

                if (_pProductBOMRegister_T04Entity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductBOMRegister_T04Entity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegister_T04Business().ProductBOMRegister_T04_Info_SUB01(_pProductBOMRegister_T04Entity);
                ...
                _dtList = new ProductBOMRegister_T04Business().ProductBOMRegister_T04_Info_SUB02(_pProductBOMRegister_T04Entity);
                ...
                _dtList = new ProductBOMRegister_T04Business().ProductBOMRegister_T04_Info_SUB03(_pProductBOMRegister_T04Entity);
                ...
                _dtList = new ProductBOMRegister_T04Business().ProductBOMRegister_T04_Info_SUB04(_pProductBOMRegister_T04Entity);
                ...
                _dtList = new ProductBOMRegister_T04Business().ProductBOMRegister_T04_Info_SUB05(_pProductBOMRegister_T04Entity);
        ...
        private void BOM_MST_Find_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegister_T04Business().ProductBOMRegister_T04_Info_Main(_pProductBOMRegister_T04Entity);

                _pProductBOMRegister_T04Entity.REVISION_NO = _dtList.Rows[0]["REVISION_NO"].ToString();
        ...
        private void BOMFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegister_T04Business().ProductBOMRegister_T04_Info_BOM(_pProductBOMRegister_T04Entity);
                ...
                //    _dtList = new ProductBOMRegister_T04Business().ProductBOMRegister_T04_Info_Main_Sub(_pProductBOMRegister_T04Entity);
            ...
            finally
            {
                ...
                _pProductBOMRegister_T04Entity.CRUD = "U";
                _pProductBOMRegister_T04Entity.PART_CODE = "";
        ...
        private DataTable BOM_Configuration_FindData()
        {
            try
            {
                ...
                _dtList = new ProductBOMRegister_T04Business().ProductBOMRegister_T04_Configuration_Info(_pProductBOMRegister_T04Entity);
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                if (treeList1.AllNodesCount > 0)
                {
                        ...
                        else
                        {
                            if (!CoFAS_ConvertManager.DataTables_isEquals(_dtBOMCheckList, dtTL))
                            {
                                if (_dtBOMCheckList.Rows.Count != dtTL.Rows.Count)
                                {
                                    _pProductBOMRegister_T04Entity.CRUD = "C";
                                    //기존 리비젼 정보와 같으면 안됨.
                                   // if (_pProductBOMRegister_T04Entity.REVISION_NO == strRev)
                                   // {
                    ...
                    // DataTable dt = dtTL;
                    //_pProductBOMRegister_T04Entity.CRUD = "C";
                    _pProductBOMRegister_T04Entity.USE_YN = _luUSE_YN.GetValue();
                    //isError = new ProductBOMRegister_T04Business().ProductBOMRegister_T04_Info_Save(_pProductBOMRegister_T04Entity, dtSave);
                    isError = new ProductBOMRegister_T04Business().ProductBOMRegister_T04_Info_Save(_pProductBOMRegister_T04Entity, dtTL);
        ...
        private void BOMData_Delete_Save()
        {
            try
            {
                ...
                isError = new ProductBOMRegister_T04Business().ProductBOMRegister_T04_Info_Enable(_pProductBOMRegister_T04Entity);
            ...
            finally
            {
                ...
                _pProductBOMRegister_T04Entity.PART_CODE_MST = "";
                _pProductBOMRegister_T04Entity.REVISION_NO = "";
                CoFAS_DevExpressManager.SetCursor(this, Cursors.Default);
            }
        }
        ...
        private void DataRowADD(TreeListNode node, string strPART_CODE_MST, string strREVISION_NO)
        {
            ...
            drTL["PROCESS_SEQ"] = node.GetValue(process_seq); // node.ParentNode == null ? drTL["PROCESS_SEQ"].ToString() : node.ParentNode.Id.ToString();
        ...
        public void SetUpTreeList()
        {
            ...
            switch (_pProductBOMRegister_T04Entity.LANGUAGE_TYPE)
            {
                case "한국어" :
        ...
        private void treeList_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (row != null)
            {
                ...
                else
                {
                    ...
                    //하위 품목 있는지 확인 필요.
                    _pProductBOMRegister_T04Entity.PART_CODE = row.ItemArray[0].ToString();
