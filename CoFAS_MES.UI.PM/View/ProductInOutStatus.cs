...
{
    public partial class ProductInOutStatus : frmBaseNone
    {
        ...
        private ProductInOutStatusEntity _pProductInOutStatusEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductInOutStatusEntity = new ProductInOutStatusEntity();
                _pProductInOutStatusEntity.CORP_CODE = _pCORP_CODE;
                _pProductInOutStatusEntity.USER_CODE = _pUSER_CODE;
                _pProductInOutStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;

                //엑셀샘플불러오기 변수
                _pProductInOutStatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pProductInOutStatusEntity.CORP_CODE = "";
                ...
                _pProductInOutStatusEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductInOutStatusEntity.CRUD = "R";
        ...
        //        _dtList = new ProductInStatusBusiness().ProductInStatus_Info_Filename(_pProductInStatusEntity); //Entity에 WINDOW_NAME 추가
        ...
        //        strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pProductInStatusEntity.WINDOW_NAME);
        ...
        //        // xml의 parameter 설정
        //        dashboard.Parameters[0].Value = _pProductInStatusEntity.CRUD; ;// "R";
        ...
        //        dashboard.Parameters[1].Value = DateTime.Parse(_luINOUT_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//_luT_ORDER_DATE.FromDateTime.ToString().Substring(0, 10).Replace("-", "");
        //        dashboard.Parameters[2].Value = DateTime.Parse(_luINOUT_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//_luT_ORDER_DATE.ToDateTime.ToString().Substring(0, 10).Replace("-", "");

        //        dashboard.Parameters[3].Value = _luPART.CodeText;
        //        dashboard.Parameters[4].Value = _luPART.NameText;
        //        dashboard.Parameters[5].Value = _luVEND.CodeText;
        //        dashboard.Parameters[6].Value = _luVEND.NameText;
        //        dashboard.Parameters[7].Value = _luINOUT_TYPE.GetValue();  //inout_type
        //        dashboard.Parameters[8].Value = _luINOUT_CODE.GetValue();  //inout_code
        //        dashboard.Parameters[9].Value = _luTINOUT_ID.Text;//inout_id
        //        dashboard.Parameters[10].Value = _luTREFERENCE_ID.Text;//production_order_id
        //        dashboard.Parameters[11].Value = _pProductInStatusEntity.LANGUAGE_TYPE;//production_order_id
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pProductInOutStatusEntity.CRUD = "R";
                _pProductInOutStatusEntity.DATE_FROM = Convert.ToString(_luINOUT_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                _pProductInOutStatusEntity.DATE_TO = Convert.ToString(_luINOUT_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
                //_pProductInOutStatusEntity.VEND_CODE = _luVEND.CodeText;
                // _pProductInOutStatusEntity.PART_NAME =
                _pProductInOutStatusEntity.PART_CODE = _luPART.CodeText;
                //_pProductInOutStatusEntity.INOUT_TYPE = _luINOUT_TYPE.GetValue();
                //_pProductInOutStatusEntity.INOUT_ID = _luINOUT_ID.Text;
                _pProductInOutStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;

                _dtList = new ProductInOutStatusBusiness().ProductInOut_Info(_pProductInOutStatusEntity);

                if (_pProductInOutStatusEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductInOutStatusEntity.CRUD == ""))
                {
        ...
        //        _pProductInOutStatusEntity.CRUD = "R";// pCRUD;
        //        _pProductInOutStatusEntity.DATE_FROM = Convert.ToString(_luINOUT_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
        //        _pProductInOutStatusEntity.DATE_TO = Convert.ToString(_luINOUT_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
        //        _pProductInOutStatusEntity.PART_CODE = _luPART.CodeText;
        //        _pProductInOutStatusEntity.PART_NAME = _luPART.NameText;
        //        _pProductInOutStatusEntity.VEND_CODE = _luVEND.CodeText = "";// _luVEND_CODE.Text;
        //        _pProductInOutStatusEntity.VEND_NAME = _luVEND.NameText = "";

               

        //        //new sheet에 dt 바인딩
        //        //_dtList = new ProductInStatusBusiness().Sheet_Info_Sheet_Data(_pProductInStatusEntity);
        //        _dsList = new ProductInStatusBusiness().Sheet_Info_Sheet_Data(_pProductInOutStatusEntity);
