...
{
    public partial class ProductInRegister_T01 : frmBaseNone
    {
        ...
        public string _pMENU_NAME = string.Empty;       // 
        ...
        private ProductInRegister_T01Entity _pProductInRegister_T01Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductInRegister_T01Entity = new ProductInRegister_T01Entity();
                _pProductInRegister_T01Entity.USER_CODE = _pUSER_CODE;
                ...
                _pProductInRegister_T01Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductInRegister_T01Entity.CRUD = "R";
                _pProductInRegister_T01Entity.DATE_FROM = DateTime.Parse(_luTINOUT_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                _pProductInRegister_T01Entity.DATE_TO = DateTime.Parse(_luTINOUT_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                _pProductInRegister_T01Entity.VEND_NAME = _luTVEND.NameText;
                _pProductInRegister_T01Entity.VEND_CODE = _luTVEND.CodeText;
                _pProductInRegister_T01Entity.PART_NAME = _luTPART.NameText;
                _pProductInRegister_T01Entity.PART_CODE = "";
                _pProductInRegister_T01Entity.VEND_PART_CODE = _luTPART.CodeText;
                _pProductInRegister_T01Entity.USE_YN = _luTUSE_YN.GetValue();
                _pProductInRegister_T01Entity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                _pProductInRegister_T01Entity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                _pProductInRegister_T01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                InputData_Save(_pProductInRegister_T01Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductInRegister_T01Business().ProductInRegister_Info(_pProductInRegister_T01Entity);

                if (_pProductInRegister_T01Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductInRegister_T01Entity.CRUD == ""))
                {
                    //데이터 필드에 맞춰 자동 바인딩
        ...
        private void InputData_Save(ProductInRegister_T01Entity _pProductInRegister_T01Entity)
            ...
            try
            {
                ...
                if (CoFAS_DevExpressManager.ShowQuestionMessage(_pMSG_SAVE_QUESTION) == DialogResult.Yes)
                {
                    ...
                    if (CoFAS_ConvertManager.DataTable_FindCount(dt, "CRUD IN ('C','U','D')", ""))
                    {
                        ...
                        isError = new ProductInRegister_T01Business().ProductInRegister_Info_Save(_pProductInRegister_T01Entity, dtTemp);
                        ...
                        else
                        {
                            ...
                            _pLocation_Code = _pProductInRegister_T01Entity.RTN_KEY;  //저장 위치
                            ...
                            _pProductInRegister_T01Entity.VEND_CODE = _luTVEND.CodeText;
                            _pProductInRegister_T01Entity.PART_NAME = _luTPART.NameText;
                            _pProductInRegister_T01Entity.PART_CODE = _luTPART.CodeText;
                            _pProductInRegister_T01Entity.USE_YN = _luTUSE_YN.GetValue();  // _luUSE_YN.GetValue();
                            _pProductInRegister_T01Entity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                            _pProductInRegister_T01Entity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                            Form_SearchButtonClicked(null, null);
                            //MainFind_DisplayData();
        ...
        private void _luTPART__OnOpenClick(object sender, EventArgs e)
        {
            try
            {
                ...
                CoFAS_MES.UI.PM.UserForm.frmCommonPopup.ARRAY_CODE = new object[2] { _luTPART.CodeText.ToString(), _luTPART.NameText.ToString() };
        ...
        private void btnEvent(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                case "BTN_INPDT": //해당 그리드에 필드명 // 2개 이상 그리드의 버튼 항목들은 버튼 타입에 필드 명칭이 모두 다르게 설정 되어야됨.
