...
{
    public partial class ProductInRegister_T02 : frmBaseNone
    {
        ...
        private ProductInRegister_T02Entity _pProductInRegister_T02Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductInRegister_T02Entity = new ProductInRegister_T02Entity();
                _pProductInRegister_T02Entity.USER_CODE = _pUSER_CODE;
                ...
                _pProductInRegister_T02Entity.CRUD = "";
                if (_pFirstYN)
                {
            ...
            try
             {
                ...
                _luTPART.NameText = "";
                _luTPART.CodeText = "";
                _luTINOUT_CODE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R",_pLANGUAGE_TYPE, "PRODUCT_INOUT_TYPE_OUT_T01", "", "", "").Tables[0], 0, 0, "", true);
                _luNIN_QTY.Text = "";
                ...
                _luINOUT_CODE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R",_pLANGUAGE_TYPE, "PRODUCT_INOUT_TYPE_OUT_T01", "", "", "").Tables[0], 0, 0, "");
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                if (_luINOUT_CODE.GetValue() == "PD031014")
                    _luINOUT_CODE.ReadOnly = true;
                else
                ...
                //
                //_pProductInRegister_T02Entity.CRUD = "R";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductInRegister_T02Entity.CRUD = "R";
                _pProductInRegister_T02Entity.DATE_FROM = DateTime.Parse(_luTINOUT_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                _pProductInRegister_T02Entity.DATE_TO = DateTime.Parse(_luTINOUT_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                _pProductInRegister_T02Entity.VEND_NAME = _luTVEND.NameText;
                _pProductInRegister_T02Entity.VEND_CODE = _luTVEND.CodeText;
                _pProductInRegister_T02Entity.PART_NAME = _luTPART.NameText;
                _pProductInRegister_T02Entity.PART_CODE = _luTPART.CodeText;
                _pProductInRegister_T02Entity.USE_YN = _luTUSE_YN.GetValue();
                _pProductInRegister_T02Entity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                _pProductInRegister_T02Entity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                _pProductInRegister_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luINOUT_ID.Text.ToString() != "")
                    _pProductInRegister_T02Entity.CRUD = "U";
                else
                    _pProductInRegister_T02Entity.CRUD = "C";

                _pProductInRegister_T02Entity.INOUT_TYPE = "I";
                _pProductInRegister_T02Entity.INOUT_ID = _luINOUT_ID.Text.ToString();
                _pProductInRegister_T02Entity.INOUT_DATE = _luINOUT_DATE.DateTime.ToString("yyyyMMdd");
                _pProductInRegister_T02Entity.INOUT_SEQ = "000000";
                _pProductInRegister_T02Entity.INOUT_CODE = _luINOUT_CODE.GetValue(); //  INOUT_CODE -> TYPE
                _pProductInRegister_T02Entity.VEND_CODE = _luVEND.CodeText;
                _pProductInRegister_T02Entity.PART_CODE = _luPART.CodeText;
                _pProductInRegister_T02Entity.INOUT_QTY = _luINOUT_QTY.Text.ToString().ToString() == "" ? "0" : _luINOUT_QTY.Text.ToString();
                _pProductInRegister_T02Entity.PART_UNIT = _luUNIT_CODE.GetValue();
                _pProductInRegister_T02Entity.UNITCOST = _luUNITCOST.Text.ToString() == "" ? "0" : _luUNITCOST.Text.ToString().ToString();
                _pProductInRegister_T02Entity.COST = _luCOST.Text.ToString() == "" ? "0" : _luCOST.Text.ToString().ToString();
                _pProductInRegister_T02Entity.REFERENCE_ID = _luREFERENCE_ID.Text.ToString();
                _pProductInRegister_T02Entity.REMARK = _luREMARK.Text.ToString();
                _pProductInRegister_T02Entity.USE_YN = _luUSE_YN.GetValue();
                _pProductInRegister_T02Entity.END_DATE = _luEND_DATE.Text;// DateTime.ToString("yyyyMMdd");

                InputData_Save(_pProductInRegister_T02Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luINOUT_ID.Text.ToString() != "")
                {
                    _pProductInRegister_T02Entity.CRUD = "D";
                }
                else
                {
                ...
                _pProductInRegister_T02Entity.COST = _luCOST.Text.ToString() == "" ? "0" : _luCOST.Text.ToString().ToString();
                _pProductInRegister_T02Entity.REFERENCE_ID = _luREFERENCE_ID.Text.ToString();
                _pProductInRegister_T02Entity.REFERENCE_ID2 = _luREFERENCE_ID.Text.ToString();
                _pProductInRegister_T02Entity.REMARK = _luREMARK.Text.ToString();
                _pProductInRegister_T02Entity.USE_YN = "N";
                _pProductInRegister_T02Entity.END_DATE = _luEND_DATE.Text;//.Replace("-", "");
                InputData_Save(_pProductInRegister_T02Entity);
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductInRegister_T02Business().ProductInRegister_T02_Info(_pProductInRegister_T02Entity);

                if (_pProductInRegister_T02Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductInRegister_T02Entity.CRUD == ""))
                {
                    //데이터 필드에 맞춰 자동 바인딩
        ...
        private void InputData_Save(ProductInRegister_T02Entity _pProductInRegister_T02Entity)
...

        {
            try
            {
                ...
                bool isError = false;
                    ...
                    isError = new ProductInRegister_T02Business().ProductInRegister_T02_Info_Save(_pProductInRegister_T02Entity);
                // 자재입고
                if (isError)
                {
                    //오류 발생.
                ...
                else
                {
                        ...
                        _pLocation_Code = _pProductInRegister_T02Entity.RTN_KEY;  //저장 위치
                        ...
                        _pProductInRegister_T02Entity.PART_NAME = _luTPART.NameText;
                        _pProductInRegister_T02Entity.PART_CODE = _luTPART.CodeText;
                        _pProductInRegister_T02Entity.USE_YN = _luTUSE_YN.GetValue();  // _luUSE_YN.GetValue();
                        _pProductInRegister_T02Entity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                        _pProductInRegister_T02Entity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                        _pProductInRegister_T02Entity.REFERENCE_ID2 = _luREFERENCE_ID.Text.ToString();
                    _pProductInRegister_T02Entity.END_DATE = _luEND_DATE.Text;//.Replace("-","");
        ...
        private void _luREFERENCE_ID_OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                CoFAS_MES.UI.PM.UserForm.frmCommonPopup.ARRAY = new object[2] { "order_id", "" }; //넘기는 파라메터 에 따라 설정
                CoFAS_MES.UI.PM.UserForm.frmCommonPopup.ARRAY_CODE = new object[1] { "material" };
                CoFAS_MES.UI.PM.UserForm.frmCommonPopup xfrmcommonPopup = new CoFAS_MES.UI.PM.UserForm.frmCommonPopup("ProductOrder"); //유저컨트롤러 설정 부분
                ...
                if (xfrmcommonPopup.dtReturn != null && xfrmcommonPopup.dtReturn.Rows.Count > 0)
                {
                    ...
                    //_luINOUT_CODE.ReadOnly = true;
                    _luINOUT_CODE.SetValue("PD031004"); //MR040011 =  발주입고
                                                        //발주입고 구분없이 변경가능하게
        ...
        private void _ucbtINSPECT_REQUEST_Click(object sender, EventArgs e)
        {
            ...
            CoFAS_MES.UI.PM.UserForm.frmCommonPopup.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            CoFAS_MES.UI.PM.UserForm.frmCommonPopup.FONT_TYPE = _pFONT_SETTING;
            CoFAS_MES.UI.PM.UserForm.frmCommonPopup._DataTable = tTempData;



            // 0 서비스네임 1 공통코드경우 CODE_TYPE 으로구분자 올린다.
            CoFAS_MES.UI.PM.UserForm.frmCommonPopup.ARRAY = new object[2] { "InputSamplingReseult", "" };

            //검색조건 전달 0 코드 1 명칭
            CoFAS_MES.UI.PM.UserForm.frmCommonPopup.ARRAY_CODE = new object[2] { "", "" };

            //ucVendCodeInfoPopup xucVendCodeInfoPopup = new CORE.UserControls.ucVendCodeInfoPopup("PartCodeInfo"); //유저컨트롤러 설정 부분
            CoFAS_MES.UI.PM.UserForm.frmCommonPopup xfrmCommonPopup = new CoFAS_MES.UI.PM.UserForm.frmCommonPopup("InputSamplingReseult"); //유저컨트롤러 설정 부분
            xfrmCommonPopup.ShowDialog();
            ...
            if (CoFAS_DevExpressManager.ShowQuestionMessage(reutrn_dtable.Rows.Count.ToString() + "건의 시험의뢰를 하시겠습니까?") == DialogResult.Yes)
            {
                ...
                _pProductInRegister_T02Entity.CRUD = "C";
                bool isError;
                isError = new ProductInRegister_T02Business().ProductInRegister_T02_Info_Check_Save(_pProductInRegister_T02Entity, reutrn_dtable);
