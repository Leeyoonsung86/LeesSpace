...
{
    public partial class ProductInRegister_T03 : frmBaseNone
    {
        ...
        private ProductInRegister_T03Entity _pProductInRegister_T03Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductInRegister_T03Entity = new ProductInRegister_T03Entity();
                _pProductInRegister_T03Entity.USER_CODE = _pUSER_CODE;
                ...
                _pProductInRegister_T03Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                //
                //_pProductInRegister_T03Entity.CRUD = "R";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductInRegister_T03Entity.CRUD = "R";
                _pProductInRegister_T03Entity.DATE_FROM = DateTime.Parse(_luTINOUT_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                _pProductInRegister_T03Entity.DATE_TO = DateTime.Parse(_luTINOUT_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                _pProductInRegister_T03Entity.VEND_NAME = _luTVEND.NameText;
                _pProductInRegister_T03Entity.VEND_CODE = _luTVEND.CodeText;
                _pProductInRegister_T03Entity.PART_NAME = _luTPART.NameText;
                _pProductInRegister_T03Entity.PART_CODE = _luTPART.CodeText;
                _pProductInRegister_T03Entity.USE_YN = _luTUSE_YN.GetValue();
                _pProductInRegister_T03Entity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                _pProductInRegister_T03Entity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                _pProductInRegister_T03Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luINOUT_ID.Text.ToString() != "")
                    _pProductInRegister_T03Entity.CRUD = "U";
                else
                    _pProductInRegister_T03Entity.CRUD = "C";

                _pProductInRegister_T03Entity.INOUT_TYPE = "I";
                _pProductInRegister_T03Entity.INOUT_ID = _luINOUT_ID.Text.ToString();
                _pProductInRegister_T03Entity.INOUT_DATE = _luINOUT_DATE.DateTime.ToString("yyyyMMdd");
                _pProductInRegister_T03Entity.INOUT_SEQ = "000000";
                _pProductInRegister_T03Entity.INOUT_CODE = _luINOUT_CODE.GetValue(); //  INOUT_CODE -> TYPE
                _pProductInRegister_T03Entity.VEND_CODE = _luVEND.CodeText;
                _pProductInRegister_T03Entity.PART_CODE = _luPART.CodeText;
                _pProductInRegister_T03Entity.INOUT_QTY = _luINOUT_QTY.Text.ToString().ToString() == "" ? "0" : _luINOUT_QTY.Text.ToString();
                _pProductInRegister_T03Entity.PART_UNIT = _luUNIT_CODE.GetValue();
                _pProductInRegister_T03Entity.UNITCOST = _luUNITCOST.Text.ToString() == "" ? "0" : _luUNITCOST.Text.ToString().ToString();
                _pProductInRegister_T03Entity.COST = _luCOST.Text.ToString() == "" ? "0" : _luCOST.Text.ToString().ToString();
                _pProductInRegister_T03Entity.REFERENCE_ID = _luREFERENCE_ID.Text.ToString();
                _pProductInRegister_T03Entity.REMARK = _luREMARK.Text.ToString();
                _pProductInRegister_T03Entity.USE_YN = _luUSE_YN.GetValue();
                _pProductInRegister_T03Entity.EXPIRATION_DATE = _luEXPIRATION_DATE.DateTime.ToString("yyyyMMdd");

                InputData_Save(_pProductInRegister_T03Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luINOUT_ID.Text.ToString() != "")
                {
                    _pProductInRegister_T03Entity.CRUD = "D";
                }
                else
                {
                ...
                _pProductInRegister_T03Entity.REFERENCE_ID = _luREFERENCE_ID.Text.ToString();
                _pProductInRegister_T03Entity.REMARK = _luREMARK.Text.ToString();
                _pProductInRegister_T03Entity.USE_YN = "N";
        ...
        private void Form_PrintButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                PM.UserForm.frmCommonPopup.strFile_NAME = "ProductInRegister_T03_v2.xlsx";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductInRegister_T03Business().ProductInRegister_T03_Info(_pProductInRegister_T03Entity);

                if (_pProductInRegister_T03Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductInRegister_T03Entity.CRUD == ""))
                {
                    //데이터 필드에 맞춰 자동 바인딩
        ...
        private void InputData_Save(ProductInRegister_T03Entity _pProductInRegister_T03Entity)
...

        {
            try
            {
                ...
                bool isError = false;
                    ...
                    isError = new ProductInRegister_T03Business().ProductInRegister_T03_Info_Save(_pProductInRegister_T03Entity);
                // 자재입고
                if (isError)
                {
                    //오류 발생.
                ...
                else
                {
                        ...
                        _pLocation_Code = _pProductInRegister_T03Entity.RTN_KEY;  //저장 위치
                        ...
                        _pProductInRegister_T03Entity.PART_NAME = _luTPART.NameText;
                        _pProductInRegister_T03Entity.PART_CODE = _luTPART.CodeText;
                        _pProductInRegister_T03Entity.USE_YN = _luTUSE_YN.GetValue();  // _luUSE_YN.GetValue();
                        _pProductInRegister_T03Entity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                        _pProductInRegister_T03Entity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                        Form_SearchButtonClicked(null, null);
                        //MainFind_DisplayData();
        ...
        private void _luPART__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                frmCommonPopup.ARRAY = new object[2] { "Product_Code_T01", _luPART.NameText }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
        ...
        private void _luTPART__OnOpenClick(object sender, EventArgs e)
        {
            try
            {
                ...
                frmCommonPopup.ARRAY = new object[2] { "Product_Code_T01", _luTPART.NameText }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
