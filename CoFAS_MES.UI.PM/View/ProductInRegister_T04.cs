...
{
    public partial class ProductInRegister_T04 : frmBaseNone
    {
        ...
        private ProductInRegister_T04Entity _pProductInRegister_T04Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductInRegister_T04Entity = new ProductInRegister_T04Entity();
                _pProductInRegister_T04Entity.USER_CODE = _pUSER_CODE;
                ...
                _pProductInRegister_T04Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                //
                //_pProductInRegister_T04Entity.CRUD = "R";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductInRegister_T04Entity.CRUD = "R";
                _pProductInRegister_T04Entity.DATE_FROM = DateTime.Parse(_luTINOUT_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                _pProductInRegister_T04Entity.DATE_TO = DateTime.Parse(_luTINOUT_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                _pProductInRegister_T04Entity.VEND_NAME = _luTVEND.NameText;
                _pProductInRegister_T04Entity.VEND_CODE = _luTVEND.CodeText;
                _pProductInRegister_T04Entity.PART_NAME = _luTPART.NameText;
                _pProductInRegister_T04Entity.PART_CODE = _luTPART.CodeText;
                _pProductInRegister_T04Entity.USE_YN = _luTUSE_YN.GetValue();
                _pProductInRegister_T04Entity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                _pProductInRegister_T04Entity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                _pProductInRegister_T04Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            ...
            try
            {
                ...
                */
                ...
                if (_luINOUT_ID.Text.ToString() != "")
                    _pProductInRegister_T04Entity.CRUD = "U";
                else
                    _pProductInRegister_T04Entity.CRUD = "C";

                _pProductInRegister_T04Entity.INOUT_TYPE = "I";
                _pProductInRegister_T04Entity.INOUT_ID = _luINOUT_ID.Text.ToString();
                _pProductInRegister_T04Entity.INOUT_DATE = _luINOUT_DATE.DateTime.ToString("yyyyMMdd");
                _pProductInRegister_T04Entity.INOUT_SEQ = "000000";
                _pProductInRegister_T04Entity.INOUT_CODE = _luINOUT_CODE.GetValue(); //  INOUT_CODE -> TYPE
                _pProductInRegister_T04Entity.VEND_CODE = _luVEND.CodeText;
                _pProductInRegister_T04Entity.PART_CODE = _luPART.CodeText;
                _pProductInRegister_T04Entity.INOUT_QTY = _luINOUT_QTY.Text.ToString().ToString() == "" ? "0" : _luINOUT_QTY.Text.ToString();
                _pProductInRegister_T04Entity.PART_UNIT = _luUNIT_CODE.GetValue();
                _pProductInRegister_T04Entity.UNITCOST = _luUNITCOST.Text.ToString() == "" ? "0" : _luUNITCOST.Text.ToString().ToString();
                _pProductInRegister_T04Entity.COST = _luCOST.Text.ToString() == "" ? "0" : _luCOST.Text.ToString().ToString();
                _pProductInRegister_T04Entity.REFERENCE_ID = _luREFERENCE_ID.Text.ToString();
                _pProductInRegister_T04Entity.REMARK = _luREMARK.Text.ToString();
                _pProductInRegister_T04Entity.USE_YN = _luUSE_YN.GetValue();


                _pProductInRegister_T04Entity.LOCATION = _luLOCATION.GetValue();

                if (_p_Saved_YN == "Y")
                {
                    if (_pProductInRegister_T04Entity.USE_YN == "N")
                        _pProductInRegister_T04Entity.CRUD = "D";
                }
                if (_p_Saved_YN == "N")
                {
                    if (_pProductInRegister_T04Entity.USE_YN == "Y")
                        _pProductInRegister_T04Entity.CRUD = "Y";
                }

                InputData_Save(_pProductInRegister_T04Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                */
                ...
                _pProductInRegister_T04Entity.REFERENCE_ID = _luREFERENCE_ID.Text.ToString();
                _pProductInRegister_T04Entity.REMARK = _luREMARK.Text.ToString();
                _pProductInRegister_T04Entity.USE_YN = "N";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductInRegister_T04Business().ProductInRegister_T04_Info(_pProductInRegister_T04Entity);

                if (_pProductInRegister_T04Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductInRegister_T04Entity.CRUD == ""))
                {
                    //데이터 필드에 맞춰 자동 바인딩
        ...
        private void InputData_Save(ProductInRegister_T04Entity _pProductInRegister_T04Entity)
...

        {
            try
            {
                ...
                bool isError = false;
                    ...
                    isError = new ProductInRegister_T04Business().ProductInRegister_T04_Info_Save(_pProductInRegister_T04Entity);
                // 자재입고
                if (isError)
                {
                    //오류 발생.
                ...
                else
                {
                        ...
                        _pLocation_Code = _pProductInRegister_T04Entity.RTN_KEY;  //저장 위치
                        ...
                        _pProductInRegister_T04Entity.PART_NAME = _luTPART.NameText;
                        _pProductInRegister_T04Entity.PART_CODE = _luTPART.CodeText;
                        _pProductInRegister_T04Entity.USE_YN = _luTUSE_YN.GetValue();  // _luUSE_YN.GetValue();
                        _pProductInRegister_T04Entity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                        _pProductInRegister_T04Entity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                        Form_SearchButtonClicked(null, null);
                        //MainFind_DisplayData();
        ...
        private void _luPART__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                */
                ...
                frmCommonPopup.ARRAY = new object[2] { "Product_Code_02", _luPART.NameText }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
        ...
        private void _luTPART__OnOpenClick(object sender, EventArgs e)
        {
            try
            {
                ...
                frmCommonPopup.ARRAY = new object[2] { "Product_Code_02", _luTPART.NameText }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
