...
{
    public partial class ProductInRegister_T05 : frmBaseNone
    {
        ...
        private ProductInRegister_T05Entity _pProductInRegister_T05Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductInRegister_T05Entity = new ProductInRegister_T05Entity();
                _pProductInRegister_T05Entity.USER_CODE = _pUSER_CODE;
                ...
                _pProductInRegister_T05Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductInRegister_T05Entity.CRUD = "R";
                _pProductInRegister_T05Entity.DATE_FROM = DateTime.Parse(_luTINOUT_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                _pProductInRegister_T05Entity.DATE_TO = DateTime.Parse(_luTINOUT_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                _pProductInRegister_T05Entity.VEND_NAME = _luTVEND.NameText;
                _pProductInRegister_T05Entity.VEND_CODE = _luTVEND.CodeText;
                _pProductInRegister_T05Entity.PART_NAME = _luTPART.NameText;
                _pProductInRegister_T05Entity.PART_CODE = _luTPART.CodeText;
                _pProductInRegister_T05Entity.USE_YN = _luTUSE_YN.GetValue();
                _pProductInRegister_T05Entity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                _pProductInRegister_T05Entity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                _pProductInRegister_T05Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luINOUT_ID.Text.ToString() != "")
                    _pProductInRegister_T05Entity.CRUD = "U";
                else
                    _pProductInRegister_T05Entity.CRUD = "C";

                _pProductInRegister_T05Entity.INOUT_TYPE = "I";
                _pProductInRegister_T05Entity.INOUT_ID = _luINOUT_ID.Text.ToString();
                _pProductInRegister_T05Entity.INOUT_DATE = _luINOUT_DATE.DateTime.ToString("yyyyMMdd");
                _pProductInRegister_T05Entity.INOUT_SEQ = "000000";
                _pProductInRegister_T05Entity.INOUT_CODE = _luINOUT_CODE.GetValue(); //  INOUT_CODE -> TYPE
                _pProductInRegister_T05Entity.VEND_CODE = _luVEND.CodeText;
                _pProductInRegister_T05Entity.PART_CODE = _luPART.CodeText;
                _pProductInRegister_T05Entity.INOUT_QTY = _luINOUT_QTY.Text.ToString().ToString() == "" ? "0" : _luINOUT_QTY.Text.ToString();
                _pProductInRegister_T05Entity.PART_UNIT = _luUNIT_CODE.GetValue();
                _pProductInRegister_T05Entity.UNITCOST = _luUNITCOST.Text.ToString() == "" ? "0" : _luUNITCOST.Text.ToString().ToString();
                _pProductInRegister_T05Entity.COST = _luCOST.Text.ToString() == "" ? "0" : _luCOST.Text.ToString().ToString();
                _pProductInRegister_T05Entity.REFERENCE_ID = _luREFERENCE_ID.Text.ToString();
                _pProductInRegister_T05Entity.REMARK = _luREMARK.Text.ToString();
                _pProductInRegister_T05Entity.USE_YN = _luUSE_YN.GetValue();

                if (_p_Saved_YN == "Y")
                {
                    if (_pProductInRegister_T05Entity.USE_YN == "N")
                        _pProductInRegister_T05Entity.CRUD = "D";
                }
                if (_p_Saved_YN == "N")
                {
                    if (_pProductInRegister_T05Entity.USE_YN == "Y")
                        _pProductInRegister_T05Entity.CRUD = "Y";
                }

                InputData_Save(_pProductInRegister_T05Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductInRegister_T05Entity.REFERENCE_ID = _luREFERENCE_ID.Text.ToString();
                _pProductInRegister_T05Entity.REMARK = _luREMARK.Text.ToString();
                _pProductInRegister_T05Entity.USE_YN = "N";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductInRegister_T05Business().ProductInRegister_Info(_pProductInRegister_T05Entity);

                if (_pProductInRegister_T05Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductInRegister_T05Entity.CRUD == ""))
                {
                    //데이터 필드에 맞춰 자동 바인딩
        ...
        private void InputData_Save(ProductInRegister_T05Entity _pProductInRegister_T05Entity)
...

        {
            try
            {
                ...
                bool isError = false;
                    ...
                    isError = new ProductInRegister_T05Business().ProductInRegister_Info_Save(_pProductInRegister_T05Entity);
                // 자재입고
                if (isError)
                {
                    //오류 발생.
                ...
                else
                {
                        ...
                        _pLocation_Code = _pProductInRegister_T05Entity.RTN_KEY;  //저장 위치
                    ...
                    _pProductInRegister_T05Entity.PART_NAME = _luTPART.NameText;
                    _pProductInRegister_T05Entity.PART_CODE = _luTPART.CodeText;
                    _pProductInRegister_T05Entity.USE_YN = _luTUSE_YN.GetValue();  // _luUSE_YN.GetValue();
                    _pProductInRegister_T05Entity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                    _pProductInRegister_T05Entity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                        Form_SearchButtonClicked(null, null);
                        //MainFind_DisplayData();
        ...
        private void _luPART__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                */
                ...
                frmCommonPopup xfrmCommonPopup = new CORE.UserForm.frmCommonPopup("PartCodeInfo2"); //유저컨트롤러 설정 부분
                ...
                if (xfrmCommonPopup.dtReturn != null && xfrmCommonPopup.dtReturn.Rows.Count > 0)
                {
                    ...
                    _luPART.NameText = xfrmCommonPopup.dtReturn.Rows[0]["PART_NAME"].ToString();
                    _luUNITCOST.Text = xfrmCommonPopup.dtReturn.Rows[0]["PART_IN_COST"].ToString();
