...
{
    public partial class ProductInStatus : frmBaseNone
    {
        ...
        private ProductInStatusEntity _pProductInStatusEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductInStatusEntity = new ProductInStatusEntity();
                _pProductInStatusEntity.CORP_CODE = _pCORP_CODE;
                _pProductInStatusEntity.USER_CODE = _pUSER_CODE;
                _pProductInStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;

                //엑셀샘플불러오기 변수
                _pProductInStatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pProductInStatusEntity.CORP_CODE = "";
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductInStatusEntity.CRUD = "R";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pProductInStatusEntity.CRUD = "R";
                _pProductInStatusEntity.DATE_FROM = Convert.ToString(_luINOUT_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                _pProductInStatusEntity.DATE_TO = Convert.ToString(_luINOUT_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
                //_pMaterialInStatusEntity.VEND_NAME = _luVEND_NAME.Text;
                //_pMaterialInStatusEntity.PART_NAME = _luPART_NAME.Text;
                _pProductInStatusEntity.PART_CODE = _luTINOUT_ID.Text;
        ...
        private void SubFind_DisplayData(string strWINDOW_NAME, string strGRID_NAME)
        {
            try
            {
                ...
                if (_pProductInStatusEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductInStatusEntity.CRUD == ""))
                {
        ...
        private void Sheet_Info_Sheet_Data()
        {
            try
            {
                ...
                _pProductInStatusEntity.CRUD = "R";// pCRUD;
                _pProductInStatusEntity.DATE_FROM = Convert.ToString(_luINOUT_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                _pProductInStatusEntity.DATE_TO = Convert.ToString(_luINOUT_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
                _pProductInStatusEntity.PART_CODE = _luPART.CodeText;
                _pProductInStatusEntity.PART_NAME = _luPART.NameText;
                _pProductInStatusEntity.VEND_CODE = _luVEND.CodeText = "";// _luVEND_CODE.Text;
                _pProductInStatusEntity.VEND_NAME = _luVEND.NameText = "";

               

                //new sheet에 dt 바인딩
                //_dtList = new ProductInStatusBusiness().Sheet_Info_Sheet_Data(_pProductInStatusEntity);
                _dsList = new ProductInStatusBusiness().Sheet_Info_Sheet_Data(_pProductInStatusEntity);
