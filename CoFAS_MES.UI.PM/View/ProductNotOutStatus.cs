...
{
    public partial class ProductNotOutStatus : frmBaseNone
    {
        ...
        private ProductNotOutStatusEntity _pProductNotOutStatusEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductNotOutStatusEntity = new ProductNotOutStatusEntity();
                //_pProductNotOutStatusEntity.CORP_CODE = _pCORP_CODE;
                _pProductNotOutStatusEntity.USER_CODE = _pUSER_CODE;
                _pProductNotOutStatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pProductNotOutStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pProductNotOutStatusEntity.CRUD = "";
                if (_pFirstYN)
                {
                    _pProductNotOutStatusEntity.CRUD = "";
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductNotOutStatusEntity.CRUD = "R";
        ...
        private void Form_InitialButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _luTCONTRACT_ID.Text = "";
                _luTCONTRACT_ID.ReadOnly = false;
                _luTPART.CodeText = "";
                _luTPART.NameText = "";
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductNotOutStatusBusiness().ProductNotOutStatus_Info_Filename(_pProductNotOutStatusEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pProductNotOutStatusEntity.WINDOW_NAME);
                ...
                // xml의 parameter 설정
                dashboard.Parameters[0].Value = _pProductNotOutStatusEntity.CRUD;
                dashboard.Parameters[1].Value = DateTime.Parse(_luTCONTRACT_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); //_luTORDER_DATE.FromDateTime.ToString().Substring(0, 10).Replace("-", "");
                dashboard.Parameters[2].Value = DateTime.Parse(_luTCONTRACT_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //_luTORDER_DATE.ToDateTime.ToString().Substring(0, 10).Replace("-", "");
                dashboard.Parameters[3].Value = _luTCONTRACT_ID.Text;
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ProductNotOutStatusBusiness().Sample_Info_Save(_pProductNotOutStatusEntity, dtSave);
