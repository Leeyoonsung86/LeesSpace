...
{ 
    public partial class ProductOutRegister : frmBaseNone
    {
        ...
        private ProductOutRegisterEntity _pProductOutRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                */
                //메뉴 화면 엔티티 설정
                _pProductOutRegisterEntity = new ProductOutRegisterEntity();
                _pProductOutRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pProductOutRegisterEntity.USER_CODE = _pUSER_CODE;
                _pProductOutRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                if (_pFirstYN)
                {
                    ...
                    _pProductOutRegisterEntity.CRUD = "";
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductOutRegisterEntity.CRUD = "R";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductOutRegisterEntity.CRUD = "R";
                _pProductOutRegisterEntity.DATE_FROM = DateTime.Parse(_luTINOUT_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");// Convert.ToString(_luTINOUT_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                _pProductOutRegisterEntity.DATE_TO = DateTime.Parse(_luTINOUT_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");// Convert.ToString(_luTINOUT_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
                _pProductOutRegisterEntity.VEND_CODE = _luTVEND_ALL.CodeText;
                _pProductOutRegisterEntity.VEND_NAME = _luTVEND_ALL.NameText;
                _pProductOutRegisterEntity.PART_CODE = _luTPART_ALL.CodeText;
                _pProductOutRegisterEntity.PART_NAME = _luTPART_ALL.NameText;
                _pProductOutRegisterEntity.REFERENCE_ID = _luTREFERENCE_ID.Text;
                _pProductOutRegisterEntity.INOUT_ID = _luTINOUT_ID.Text;
                _pProductOutRegisterEntity.INOUT_CODE = _luTINOUT_CODE.GetValue();
                _pProductOutRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
        ...
        private bool CheckInputData()
        {
            ...
            try
            {
                ...
                //생산출고
                if (_luINOUT_CODE.Text.Trim() != "1002")//일반입고, 一般着て
                { 
                ...
                if (pErrName != "")
                {
                    ...
                    //DisplayMessage(_pMSG_PRODUCT_INOUT_NECESSARY_ITEM_VALID);
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (CoFAS_DevExpressManager.ShowQuestionMessage(_pMSG_SAVE_QUESTION) == DialogResult.No)
                    return;
            /*
                    if (_luINOUT_CODE.Text.Trim() == "생산출고"&& _luINOUT_ID.Text != "") //PD02
                {
             ...
             string before_qty = _luINOUT_QTY.Text;
              ...
              if (pQTY > _pLEAVE_QTY+ _pBefore_inout_Qty)
                ...
                _pProductOutRegisterEntity.INOUT_QTY = _luINOUT_QTY.Text.ToString().ToString() == "" ? "0" : _luINOUT_QTY.Text.ToString();
                _pProductOutRegisterEntity.UNITCOST = _luUNITCOST.Text.ToString() == "" ? "0" : _luUNITCOST.Text.ToString().ToString();
                _pProductOutRegisterEntity.COST = _luCOST.Text.ToString() == "" ? "0" : _luCOST.Text.ToString().ToString();
                ...
                if (_p_Saved_YN == "Y")
                {
                    if (_pProductOutRegisterEntity.USE_YN == "N")
                        _pProductOutRegisterEntity.CRUD = "D";
                }
                if (_p_Saved_YN == "N")
                {
                    if (_pProductOutRegisterEntity.USE_YN == "Y")
                        _pProductOutRegisterEntity.CRUD = "U";
                }
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductOutRegisterBusiness().ProductOutRegister_Info(_pProductOutRegisterEntity);
        ...
        private void InputData_Save(ProductOutRegisterEntity _pProductOutRegisterEntity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                ...
                bool isError = false;
                    ...
                    isError = new ProductOutRegisterBusiness().ProductOutRegister_Info_Save(_pProductOutRegisterEntity);
                ...
                else
                {
                    ...
                    _pLocation_Code = _pProductOutRegisterEntity.RTN_KEY;  //저장 위치 
