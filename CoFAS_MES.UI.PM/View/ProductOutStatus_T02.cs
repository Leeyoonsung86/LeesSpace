...
{
    public partial class ProductOutStatus_T02 : frmBaseNone
    {
        ...
        private ProductOutStatus_T02Entity _pProductOutStatus_T02Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductOutStatus_T02Entity = new ProductOutStatus_T02Entity();
                //_pProductOutStatus_T02Entity.CORP_CODE = _pCORP_CODE;
                _pProductOutStatus_T02Entity.USER_CODE = _pUSER_CODE;
                _pProductOutStatus_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pProductOutStatus_T02Entity.CRUD = "";

                if (_pFirstYN)
                {
                    //MainFind_DisplayData(); //Dev Grid 데이터소스 로 바인딩 작업 처리 할 경우에는 최초 빈 데이터 테이블을 바인딩 해야 됨.
                    // Form_SearchButtonClicked(null, null);
                    _pProductOutStatus_T02Entity.PART_CODE = _luTPART_ALL.CodeText;
                    _pProductOutStatus_T02Entity.PART_NAME = _luTPART_ALL.NameText;
                    _pProductOutStatus_T02Entity.PART_TYPE = _luTPART_TYPE.GetValue();
                    _pProductOutStatus_T02Entity.VEND_PART_CODE = _luTVEND_PART_CODE.Text;
                    _pProductOutStatus_T02Entity.INOUT_TYPE = _luTINOUT_TYPE.GetValue();
                    _pProductOutStatus_T02Entity.VEND_CODE = _luTVEND.CodeText;
                    _pProductOutStatus_T02Entity.VEND_NAME = _luTVEND.NameText;
                    _pProductOutStatus_T02Entity.DATE_FROM = _luTINOUT_DATE.FromDateTime.ToString();
                    _pProductOutStatus_T02Entity.DATE_TO = _luTINOUT_DATE.ToDateTime.ToString();
                    _pFirstYN = false;
                }
        ...
        private void InitializeControl(bool bSearch)
        {
            try
            {
                ...
                _luTINOUT_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "I_O", "", "", "").Tables[0], 0, 0, "", false);
                _luTINOUT_TYPE.ItemIndex = 1;
                _luTINOUT_TYPE.ReadOnly = true;
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductOutStatus_T02Entity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductOutStatus_T02Entity.PART_TYPE = _luTPART_TYPE.GetValue();
                _pProductOutStatus_T02Entity.VEND_PART_CODE = _luTVEND_PART_CODE.Text;
                _pProductOutStatus_T02Entity.DATE_FROM = _luTINOUT_DATE.FromDateTime.ToString("yyyyMMdd");
                _pProductOutStatus_T02Entity.DATE_TO = _luTINOUT_DATE.ToDateTime.ToString("yyyyMMdd");
                _pProductOutStatus_T02Entity.VEND_CODE = _luTVEND.CodeText;
                _pProductOutStatus_T02Entity.VEND_NAME = _luTVEND.NameText;
                _pProductOutStatus_T02Entity.INOUT_TYPE = _luTINOUT_TYPE.GetValue();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductOutStatus_T02Business().Sample_Info(_pProductOutStatus_T02Entity);

                if (_pProductOutStatus_T02Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductOutStatus_T02Entity.CRUD == ""))
                {
        ...
        private void InputData_Save(ProductOutStatus_T02Entity _pProductOutStatus_T02Entity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
