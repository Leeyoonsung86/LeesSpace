...
{
    public partial class ProductRecepiStatus_T01 : frmBaseNone
    {
        ...
        private ProductRecepiStatus_T01Entity _pProductRecepiStatus_T01Entity = null; // 엔티티 생성
        ...
        public ProductRecepiStatus_T01()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductRecepiStatus_T01Entity = new ProductRecepiStatus_T01Entity();
                //_pWorkResultStatus_T01Entity.CORP_CODE = _pCORP_CODE;
                _pProductRecepiStatus_T01Entity.USER_CODE = _pUSER_CODE;
                _pProductRecepiStatus_T01Entity.WINDOW_NAME = _pWINDOW_NAME;
                _pProductRecepiStatus_T01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pProductRecepiStatus_T01Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductRecepiStatus_T01Entity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luT_PLAN_DATE.FromDateTime > _luT_PLAN_DATE.ToDateTime)
                {
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductRecepiStatus_T01Business().ProductRecepiStatus_T01_Info_Filename(_pProductRecepiStatus_T01Entity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pProductRecepiStatus_T01Entity.WINDOW_NAME);
                ...
                // xml의 parameter 설정
                dashboard.Parameters[0].Value = _pProductRecepiStatus_T01Entity.CRUD;
                dashboard.Parameters[1].Value = _luTPART.CodeText;
                dashboard.Parameters[2].Value = _luTPART.NameText;
                dashboard.Parameters[3].Value = DateTime.Parse(_luT_PLAN_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//_luT_ORDER_DATE.FromDateTime.ToString().Substring(0, 10).Replace("-", "");
                dashboard.Parameters[4].Value = DateTime.Parse(_luT_PLAN_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//_luT_ORDER_DATE.ToDateTime.ToString().Substring(0, 10).Replace("-", "");
                dashboard.Parameters[5].Value = _luT_PRODUCTION_ORDER_ID.Text;
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                //isError = new WorkResultStatus_T01Business().Sample_Info_Save(_pWorkResultStatus_T01Entity, dtSave);
                ...
                //    // 화면 갱신
                //    _pWorkResultStatus_T01Entity.CRUD = "R";
