...
{
    public partial class ProductStockStatus : frmBaseNone
    {
        ...
        private ProductStockStatusEntity _pProductStockStatusEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductStockStatusEntity = new ProductStockStatusEntity();
                //_pProductStockStatusEntity.CORP_CODE = _pCORP_CODE;
                _pProductStockStatusEntity.USER_CODE = _pUSER_CODE;
                _pProductStockStatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pProductStockStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
               ...
               // _pProductStockStatusEntity.CRUD = "";
        ...
        private void InitializeControl()
        {
            ...
            {
                //조회조건 영역 
                _luPART_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R",_pLANGUAGE_TYPE, "PART_CHECK", "", "", "").Tables[0], 0, -1, "",true);
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductStockStatusEntity.CRUD = "R";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pProductStockStatusEntity.PART_TYPE = _luPART_TYPE.GetValue();
                _pProductStockStatusEntity.PART_CODE = _luPART.CodeText;
                _pProductStockStatusEntity.PART_NAME = _luPART.NameText;
        ...
        private void SheetFind_DisplayData()
        {
            try
            {
              ...
              //
              //
              //  _dtList = new ProductStockStatusBusiness().Sheet_Info_Sheet(_pProductStockStatusEntity);   //엑셀 시트 조회하기
              //
              ...
              //          break;
              //      case "VIEW":
              //          strFTP_PATH = string.Format(@"{0}{1}/{2}/", _pFTP_PATH, "PROGRAM_VIEW", _pProductStockStatusEntity.WINDOW_NAME);
              //          break;
              //      case "REGIT":
              //          strFTP_PATH = string.Format(@"{0}{1}/{2}/", _pFTP_PATH, "PROGRAM_VIEW", _pProductStockStatusEntity.WINDOW_NAME);
              //          break;
        ...
        private void Sheet_Info_Sheet_Data()
        {
            try
            {
              ...
              //
              //  _pProductStockStatusEntity.PART_TYPE = _luPART_TYPE.GetValue();
              //  _pProductStockStatusEntity.PART_CODE = _luPART_CODE.Text.ToString();
              //  _pProductStockStatusEntity.PART_NAME = _luPART_NAME.Text.ToString();
              //
              //  //new sheet에 dt 바인딩
              //  _dtList = new ProductStockStatusBusiness().ProductStockStatus_Mst(_pProductStockStatusEntity);
              //
              //
              //  IWorkbook workbook = _sdMAIN.Document;
              //
              //  Worksheet worksheet_1 = workbook.Worksheets["Data"];
              //
              //  if (_dtList != null)
              //  {
              ...
              //
              //
              //      //worksheet_1.Tables.Add(_dtList, _dtList.Rows.Count, _dtList.Columns.Count);
              //      worksheet_1.DataBindings.BindToDataSource(_dtList, 1, 0, dsOptions);
              //
              //      dsOptions.ImportHeaders = true;
              //      worksheet_1.Tables.Add(_dtList, 0, 0, dsOptions);
              //  }
              //  else
              //  {
              //      CoFAS_DevExpressManager.ShowInformationMessage("조회 내역이 없습니다.");
              //  }
              //
              //  Worksheet worksheet_2 = workbook.Worksheets[2];
              //  PivotTable pivotTable = worksheet_2.PivotTables[0];
        ...
        private void SubFind_DisplayData(string strWINDOW_NAME, string strGRID_NAME)
        {
            try
            {
                ...
                _dtList = new ProductStockStatusBusiness().Sample_Info_Sub(_pProductStockStatusEntity);

                if (_pProductStockStatusEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductStockStatusEntity.CRUD == ""))
                {
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ProductStockStatusBusiness().Sample_Info_Save(_pProductStockStatusEntity, dtSave);
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductStockStatusBusiness().ProductStockStatus_Info_Filename(_pProductStockStatusEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pProductStockStatusEntity.WINDOW_NAME);
                ...
                {
                    dashboard.Parameters[0].Value = _pProductStockStatusEntity.CRUD;
                    dashboard.Parameters[1].Value = _luPART.CodeText;
                    dashboard.Parameters[2].Value = _luPART.NameText;
                    dashboard.Parameters[3].Value = _luPART_TYPE.GetValue();
                    dashboard.Parameters[4].Value = _pProductStockStatusEntity.LANGUAGE_TYPE;
                    dashboard.Parameters[5].Value = "";
                }
                else
                //if (_pLANGUAGE_TYPE == "한국어")
                {
                    dashboard.Parameters[0].Value = _luPART_TYPE.GetValue();
                    dashboard.Parameters[1].Value = _luPART.CodeText;
                    dashboard.Parameters[2].Value = _luPART.NameText;
                    dashboard.Parameters[3].Value = _pProductStockStatusEntity.CRUD;
                    dashboard.Parameters[4].Value = _pProductStockStatusEntity.LANGUAGE_TYPE;
                }
                    /*
        ...
        private void Dashboard_ConfigureDataConnection(object sender, DashboardConfigureDataConnectionEventArgs e)
        {
            try
            {
                switch (DBManager.PrimaryDBManagerType)
