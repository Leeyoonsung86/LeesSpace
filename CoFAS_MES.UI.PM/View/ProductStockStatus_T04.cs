...
{
    public partial class ProductStockStatus_T04 : frmBaseNone
    {
        ...
        private ProductStockStatus_T04Entity _pProductStockStatus_T04Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductStockStatus_T04Entity = new ProductStockStatus_T04Entity();
                //_pProductStockStatus_T04Entity.CORP_CODE = _pCORP_CODE;
                _pProductStockStatus_T04Entity.USER_CODE = _pUSER_CODE;
                _pProductStockStatus_T04Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pProductStockStatus_T04Entity.CRUD = "";

                if (_pFirstYN)
                {
                    //MainFind_DisplayData(); //Dev Grid 데이터소스 로 바인딩 작업 처리 할 경우에는 최초 빈 데이터 테이블을 바인딩 해야 됨.
                    // Form_SearchButtonClicked(null, null);
                    _pProductStockStatus_T04Entity.PART_CODE = _luTPART_ALL.CodeText;
                    _pProductStockStatus_T04Entity.PART_NAME = _luTPART_ALL.NameText;
                    _pProductStockStatus_T04Entity.PART_TYPE = _luPART_TYPE.GetValue();
                    _pProductStockStatus_T04Entity.VEND_PART_CODE = _luTVEND_PART_CODE.Text;
                    _pFirstYN = false;
                }
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductStockStatus_T04Entity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductStockStatus_T04Business().Sample_Info(_pProductStockStatus_T04Entity);

                if (_pProductStockStatus_T04Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductStockStatus_T04Entity.CRUD == ""))
                {
        ...
        private void InputData_Save(ProductStockStatus_T04Entity _pProductStockStatus_T04Entity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
