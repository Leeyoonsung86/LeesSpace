...
{
    public partial class ProductStockStatus_T05 : frmBaseNone
    {
        ...
        private ProductStockStatus_T05Entity _pProductStockStatus_T05Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductStockStatus_T05Entity = new ProductStockStatus_T05Entity();
                //_pProductStockStatus_T05Entity.CORP_CODE = _pCORP_CODE;
                _pProductStockStatus_T05Entity.USER_CODE = _pUSER_CODE;
                _pProductStockStatus_T05Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pProductStockStatus_T05Entity.CRUD = "";

                if (_pFirstYN)
                {
                    //MainFind_DisplayData(); //Dev Grid 데이터소스 로 바인딩 작업 처리 할 경우에는 최초 빈 데이터 테이블을 바인딩 해야 됨.
                    // Form_SearchButtonClicked(null, null);
                    _pProductStockStatus_T05Entity.PART_CODE = _luTPART_ALL.CodeText;
                    _pProductStockStatus_T05Entity.PART_NAME = _luTPART_ALL.NameText;
                    _pProductStockStatus_T05Entity.PART_TYPE = _luPART_TYPE.GetValue();
        ...
        private void InitializeControl(bool bSearch)
        {
            try
            {
                ...
                _luPART_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "PART_TYPE_PRODUCT", "", "", "").Tables[0], 0, 0, "", true);
                _luPART_TYPE.ItemIndex = 0;
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductStockStatus_T05Entity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductStockStatus_T05Business().Sample_Info(_pProductStockStatus_T05Entity);

                if (_pProductStockStatus_T05Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductStockStatus_T05Entity.CRUD == ""))
                {
        ...
        private void InputData_Save(ProductStockStatus_T05Entity _pProductStockStatus_T05Entity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
        ...
        {/*
            ...
            try
            {
                ...
                frmCommonPopup.ARRAY = new object[2] { "Product_Code_02", _luTPART_ALL.NameText }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
