...
{
    public partial class ucMakeNoMappingPopup : UserControl
    {
        ...
        private ucMakeNoMappingPopupEntity _pucMakeNoMappingPopupEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            ...
            _pucMakeNoMappingPopupEntity = new ucMakeNoMappingPopupEntity();
            //그리드 설정 ==고정==
            _pucMakeNoMappingPopupEntity.PART_TYPE = _pARRAY_CODE[2].ToString();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                string strPART_TYPE = _pucMakeNoMappingPopupEntity.PART_TYPE;
                ...
                _pCRUD = "R";
                _dtList = new ucMakeNoMappingPopupBusiness().ucMakeNoMappingPopup_Return(_pCRUD,  pFROM_DATE,  pTO_DATE,  pPRODUCTION_ORDER_ID,  pPART_NAME,  pPART_CODE,  pPROCESS_CODE_MST).Tables[0];
        ...
        {
            _pucMakeNoMappingPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucMakeNoMappingPopupEntity.USER_CODE = _pUSER_CODE;
            int cnt = 0;
            ...
            {
                _pucMakeNoMappingPopupEntity.CRUD = "U";
                bool isError;
                isError = new ucMakeNoMappingPopupBusiness().ucMakeNoMappingPopup_Check_Save(_pucMakeNoMappingPopupEntity, tDataTable);
                ...
                else
                {
                    ...
                    //_pLocation_Code = _pucMakeNoMappingPopupEntity.RTN_KEY;  //저장 위치 
