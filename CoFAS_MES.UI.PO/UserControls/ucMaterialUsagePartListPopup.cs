...
{
    public partial class ucMaterialUsagePartListPopup : UserControl
    {
        ...
        private ucMaterialUsagePartListPopupEntity _pucMaterialUsagePartListPopupEntity = null; // 엔티티 생성
        ...
        public ucMaterialUsagePartListPopup()
        {
            InitializeComponent();
        ...
        public ucMaterialUsagePartListPopup(DataTable dt)
        {
            InitializeComponent();
            //_dtreturn = dt;
            _pWINDOW_NAME = this.Name.ToString();
        ...
        private void ucMaterialUsagePartListPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pucMaterialUsagePartListPopupEntity = new ucMaterialUsagePartListPopupEntity();
            _pucMaterialUsagePartListPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucMaterialUsagePartListPopupEntity.USER_CODE = _pUSER_CODE;
            _pucMaterialUsagePartListPopupEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            ...
            _pucMaterialUsagePartListPopupEntity.CRUD = "R";
        ...
        private void _btCLEAR_Click(object sender, EventArgs e)
        {
            ...
            _pucMaterialUsagePartListPopupEntity.CRUD = "";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucMaterialUsagePartListPopupEntity.CRUD = "R";
                _pucMaterialUsagePartListPopupEntity.VEND_PART_CODE = _luVEND_PART_CODE.Text.ToString();
                _pucMaterialUsagePartListPopupEntity.PART_NAME = _luPART_NAME.Text.ToString();
                _pucMaterialUsagePartListPopupEntity.PART_REVISION_NO = _luPART_REVISION_NO.Text.ToString();
                _pucMaterialUsagePartListPopupEntity.PART_HIGH = _luPART_HIGH.Text.ToString();
                _pucMaterialUsagePartListPopupEntity.PART_MIDDLE = _luPART_MIDDLE.Text.ToString();
                _pucMaterialUsagePartListPopupEntity.PART_LOW = _luPART_LOW.Text.ToString();

                _dtList = new ucMaterialUsagePartListPopupBusiness().ucMaterialUsagePartListPopup_Info_Return(_pucMaterialUsagePartListPopupEntity);

                if (_pucMaterialUsagePartListPopupEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucMaterialUsagePartListPopupEntity.CRUD == ""))
                {
        ...
        private void _btCancle_Click(object sender, EventArgs e)
        {
            ...
            {
                PO.UserForm.frmCommonPopup._DataTable = null;
