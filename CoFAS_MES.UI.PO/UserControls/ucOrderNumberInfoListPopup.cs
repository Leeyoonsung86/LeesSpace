...
{
    public partial class ucOrderNumberInfoListPopup : UserControl
    {
        ...
        private ucOrderNumberInfoListPopupEntity _pucOrderNumberInfoListPopupEntity = null; // 엔티티 생성
        ...
        public ucOrderNumberInfoListPopup()
        {
            InitializeComponent();
        ...
        private void ucOrderNumberInfoListPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void _btCLEAR_Click(object sender, EventArgs e)
        {
            ...
            _luTORDER_NAME.Text = "";
            _pucOrderNumberInfoListPopupEntity.CRUD = "";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                if (_pucOrderNumberInfoListPopupEntity.CRUD == "") _dtList.Rows.Clear();
