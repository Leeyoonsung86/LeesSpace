...
{
    public partial class ucOrderNumberInfoPopup : UserControl
    {
        ...
        private ucOrderNumberInfoPopup_Entity _pOrderNumberInfoPopup_Entity = null;
        ...
        private void ucOrderNumberInfoPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            _pOrderNumberInfoPopup_Entity = new ucOrderNumberInfoPopup_Entity();
            _pOrderNumberInfoPopup_Entity.CONTRACT_NUMBER = ARRAY[0].ToString();
            _pOrderNumberInfoPopup_Entity.PRODUCTION_PLAN_ID = ARRAY[1].ToString();
            _pOrderNumberInfoPopup_Entity.PRODUCTION_PLAN_DATE = ARRAY[2].ToString();
            _pOrderNumberInfoPopup_Entity.PRODUCTION_PLAN_SEQ = ARRAY[3].ToString();
            _pOrderNumberInfoPopup_Entity.ORDER_NUMBER = ARRAY[4].ToString();
            _pOrderNumberInfoPopup_Entity.ORDER_SEQ = "";
            //_pOrderNumberInfoPopup_Entity.VEND_CODE = ARRAY[1].ToString();
            _pOrderNumberInfoPopup_Entity.USER_CODE = USER_CODE.ToString();
            ...
            _pOrderNumberInfoPopup_Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            //화면 컨트롤러 설정
            InitializeControl();
            ...
            _luORDER_NUMBER.Text = _pOrderNumberInfoPopup_Entity.CONTRACT_NUMBER;
        ...
        private void _luORDER_NUMBER__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                {
                    _luORDER_NUMBER.Text = xfrmCommonPopup.dtReturn.Rows[0]["CONTRACT_ID"].ToString();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pOrderNumberInfoPopup_Entity.CRUD = "R";

                _dtList = new ucOrderNumberInfoPopup_Business().ContractMst_Info(_pOrderNumberInfoPopup_Entity);

                if (_pOrderNumberInfoPopup_Entity.CRUD == "")
                    _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pOrderNumberInfoPopup_Entity.CRUD == ""))
                {
                    //데이터 필드에 맞춰 자동 바인딩
