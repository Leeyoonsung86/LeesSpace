...
{
    public partial class ucPlanOrderinfoPopup_T01 : UserControl
    {
        ...
        private ucPlanOrderinfoPopup_T01_Entity _pucPlanOrderinfoPopup_T01_Entity = null;
        ...
        public ucPlanOrderinfoPopup_T01()
        {
            InitializeComponent();
        ...
        private void ucPlanOrderinfoPopup_T01_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            _pucPlanOrderinfoPopup_T01_Entity = new ucPlanOrderinfoPopup_T01_Entity();
            _pucPlanOrderinfoPopup_T01_Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucPlanOrderinfoPopup_T01_Entity.CRUD = "R";
                _pucPlanOrderinfoPopup_T01_Entity.DATE_FROM = _ucFROMDATE.FromDateTime.ToString("yyyyMMdd");
                _pucPlanOrderinfoPopup_T01_Entity.DATE_TO = _ucFROMDATE.ToDateTime.ToString("yyyyMMdd");
                _pucPlanOrderinfoPopup_T01_Entity.PART_CODE = _luPART_ALL.CodeText;
                _pucPlanOrderinfoPopup_T01_Entity.PART_NAME = _luPART_ALL.NameText;
                _pucPlanOrderinfoPopup_T01_Entity.PLAN_ORDER_ID = _luPLAN_ORDER.Text;
                //_pucPlanOrderinfoPopup_T01_Entity.VEND_NAME = _luPART_ALL.NameText;

                _dtList = new pucPlanOrderinfoPopup_T01Business().ucPlanOrderinfoPopup_T01_Select(_pucPlanOrderinfoPopup_T01_Entity).Tables[0];

                if (_pucPlanOrderinfoPopup_T01_Entity.CRUD == "")
                    _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucPlanOrderinfoPopup_T01_Entity.CRUD == ""))
                {
