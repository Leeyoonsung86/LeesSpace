...
{
    public partial class ucProductPlanDocumentListPopup : UserControl
    {
        ...
        private ucProductPlanDocumentListPopupEntity _pucProductPlanDocumentListPopupEntity = null; // 엔티티 생성
        ...
        public ucProductPlanDocumentListPopup()
        {
            InitializeComponent();
        ...
        private void ucProductPlanDocumentListPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pucProductPlanDocumentListPopupEntity = new ucProductPlanDocumentListPopupEntity();
            _pucProductPlanDocumentListPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucProductPlanDocumentListPopupEntity.USER_CODE = _pUSER_CODE;
            _pucProductPlanDocumentListPopupEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            ...
            _luORDER_NUMBER.Text = ARRAY_CODE[4].ToString();
            _luORDER_REVISION.Text = ARRAY_CODE[5].ToString();
            _luCONTRACT_ID.Text = ARRAY_CODE[2].ToString();
            _luPRODUCT_PLAN_ID.Text = ARRAY_CODE[0].ToString();
            _luCONTRACT_NUMBER.Text = ARRAY_CODE[3].ToString();

            _pucProductPlanDocumentListPopupEntity.PRODUCTION_PLAN_ID = ARRAY_CODE[0].ToString();
            _pucProductPlanDocumentListPopupEntity.PRODUCTION_PLAN_SEQ = ARRAY_CODE[1].ToString();
            _pucProductPlanDocumentListPopupEntity.CONTRACT_ID = ARRAY_CODE[2].ToString();
            _pucProductPlanDocumentListPopupEntity.CONTRACT_NUMBER = ARRAY_CODE[3].ToString();
            _pucProductPlanDocumentListPopupEntity.ORDER_NUMBER = ARRAY_CODE[4].ToString();
            _pucProductPlanDocumentListPopupEntity.ORDER_REVISION = ARRAY_CODE[5].ToString();
        ...
        private void CoFAS_DevExpressManager__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                case "PRODUCTPALN_DOCUMENT_VIEW_MAIN_BTN":
                    ...
                    break;
                case "PRODUCTPALN_DOCUMENT_VIEW_SUB_BTN":
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucProductPlanDocumentListPopupEntity.CRUD = "R";
                _pucProductPlanDocumentListPopupEntity.CONTRACT_ID = _luCONTRACT_ID.Text.ToString();
                _pucProductPlanDocumentListPopupEntity.CONTRACT_REVISION = _luORDER_REVISION.Text.ToString();
                _pucProductPlanDocumentListPopupEntity.USE_YN = _luUSE_YN.GetValue();

                _dtList = new ucProductPlanDocumentListPopupBusiness().ucProductPlanDocumentListPopup_Info_Main(_pucProductPlanDocumentListPopupEntity);

                if (_pucProductPlanDocumentListPopupEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucProductPlanDocumentListPopupEntity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _pucProductPlanDocumentListPopupEntity.CRUD = "R";
                _pucProductPlanDocumentListPopupEntity.CONTRACT_ID = _luCONTRACT_ID.Text.ToString();
                _pucProductPlanDocumentListPopupEntity.CONTRACT_NUMBER = _luCONTRACT_NUMBER.Text.ToString();
                _pucProductPlanDocumentListPopupEntity.DOCUMENT_TYPE = _luDOCUMENT_TYPE.GetValue();
                _pucProductPlanDocumentListPopupEntity.DOCUMENT_NAME = _luDOCUMENT_NAME.Text.ToString();
                _pucProductPlanDocumentListPopupEntity.DOCUMENT_VER = _luDOCUMENT_VER.Text.ToString();
                _pucProductPlanDocumentListPopupEntity.USE_YN = _luDOCUMENT_USE_YN.GetValue();

                _dtList = new ucProductPlanDocumentListPopupBusiness().ucProductPlanDocumentListPopup_Info_Sub(_pucProductPlanDocumentListPopupEntity);
        ...
        private void InputDataMain_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ucProductPlanDocumentListPopupBusiness().ucProductPlanDocumentListPopup_Info_Save(_pucProductPlanDocumentListPopupEntity, dtSave);
