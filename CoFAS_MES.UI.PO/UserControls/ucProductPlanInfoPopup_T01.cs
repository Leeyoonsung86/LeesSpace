...
{
    public partial class ucProductPlanInfoPopup_T01 : UserControl
    {
        ...
        private ProductPlanInfoPopup_T01Entity _pProductPlanInfoPopup_T01Entity = null;
        ...
        //화면 추가 메시지 영역 
        private string _pMSG_PLAN_QTY = string.Empty;     //잔여수량보다 계획수량이 많을 수 없습니다.
        ...
        public ucProductPlanInfoPopup_T01()
        {
            InitializeComponent();
        ...
        private void ucProductPlanInfoPopup_T01_Load(object sender, EventArgs e)
        {
            try
            {
                //180712_3
        ...
        private void InitializeSetting()
        {
            ...
            _pProductPlanInfoPopup_T01Entity = new ProductPlanInfoPopup_T01Entity();
            ...
            {
                _pMSG_PLAN_QTY = dtMessage.Rows[0]["MSG_PLAN_QTY"].ToString();
            }
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _luPLAN_QTY.Text = "0";
                _luCONTRACT_QTY.Text = "";
                _luCONTRACT_QTY.ReadOnly = true;
                _luREMAIN_QTY.Text = "";
                _luREMAIN_QTY.ReadOnly = true;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductPlanInfoPopup_T01Business().ProductPlanInfoPopup_T01_Return(_pCRUD, pPART_CODE).Tables[0];
                if (_pCRUD == "")
                    _dtList.Rows.Clear();
        ...
        private void InputData_Save(DataTable pDataTable)
        {
            try
            {
                ...
                _pProductPlanInfoPopup_T01Entity.USER_CODE = _pUSER_CODE;
                _pProductPlanInfoPopup_T01Entity.PART_CODE_MST = _luPART_CODE.Text;
                _pProductPlanInfoPopup_T01Entity.CONTRACT_ID = _luCONTRACT_ID.Text;

                DataTable qDataTable = new ProductPlanInfoPopup_T01Business().ProductPlanInfoPopup_T01_Save(_pProductPlanInfoPopup_T01Entity, pDataTable);
        ...
        private void _btAPPLY_Click(object sender, EventArgs e)
        {
            try
            {
                if (Decimal.Parse(_luREMAIN_QTY.Text) >= Decimal.Parse(_luPLAN_QTY.Text))
                {
                ...
                {
                    CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_PLAN_QTY); //잔여수량보다 계획수량이 많을 수 없습니다.
                }
        ...
        private void _luCONTRACT_ID__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                try
                {
                    ...
                    UI.PO.UserForm.frmCommonPopup.ARRAY = new object[2] { "ContractInfo_Popup", _luTPART_NAME.Text }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
