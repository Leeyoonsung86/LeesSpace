...
{
    public partial class ucProductionOrderInfoPopup_T04 : UserControl
    {
        ...
        private ucProductionOrderInfoPopup_T04_Entity _pucProductionOrderInfoPopup_T04_Entity = null;
        ...
        public ucProductionOrderInfoPopup_T04()
        {
            InitializeComponent();
        ...
        private void ucProductionOrderInfoPopup_T04_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            _pucProductionOrderInfoPopup_T04_Entity = new ucProductionOrderInfoPopup_T04_Entity();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucProductionOrderInfoPopup_T04_Entity.CRUD = "R";
                _pucProductionOrderInfoPopup_T04_Entity.DATE_FROM = _ucFROMDATE.FromDateTime.ToString("yyyyMMdd");
                _pucProductionOrderInfoPopup_T04_Entity.DATE_TO = _ucFROMDATE.ToDateTime.ToString("yyyyMMdd");
                ...
                _dtList = new pucProductionOrderInfoPopup_T04Business().ucProductionOrderInfoPopup_T04_Select(_pucProductionOrderInfoPopup_T04_Entity).Tables[0];

                if (_pucProductionOrderInfoPopup_T04_Entity.CRUD == "")
                    _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucProductionOrderInfoPopup_T04_Entity.CRUD == ""))
                {
