...
{
    public partial class ucProductionOrderInfoPopup_T07 : UserControl
    {
        ...
        private ucProductionOrderInfoPopup_T07_Entity _pucProductionOrderInfoPopup_T07_Entity = null;
        ...
        public ucProductionOrderInfoPopup_T07()
        {
            InitializeComponent();
        ...
        private void ucProductionOrderInfoPopup_T07_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            _pucProductionOrderInfoPopup_T07_Entity = new ucProductionOrderInfoPopup_T07_Entity();
            ...
            _ucPRODUCTION_PLAN_DATE.FromDateTime = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1);  //조회 시작일, 매월 초 날짜로 설정
            _ucPRODUCTION_PLAN_DATE.ToDateTime = DateTime.Today;  //조회 종료일
