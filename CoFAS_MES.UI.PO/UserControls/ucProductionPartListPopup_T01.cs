...
{
    public partial class ucProductionPartListPopup_T01 : UserControl
    {
        ...
        private ucProductionPartListPopup_T01Entity _pucProductionPartListPopup_T01Entity = null; // 엔티티 생성
        ...
        public ucProductionPartListPopup_T01()
        {
            InitializeComponent();
        ...
        private void ucProductionPartListPopup_T01_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pucProductionPartListPopup_T01Entity = new ucProductionPartListPopup_T01Entity();
            _pucProductionPartListPopup_T01Entity.CORP_CODE = _pCORP_CODE;
            _pucProductionPartListPopup_T01Entity.USER_CODE = _pUSER_CODE;
            _pucProductionPartListPopup_T01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void _btCLEAR_Click(object sender, EventArgs e)
        {
            ...
            _pucProductionPartListPopup_T01Entity.CRUD = "";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                if (_pucProductionPartListPopup_T01Entity.CRUD == "") _dtList.Rows.Clear();
