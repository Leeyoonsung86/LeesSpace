...
{
    public partial class ucShipmentInfoPopup : UserControl
    {
        ...
        private ucShipmentInfoPopupEntity _pucShipmentInfoPopupEntity = null;
        ...
        public ucShipmentInfoPopup(DataTable dt)
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            ...
            _pucShipmentInfoPopupEntity = new ucShipmentInfoPopupEntity();
            //_pOrderNumberInfoPopup_Entity.VEND_CODE = ARRAY[1].ToString();
            _pucShipmentInfoPopupEntity.USER_CODE = USER_CODE.ToString();
            ...
            _pucShipmentInfoPopupEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            //화면 컨트롤러 설정
            InitializeControl();
        ...
        private void _luTPART_CODE__OnOpenClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xfrmCommonPopup.dtReturn != null && xfrmCommonPopup.dtReturn.Rows.Count > 0)
                {
                    ...
                    _pucShipmentInfoPopupEntity.PART_CODE = xfrmCommonPopup.dtReturn.Rows[0]["PART_CODE"].ToString();
                }
