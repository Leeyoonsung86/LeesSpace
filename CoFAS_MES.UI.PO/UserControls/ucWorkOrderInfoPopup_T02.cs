...
{
    public partial class ucWorkOrderInfoPopup_T02 : UserControl
    {
        #region ○ 기본 전역변수
        ...
        private WorkOrderInfoPopup_T02Entity _pWorkOrderInfoPopup_T02Entity = null;
        ...
        private string _pMSG_NOT_ROUTING_CONNECT = string.Empty;
        ...
        #region ○ 생성자
        public ucWorkOrderInfoPopup_T02()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            ...
            _pMSG_NOT_ROUTING_CONNECT = _pMessageEntity.MSG_NOT_ROUTING_CONNECT;
            _pMSG_RESET_COMPLETE = _pMessageEntity.MSG_RESET_COMPLETE;

            _pWorkOrderInfoPopup_T02Entity = new WorkOrderInfoPopup_T02Entity();
            _pWorkOrderInfoPopup_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            ...
            {
                _pMSG_NOT_ROUTING_CONNECT = dtMessage2.Rows[0]["MSG_NOT_ROUTING_CONNECT"].ToString();
            }
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new WorkOrderInfoPopup_T02Business().WorkOrderInfoPopup_T02_Return(_pCRUD, pPLAN_ORDER, pPART_CODE, _pWorkOrderInfoPopup_T02Entity).Tables[0];
                if (_pCRUD == "")
                    _dtList.Rows.Clear();
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pCRUD == ""))
                {
                    ...
                    /*
                    RepositoryItemLookUpEdit lookupedit_workcenter = new RepositoryItemLookUpEdit();
                    DataTable dt2 = new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "WORKCENTER_BUMA2", _luTPART_CODE.Text.ToString(), "", "").Tables[0];//, 0, 0, "", true);
                    lookupedit_workcenter.DataSource = dt2;
                    _gdMAIN_VIEW.Columns["WORKCENTER_CODE"].ColumnEdit = lookupedit_workcenter;
                    */
                ...
                else
                {
                    ...
                    CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_NOT_ROUTING_CONNECT);
                    _dtList.Rows.Clear();
        ...
        private void InputData_Save(DataTable pDataTable)
        {
            try
            {
                ...
                bool isError = false;
                _pWorkOrderInfoPopup_T02Entity.CRUD = "C";
                _pWorkOrderInfoPopup_T02Entity.USER_CODE = _pUSER_CODE;
                _pWorkOrderInfoPopup_T02Entity.REFERENCE_ID = _luPLAN_ORDER_ID.Text;  //계획정보를 레퍼런스에 담음

                for (int i = 0; i < pDataTable.Rows.Count; i++)
                {
                    if (Convert.ToDecimal(pDataTable.Rows[i]["PLAN_ORDER_QTY"].ToString()) < Convert.ToDecimal(pDataTable.Rows[i]["IN_QTY"].ToString()) + Convert.ToDecimal(pDataTable.Rows[i]["ORDER_QTY"].ToString()))
                    {
                ...
                isError = new WorkOrderInfoPopup_T02Business().WorkOrderInfoPopup_T02_Save(_pWorkOrderInfoPopup_T02Entity, pDataTable);
        ...
        private void _luCONTRACT_ID__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                try
                {
                    ...
                    UI.PO.UserForm.frmCommonPopup.ARRAY = new object[2] { "PlanOrderInfo_Popup", _luTPART_NAME.Text }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
                    UI.PO.UserForm.frmCommonPopup.ARRAY_CODE = new object[2] { _luTPART_CODE.Text, _luTPART_NAME.Text };
                    UI.PO.UserForm.frmCommonPopup xfrmCommonPopup = new UI.PO.UserForm.frmCommonPopup("PlanOrderInfo_Popup_T01"); //유저컨트롤러 설정 부분
        ...
        private void _luCUT_COUNT__OnKeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
