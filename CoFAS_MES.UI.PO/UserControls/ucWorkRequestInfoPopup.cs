...
{
    public partial class ucWorkRequestInfoPopup : UserControl
    {
        ...
        private ucWorkRequestInfoPopupEntity _pucWorkRequestInfoPopupEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            ...
            _pucWorkRequestInfoPopupEntity = new ucWorkRequestInfoPopupEntity();
            //그리드 설정 ==고정==
            _pucWorkRequestInfoPopupEntity.PART_TYPE = _pARRAY_CODE[2].ToString();
