...
{
    public partial class ucWorkResultPopUp_T03 : UserControl
    {
        #region ○ 기본 전역변수 영역
        ...
        private ucWorkResultPopUp_T03_Entity _pucWorkResultPopUp_T03_Entity = null;
        ...
        #region ○ 폼 로드 이벤트
        private void ucWorkResultPopUp_T03_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                _pucWorkResultPopUp_T03_Entity = new ucWorkResultPopUp_T03_Entity();
                _pucWorkResultPopUp_T03_Entity.CORP_CODE = _pCORP_CODE;
                _pucWorkResultPopUp_T03_Entity.USER_CODE = _pUSER_CODE;
                _pucWorkResultPopUp_T03_Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _luTERMINAL_CODE.ReadOnly = true;
        ...
        private void _ucbtSAVE_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    //_pucWorkResultPopUp_T03_Entity.RESOURCE_CODE = _luPROCESS_CODE.GetValue();
                    _pucWorkResultPopUp_T03_Entity.RESOURCE_CODE = _luTERMINAL_CODE.GetValue();
                    _pucWorkResultPopUp_T03_Entity.COLLECTION_DATE = DateTime.Now.ToString("yyyyMMddHHmmss");
                    _pucWorkResultPopUp_T03_Entity.PROPERTY_VALUE = _luWORKORDERID.Text;

                    switch (_luRESULT_GUBN.GetValue().ToString())
                    {
                        case "CD501001":
                            _pucWorkResultPopUp_T03_Entity.CONDITION_CODE = _luRESULT_GUBN.GetValue();
                            _pucWorkResultPopUp_T03_Entity.COLLECTION_VALUE = _luRESULT_QTY.Text.Replace(",", "");
                            //_pucWorkResultPopUp_T03_Entity.CONDITION_CODE = "CD501001";
                            break;
                        case "CD501002":
                            _pucWorkResultPopUp_T03_Entity.CONDITION_CODE = _luBAD_CODE.GetValue();
                            _pucWorkResultPopUp_T03_Entity.COLLECTION_VALUE = _luRESULT_QTY.Text.Replace(",", "");
                            break;
                        case "CD501003":
                            _pucWorkResultPopUp_T03_Entity.CONDITION_CODE = _luSTATUS_CODE.GetValue();
                            ...
                            _pucWorkResultPopUp_T03_Entity.COLLECTION_VALUE = pTimeSpan.TotalSeconds.ToString(); // Math.Floor(pTimeSpan.TotalSeconds).ToString(); // _luSTATUS_TIME.Text.Replace("-", "").Replace(" / ", "").Replace(":", "");
                            break;
                    }
                    ...
                    bool isError = false;
                    isError = new ucWorkResultPopUp_T03Business().ucWorkResultPopUp_T03_Save(_pucWorkResultPopUp_T03_Entity);
                    ...
                    if (!isError)
                    {
                        ...
                        if (_luRESULT_GUBN.GetValue().ToString() == "CD501003" && _pucWorkResultPopUp_T03_Entity.CONDITION_CODE == "ES011003")
                        {
                            _pucWorkResultPopUp_T03_Entity.CRUD = "U";
                            _pucWorkResultPopUp_T03_Entity.PRODUCTION_ORDER_ID = _pucWorkResultPopUp_T03_Entity.PROPERTY_VALUE;
                            _pucWorkResultPopUp_T03_Entity.COMPLETE_YN = "Y";

                            isError = new ucWorkResultPopUp_T03Business().usWorkResultPopUp_T03_Save_01(_pucWorkResultPopUp_T03_Entity);
