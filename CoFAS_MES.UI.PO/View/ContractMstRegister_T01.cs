...
{
    public partial class ContractMstRegister_T01 : frmBaseNone
    {
        #region ○ 기본 전역변수
        ...
        private ContractMstRegister_T01Entity _pContractMstRegister_T01Entity = null; // 엔티티 생성
        ...
        public ContractMstRegister_T01()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pContractMstRegister_T01Entity = new ContractMstRegister_T01Entity();
                _pContractMstRegister_T01Entity.USER_CODE = _pUSER_CODE;
                _pContractMstRegister_T01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pContractMstRegister_T01Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                //조회조건 영역
                _luTCONTRACT_DATE.FromDateTime = Convert.ToDateTime("2000-01-01");  //조회 시작일, 매월 초 날짜로 설정
                _luTCONTRACT_DATE.ToDateTime =  DateTime.Today.AddDays(1);  //조회 종료일, 당일 설정
                ...
                //데이터 영역
                _luTVEND.Text = "";
                _pContractMstRegister_T01Entity.VEND_CODE = "";
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                //if (gv.GetFocusedRowCellValue("CONTRACT_ID") == null) return;

                //string strPROCESS_CODE = gv.GetFocusedRowCellValue("CONTRACT_ID").ToString();

                //_pContractMstRegister_T01Entity.CRUD = "R";

                //_pContractMstRegister_T01Entity.CONTRACT_ID = gv.GetFocusedRowCellValue("CONTRACT_ID").ToString();
                //_pContractMstRegister_T01Entity.ORDER_NUMBER = gv.GetFocusedRowCellValue("ORDER_NUMBER").ToString();
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                InitializeControl2();
                _pContractMstRegister_T01Entity.CRUD = "R";
                _pContractMstRegister_T01Entity.DATE_FROM = DateTime.Parse(_luTCONTRACT_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); //Convert.ToString(_luTCONTRACT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                _pContractMstRegister_T01Entity.DATE_TO = DateTime.Parse(_luTCONTRACT_DATE.ToDateTime.ToString()).ToString("yyyyMMdd"); //Convert.ToString(_luTCONTRACT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                //_pContractMstRegister_T01Entity.VEND_NAME = _luTVEND.NameText;
                //_pContractMstRegister_T01Entity.VEND_CODE = _luTVEND.CodeText;
                //_pContractMstRegister_T01Entity.PART_NAME = _luTPART.NameText;
                //_pContractMstRegister_T01Entity.PART_CODE = _luTPART.CodeText;
                _pContractMstRegister_T01Entity.USE_YN = _luTUSE_YN.GetValue();
                //_pContractMstRegister_T01Entity.CONTRACT_ID = _luTCONTRACT_ID.Text;
                _pContractMstRegister_T01Entity.CONTRACT_ID = "";
                _pContractMstRegister_T01Entity.CONTRACT_NUMBER = _luTCONTRACT_NUMBER.Text;
                MainFind_DisplayData();
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (CoFAS_ConvertManager.DataTable_FindCount(dtCheck_Temp, "Convert([CONTRACT_DATE], 'System.DateTime') > Convert([DELIVERY_DATE], 'System.DateTime')", ""))
                {
                    CoFAS_DevExpressManager.ShowInformationMessage("계약일자가 종료일자보다 클 수 없습니다.");
                    return;
                }
                ...
                if (CoFAS_ConvertManager.DataTable_FindCount(dtCheck_Temp, "[CONTRACT_NAME] is null OR [CONTRACT_NAME] = ''", ""))
                {
                    //CONTRACT_NAME
                    CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_CHECK_VALID_ITEM);
                    return;
                }
                if (CoFAS_ConvertManager.DataTable_FindCount(dtCheck_Temp, "[VEND_CODE] is null OR [VEND_CODE] = ''", ""))
                {
                    //VEND_CODE, VEND_NAME
                    CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_CHECK_VALID_ITEM);
                    return;
                }
                if (CoFAS_ConvertManager.DataTable_FindCount(dtCheck_Temp, "[CONTRACT_DATE] is null OR [CONTRACT_DATE] = ''", ""))
                {
                    //CONTRACT_DATE
                    CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_CHECK_VALID_ITEM);
                    return;
                }
                if (CoFAS_ConvertManager.DataTable_FindCount(dtCheck_Temp, "[DELIVERY_DATE] is null OR [DELIVERY_DATE] = ''", ""))
                {
                    //DELIVERY_DATE
                    CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_CHECK_VALID_ITEM);
                    return;
                }
                if (CoFAS_ConvertManager.DataTable_FindCount(dtCheck_Temp, "[USE_YN] is null OR [USE_YN] = ''", ""))
                {
                    //USE_YN
                    CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_CHECK_VALID_ITEM);
                    return;
                ...
                InputData_Save(_pContractMstRegister_T01Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                //    _pContractMstRegister_T01Entity.CRUD = "D";
                //else
                //{ 
                ...
                //_pContractMstRegister_T01Entity.CONTRACT_ID = _luCONTRACT_ID.Text;
                //_pContractMstRegister_T01Entity.CONTRACT_DATE = _luCONTRACT_DATE.DateTime.ToString("yyyyMMdd");
                //_pContractMstRegister_T01Entity.PART_CODE = _luPART.CodeText;
                //_pContractMstRegister_T01Entity.VEND_CODE = _luVEND.CodeText;
                //_pContractMstRegister_T01Entity.CONTRACT_QTY = _luCONTRACT_QTY.Text == "" ? "0.00" : _luCONTRACT_QTY.Text.Replace(",", "");
                //_pContractMstRegister_T01Entity.UNITCOST = _luUNITCOST.Text == "" ? "0.00" : _luUNITCOST.Text.Replace(",", "");
                //_pContractMstRegister_T01Entity.COST = _luCOST.Text == "" ? "0.00" : _luCOST.Text.Replace(",", "");
                //_pContractMstRegister_T01Entity.DELIVERY_DATE = _luDELIVERY_DATE.DateTime.ToString("yyyyMMdd");
                //_pContractMstRegister_T01Entity.DELIVERY_LOCATION = _luDELIVERY_LOCATION.Text;
                //_pContractMstRegister_T01Entity.REMARK = _luREMARK.Text;
                //_pContractMstRegister_T01Entity.USE_YN = "N";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ContractMstRegister_T01Business().ContractMst_Info(_pContractMstRegister_T01Entity);

                if (_pContractMstRegister_T01Entity.CRUD == "")
                    _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pContractMstRegister_T01Entity.CRUD == ""))
                {
                    //데이터 필드에 맞춰 자동 바인딩
        ...
        private void SubFind_DisplayData()
        {
            ...
            //    _dtList = new ContractMstRegister_T01Business().ContractSub_Info(_pContractMstRegister_T01Entity);
            ...
            //        if (_pLocation_Code != "" && _pLocation_YN)
            //        {
            //            int rowHandle = _gdSUB_VIEW.LocateByValue("CONTRACT_ID", _pLocation_Code);
            //            if (rowHandle != DevExpress.XtraGrid.GridControl.InvalidRowHandle)
        ...
        private void InputData_Save(ContractMstRegister_T01Entity _pContractMstRegister_T01Entity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                ...
                if (CoFAS_DevExpressManager.ShowQuestionMessage(_pMSG_SAVE_QUESTION) == DialogResult.Yes)
                {
                    ...
                    if ((CoFAS_ConvertManager.DataTable_FindCount(dt, "CRUD IN ('C','U','D')", "")))
                    {
                        ...
                        isError = new ContractMstRegister_T01Business().ContractMst_Save(_pContractMstRegister_T01Entity, dtTemp);

                        if (!isError)
                        {
                            //CoFAS_DevExpressManager.ShowInformationMessage("저장 처리 되었습니다.");
                            CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_SAVE);
                            _pLocation_Code = _pContractMstRegister_T01Entity.RTN_KEY;  //저장 위치
        ...
        private void _luVEND_OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            if (xfrmCommonPopup.dtReturn.Rows.Count > 0)
            {
                _pContractMstRegister_T01Entity.VEND_CODE = xfrmCommonPopup.dtReturn.Rows[0]["VEND_CODE"].ToString();
                _pContractMstRegister_T01Entity.VEND_NAME = xfrmCommonPopup.dtReturn.Rows[0]["VEND_NAME"].ToString();
