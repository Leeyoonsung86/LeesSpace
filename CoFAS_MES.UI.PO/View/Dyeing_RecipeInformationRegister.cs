...
{
    public partial class Dyeing_RecipeInformationRegister : frmBaseNone
    {
        ...
        private Dyeing_RecipeInformationRegisterEntity _pDyeing_RecipeInformationRegisterEntity = null; // 엔티티 생성
        ...
        public Dyeing_RecipeInformationRegister()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pDyeing_RecipeInformationRegisterEntity = new Dyeing_RecipeInformationRegisterEntity();
                _pDyeing_RecipeInformationRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pDyeing_RecipeInformationRegisterEntity.USER_CODE = _pUSER_CODE;
                _pDyeing_RecipeInformationRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pDyeing_RecipeInformationRegisterEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pDyeing_RecipeInformationRegisterEntity.CRUD = "R";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new Dyeing_RecipeInformationRegisterBusiness().Sample_Info(_pDyeing_RecipeInformationRegisterEntity);

                if (_pDyeing_RecipeInformationRegisterEntity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pDyeing_RecipeInformationRegisterEntity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData(string strWINDOW_NAME, string strGRID_NAME)
        {
            try
            {
                ...
                _dtList = new Dyeing_RecipeInformationRegisterBusiness().Sample_Info_Sub(_pDyeing_RecipeInformationRegisterEntity);
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new Dyeing_RecipeInformationRegisterBusiness().Sample_Info_Save(_pDyeing_RecipeInformationRegisterEntity, dtSave);
