...
{
    public partial class Dyeing_WorkOrdersRegister : frmBaseNone
    {
        ...
        private Dyeing_WorkOrdersRegisterEntity _pDyeing_WorkOrdersRegisterEntity = null; // 엔티티 생성
        ...
        public Dyeing_WorkOrdersRegister()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pDyeing_WorkOrdersRegisterEntity = new Dyeing_WorkOrdersRegisterEntity();
                _pDyeing_WorkOrdersRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pDyeing_WorkOrdersRegisterEntity.USER_CODE = _pUSER_CODE;
                _pDyeing_WorkOrdersRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pDyeing_WorkOrdersRegisterEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new Dyeing_WorkOrdersRegisterBusiness().Sample_Info(_pDyeing_WorkOrdersRegisterEntity);

                if (_pDyeing_WorkOrdersRegisterEntity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pDyeing_WorkOrdersRegisterEntity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData(string strWINDOW_NAME, string strGRID_NAME)
        {
            try
            {
                ...
                //_dtList = new Dyeing_WorkOrdersRegisterBusiness().Sample_Info_Sub(_pDyeing_WorkOrdersRegisterEntity);
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new Dyeing_WorkOrdersRegisterBusiness().Sample_Info_Save(_pDyeing_WorkOrdersRegisterEntity, dtSave);
