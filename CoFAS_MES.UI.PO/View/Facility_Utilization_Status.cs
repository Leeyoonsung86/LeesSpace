...
{
    public partial class Facility_Utilization_Status : frmBaseNone
    {
        ...
        private Facility_Utilization_StatusEntity _pFacility_Utilization_StatusEntity = null; // 엔티티 생성
        ...
        public Facility_Utilization_Status()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pFacility_Utilization_StatusEntity = new Facility_Utilization_StatusEntity();
                //_pJobResultRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pFacility_Utilization_StatusEntity.USER_CODE = _pUSER_CODE;
                _pFacility_Utilization_StatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pFacility_Utilization_StatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pFacility_Utilization_StatusEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pFacility_Utilization_StatusEntity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager));
