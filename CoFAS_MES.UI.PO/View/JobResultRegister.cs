...
{
    public partial class JobResultRegister : frmBaseNone
    {
        ...
        private JobResultRegisterEntity _pJobResultRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pJobResultRegisterEntity = new JobResultRegisterEntity();
                //_pJobResultRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pJobResultRegisterEntity.USER_CODE = _pUSER_CODE;
                _pJobResultRegisterEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pJobResultRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pJobResultRegisterEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pJobResultRegisterEntity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pJobResultRegisterEntity.CRUD = "R";
                _pJobResultRegisterEntity.DATE_FROM = Convert.ToString(_luT_ORDER_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                _pJobResultRegisterEntity.DATE_TO = Convert.ToString(_luT_ORDER_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new JobResultRegisterBusiness().JobResultRegister_Info_Filename(_pJobResultRegisterEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pJobResultRegisterEntity.WINDOW_NAME);
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                //_dtList = new JobResultRegisterBusiness().JobResultRegister_Info_Filename(_pJobResultRegisterEntity);

                //if (_pJobResultRegisterEntity.CRUD == "") _dtList.Rows.Clear();


                //if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pJobResultRegisterEntity.CRUD == ""))
                //{
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new JobResultRegisterBusiness().Sample_Info_Save(_pJobResultRegisterEntity, dtSave);
