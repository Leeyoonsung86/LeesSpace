...
{
    public partial class NgResultRegister : frmBaseNone
    {
        ...
        private NgResultRegisterEntity _pNgResultRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pNgResultRegisterEntity = new NgResultRegisterEntity();
                //_pNgResultRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pNgResultRegisterEntity.USER_CODE = _pUSER_CODE;
                _pNgResultRegisterEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pNgResultRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pNgResultRegisterEntity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pNgResultRegisterEntity.CRUD = "R";
                _pNgResultRegisterEntity.DATE_FROM = Convert.ToString(_luT_ORDER_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                _pNgResultRegisterEntity.DATE_TO = Convert.ToString(_luT_ORDER_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new NgResultRegisterBusiness().NgResultRegister_Info_Filename(_pNgResultRegisterEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pNgResultRegisterEntity.WINDOW_NAME);
                ...
                // xml의 parameter 설정
                dashboard.Parameters[0].Value = _pNgResultRegisterEntity.CRUD;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                //_dtList = new NgResultRegisterBusiness().NgResultRegister_Info_Filename(_pNgResultRegisterEntity);

                //if (_pNgResultRegisterEntity.CRUD == "") _dtList.Rows.Clear();


                //if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pNgResultRegisterEntity.CRUD == ""))
                //{
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new NgResultRegisterBusiness().Sample_Info_Save(_pNgResultRegisterEntity, dtSave);
