...
{
    public partial class ProductMonitoring_T01 : frmBaseNone
    {
        ...
        private ProductMonitoring_T01Entity _pProductMonitoring_T01Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductMonitoring_T01Entity = new ProductMonitoring_T01Entity();
                //_pProductMonitoring_T01Entity.CORP_CODE = _pCORP_CODE;
                _pProductMonitoring_T01Entity.USER_CODE = _pUSER_CODE;
                _pProductMonitoring_T01Entity.WINDOW_NAME = _pWINDOW_NAME;
                _pProductMonitoring_T01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pProductMonitoring_T01Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _pProductMonitoring_T01Entity.CRUD = "R";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                string sfilename = "";
                _pProductMonitoring_T01Entity.CRUD = "R";
                _pProductMonitoring_T01Entity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _pProductMonitoring_T01Entity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                _pProductMonitoring_T01Entity.VEND_NAME = "";// _luTVEND_NAME.Text;


                _dtList = new ProductMonitoring_T01Business().ProductMonitoring_T01_Info(_pProductMonitoring_T01Entity); //Entity에 WINDOW_NAME 추가
                
                if (_pProductMonitoring_T01Entity.CRUD == "")
                    _dtList.Rows.Clear();
