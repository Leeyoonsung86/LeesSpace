...
{
    public partial class ProductMonitoring_T02 : frmBaseNone
    {
        ...
        private ProductMonitoring_T02Entity _pProductMonitoring_T02Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductMonitoring_T02Entity = new ProductMonitoring_T02Entity();
                //_pProductMonitoring_T01Entity.CORP_CODE = _pCORP_CODE;
                _pProductMonitoring_T02Entity.USER_CODE = _pUSER_CODE;
                _pProductMonitoring_T02Entity.WINDOW_NAME = _pWINDOW_NAME;
                _pProductMonitoring_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pProductMonitoring_T02Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _pProductMonitoring_T02Entity.CRUD = "R";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                string sfilename = "";
                _pProductMonitoring_T02Entity.CRUD = "R";
                _pProductMonitoring_T02Entity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _pProductMonitoring_T02Entity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                _pProductMonitoring_T02Entity.VEND_NAME = "";// _luTVEND_NAME.Text;
                

                _dtList = new ProductMonitoring_T02Business().ProductMonitoring_T02_Info(_pProductMonitoring_T02Entity); //Entity에 WINDOW_NAME 추가
                
                if (_pProductMonitoring_T02Entity.CRUD == "")
                    _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductMonitoring_T02Entity.CRUD == ""))
                {
        ...
        private void gdMAIN_VIEW_RowStyle(object sender, DevExpress.XtraGrid.Views.Grid.RowStyleEventArgs e)
        {
            ...
            string Contract_id = view.GetRowCellDisplayText(e.RowHandle, view.Columns["CONTRACT_ID"]); 
            if (Contract_id=="")
            {
