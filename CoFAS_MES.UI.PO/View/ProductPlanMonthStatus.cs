...
{
    public partial class ProductPlanMonthStatus : frmBaseNone
    {
        ...
        private ProductPlanMonthStatusEntity _pProductPlanMonthStatusEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductPlanMonthStatusEntity = new ProductPlanMonthStatusEntity();
                //_pResultStatusPlanResultEntity.CORP_CODE = _pCORP_CODE;
                _pProductPlanMonthStatusEntity.USER_CODE = _pUSER_CODE;
                _pProductPlanMonthStatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pProductPlanMonthStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _pProductPlanMonthStatusEntity.CRUD = "";
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductPlanMonthStatusEntity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductPlanMonthStatusEntity.CRUD = "R";
                _pProductPlanMonthStatusEntity.DATE = DateTime.Today.ToString();
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductPlanMonthStatusBusiness().ResultStatusPlanResult_Info_Filename(_pProductPlanMonthStatusEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pProductPlanMonthStatusEntity.WINDOW_NAME);
