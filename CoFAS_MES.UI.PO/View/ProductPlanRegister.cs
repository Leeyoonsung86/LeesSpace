...
{
    public partial class ProductPlanRegister: frmBaseNone
    {
        #region ○ 기본 전역변수
        ...
        private ProductPlanRegisterEntity _pProductPlanRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductPlanRegisterEntity = new ProductPlanRegisterEntity();
                _pProductPlanRegisterEntity.USER_CODE = _pUSER_CODE;
                _pProductPlanRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pProductPlanRegisterEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductPlanRegisterEntity.CRUD = "R";
                _pProductPlanRegisterEntity.DATE_FROM = DateTime.Parse(_luTPRODUCT_PLAN_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _pProductPlanRegisterEntity.DATE_TO = DateTime.Parse(_luTPRODUCT_PLAN_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                _pProductPlanRegisterEntity.PART_NAME = _luTPART.NameText;
                _pProductPlanRegisterEntity.PART_CODE = _luTPART.CodeText;
                _pProductPlanRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
                _pProductPlanRegisterEntity.CONTRACT_ID = _luTCONTRACT_ID.Text;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductPlanRegisterEntity.CRUD = "U";
                _pProductPlanRegisterEntity.USE_YN = "Y";
                ...
                return;
                //InputData_Save(_pProductPlanRegisterEntity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
