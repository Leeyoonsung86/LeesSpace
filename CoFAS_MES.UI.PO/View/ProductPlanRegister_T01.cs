...
{
    public partial class ProductPlanRegister_T01 : frmBaseNone
    {
        #region ○ 기본 전역변수
        ...
        private ProductPlanRegister_T01Entity _pProductPlanRegister_T01Entity = null; // 엔티티 생성
        ...
        //화면 추가 메시지 영역 
        private string _pMSG_NOT_DELETE_PLAN = string.Empty;     //이미 등록된 작업지시가 있습니다.  

        #endregion

        #region ○ 생성자

        public ProductPlanRegister_T01()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductPlanRegister_T01Entity = new ProductPlanRegister_T01Entity();
                _pProductPlanRegister_T01Entity.USER_CODE = _pUSER_CODE;
                _pProductPlanRegister_T01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                {
                    _pMSG_NOT_DELETE_PLAN = dtMessage.Rows[0]["MSG_NOT_DELETE_PLAN"].ToString();
                }
                ...
                _pProductPlanRegister_T01Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                //조회조건 영역
                _luTPRODUCT_PLAN_DATE.FromDateTime = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1);  //조회 시작일, 매월 초 날짜로 설정
                _luTPRODUCT_PLAN_DATE.ToDateTime = DateTime.Today;  //조회 종료일, 당일 설정
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductPlanRegister_T01Entity.production_plan_id = gv.GetFocusedRowCellValue("PRODUCTION_PLAN_ID").ToString(); ;
                _pProductPlanRegister_T01Entity.USE_YN = gv.GetFocusedRowCellValue("USE_YN").ToString();
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductPlanRegister_T01Entity.CRUD = "R";
                _pProductPlanRegister_T01Entity.DATE_FROM = DateTime.Parse(_luTPRODUCT_PLAN_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _pProductPlanRegister_T01Entity.DATE_TO = DateTime.Parse(_luTPRODUCT_PLAN_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                _pProductPlanRegister_T01Entity.PART_NAME = _luTPART.NameText;
                _pProductPlanRegister_T01Entity.PART_CODE = _luTPART.CodeText;
                _pProductPlanRegister_T01Entity.USE_YN = _luTUSE_YN.GetValue();
                _pProductPlanRegister_T01Entity.CONTRACT_ID = _luTCONTRACT_ID.Text;
                _pProductPlanRegister_T01Entity.production_plan_id = _luTPLAN_ID.Text;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductPlanRegister_T01Entity.CRUD = "U";
                _pProductPlanRegister_T01Entity.USE_YN = "Y";
                ...
                return;
                //InputData_Save(_pProductPlanRegister_T01Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_AddItemButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                CoFAS_MES.UI.PO.UserForm.frmCommonPopup.ARRAY = new object[2] { "ProductPlan", "" }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
                CoFAS_MES.UI.PO.UserForm.frmCommonPopup xfrmCommonPopup = new UI.PO.UserForm.frmCommonPopup("ProductPlanInfo_T01"); //유저컨트롤러 설정 부분
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                string str = _pProductPlanRegister_T01Entity.production_plan_id;

                if (_pProductPlanRegister_T01Entity.USE_YN == "N")
                {
                ...
                if (CoFAS_DevExpressManager.ShowQuestionMessage(string.Format(_pMSG_DELETE_QUESTION, str)) == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        _pProductPlanRegister_T01Entity.DATE_FROM = "00010101";
                        _pProductPlanRegister_T01Entity.DATE_TO = "99991231";
                        _pProductPlanRegister_T01Entity.ORDER_CODE = "";
                        //_pProductPlanRegister_T01Entity.PLAN_CODE = _luTPLAN_ORDER.Text; //생산계획번호
                        _pProductPlanRegister_T01Entity.PART_CODE = "";
                        _pProductPlanRegister_T01Entity.PART_NAME = "";
                        _pProductPlanRegister_T01Entity.REFERENCE_ID = _pProductPlanRegister_T01Entity.production_plan_id; //생산계획번호
                        _pProductPlanRegister_T01Entity.WORKCENTER_CODE = "";
                        _pProductPlanRegister_T01Entity.PROCESS_CODE = "";
                        _pProductPlanRegister_T01Entity.USE_YN = "Y";
                        _pProductPlanRegister_T01Entity.COMPLETE_YN = "";


                        _pProductPlanRegister_T01Entity.CRUD = "R";
                        //Check_Next_Process();                        
                        #region ○ 생산계획 삭제 시, 해당 생산계획번호의 작업지시 있는지 조회     
                        try
                        {
                            CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);

                            _dtList2 = new ProductPlanRegister_T01Business().Sample_Check_Next_Process(_pProductPlanRegister_T01Entity);

                            if (_pProductPlanRegister_T01Entity.CRUD == "") _dtList2.Rows.Clear();

                            //해당 생산계획번호로 내려진 작업지시가 있으면
                            if ((_dtList2 != null && _dtList2.Rows.Count > 0) || (_dtList2 != null && _pProductPlanRegister_T01Entity.CRUD == ""))
                            {
                                //CoFAS_DevExpressManager.BindGridControl(_gdMAIN, _gdMAIN_VIEW, _dtList2); //데이터 필드에 맞춰 자동 바인딩

                                CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_NOT_DELETE_PLAN); //이미 등록된 작업지시가 있습니다.
                            ...
                            //해당 생산계획번호로 내려진 작업지시가 없으면
                            else
                            {
                                bool isCheck = false;
                                
                                _pProductPlanRegister_T01Entity.CRUD = "D";
                                _pProductPlanRegister_T01Entity.USE_YN = "N";

                                //////////////////
                                //CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                                DataTable dt = new DataTable();
                                bool isError = false;
                                dt = new ProductPlanRegister_T01Business().ProductPlanMst_Del(_pProductPlanRegister_T01Entity);
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductPlanRegister_T01Business().ProductPlanMst_Info(_pProductPlanRegister_T01Entity);

                if (_pProductPlanRegister_T01Entity.CRUD == "")
                    _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductPlanRegister_T01Entity.CRUD == ""))
                {
                    //데이터 필드에 맞춰 자동 바인딩
