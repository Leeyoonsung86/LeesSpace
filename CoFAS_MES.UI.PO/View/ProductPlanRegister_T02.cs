...
{
    public partial class ProductPlanRegister_T02 : frmBaseNone
    {
        #region ○ 기본 전역변수
        ...
        private ProductPlanRegister_T02Entity _pProductPlanRegister_T02Entity = null; // 엔티티 생성
        private DataTable _dtList = null; //조회 데이터 리스트
        private DataTable _dtSList = null; // 선택 데이터 모음
        private DataTable _dtList_sub = null; //서브 조회데이터 리스트
        ...
        public ProductPlanRegister_T02()
        {
            InitializeComponent();
        ...
        private void Form_FormClosed(object pSender, FormClosedEventArgs pFormClosedEventArgs)
        {
            try
            {
                ...
                _luCONTRACT._OnOpenClick -= _luCONTRACT_OnOpenClick;
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductPlanRegister_T02Entity = new ProductPlanRegister_T02Entity();
                _pProductPlanRegister_T02Entity.USER_CODE = _pUSER_CODE;
                _pProductPlanRegister_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pProductPlanRegister_T02Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _luORDER_NUMBER.ReadOnly = false;
                _luORDER_NAME.ReadOnly = false;
                _luCONTRACT.CodeReadOnly = false;
                _luCONTRACT.NameReadOnly = false;
                ...
                _luORDER_REVISION.ReadOnly = false;
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductPlanRegister_T02Entity.PRODUCTION_PLAN_ID = gv.GetFocusedRowCellValue("PRODUCTION_PLAN_ID").ToString(); ;
                _pProductPlanRegister_T02Entity.USE_YN = gv.GetFocusedRowCellValue("USE_YN").ToString();
                ...
                _pProductPlanRegister_T02Entity.PRODUCTION_PLAN_DATE = _dtSList.Rows[0]["PRODUCTION_PLAN_DATE"].ToString();
                _pProductPlanRegister_T02Entity.ORDER_NUMBER = _dtSList.Rows[0]["ORDER_NUMBER"].ToString();
                _pProductPlanRegister_T02Entity.PRODUCTION_PLAN_SEQ = _dtSList.Rows[0]["PRODUCTION_PLAN_SEQ"].ToString();
                _pProductPlanRegister_T02Entity.CONTRACT_NUMBER = _dtSList.Rows[0]["CONTRACT_NUMBER"].ToString();
                _pProductPlanRegister_T02Entity.ORDER_REVISION = _dtSList.Rows[0]["ORDER_REVISION"].ToString();
                _pProductPlanRegister_T02Entity.REFERENCE_ID = _dtSList.Rows[0]["REFERENCE_ID"].ToString();
                ...
                _pProductPlanRegister_T02Entity.CRUD = "R";
                SubFind_DisplayData(_pProductPlanRegister_T02Entity, _dtSList);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductPlanRegister_T02Entity.CRUD = "R";
                _pProductPlanRegister_T02Entity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _pProductPlanRegister_T02Entity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                _pProductPlanRegister_T02Entity.ORDER_NUMBER = _luTORDER_NUMBER.CodeText;
                _pProductPlanRegister_T02Entity.ORDER_NAME = _luTORDER_NUMBER.NameText;
                _pProductPlanRegister_T02Entity.CONTRACT_NUMBER = _luTCONTRACT.CodeText;
                _pProductPlanRegister_T02Entity.USE_YN = _luTUSE_YN.GetValue();
                //_pProductPlanRegister_T02Entity.CONTRACT_ID = _luTCONTRACT_NUMBER.Text;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luORDER_NUMBER.ReadOnly)
                {
                    _pProductPlanRegister_T02Entity.CRUD = "U";
                }
                else
                {
                    _pProductPlanRegister_T02Entity.CRUD = "C";
                    _pProductPlanRegister_T02Entity.PRODUCTION_PLAN_ID = "";
                }


                _pProductPlanRegister_T02Entity.ORDER_NAME = _luORDER_NAME.Text.ToString();
                _pProductPlanRegister_T02Entity.ORDER_NUMBER = _luORDER_NUMBER.Text.ToString();          
                _pProductPlanRegister_T02Entity.PRODUCTION_PLAN_DATE = _luORDER_DATE.DateTime.ToString("yyyyMMdd");
                
                _pProductPlanRegister_T02Entity.REFERENCE_ID = _luCONTRACT.CodeText;
                _pProductPlanRegister_T02Entity.USE_YN = "Y";
                _pProductPlanRegister_T02Entity.ORDER_REVISION = _luORDER_REVISION.Text.ToString();
                _pProductPlanRegister_T02Entity.REMARK = _luREMARK.Text.ToString();
                if (_luORDER_OPTION.Checked)
                {
                    _pProductPlanRegister_T02Entity.ORDER_OPTION = "Y";
                }
                else
                {
                    _pProductPlanRegister_T02Entity.ORDER_OPTION = "N";
                }
                InputData_Save(_pProductPlanRegister_T02Entity);
                ////CoFAS_DevExpressManager.ShowInformationMessage("생산계획데이터는 다시 입력하여야 합니다");
                //CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_AGAIN_INPUT_DATA);
                //_pProductPlanRegister_T02Entity.CRUD = "R";
                return;
        ...
        private void Form_AddItemButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luCONTRACT.CodeText.ToString().Equals(""))
                {
                    return;
                }
                ...
                UserForm.frmCommonPopup.ARRAY = new object[5] { _luCONTRACT.CodeText, _pProductPlanRegister_T02Entity.PRODUCTION_PLAN_ID
                    , _pProductPlanRegister_T02Entity.PRODUCTION_PLAN_DATE, _pProductPlanRegister_T02Entity.PRODUCTION_PLAN_SEQ
                    , _pProductPlanRegister_T02Entity.ORDER_NUMBER }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
                UserForm.frmCommonPopup xfrmCommonPopup = new UserForm.frmCommonPopup("contract_number_info"); //유저컨트롤러 설정 부분
                ...
                //frmCommonPopup.ARRAY = new object[2] { "ProductPlan", "" }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
                //frmCommonPopup xfrmCommonPopup = new CORE.UserForm.frmCommonPopup("ProductPlanInfo"); //유저컨트롤러 설정 부분
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_pProductPlanRegister_T02Entity.USE_YN == "N")
                {
                ...
                bool isCheck = false;
                string str = _pProductPlanRegister_T02Entity.PRODUCTION_PLAN_ID;
                _pProductPlanRegister_T02Entity.CRUD = "D";
                _pProductPlanRegister_T02Entity.USE_YN = "N";
                ...
                if (CoFAS_DevExpressManager.ShowQuestionMessage(string.Format(_pMSG_DELETE_QUESTION, str)) == DialogResult.Yes)
                {
                    ...
                    bool isError = false;
                    dt = new ProductPlanRegister_T02Business().ProductPlanMst_Del(_pProductPlanRegister_T02Entity);
        ...
        #region 조회 서치박스-_luTCONTRACT_OnOpenClick
        ...
        #region 서치박스-_luTCONTRACT_OnOpenClick
        private void _luCONTRACT_OnOpenClick(object sender, EventArgs e)
        {
            try
            {
                if(_luCONTRACT.CodeReadOnly)
                {
                    return;
                }
                ...
                // 0 서비스네임 1 공통코드경우 CODE_TYPE 으로구분자 올린다.
                frmCommonPopup.ARRAY = new object[2] { "contract_number_R", "" };
                frmCommonPopup.ARRAY_CODE = new object[2] { _luCONTRACT.CodeText.ToString(), _luCONTRACT.NameText.ToString() };
                frmCommonPopup xfrmCommonPopup = new CORE.UserForm.frmCommonPopup("CommonCode"); //유저컨트롤러 설정 부분
                ...
                if (xfrmCommonPopup.dtReturn != null && xfrmCommonPopup.dtReturn.Rows.Count > 0)
                {
                    _luCONTRACT.CodeText = xfrmCommonPopup.dtReturn.Rows[0]["CD"].ToString();
                    _luCONTRACT.NameText = xfrmCommonPopup.dtReturn.Rows[0]["CD_NM"].ToString();
                }
                ...
                if(!_luCONTRACT.CodeText.ToString().Equals(""))
                {
                    CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                    _pProductPlanRegister_T02Entity.CRUD = "R";
                    _pProductPlanRegister_T02Entity.CONTRACT_NUMBER = _luCONTRACT.CodeText.ToString();
                    _pProductPlanRegister_T02Entity.ORDER_NUMBER = _luORDER_NUMBER.Text.ToString();
                    _dtList = new ProductPlanRegister_T02Business().ProductPlandetail_Info(_pProductPlanRegister_T02Entity);

                    if (_pProductPlanRegister_T02Entity.CRUD == "")
                        _dtList.Rows.Clear();

                    if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductPlanRegister_T02Entity.CRUD == ""))
                    {
                        //데이터 필드에 맞춰 자동 바인딩
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductPlanRegister_T02Business().ProductPlanMst_Info(_pProductPlanRegister_T02Entity);
        ...
        #region 메인저장
        private void InputData_Save(ProductPlanRegister_T02Entity _pProductPlanRegister_T02Entity)
        {
            CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
            DataTable dt;
            ...
            try
            {
                using (DBManager pDBManager = new DBManager())
                {
                    if (CoFAS_DevExpressManager.ShowQuestionMessage(_pMSG_SAVE_QUESTION) == DialogResult.Yes)
                    {
                        ...
                        isError = new ProductPlanRegister_T02Business().ProductPlanMst_Save(_pProductPlanRegister_T02Entity, dtTemp);
                        ...
                        else
                        {
                            ...
                            _pLocation_Code = _pProductPlanRegister_T02Entity.RTN_KEY;  //저장 위치
                            SubFind_DisplayData(_pProductPlanRegister_T02Entity, _dtSList);
                            Form_SearchButtonClicked(null, null);
                            if (rowhandle == 0)
        ...
        #region  서브조회
        private void SubFind_DisplayData(ProductPlanRegister_T02Entity _pProductPlanRegister_T02Entity, DataTable selectdt)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                
                _dtList_sub = new ProductPlanRegister_T02Business().ProductPlanMst_Info_sub(_pProductPlanRegister_T02Entity);

                if ((_dtList_sub != null && _dtList_sub.Rows.Count > 0) || (_dtList_sub != null && _pProductPlanRegister_T02Entity.CRUD == ""))
                {
                    //데이터 필드에 맞춰 자동 바인딩
                    ...
                    if (_pLocation_Code != "" && _pLocation_YN)
                    {
                        int rowHandle = _gdSUB_VIEW.LocateByValue("PRODUCT_PLAN_ID", _pLocation_Code);
                        if (rowHandle != DevExpress.XtraGrid.GridControl.InvalidRowHandle)
        ...
        {
            if (!_luORDER_NUMBER.ReadOnly) return;
            ...
            PO.UserForm.frmCommonPopup.ARRAY_CODE = new object[6] { _pProductPlanRegister_T02Entity.PRODUCTION_PLAN_ID, _pProductPlanRegister_T02Entity.PRODUCTION_PLAN_SEQ, _pProductPlanRegister_T02Entity.REFERENCE_ID, _pProductPlanRegister_T02Entity.CONTRACT_NUMBER, _pProductPlanRegister_T02Entity.ORDER_NUMBER, _pProductPlanRegister_T02Entity.ORDER_REVISION };//넘기는 파라메터 에 따라 설정

            PO.UserForm.frmCommonPopup xfrmcommonPopup2 = new PO.UserForm.frmCommonPopup("ucProductPlanDocumentListPopup"); //유저컨트롤러 설정 부분
