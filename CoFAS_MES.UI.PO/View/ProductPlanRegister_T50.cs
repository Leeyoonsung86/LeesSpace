...
{
    public partial class ProductPlanRegister_T50: frmBaseNone
    {
        #region ○ 기본 전역변수
        ...
        private ProductPlanRegister_T50Entity _pProductPlanRegister_T50Entity = null; // 엔티티 생성
        ...
        public ProductPlanRegister_T50()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductPlanRegister_T50Entity = new ProductPlanRegister_T50Entity();
                _pProductPlanRegister_T50Entity.USER_CODE = _pUSER_CODE;
                _pProductPlanRegister_T50Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pProductPlanRegister_T50Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductPlanRegister_T50Entity.production_plan_id = gv.GetFocusedRowCellValue("PRODUCTION_PLAN_ID").ToString(); ;
                _pProductPlanRegister_T50Entity.USE_YN = gv.GetFocusedRowCellValue("USE_YN").ToString();
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductPlanRegister_T50Entity.CRUD = "R";
                _pProductPlanRegister_T50Entity.DATE_FROM = DateTime.Parse(_luTPRODUCT_PLAN_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _pProductPlanRegister_T50Entity.DATE_TO = DateTime.Parse(_luTPRODUCT_PLAN_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                _pProductPlanRegister_T50Entity.PART_NAME = _luTPART.NameText;
                _pProductPlanRegister_T50Entity.PART_CODE = _luTPART.CodeText;
                _pProductPlanRegister_T50Entity.USE_YN = _luTUSE_YN.GetValue();
                _pProductPlanRegister_T50Entity.CONTRACT_ID = _luTCONTRACT_ID.Text;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductPlanRegister_T50Entity.CRUD = "U";
                _pProductPlanRegister_T50Entity.USE_YN = "Y";
                ...
                return;
                //InputData_Save(_pProductPlanRegister_T50Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_AddItemButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                frmCommonPopup xfrmCommonPopup = new CORE.UserForm.frmCommonPopup("ProductPlanInfo_T50"); //유저컨트롤러 설정 부분
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if(_pProductPlanRegister_T50Entity.USE_YN == "N")
                {
                ...
                bool isCheck = false;
                string str = _pProductPlanRegister_T50Entity.production_plan_id;
                _pProductPlanRegister_T50Entity.CRUD = "D";
                _pProductPlanRegister_T50Entity.USE_YN = "N";
                ...
                if (CoFAS_DevExpressManager.ShowQuestionMessage(string.Format(_pMSG_DELETE_QUESTION, str)) == DialogResult.Yes)
                {
                    ...
                    bool isError = false;
                    dt = new ProductPlanRegister_T50Business().ProductPlanMst_Del(_pProductPlanRegister_T50Entity);
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                //ProductPlanMst_T50_Info
                _dtList = new ProductPlanRegister_T50Business().ProductPlanMst_T50_Info(_pProductPlanRegister_T50Entity);

                if (_pProductPlanRegister_T50Entity.CRUD == "")
                    _dtList.Rows.Clear();

                if((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductPlanRegister_T50Entity.CRUD == ""))
                {
                    //데이터 필드에 맞춰 자동 바인딩
