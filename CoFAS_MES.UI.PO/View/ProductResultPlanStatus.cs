...
{
    public partial class ProductResultPlanStatus : frmBaseNone
    {
        ...
        private ProductResultPlanStatusEntity _pProductResultPlanStatusEntity = null; // 엔티티 생성
        ...
        public ProductResultPlanStatus()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductResultPlanStatusEntity = new ProductResultPlanStatusEntity();
                //_pResultStatusPlanResultEntity.CORP_CODE = _pCORP_CODE;
                _pProductResultPlanStatusEntity.USER_CODE = _pUSER_CODE;
                _pProductResultPlanStatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pProductResultPlanStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void InitializeControl()
        {
            ...
            {
                //조회조건 영역 
                _luT_PLAN_DATE.DateTime = DateTime.Today;
                ...
                _pProductResultPlanStatusEntity.CRUD = "";
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductResultPlanStatusEntity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductResultPlanStatusEntity.CRUD = "R";
                _pProductResultPlanStatusEntity.DATE = DateTime.Today.ToString();
                //_pResultStatusPlanResultEntity.DATE_FROM = DateTime.Parse(_luT_PLAN_DATE1.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luT_PLAN_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                //_pResultStatusPlanResultEntity.DATE_TO = DateTime.Parse(_luT_PLAN_DATE1.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luT_PLAN_DATE.ToDateTime).Substring(0, 10).Replace("-", "");

                //DateTime stdate = _luT_PLAN_DATE1.FromDateTime;
                //DateTime ltdate = _luT_PLAN_DATE1.ToDateTime;
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductResultPlanStatusBusiness().ProductResultPlanStatus_Info_Filename(_pProductResultPlanStatusEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pProductResultPlanStatusEntity.WINDOW_NAME);
