...
{
    public partial class ProductTimeMonthLive : frmBaseNone
    {
        ...
        private ProductTimeMonthLiveEntity _pProductTimeMonthLiveEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductTimeMonthLiveEntity = new ProductTimeMonthLiveEntity();
                //_pResultStatusPlanResultEntity.CORP_CODE = _pCORP_CODE;
                _pProductTimeMonthLiveEntity.USER_CODE = _pUSER_CODE;
                _pProductTimeMonthLiveEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pProductTimeMonthLiveEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _pProductTimeMonthLiveEntity.CRUD = "";
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductTimeMonthLiveEntity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductTimeMonthLiveEntity.CRUD = "R";
                _pProductTimeMonthLiveEntity.DATE = DateTime.Today.ToString();
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductTimeMonthLiveBusiness().ProductTimeMonthLive_Info_Filename(_pProductTimeMonthLiveEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pProductTimeMonthLiveEntity.WINDOW_NAME);
