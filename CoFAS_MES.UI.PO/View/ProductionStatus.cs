...
{
    public partial class ProductionStatus : frmBaseNone
    {
        ...
        private ProductionStatusEntity _pProductionStatusEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductionStatusEntity = new ProductionStatusEntity();
                //_pProductionStatusEntity.CORP_CODE = _pCORP_CODE;
                _pProductionStatusEntity.USER_CODE = _pUSER_CODE;
                _pProductionStatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pProductionStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductionStatusEntity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductionStatusEntity.CRUD = "R";
                _pProductionStatusEntity.DATE_FROM = Convert.ToString(_luT_PLAN_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                _pProductionStatusEntity.DATE_TO = Convert.ToString(_luT_PLAN_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new ProductionStatusBusiness().ProductionStatus_Info_Filename(_pProductionStatusEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pProductionStatusEntity.WINDOW_NAME);
                ...
                // xml의 parameter 설정
                dashboard.Parameters[0].Value = _pProductionStatusEntity.CRUD;
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                //isError = new ProductionStatusBusiness().Sample_Info_Save(_pProductionStatusEntity, dtSave);
