...
{
    public partial class ResultStatusData : frmBaseNone
    {
        ...
        private ResultStatusDataEntity _pResultStatusDataEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pResultStatusDataEntity = new ResultStatusDataEntity();
                //_pResultStatusDataEntity.CORP_CODE = _pCORP_CODE;
                _pResultStatusDataEntity.USER_CODE = _pUSER_CODE;
                _pResultStatusDataEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pResultStatusDataEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new ResultStatusDataBusiness().ResultStatusData_Info_Filename(_pResultStatusDataEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pResultStatusDataEntity.WINDOW_NAME);
                ...
                // xml의 parameter 설정
                dashboard.Parameters[0].Value = _pResultStatusDataEntity.CRUD;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                //_dtList = new ResultStatusDataBusiness().ResultStatusData_Info_Filename(_pResultStatusDataEntity);

                //if (_pResultStatusDataEntity.CRUD == "") _dtList.Rows.Clear();


                //if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pResultStatusDataEntity.CRUD == ""))
                //{
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ResultStatusDataBusiness().Sample_Info_Save(_pResultStatusDataEntity, dtSave);
