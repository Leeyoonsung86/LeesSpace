...
{
    public partial class ResultStatusPlanResult : frmBaseNone
    {
        ...
        private ResultStatusPlanResultEntity _pResultStatusPlanResultEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pResultStatusPlanResultEntity = new ResultStatusPlanResultEntity();
                //_pResultStatusPlanResultEntity.CORP_CODE = _pCORP_CODE;
                _pResultStatusPlanResultEntity.USER_CODE = _pUSER_CODE;
                _pResultStatusPlanResultEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pResultStatusPlanResultEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pResultStatusPlanResultEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _luT_PROCESS.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R",_pLANGUAGE_TYPE, "processcode", "", "", "").Tables[0], 0, 0, "", true);
                _luT_PROCESS.ItemIndex = 0;
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pResultStatusPlanResultEntity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pResultStatusPlanResultEntity.CRUD = "R";
                _pResultStatusPlanResultEntity.DATE_FROM = DateTime.Parse(_luT_PLAN_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luT_PLAN_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                _pResultStatusPlanResultEntity.DATE_TO = DateTime.Parse(_luT_PLAN_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luT_PLAN_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new ResultStatusPlanResultBusiness().ResultStatusPlanResult_Info_Filename(_pResultStatusPlanResultEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pResultStatusPlanResultEntity.WINDOW_NAME);
                ...
                // xml의 parameter 설정
                dashboard.Parameters[0].Value = _pResultStatusPlanResultEntity.CRUD;
                dashboard.Parameters[1].Value = DateTime.Parse(_luT_PLAN_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//_luT_PLAN_DATE.FromDateTime.ToString().Substring(0, 10).Replace("-", "");
                dashboard.Parameters[2].Value = DateTime.Parse(_luT_PLAN_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//_luT_PLAN_DATE.ToDateTime.ToString().Substring(0, 10).Replace("-", "");
                ...
                dashboard.Parameters[6].Value = _luT_PROCESS.GetValue();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                //_dtList = new ResultStatusPlanResultBusiness().ResultStatusPlanResult_Info_Filename(_pResultStatusPlanResultEntity);

                //if (_pResultStatusPlanResultEntity.CRUD == "") _dtList.Rows.Clear();


                //if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pResultStatusPlanResultEntity.CRUD == ""))
                //{
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ResultStatusPlanResultBusiness().Sample_Info_Save(_pResultStatusPlanResultEntity, dtSave);
