...
{
    public partial class ResultStatusProduct : frmBaseNone
    {
        ...
        private ResultStatusProductEntity _pResultStatusProductEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pResultStatusProductEntity = new ResultStatusProductEntity();
                //_pResultStatusProductEntity.CORP_CODE = _pCORP_CODE;
                _pResultStatusProductEntity.USER_CODE = _pUSER_CODE;
                _pResultStatusProductEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pResultStatusProductEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pResultStatusProductEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pResultStatusProductEntity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pResultStatusProductEntity.CRUD = "R";
                _pResultStatusProductEntity.DATE_FROM = DateTime.Parse(_luT_ORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luT_ORDER_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                _pResultStatusProductEntity.DATE_TO = DateTime.Parse(_luT_ORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luT_ORDER_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                string strFTP_PATH = "";
                string sfilename = "";
                _dtList = new ResultStatusProductBusiness().ResultStatusProduct_Info_Filename(_pResultStatusProductEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pResultStatusProductEntity.WINDOW_NAME);
                ...
                // xml의 parameter 설정
                dashboard.Parameters[0].Value = _pResultStatusProductEntity.CRUD;
                ...
                dashboard.Parameters[3].Value = _luT_ORDER_ID.Text;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                //_dtList = new ResultStatusProductBusiness().ResultStatusProduct_Info_Filename(_pResultStatusProductEntity);

                //if (_pResultStatusProductEntity.CRUD == "") _dtList.Rows.Clear();


                //if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pResultStatusProductEntity.CRUD == ""))
                //{
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ResultStatusProductBusiness().Sample_Info_Save(_pResultStatusProductEntity, dtSave);
