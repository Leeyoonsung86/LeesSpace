...
{
    public partial class WorkOrdersRegister : frmBaseNone
    {
        ...
        private WorkOrdersRegisterEntity _pWorkOrdersRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pWorkOrdersRegisterEntity = new WorkOrdersRegisterEntity();
                _pWorkOrdersRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pWorkOrdersRegisterEntity.USER_CODE = _pUSER_CODE;
                _pWorkOrdersRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pWorkOrdersRegisterEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pWorkOrdersRegisterEntity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pWorkOrdersRegisterEntity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _pWorkOrdersRegisterEntity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                _pWorkOrdersRegisterEntity.ORDER_CODE = _luTWORK_ORDER.Text;
                _pWorkOrdersRegisterEntity.PLAN_CODE = _luTPLAN_ORDER.Text;
                _pWorkOrdersRegisterEntity.PART_CODE = _luTPART_ALL.CodeText;
                _pWorkOrdersRegisterEntity.PART_NAME = _luTPART_ALL.NameText;
                _pWorkOrdersRegisterEntity.REFERENCE_ID = _luTPLAN_ORDER.Text;
                _pWorkOrdersRegisterEntity.WORKCENTER_CODE = _luTWC_CODE.GetValue();
                _pWorkOrdersRegisterEntity.PROCESS_CODE = _luTPC_CODE.GetValue();
                _pWorkOrdersRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    //확인
                    _pWorkOrdersRegisterEntity.CRUD = "U";
                    ...
                    _pWorkOrdersRegisterEntity.COMPLETE_YN = _luTCOMPLETE_YN.GetValue();
                    InputData_Save(_pWorkOrdersRegisterEntity);
                }
            }
            catch (ExceptionManager pExceptionManager)
            {
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new WorkOrdersRegisterBusiness().Sample_Info(_pWorkOrdersRegisterEntity);

                if (_pWorkOrdersRegisterEntity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pWorkOrdersRegisterEntity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData(string strWINDOW_NAME, string strGRID_NAME)
        {
            try
            {
                ...
                _dtList = new WorkOrdersRegisterBusiness().Sample_Info_Sub(_pWorkOrdersRegisterEntity);
