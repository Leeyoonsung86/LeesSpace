...
{
    public partial class WorkOrdersRegister_T01 : frmBaseNone
    {
        ...
        private WorkOrdersRegister_T01Entity _pWorkOrdersRegister_T01Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pWorkOrdersRegister_T01Entity = new WorkOrdersRegister_T01Entity();
                _pWorkOrdersRegister_T01Entity.CORP_CODE = _pCORP_CODE;
                _pWorkOrdersRegister_T01Entity.USER_CODE = _pUSER_CODE;
                _pWorkOrdersRegister_T01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                if (_pFirstYN)
                {
                    _pWorkOrdersRegister_T01Entity.CRUD = "";
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                if (_pFirstYN)
                {
                    ...
                    _luTPC_CODE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R",_pLANGUAGE_TYPE, "PROCESS_MST_CODE_COSMETICS", "", "", "").Tables[0], 0, 0, "", true);
                ...
                _luPROCESS_CODE_MST.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R",_pLANGUAGE_TYPE, "PROCESS_MST_CODE_COSMETICS", "", "", "").Tables[0], 0, 0, "");
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pWorkOrdersRegister_T01Entity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pWorkOrdersRegister_T01Entity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _pWorkOrdersRegister_T01Entity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                _pWorkOrdersRegister_T01Entity.ORDER_CODE = _luTWORK_ORDER.Text;
                _pWorkOrdersRegister_T01Entity.PLAN_CODE = _luTPRODUCTION_ORDER.Text;
                _pWorkOrdersRegister_T01Entity.PART_CODE = _luTPART_ALL.CodeText;
                _pWorkOrdersRegister_T01Entity.PART_NAME = _luTPART_ALL.NameText;
                _pWorkOrdersRegister_T01Entity.REFERENCE_ID = _luTPRODUCTION_ORDER.Text;
                _pWorkOrdersRegister_T01Entity.WORKCENTER_CODE = "";// _luTWC_CODE.GetValue();
                _pWorkOrdersRegister_T01Entity.PROCESS_CODE = _luTPC_CODE.GetValue();
                _pWorkOrdersRegister_T01Entity.USE_YN = _luTUSE_YN.GetValue();
                _pWorkOrdersRegister_T01Entity.COMPLETE_YN = _luTCOMPLETE_YN.GetValue();
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    //확인
                    _pWorkOrdersRegister_T01Entity.CRUD = "U";
                    _pWorkOrdersRegister_T01Entity.ORDER_CODE = _luORDER_ID.Text;
                    _pWorkOrdersRegister_T01Entity.ORDER_DATE = _luORDER_DATE.DateTime.ToString("yyyyMMdd");
                    _pWorkOrdersRegister_T01Entity.ORDER_QTY = _luPRODUCTION_ORDER_QTY.Text;
                    _pWorkOrdersRegister_T01Entity.WORKCENTER_CODE = _luPROCESS_CODE.GetValue();
                    _pWorkOrdersRegister_T01Entity.USE_YN = _luUSE_YN.GetValue();
                    _pWorkOrdersRegister_T01Entity.COMPLETE_YN = _luTCOMPLETE_YN.GetValue();
                    InputData_Save(_pWorkOrdersRegister_T01Entity);
                }
            }
            catch (ExceptionManager pExceptionManager)
            {
        ...
        private void Form_AddItemButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                CoFAS_MES.UI.PO.UserForm.frmCommonPopup.ARRAY_CODE = new object[2] { "", "" }; CoFAS_MES.UI.PO.UserForm.frmCommonPopup.FTP_PW = _pFTP_PW;
                CoFAS_MES.UI.PO.UserForm.frmCommonPopup.ARRAY = new object[2] { "WorkOrderInfoPopup_T01", "" }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
                CoFAS_MES.UI.PO.UserForm.frmCommonPopup xfrmCommonPopup = new CoFAS_MES.UI.PO.UserForm.frmCommonPopup("WorkOrderInfoPopup_T01"); //유저컨트롤러 설정 부분
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new WorkOrdersRegister_T01Business().Sample_Info(_pWorkOrdersRegister_T01Entity);

                if (_pWorkOrdersRegister_T01Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pWorkOrdersRegister_T01Entity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData(string strWINDOW_NAME, string strGRID_NAME)
        {
            try
            {
                ...
                _dtList = new WorkOrdersRegister_T01Business().Sample_Info_Sub(_pWorkOrdersRegister_T01Entity);
        ...
        private void InputData_Save(WorkOrdersRegister_T01Entity _pWorkOrdersRegister_T01Entity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                ...
                isError = new WorkOrdersRegister_T01Business().Sample_Info_Save(_pWorkOrdersRegister_T01Entity);
                ...
                else
                {
                    ...
                    _pLocation_Code = _pWorkOrdersRegister_T01Entity.RTN_KEY;  //저장 위치 
        ...
        private void _luTPLAN_ORDER__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                CoFAS_MES.UI.PO.UserForm.frmCommonPopup.ARRAY_CODE = new object[2] { _luTPRODUCTION_ORDER.Text, "" };
                ...
                if (xfrmCommonPopup.dtReturn != null && xfrmCommonPopup.dtReturn.Rows.Count > 0)
                {
                    _luTPRODUCTION_ORDER.Text = xfrmCommonPopup.dtReturn.Rows[0]["CONTRACT_ID"].ToString();
                }
