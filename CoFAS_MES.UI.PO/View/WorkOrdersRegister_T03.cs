...
{
    public partial class WorkOrdersRegister_T03 : frmBaseNone
    {
        ...
        private WorkOrdersRegister_T03Entity _pWorkOrdersRegister_T03Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pWorkOrdersRegister_T03Entity = new WorkOrdersRegister_T03Entity();
                _pWorkOrdersRegister_T03Entity.CORP_CODE = _pCORP_CODE;
                _pWorkOrdersRegister_T03Entity.USER_CODE = _pUSER_CODE;
                _pWorkOrdersRegister_T03Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pWorkOrdersRegister_T03Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pWorkOrdersRegister_T03Entity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pWorkOrdersRegister_T03Entity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _pWorkOrdersRegister_T03Entity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                _pWorkOrdersRegister_T03Entity.ORDER_CODE = _luTWORK_ORDER.Text;
                _pWorkOrdersRegister_T03Entity.PLAN_CODE = _luTPLAN_ORDER.Text;
                _pWorkOrdersRegister_T03Entity.PART_CODE = _luTPART_ALL.CodeText;
                _pWorkOrdersRegister_T03Entity.PART_NAME = _luTPART_ALL.NameText;
                _pWorkOrdersRegister_T03Entity.REFERENCE_ID = _luTPLAN_ORDER.Text;
                _pWorkOrdersRegister_T03Entity.WORKCENTER_CODE = _luTWC_CODE.GetValue();
                _pWorkOrdersRegister_T03Entity.PROCESS_CODE = ""; //_luTPC_CODE.GetValue();
                _pWorkOrdersRegister_T03Entity.USE_YN = _luTUSE_YN.GetValue();
                _pWorkOrdersRegister_T03Entity.COMPLETE_YN = _luTCOMPLETE_YN.GetValue();
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            _pWorkOrdersRegister_T03Entity.CRUD = "R";
                            _pWorkOrdersRegister_T03Entity.DATE_FROM = "00010101";
                            _pWorkOrdersRegister_T03Entity.DATE_TO = "99991231";
                            _pWorkOrdersRegister_T03Entity.PART_CODE = "";
                            _pWorkOrdersRegister_T03Entity.PART_NAME = "";
                            _pWorkOrdersRegister_T03Entity.PRODUCTION_ORDER_ID = _luORDER_ID.Text;
                            _pWorkOrdersRegister_T03Entity.PROCESS_CODE_MST = "";
                            _pWorkOrdersRegister_T03Entity.PROCESS_CODE = "";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new WorkOrdersRegister_T03Business().Sample_Info(_pWorkOrdersRegister_T03Entity);

                if (_pWorkOrdersRegister_T03Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pWorkOrdersRegister_T03Entity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData(string strWINDOW_NAME, string strGRID_NAME)
        {
            try
            {
                ...
                _dtList = new WorkOrdersRegister_T03Business().Sample_Info_Sub(_pWorkOrdersRegister_T03Entity);
        ...
        private void Check_Next_Process()
        {
            try
            {
                ...
                _dtList2 = new WorkOrdersRegister_T03Business().Sample_Check_Next_Process(_pWorkOrdersRegister_T03Entity);

                if (_pWorkOrdersRegister_T03Entity.CRUD == "")
                    _dtList2.Rows.Clear();

                //조회결과 있으면
                if ((_dtList2 != null && _dtList2.Rows.Count > 0) || (_dtList2 != null && _pWorkOrdersRegister_T03Entity.CRUD == ""))
                {
                    ...
                    {                        
                        _pWorkOrdersRegister_T03Entity.CRUD = "U";
                        _pWorkOrdersRegister_T03Entity.ORDER_CODE = _luORDER_ID.Text;
                        _pWorkOrdersRegister_T03Entity.ORDER_DATE = _luORDER_DATE.DateTime.ToString("yyyyMMdd");
                        _pWorkOrdersRegister_T03Entity.ORDER_QTY = _luPRODUCTION_ORDER_QTY.Text;
                        _pWorkOrdersRegister_T03Entity.WORKCENTER_CODE = _luPROCESS_CODE.GetValue();
                        _pWorkOrdersRegister_T03Entity.USE_YN = _luUSE_YN.GetValue();
                        _pWorkOrdersRegister_T03Entity.COMPLETE_YN = _luTCOMPLETE_YN.GetValue();
                        InputData_Save(_pWorkOrdersRegister_T03Entity); //저장함수
                    }
                ...
                {
                    //CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_SEARCH_EMPT); //"조회 내역이 없습니다."
                    _dtList2.Rows.Clear();
                    //CoFAS_DevExpressManager.BindGridControl(_gdMAIN, _gdMAIN_VIEW, _dtList2); //데이터 필드에 맞춰 자동 바인딩
                    //CoFAS_DevExpressManager.BindGridControl(_gdSUB1, _gdSUB1_VIEW, _dtList2);
                    //CoFAS_DevExpressManager.BindGridControl(_gdSUB2, _gdSUB2_VIEW, _dtList2);                    
                }
            }
            catch (ExceptionManager pExceptionManager)
            {
        ...
        private void InputData_Save(WorkOrdersRegister_T03Entity _pWorkOrdersRegister_T03Entity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                ...
                isError = new WorkOrdersRegister_T03Business().Sample_Info_Save(_pWorkOrdersRegister_T03Entity);
                ...
                else
                {
                    ...
                    _pLocation_Code = _pWorkOrdersRegister_T03Entity.RTN_KEY;  //저장 위치 
