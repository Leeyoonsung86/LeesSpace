...
{
    public partial class WorkOrdersRegister_T06 : frmBaseNone
    {
        ...
        private void InitializeControl()
        {
            try
            {
                if (_pFirstYN)
                {
                    ...
                    _luTTERMINAL_CODE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "POP_TERMINALE_DETAIL3", ProcessCode1, "", "").Tables[0], 0, 0, "",false);
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new WorkOrdersRegister_T06Business().Sample_Info(_pWorkOrdersRegister_T06Entity);
        ...
        private void InputData_Save(WorkOrdersRegister_T06Entity _pWorkOrdersRegister_T06Entity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                ...
                isError = new WorkOrdersRegister_T06Business().Sample_Info_Save(_pWorkOrdersRegister_T06Entity);
