...
{
    public partial class WorkOrdersRegister_T07 : frmBaseNone
    {
        ...
        private WorkOrdersRegister_T07Entity _pWorkOrdersRegister_T07Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pWorkOrdersRegister_T07Entity = new WorkOrdersRegister_T07Entity();
                _pWorkOrdersRegister_T07Entity.CORP_CODE = _pCORP_CODE;
                _pWorkOrdersRegister_T07Entity.USER_CODE = _pUSER_CODE;
                _pWorkOrdersRegister_T07Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pWorkOrdersRegister_T07Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pWorkOrdersRegister_T07Entity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pWorkOrdersRegister_T07Entity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _pWorkOrdersRegister_T07Entity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                _pWorkOrdersRegister_T07Entity.ORDER_CODE = _luTWORK_ORDER.Text;
                _pWorkOrdersRegister_T07Entity.PLAN_CODE = _luTPLAN_ORDER.Text;
                _pWorkOrdersRegister_T07Entity.PART_CODE = _luTPART_ALL.CodeText;
                _pWorkOrdersRegister_T07Entity.PART_NAME = _luTPART_ALL.NameText;
                _pWorkOrdersRegister_T07Entity.REFERENCE_ID = _luTPLAN_ORDER.Text;
                _pWorkOrdersRegister_T07Entity.PROCESS_CODE = _luTPC_CODE.GetValue();
                _pWorkOrdersRegister_T07Entity.COMPLETE_YN = _luTCOMPLETE_YN.GetValue();
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    //확인
                    _pWorkOrdersRegister_T07Entity.CRUD = "U";
                    _pWorkOrdersRegister_T07Entity.ORDER_CODE = _luORDER_ID.Text;
                    _pWorkOrdersRegister_T07Entity.ORDER_DATE = _luORDER_DATE.DateTime.ToString("yyyyMMdd");
                    _pWorkOrdersRegister_T07Entity.ORDER_QTY = _luPRODUCTION_ORDER_QTY.Text;
                    _pWorkOrdersRegister_T07Entity.USE_YN = _luUSE_YN.GetValue();
                    _pWorkOrdersRegister_T07Entity.COMPLETE_YN = _luTCOMPLETE_YN.GetValue();
                    InputData_Save(_pWorkOrdersRegister_T07Entity);
                }
            }
            catch (ExceptionManager pExceptionManager)
            {
        ...
        private void Form_AddItemButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                PO.UserForm.frmCommonPopup.ARRAY = new object[2] { "WorkOrder", "" }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new WorkOrdersRegister_T07Business().Sample_Info(_pWorkOrdersRegister_T07Entity);

                if (_pWorkOrdersRegister_T07Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pWorkOrdersRegister_T07Entity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData(string strWINDOW_NAME, string strGRID_NAME)
        {
            try
            {
                ...
                _dtList = new WorkOrdersRegister_T07Business().Sample_Info_Sub(_pWorkOrdersRegister_T07Entity);
        ...
        private void InputData_Save(WorkOrdersRegister_T07Entity _pWorkOrdersRegister_T07Entity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                ...
                isError = new WorkOrdersRegister_T07Business().Sample_Info_Save(_pWorkOrdersRegister_T07Entity);
                ...
                else
                {
                    ...
                    _pLocation_Code = _pWorkOrdersRegister_T07Entity.RTN_KEY;  //저장 위치 
        ...
        private void _luTPART_ALL__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            try
            {
                ...
                frmCommonPopup.ARRAY = new object[2] { "Product_Code_03", _luTPART_ALL.NameText }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
