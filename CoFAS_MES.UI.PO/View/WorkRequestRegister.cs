...
{
    public partial class WorkRequestRegister : frmBaseNone
    {
        ...
        private WorkRequestRegisterEntity _pWorkRequestRegisterEntity = null; // 엔티티 생성

        private static CORE.BaseControls.ucSpreadSheetControl _Temp_sdMAIN = null;
        ...
        private bool mapping_yn = false;
        public WorkRequestRegister()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //버튼 폰트색상 및 배경색상
                _ucbtWORK_REQUEST.BackColor = Color.LightBlue;
                ...
                //메뉴 화면 엔티티 설정
                _pWorkRequestRegisterEntity = new WorkRequestRegisterEntity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pWorkRequestRegisterEntity.USER_CODE = _pUSER_CODE;
                _pWorkRequestRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pWorkRequestRegisterEntity.WINDOW_NAME = _pWINDOW_NAME;
                //화면 설정 언어 & 명칭 변경.
               ...
               // _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Disabled;
                ...
                _pWorkRequestRegisterEntity.CRUD = "";
                ...
                if (_pFirstYN)
                {
                    ...
                    _luTWORK_STATUS.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "INSPECT_STATUS_AC", "", "", "").Tables[0], 0, 0, "");

                    _luTWORK_STATUS.ItemIndex = 0;
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pWorkRequestRegisterEntity.CRUD = "R";
                    _pWorkRequestRegisterEntity.DATE_FROM = DateTime.Parse(_luT_ACCEPT_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.FromDateTime).Replace("-", "").Substring(0, 8);//
                    _pWorkRequestRegisterEntity.DATE_TO = DateTime.Parse(_luT_ACCEPT_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Replace("-", "").Substring(0, 8);//
                    //_pWorkRequestRegisterEntity.VEND_NAME = _luTVEND.NameText;
                    //_pWorkRequestRegisterEntity.VEND_CODE = _luTVEND.CodeText;
                    _pWorkRequestRegisterEntity.PART_NAME = _luT_PART.NameText;
                    _pWorkRequestRegisterEntity.PART_CODE = _luT_PART.CodeText;
                    //_pWorkRequestRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
                    _pWorkRequestRegisterEntity.WORK_STATUS = _luTWORK_STATUS.GetValue();
                   //
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                InputData_Save(_pWorkRequestRegisterEntity);
        ...
        private void InputData_Save(WorkRequestRegisterEntity _pWorkRequestRegisterEntity)
        {
            try
            {
                ...
                if (CoFAS_DevExpressManager.ShowQuestionMessage(_pMSG_SAVE_QUESTION) == DialogResult.Yes)
                {
                    ...
                    _pWorkRequestRegisterEntity.CRUD = "U";
                    //_pWorkRequestRegisterEntity.CRUD = "C";
                    ...
                    /*
                    if (_pWorkRequestRegisterEntity.PRODUCTION_FILE=="")
                    {
                        ...
                        //서버주소는 제외
                        _pWorkRequestRegisterEntity.PRODUCTION_FILE = "PRODUCTION/" + _ptime + "_" + _pWorkRequestRegisterEntity.REFERENCE_ID + '.' + _pFile_Attr;
                    ...
                    */
                    ...
                    /*
                    pWorkRequestRegisterEntity.PART_CODE
                    pWorkRequestRegisterEntity.PART_NAME
                    pWorkRequestRegisterEntity.INSPECT_STATUS
                    pWorkRequestRegisterEntity.INSPECT_ID
                    pWorkRequestRegisterEntity.INSPECT__DATE
                    pWorkRequestRegisterEntity.INSPECT_SEQ
                    pWorkRequestRegisterEntity.VEND_PART_CODE
                    pWorkRequestRegisterEntity.PART_TYPE
                    pWorkRequestRegisterEntity.REFERENCE_ID
                    pWorkRequestRegisterEntity.MAKE_VEND
                    pWorkRequestRegisterEntity.MAKE_VEND_NAME
                    pWorkRequestRegisterEntity.VEND_CODE
                    pWorkRequestRegisterEntity.VEND_NAME
                    pWorkRequestRegisterEntity.REQUEST_DEPT
                    pWorkRequestRegisterEntity.CODE_NAME
                    pWorkRequestRegisterEntity.INOUT_DATE
                    pWorkRequestRegisterEntity.INOUT_QTY
                        */
                    //_pWorkRequestRegisterEntity.PACKING_REMARK  = sheet_1.GetCellValue(4, 6).TextValue;
                    //_pWorkRequestRegisterEntity.SAMPLE_DATE     = sheet_1.GetCellValue(4, 7).TextValue;
                    //_pWorkRequestRegisterEntity.SAMPLE_LOCATION = sheet_1.GetCellValue(6, 4).TextValue;
                    //_pWorkRequestRegisterEntity.SAMPLE_USER     = sheet_1.GetCellValue(6, 5).TextValue;
                    //_pWorkRequestRegisterEntity.SAMPLE_METHOD   = sheet_1.GetCellValue(6, 6).TextValue;
                    //_pWorkRequestRegisterEntity.SAMPLE_QTY      = sheet_1.GetCellValue(6, 7).TextValue;
                    /*
                pWorkRequestRegisterEntity.MAKE_NO
                pWorkRequestRegisterEntity.STANDARD
                pWorkRequestRegisterEntity.REQUEST_DATE
                pWorkRequestRegisterEntity.REQUEST_USER
                pWorkRequestRegisterEntity.END_DATE
                pWorkRequestRegisterEntity.TOTAL_RESULT
                pWorkRequestRegisterEntity.TOTAL_DATE
                pWorkRequestRegisterEntity.TOTAL_USER
                pWorkRequestRegisterEntity.COMPLETE_YN
                pWorkRequestRegisterEntity.REMARK
                pWorkRequestRegisterEntity.USER_YN
                */
                //확인쪽에 서명있는지체크
                //있으면 완료 / 없으면 접수상태
                if (sheet_1.GetCellValue(6, 2).ToString()=="")
                    _pWorkRequestRegisterEntity.ACCEPT_CHK = "N";
                else
                    _pWorkRequestRegisterEntity.ACCEPT_CHK = "Y";

                    if (mapping_yn)
                        isError = new WorkRequestRegisterBusiness().WorkRequestRegister_Info_MAKE_NO_SAVE(_pWorkRequestRegisterEntity, sheet_1);
                    else
                        isError = true;
                    // 자재입고
                    if (isError)
                    ...
                    {
                        isError = new WorkRequestRegisterBusiness().WorkRequestRegister_Info_Mst_Save(_pWorkRequestRegisterEntity, sheet_1);
                        ...
                        {
                            // isError = new WorkRequestRegisterBusiness().WorkRequestRegister_Info_Detail_Save(_pWorkRequestRegisterEntity, sheet_2);
                            // if (isError)
                            // {
                            //     //오류 발생.
                            //     //CoFAS_DevExpressManager.ShowInformationMessage("저장 오류 발생! 데이터를 확인 하세요.");
                        ...
                        byte[] data = SaveDocument(_sdMAIN, enFileFormat.Xlsx);
                        //_pFTP_BEFROE_FILENAME

                        if (CoFAS_FTPManager.FTPDelete(_pWorkRequestRegisterEntity.PRODUCTION_FILE, strFTP_PATH, _pFTP_ID, _pFTP_PW))
                        {
                            if (CoFAS_FTPManager.FTPUpload_DataofByte_CheckDirectory(_pWorkRequestRegisterEntity.PRODUCTION_FILE, _pFTP_ID, _pFTP_PW, strFTP_PATH, "", data)) // _pListofManagementEntity.WINDOW_NAME + _pListofManagementEntity.RTN_KEY + _pFileName
                            {
                        ...
                        //파일이 없는지 체크
                        else if (!qFTPUtil.IsFTPFileExsit(strFTP_PATH + _pWorkRequestRegisterEntity.PRODUCTION_FILE))
                        {
                            //정상 처리
                        ...
                        _pFile_Attr = "";
                        _pLocation_Code = _pWorkRequestRegisterEntity.RTN_KEY;  //저장 위치
                        ...
                        _pWorkRequestRegisterEntity.PRODUCTION_FILE = "";
        ...
        public byte[] SaveDocument(SpreadsheetControl _pSpreadSheetControl, enFileFormat _enFileFormat)
        {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            _pWorkRequestRegisterEntity.PRODUCTION_ORDER_ID = gv.GetFocusedRowCellValue("PRODUCTION_ORDER_ID").ToString();
            _pWorkRequestRegisterEntity.REFERENCE_ID = gv.GetFocusedRowCellValue("CONTRACT_ID").ToString();
            _pWorkRequestRegisterEntity.PROCESS_CODE_MST = gv.GetFocusedRowCellValue("PROCESS_CODE_MST").ToString();
            _pWorkRequestRegisterEntity.PRODUCTION_FILE = gv.GetFocusedRowCellValue("PRODUCTION_FILE").ToString();
            _pWorkRequestRegisterEntity.PART_CODE = gv.GetFocusedRowCellValue("PART_CODE").ToString();

            _pWorkRequestRegisterEntity.QA_QTY = gv.GetFocusedRowCellValue("QA_QTY").ToString();
            _pWorkRequestRegisterEntity.VEND_QTY = gv.GetFocusedRowCellValue("VEND_QTY").ToString();
            _pWorkRequestRegisterEntity.MESH = gv.GetFocusedRowCellValue("MESH").ToString();
            _pWorkRequestRegisterEntity.WORK_REMARK = gv.GetFocusedRowCellValue("WORK_REMARK").ToString();

            _pWorkRequestRegisterEntity.REMARK = gv.GetFocusedRowCellValue("REMARK").ToString();
            _pWorkRequestRegisterEntity.POSITION = gv.GetFocusedRowCellValue("POSITION").ToString();

          //  _pWorkRequestRegisterEntity.PRODUCTION_ORDER_ID = "";
            _pWorkRequestRegisterEntity.MAKE_NO = gv.GetFocusedRowCellValue("MAKE_NO").ToString();
          //  mapping_yn = false;

            //QC010003 : 접수
            //QC010004 : 완료
            //승인인경우 수정x
            if (gv.GetFocusedRowCellValue("WORK_STATUS").ToString() != "QC010004")
                _pApproval_YN = false;
            else
                _pApproval_YN = true;
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new WorkRequestRegisterBusiness().Sample_Info(_pWorkRequestRegisterEntity);
                mapping_yn = false;
                if (_pWorkRequestRegisterEntity.CRUD == "")
                    _dtList.Rows.Clear();
                //else
                //{
                //    IWorkbook workbook = _sdMAIN.Document;
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pWorkRequestRegisterEntity.CRUD == ""))
                {
        ...
        #region 시험의뢰 불러오기
        private void _ucbtWORK_REQUEST_Click(object sender, EventArgs e)
        {
             try
             {
                string part_type = "1005";
                 ...
                 CoFAS_MES.UI.PO.UserForm.frmCommonPopup.ARRAY = new object[2] { "Material_Code", _luT_PART.NameText }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
                 CoFAS_MES.UI.PO.UserForm.frmCommonPopup.ARRAY_CODE = new object[3] { _luT_PART.CodeText, _luT_PART.NameText , part_type };
                 CoFAS_MES.UI.PO.UserForm.frmCommonPopup xfrmCommonPopup = new CoFAS_MES.UI.PO.UserForm.frmCommonPopup("WorkRequestInfo"); //유저컨트롤러 설정 부분
        ...
        private void SheetFind_DisplayData()
        {
            try
            {
                ...
                _pWorkRequestRegisterEntity.CRUD = "R";
                //조회할거 프로시져
                _dtList = new WorkRequestRegisterBusiness().Sheet_Info_Sheet(_pWorkRequestRegisterEntity);   //엑셀 시트 조회하기
                _dtList_02 = new WorkRequestRegisterBusiness().Sub_BOM_Info(_pWorkRequestRegisterEntity);
                //엑셀서식관리 되면 다시 설정하기
               ...
               // _pFile_Attr=
               // strUSE_TYPE = "VIEW";
               // strFILE_NAME = "WorkRequestRegister_Sample_v1.xlsx";
               ...
               // strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_PATH, "USER", "PROGRAM_VIEW", "WorkRequestRegister");
                ...
                curfile = curfile + _pFTP_PATH + _pWorkRequestRegisterEntity.PRODUCTION_FILE;
                //PT040001 : 제조
                //PT040002 : 포장
                if (_pWorkRequestRegisterEntity.PROCESS_CODE_MST !=null)
                {
                    //초기파일은 작업지시등록할때 작업요청서를 등록
                    /*
                    if (_pWorkRequestRegisterEntity.PROCESS_CODE_MST == "PT040001")
                    {
                        //QC010003 : 접수
                        //QC010003 : 완료
                        //접수면 신규이므로 샘플 불러오기
                        //완료면 기존 저장된 path 불러오기
                        if (_pWorkRequestRegisterEntity.WORK_STATUS == "QC010003")
                        {
                            curfile = curfile + strFTP_PATH + strFILE_NAME;
                        }
                        else
                        //기존꺼 path꺼
                        {
                            // strFTP_PATH = string.Format(@"{0}{1}/", _pFTP_PATH, "PRODUCTION");
                            strFILE_NAME = _pWorkRequestRegisterEntity.PRODUCTION_FILE;
                            strFTP_PATH = _pFTP_PATH;
                             curfile = curfile + _pFTP_PATH + _pWorkRequestRegisterEntity.PRODUCTION_FILE;
                        }
                    }
                    */
                   ...
                   //     curfile = "ftp://"+strFTP_PATH + strFILE_NAME;
                   //
                   // }
                    ...
                    if (qFTPUtil.IsFTPFileExsit(_pFTP_PATH + _pWorkRequestRegisterEntity.PRODUCTION_FILE))
                    {

                        FtpWebRequest requestFileDownload = (FtpWebRequest)WebRequest.Create("ftp://" + _pFTP_PATH + _pWorkRequestRegisterEntity.PRODUCTION_FILE);
...

                        {
                            ...
                            sheet_0.Cells[29, 2].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("MAKE_NO") + "\r\n / " + _gdMAIN_VIEW.GetFocusedRowCellValue("END_DATE"));

                            string tmp_date = _gdMAIN_VIEW.GetFocusedRowCellValue("PRODUCTION_ORDER_DATE").ToString();
                            string yyyy = tmp_date.Substring(0, 4);
                            string mm = tmp_date.Substring(4, 2);
                            string dd = tmp_date.Substring(6, 2);
                            sheet_0.Cells[3, 0].SetValue(yyyy + '-' + mm + '-' + dd);
                         //   sheet_0.Cells[3, 0].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("PRODUCTION_ORDER_DATE"));
                            sheet_0.Cells[6, 1].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("PRODUCTION_ORDER_QTY"));
                            sheet_0.Cells[5, 1].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("PART_NAME"));
                            sheet_0.Cells[29, 0].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("PART_NAME"));
                            sheet_0.Cells["A22"].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("PART_NAME"));
                            sheet_0.Cells["A26"].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("PART_NAME"));
                            // sheet_0.Cells[7, 1].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("PART_UNIT"));
                            sheet_0.Cells[7, 1].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("PART_STANDARD"));
                            sheet_0.Cells[8, 1].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("DELIVERY_DATE"));
                            sheet_0.Cells[9, 1].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("DELIVERY_LOCATION"));
                            sheet_0.Cells[21, 1].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("PART_STANDARD"));
                            
                            sheet_0.Cells[12, 0].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("WORK_REMARK"));
                            sheet_0.Cells[17, 1].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("MESH"));
                            sheet_0.Cells[32, 1].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("VEND_QTY"));
                            sheet_0.Cells[33, 1].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("QA_QTY"));
                            sheet_0.Cells[25, 2].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("OUT_BOX"));
                            sheet_0.Cells[25, 1].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("IN_BOX"));

                            sheet_0.Cells[29, 1].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("POSITION"));
                            sheet_0.Cells[34, 1].SetValue(_gdMAIN_VIEW.GetFocusedRowCellValue("REMARK"));

                            string bom_list = string.Empty;
                            for(int i =0; i< _dtList_02.Rows.Count;i++)
                            {
                                bom_list += _dtList_02.Rows[i]["PART_NAME"].ToString();
                                if(i+1<_dtList_02.Rows.Count)
                                    bom_list += ",\n";
                            }
                            sheet_0.Cells[21, 2].SetValue(bom_list);


                            DataTable _dtList2 = null;
                           string name_tmp = string.Empty;
                           name_tmp = sheet_0.GetCellValue(4,2).ToString();
                           if (name_tmp != "")
                           {
                               _dtList2 = new WorkRequestRegisterBusiness().GetUserImage("R", name_tmp);
        ...
        private void _sdMAIN_PopupMenuShowing(object sender, DevExpress.XtraSpreadsheet.PopupMenuShowingEventArgs e)
        {
            ...
            if (e.MenuType == SpreadsheetMenuType.Cell)
            {
                ...
                //판정 = 담당자
                /*
                if ((_sdMAIN.ActiveCell == activeSheet.Cells["D31"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["E31"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["F31"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["G31"]) )
                {
                ...
                */
                //담당 = 작성자
                if ((_sdMAIN.ActiveCell == activeSheet.Cells["E3"])) //|| (_sdMAIN.ActiveCell == activeSheet.Cells["J30"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["K30"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["I31"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["J31"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["K31"]))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
                ...
                //확인
                if ((_sdMAIN.ActiveCell == activeSheet.Cells["F3"]))// || (_sdMAIN.ActiveCell == activeSheet.Cells["M30"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["N30"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["L31"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["M31"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["N31"]))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
                ...
                //확인
                if ((_sdMAIN.ActiveCell == activeSheet.Cells["G3"]))// || (_sdMAIN.ActiveCell == activeSheet.Cells["M30"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["N30"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["L31"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["M31"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["N31"]))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
        ...
        public void InsertSignImage(object sender, EventArgs e)
        {
            ...
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _pWorkRequestRegisterEntity.CRUD = "R";
                _dtList = new WorkRequestRegisterBusiness().GetUserImage(_pWorkRequestRegisterEntity.CRUD, _pWorkRequestRegisterEntity.USER_CODE);
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pWorkRequestRegisterEntity.CRUD == ""))
                {
                    IWorkbook workbook = _sdMAIN.Document;
                    Worksheet sheet_0 = workbook.Worksheets[0];
                    ...
                    if (signature_user == "total_writer")
                    {
                        ...
                        sheet_0.Pictures.AddPicture(imageSource, sheet_0.Range["E3"]);
                        sheet_0.Cells["E3"].SetValue(_pUSER_CODE);
                    }
                    else if (signature_user == "total_checker")
                    {
                        // sheet_0.Pictures.AddPicture(imageSource, sheet_0.Range["I30:K31"]);
                        sheet_0.Pictures.AddPicture(imageSource, sheet_0.Range["F3"]);
                        sheet_0.Cells["F3"].SetValue(_pUSER_CODE);
                    }
                    else if (signature_user == "total_approver")
                    {
                        // sheet_0.Pictures.AddPicture(imageSource, sheet_0.Range["L30:N31"]);
                        sheet_0.Pictures.AddPicture(imageSource, sheet_0.Range["G3"]);
                        sheet_0.Cells["G3"].SetValue(_pUSER_CODE);
                    }
        ...
        private void Sheet_Info_Sheet_Data()   //추가
        {
            try
            {
               ...
               // _pWorkRequestRegisterEntity.ORDER_ID = _luORDER_ID.Text.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    // _dtList = new MaterialOrderRegisterProvider(pDBManager).Sheet_Info_Sheet_Data(_pWorkRequestRegisterEntity);
                    _dsList = new WorkRequestRegisterProvider(pDBManager).WorkRequestRegister_info_ExcelBinding(_pWorkRequestRegisterEntity);
                    //품목정보용
                    _dtList = _dsList.Tables[0];
                    //시험항목검사결과(엑셀바인딩용)
                    _dtList_01 = _dsList.Tables[1];
                    _pWorkRequestRegisterEntity.dtListCnt = _dtList_01.Rows.Count;
        ...
        */
        ...
        private void _ucbtMAKE_NO_MAPPING_Load(object sender, EventArgs e)
        {
           
        }

        private void _ucbtMAKE_NO_MAPPING_Click(object sender, EventArgs e)
        {
             try
            {
                string part_type = "1005";
                ...
                CoFAS_MES.UI.PO.UserForm.frmCommonPopup.ARRAY = new object[2] { "Material_Code", _luT_PART.NameText }; //넘기는 파라메터 에 따라 설정, 제품/조회할때 품목명을 던지기
                CoFAS_MES.UI.PO.UserForm.frmCommonPopup.ARRAY_CODE = new object[3] { _luT_PART.CodeText, _luT_PART.NameText, part_type };
                CoFAS_MES.UI.PO.UserForm.frmCommonPopup xfrmCommonPopup = new CoFAS_MES.UI.PO.UserForm.frmCommonPopup("MakeNoMapping"); //유저컨트롤러 설정 부분
                ...
                if (xfrmCommonPopup.dtReturn != null && xfrmCommonPopup.dtReturn.Rows.Count > 0)
                {
                    ...
                    // _luT_PART.CodeText = xfrmCommonPopup.dtReturn.Rows[0]["REFERENCE_ID"].ToString();
                    // _luT_PART.NameText = xfrmCommonPopup.dtReturn.Rows[0]["MAKE_NO"].ToString();
                    //_pWorkRequestRegisterEntity.REFERENCE_ID = xfrmCommonPopup.dtReturn.Rows[0]["REFERENCE_ID"].ToString();
                    _pWorkRequestRegisterEntity.MAKE_NO = xfrmCommonPopup.dtReturn.Rows[0]["MAKE_NO"].ToString();
                    sheet_0.Cells[29, 2].SetValue(xfrmCommonPopup.dtReturn.Rows[0]["MAKE_NO"].ToString() + "\r\n / " + _gdMAIN_VIEW.GetFocusedRowCellValue("END_DATE"));
                    mapping_yn = true;
                }
                else
                {
                    //_pWorkRequestRegisterEntity.REFERENCE_ID = "";
                    _pWorkRequestRegisterEntity.MAKE_NO ="";
                    mapping_yn = false;
                }
