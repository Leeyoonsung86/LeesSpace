...
{
    public partial class WorkResultRegister_T02 : frmBaseNone
    {
        #region ○ 기본 전역변수
        ...
        private WorkResultRegister_T02Entity _pWorkResultRegister_T02Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pWorkResultRegister_T02Entity = new WorkResultRegister_T02Entity();
                _pWorkResultRegister_T02Entity.USER_CODE = _pUSER_CODE;
                _pWorkResultRegister_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pWorkResultRegister_T02Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pWorkResultRegister_T02Entity.PRODUCTION_ORDER_ID = gv.GetRowCellValue(qRowIndex, "PRODUCTION_ORDER_ID").ToString();
                _pWorkResultRegister_T02Entity.PART_CODE = gv.GetRowCellValue(qRowIndex, "PART_CODE").ToString();
                _pWorkResultRegister_T02Entity.PART_NAME = gv.GetRowCellValue(qRowIndex, "PART_NAME").ToString(); ;
                _pWorkResultRegister_T02Entity.PROCESS_CODE = gv.GetRowCellValue(qRowIndex, "PROCESS_CODE").ToString();
                _pWorkResultRegister_T02Entity.USE_YN = gv.GetRowCellValue(qRowIndex, "PRODUCTION_STATUS").ToString();

                _pWorkResultRegister_T02Entity.COMPLETE_YN = gv.GetRowCellValue(qRowIndex, "COMPLETE_YN").ToString();
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pWorkResultRegister_T02Entity.CRUD = "R";
                _pWorkResultRegister_T02Entity.DATE_FROM = DateTime.Parse(_luTORDER_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _pWorkResultRegister_T02Entity.DATE_TO = DateTime.Parse(_luTORDER_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                _pWorkResultRegister_T02Entity.PART_CODE = _luTPART.CodeText;
                _pWorkResultRegister_T02Entity.PART_NAME = _luTPART.NameText;
                _pWorkResultRegister_T02Entity.PRODUCTION_ORDER_ID = _luTWORK_ORDER.Text;
                _pWorkResultRegister_T02Entity.PROCESS_CODE_MST = ""; // _luTPC_CODE.GetValue();
                _pWorkResultRegister_T02Entity.PROCESS_CODE = _luTWC_CODE.GetValue();
        ...
        private void Form_AddItemButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                {
                    // 작업장 필수항목 체크 - 팝업 불필요
                    if (_pWorkResultRegister_T02Entity.PROCESS_CODE == "")
                    {
                        CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_PROCESS_CODE);
                        return;
                    }
                    // 작업상태 완료시 체크 - 수정불가
                    if (_pWorkResultRegister_T02Entity.USE_YN == "ES011003")
                    {
                    ...
                    _pLocation_Code = _pWorkResultRegister_T02Entity.PRODUCTION_ORDER_ID;
                    UI.PO.UserForm.frmCommonPopup.ARRAY_CODE = new object[4] { _pWorkResultRegister_T02Entity.PRODUCTION_ORDER_ID, _pWorkResultRegister_T02Entity.PART_CODE, _pWorkResultRegister_T02Entity.PART_NAME, _pWorkResultRegister_T02Entity.PROCESS_CODE };
                    UI.PO.UserForm.frmCommonPopup xfrmCommonPopup = new UI.PO.UserForm.frmCommonPopup("WorkResult_T02"); //유저컨트롤러 설정 부분
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new WorkResultRegister_T02Business().WorkResultRegister_T02_Info_Mst(_pWorkResultRegister_T02Entity);

                if (_pWorkResultRegister_T02Entity.CRUD == "")
                    _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pWorkResultRegister_T02Entity.CRUD == ""))
                {
                    //데이터 필드에 맞춰 자동 바인딩
        ...
        private void SubFind_DisplayData(string qWorkOrder, string qColumnHeader)
        {
            try
            {
                ...
                _pWorkResultRegister_T02Entity.PRODUCTION_ORDER_ID = qWorkOrder;
                _pWorkResultRegister_T02Entity.CODE_GUBN = qColumnHeader;
                _dtSub = new WorkResultRegister_T02Business().WorkResultRegister_T02_Info_Sub1(_pWorkResultRegister_T02Entity);
        ...
        private void InputData_Save (DataTable dtSave) //(ContractMstRegisterEntity _pContractMstRegisterEntity)
        {
            try
            {
                ...
                isError = new WorkResultRegister_T02Business().WorkResultMst_Save_T02(_pWorkResultRegister_T02Entity, dtSave);
