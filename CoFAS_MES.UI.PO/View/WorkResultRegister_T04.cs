...
{
    public partial class WorkResultRegister_T04 : frmBaseNone
    {
        #region ○ 기본 전역변수
        ...
        private WorkResultRegister_T04Entity _pWorkResultRegister_T04Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pWorkResultRegister_T04Entity = new WorkResultRegister_T04Entity();
                _pWorkResultRegister_T04Entity.USER_CODE = _pUSER_CODE;
                _pWorkResultRegister_T04Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pWorkResultRegister_T04Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                {
                    _pWorkResultRegister_T04Entity.CRUD = "R";
                    _pWorkResultRegister_T04Entity.PRODUCTION_ORDER_ID = oPRODUCTION_ORDER_ID;
                    _dtEquip = new WorkResultRegister_T04Business().WorkResultRegister_Info_Equip(_pWorkResultRegister_T04Entity);

                    if (_pWorkResultRegister_T04Entity.CRUD == "")
                        _dtEquip.Rows.Clear();
                }
                MainBindingFind_DisplayData(gv.GetFocusedRowCellValue("PRODUCTION_ORDER_ID").ToString());
                SubFind_DisplayData(gv.GetFocusedRowCellValue("PRODUCTION_ORDER_ID").ToString());
                SubFind_Packing_DisplayData(gv.GetFocusedRowCellValue("PRODUCTION_ORDER_ID").ToString(), _pWorkResultRegister_T04Entity.LOT_ID);
                _lastindex = gv.FocusedRowHandle;
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        #region 단말기선택 -- 기존에 설비였는데 단말기로 급하게 변경함
        ...
        private void _luEQUIPMENT_LIST_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                _pWorkResultRegister_T04Entity.PROCESS_CODE = _luEQUIPMENT_LIST.GetValue();
                ...
                _pWorkResultRegister_T04Entity.CONFIGURATION_CODE = sRoutingCheck;
        ...
        private void _gdSUB_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            try
            {
                ...
                //if (gv.FocusedColumn.FieldName.ToString().Equals("WORKRESULT_DOCUMENT_VIEW_SUB_BTN"))
                //{
        ...
        private void _gdSUB_PACK_VIEW_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            ...
            view.SetRowCellValue(e.RowHandle, view.Columns["LOT_ID"], _pWorkResultRegister_T04Entity.LOT_ID);
        ...
        private void CoFAS_DevExpressManager_OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    case "WORKRESULT4_DOCUMENT_VIEW_SUB_BTN":
                        ...
                        break;
                    case "WORKRESULT4_MAT_USAGE_BTN": //사용량
                        ...
                        PO.UserForm.frmCommonPopup.ARRAY_CODE = new object[4] { _pWorkResultRegister_T04Entity.PRODUCTION_ORDER_ID.ToString(), _pWorkResultRegister_T04Entity.LOT_ID, _pWorkResultRegister_T04Entity.CONFIGURATION_CODE, _pWorkResultRegister_T04Entity.PART_CODE };
                        ...
                        xfrmCommonPopup.Dispose();
                        _pWorkResultRegister_T04Entity.CRUD = "R";
                        MainBindingFind_DisplayData(_pWorkResultRegister_T04Entity.PRODUCTION_ORDER_ID.ToString());
                        SubFind_DisplayData(_pWorkResultRegister_T04Entity.PRODUCTION_ORDER_ID.ToString());
                        SubFind_Packing_DisplayData(_pWorkResultRegister_T04Entity.PRODUCTION_ORDER_ID.ToString(), _pWorkResultRegister_T04Entity.LOT_ID);
                        break;
                }
            }
            catch (ExceptionManager pExceptionManager)
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                InputData_Save(_pWorkResultRegister_T04Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _pWorkResultRegister_T04Entity.CRUD = "R";
                _pWorkResultRegister_T04Entity.DATE_FROM = _luTORDER_DATE.FromDateTime.ToString("yyyyMMdd");
                _pWorkResultRegister_T04Entity.DATE_TO = _luTORDER_DATE.ToDateTime.ToString("yyyyMMdd");
                _pWorkResultRegister_T04Entity.PRODUCTION_ORDER_ID = "";
                _pWorkResultRegister_T04Entity.PART_CODE = _pWorkResultRegister_T04Entity.PART_CODE == null ? "" : _pWorkResultRegister_T04Entity.PART_CODE;
                _pWorkResultRegister_T04Entity.VEND_PART_CODE = _luTPART.CodeText.ToString();
                _pWorkResultRegister_T04Entity.PART_NAME = _luTPART.NameText.ToString();
                _pWorkResultRegister_T04Entity.PART_HIGH = _luTPART_HIGH.Text.ToString();
                _pWorkResultRegister_T04Entity.PART_MIDDLE = _luTPART_MIDDLE.Text.ToString();
                _pWorkResultRegister_T04Entity.PART_LOW = _luTPART_LOW.Text.ToString();
                _pWorkResultRegister_T04Entity.ORDER_NUMBER = _luTORDER_NUMBER.CodeText.ToString();
                _dtList = new WorkResultRegister_T04Business().WorkResultRegister_Info_Mst(_pWorkResultRegister_T04Entity);

                if (_pWorkResultRegister_T04Entity.CRUD == "")
                    _dtList.Rows.Clear();

                if((_dtList != null && _dtList.Rows.Count > 0) || (_dtList !=null && _pWorkResultRegister_T04Entity.CRUD == ""))
                {
                    //데이터 필드에 맞춰 자동 바인딩
        ...
        private void MainBindingFind_DisplayData(string qWorkOrder)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                ...
                _pWorkResultRegister_T04Entity.CRUD = "R";
                _pWorkResultRegister_T04Entity.PRODUCTION_ORDER_ID = qWorkOrder;

                _dtList_binding = new WorkResultRegister_T04Business().WorkResultRegister_Info_Mst_Binding(_pWorkResultRegister_T04Entity);
                _luLOT_NO.Text = "";
                _luSPEC_NO.Text = "";
                _luDRAWING_NO.Text = "";
                _luPURCHASE_SPEC_NO.Text = "";
                    ...
                    for(int i=0;i< _dtList_binding.Rows.Count;i++)
                    {
                        ...
                        switch (_dtList_binding.Rows[i]["DOCUMENT_TYPE"].ToString())
                        {
                            case "CD050007": // 구매시방서
                                ...
                                _pWorkResultRegister_T04Entity.SPEC_NO_FILENAME = _dtList_binding.Rows[i]["DOCUMENT_FILE_NAME"].ToString();
                                _pWorkResultRegister_T04Entity.SPEC_NO_TYPE = _dtList_binding.Rows[i]["DOCUMENT_TYPE"].ToString();
                                break;
                            case "CD050003": // 도면
                                _luDRAWING_NO.Text = _dtList_binding.Rows[i]["DOCUMENT_NAME"].ToString();
                                _pWorkResultRegister_T04Entity.DRAWING_NO_FILENAME = _dtList_binding.Rows[i]["DOCUMENT_FILE_NAME"].ToString();
                                _pWorkResultRegister_T04Entity.DRAWING_NO_TYPE = _dtList_binding.Rows[i]["DOCUMENT_TYPE"].ToString();
                                break;
                            case "CD050002": // 공통시방서
                                _luPURCHASE_SPEC_NO.Text = _dtList_binding.Rows[i]["DOCUMENT_NAME"].ToString();
                                _pWorkResultRegister_T04Entity.PURCHASE_SPEC_NO_FILENAME = _dtList_binding.Rows[i]["DOCUMENT_FILE_NAME"].ToString();
                                _pWorkResultRegister_T04Entity.PURCHASE_SPEC_NO_TYPE = _dtList_binding.Rows[i]["DOCUMENT_TYPE"].ToString();
                                break;
                        }
                        ...
                        if(_dtList_binding.Rows[i]["ORDER_OPTION"].ToString().Equals("Y"))
                        {
                            _luORDER_OPTION.Checked = true;
                        }else
                        {
                            _luORDER_OPTION.Checked = false;
                        }
        ...
        private void SubFind_DisplayData(string qWorkOrder)
        {
            try
            {
                ...
                _pWorkResultRegister_T04Entity.CRUD = "R";
                _pWorkResultRegister_T04Entity.PRODUCTION_ORDER_ID = qWorkOrder;
                _dtSub = new WorkResultRegister_T04Business().WorkResultRegister_Info_Mst_Lot(_pWorkResultRegister_T04Entity);
                ...
                {
                    _pWorkResultRegister_T04Entity.PRODUCTION_ORDER_ID = _dtSub.Rows[0]["PRODUCTION_ORDER_ID"].ToString();
                    _pWorkResultRegister_T04Entity.PART_CODE = _dtSub.Rows[0]["PART_CODE"].ToString();
                    _pWorkResultRegister_T04Entity.LOT_ID = _dtSub.Rows[0]["LOT_ID"].ToString();
        ...
        {
            bool isChecked = true;
            if(this.Name == "WorkResultRegister_T04")
            {
                ...
                //if(focusRow != null)
                //{
                //    if (!e.Appearance.BackColor2 == Color.White)
                //    {
                //        e.Cancel = true;
                //    }
                //}
        ...
        private void rowcellstyle(object sender, RowStyleEventArgs e)
        {
            ...
            if (e.RowHandle >= 0)
            {
                ...
                if (!CoFAS_ConvertManager.DataTable_FindCount(_dtEquip, "ROUTING_CODE = '" + _luEQUIPMENT_LIST.GetValue().ToString() + "' AND CONFIGURATION_CODE = '" + view.GetRowCellValue(e.RowHandle, "CONFIGURATION_CODE").ToString() + "'", ""))
                {
                    ...
                    //view.SetFocusedRowCellValue("CRUD", "U");
                ...
                //if (view.GetRowCellValue(e.RowHandle,"ROUTING_CODE") != null)
                //{
                //    if (!view.GetRowCellValue(e.RowHandle, "ROUTING_CODE").ToString().Equals(_luEQUIPMENT_LIST.GetValue().ToString()))
                //    {
        ...
        private void SubFind_Packing_DisplayData(string qWorkOrder, string qlot_id)
        {
            try
            {
                ...
                _pWorkResultRegister_T04Entity.CRUD = "R";
                _pWorkResultRegister_T04Entity.PRODUCTION_ORDER_ID = qWorkOrder;
                _pWorkResultRegister_T04Entity.LOT_ID = qlot_id;

                _dtSub_Pack = new WorkResultRegister_T04Business().WorkResultRegister_Info_Sub_Packing(_pWorkResultRegister_T04Entity);
        ...
        private void SubFind_Bad_DisplayData(string qWorkOrder, string qProcessCode)
        {
            try
            {
                ...
                _pWorkResultRegister_T04Entity.CRUD = "R";
                _pWorkResultRegister_T04Entity.PRODUCTION_ORDER_ID = qWorkOrder;
                _pWorkResultRegister_T04Entity.PROCESS_CODE = _luEQUIPMENT_LIST.GetValue().ToString();

                _dtSub_Ng = new WorkResultRegister_T04Business().WorkResultRegister_Info_Sub_Bad(_pWorkResultRegister_T04Entity);
        ...
        private void SubFind_Status_DisplayData(string qWorkOrder, string qProcessCode)
        {
            try
            {
                ...
                _dtSub_Status = new WorkResultRegister_T04Business().WorkResultRegister_Info_Sub_Status(_pWorkResultRegister_T04Entity);
        ...
        private void InputData_Save(WorkResultRegister_T04Entity _pWorkResultRegister_T04Entity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    if (CoFAS_DevExpressManager.ShowQuestionMessage(_pMSG_SAVE_QUESTION) == DialogResult.Yes)
                    {
                        ...
                        if (CoFAS_ConvertManager.DataTable_FindCount(dt1, "CRUD IN ('U')", ""))
                        {
                            ...
                            for (int i = 0; i < dtTemp1.Rows.Count; i++)
                            {
                                if(Convert.ToDecimal(dtTemp1.Rows[i]["ORIGIN_PRODUCTION_OK_QTY"].ToString()) == 0)
                                {
                                    ...
                                    row["PROPERTY_VALUE"] = _pWorkResultRegister_T04Entity.LOT_ID;
                                    row["CONDITION_CODE"] = "CD501001";
                                    row["OPTION_CODE"] = "";//"PC190004";  // 검사코드 PC190001
                                    row["COLLECTION_VALUE"] = dtTemp1.Rows[i]["PRODUCTION_OK_QTY"].ToString();
                                    row["COLLECTION_VALUE_STR"] = "";
                                    row["USER_CODE"] = _pWorkResultRegister_T04Entity.USER_CODE;
                        ...
                        //#endregion
                        _pWorkResultRegister_T04Entity.MTC_NO = _luMTC_NO.Text;
                        _pWorkResultRegister_T04Entity.MATERAL_TRS_NO = _luMATERAL_TRS_NO.Text;
                        ...
                        {
                            isError = new WorkResultRegister_T04Business().WorkResultRegister_Save(_pWorkResultRegister_T04Entity, resultdt, dtPacking_Temp, dtsub_Temp);
        ...
        {
            CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
            if (_pWorkResultRegister_T04Entity.PRODUCTION_ORDER_ID.ToString().Equals(""))
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.Default);
                return;
            }
            ...
            bool isError = false;
            _pWorkResultRegister_T04Entity.CRUD = "C";

            if (_luORDER_OPTION.Checked)
            {
                _pWorkResultRegister_T04Entity.USA_LOT_CHECK = "Y";
            }
            else
            {
                _pWorkResultRegister_T04Entity.USA_LOT_CHECK = "N";
            }

            try
            {
                isError = new WorkResultRegister_T04Business().WorkResultRegister_Mst_Lot_save(_pWorkResultRegister_T04Entity);

                if (!isError)
                {
                    _luLOT_NO.Text = _pWorkResultRegister_T04Entity.RTN_LOT_NO.ToString();
                    SubFind_DisplayData(_pWorkResultRegister_T04Entity.PRODUCTION_ORDER_ID);
                    CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_SAVE);
                }
                else
                {
        ...
        private void _luTPART__OnOpenClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xfrmCommonPopup.dtReturn != null && xfrmCommonPopup.dtReturn.Rows.Count > 0)
                {
                    ...
                    _pWorkResultRegister_T04Entity.PART_CODE = xfrmCommonPopup.dtReturn.Rows[0]["PART_CODE"].ToString();
                }
        ...
        private void _luSPEC_NO__OnMouseUp(object sender, EventArgs e)
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                if (_pWorkResultRegister_T04Entity.SPEC_NO_FILENAME == null || _luSPEC_NO.Text == "") return;

                DocumentView(_pWorkResultRegister_T04Entity.SPEC_NO_FILENAME, _pWorkResultRegister_T04Entity.SPEC_NO_TYPE);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void _luDRAWING_NO__OnMouseUp(object sender, EventArgs e)
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                if (_pWorkResultRegister_T04Entity.DRAWING_NO_FILENAME == null || _luDRAWING_NO.Text == "") return;
                DocumentView(_pWorkResultRegister_T04Entity.DRAWING_NO_FILENAME, _pWorkResultRegister_T04Entity.DRAWING_NO_TYPE);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void _luPURCHASE_SPEC_NO__OnMouseUp(object sender, EventArgs e)
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                if (_pWorkResultRegister_T04Entity.PURCHASE_SPEC_NO_FILENAME == null || _luPURCHASE_SPEC_NO.Text == "") return;
                DocumentView(_pWorkResultRegister_T04Entity.PURCHASE_SPEC_NO_FILENAME, _pWorkResultRegister_T04Entity.PURCHASE_SPEC_NO_TYPE);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
