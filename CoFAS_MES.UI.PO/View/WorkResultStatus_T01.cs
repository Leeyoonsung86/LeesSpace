...
{
    public partial class WorkResultStatus_T01 : frmBaseNone
    {
        ...
        private WorkResultStatus_T01Entity _pWorkResultStatus_T01Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pWorkResultStatus_T01Entity = new WorkResultStatus_T01Entity();
                //_pWorkResultStatus_T01Entity.CORP_CODE = _pCORP_CODE;
                _pWorkResultStatus_T01Entity.USER_CODE = _pUSER_CODE;
                _pWorkResultStatus_T01Entity.WINDOW_NAME = _pWINDOW_NAME;
                _pWorkResultStatus_T01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pWorkResultStatus_T01Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pWorkResultStatus_T01Entity.CRUD = "R";
                _pWorkResultStatus_T01Entity.DATE_FROM = Convert.ToString(_luT_PLAN_DATE.FromDateTime).Substring(0, 10).Replace("-", "");
                _pWorkResultStatus_T01Entity.DATE_TO = Convert.ToString(_luT_PLAN_DATE.ToDateTime).Substring(0, 10).Replace("-", "");
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new WorkResultStatus_T01Business().WorkResultStatus_T01_Info_Filename(_pWorkResultStatus_T01Entity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pWorkResultStatus_T01Entity.WINDOW_NAME);
                ...
                // xml의 parameter 설정
                dashboard.Parameters[0].Value = _pWorkResultStatus_T01Entity.CRUD;
