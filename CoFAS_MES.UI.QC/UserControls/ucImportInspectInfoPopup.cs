...
{
    public partial class ucImportInspectInfoPopup : UserControl
    {
        ...
        private ucImportinspectInfoPopupEntity _pucImportinspectInfoPopupEntity = null; // 엔티티 생성
        ...
        public ucImportInspectInfoPopup()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            ...
            _pucImportinspectInfoPopupEntity = new ucImportinspectInfoPopupEntity();
            //그리드 설정 ==고정==
        ...
        {
            _luPART_NAME.Text = "";  //자재명 초기화pDateTime.AddDays(1 - pDateTime.Day);
            DateTime pDateTime = DateTime.Today;
            _luTORDER_DATE.FromDateTime = pDateTime.AddDays(1 - pDateTime.Day);
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                string strPART_TYPE = _pucImportinspectInfoPopupEntity.PART_TYPE;
                _pCRUD = "R";
                _dtList = new ucImportInspectInfoPopupBusiness().ucImportInspectInfo_Return(_pCRUD, FromDATE, ToDATE, strCODE, strPART_TYPE).Tables[0];
