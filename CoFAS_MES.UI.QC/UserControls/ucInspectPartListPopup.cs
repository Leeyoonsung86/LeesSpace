...
{
    public partial class ucInspectPartListPopup : UserControl
    {
        ...
        private ucInspectPartListPopupEntity _pucInspectPartListPopupEntity = null; // 엔티티 생성
        ...
        private void ucInspectPartListPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pucInspectPartListPopupEntity = new ucInspectPartListPopupEntity();
            _pucInspectPartListPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucInspectPartListPopupEntity.USER_CODE = _pUSER_CODE;
            _pucInspectPartListPopupEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            ...
            _pucInspectPartListPopupEntity.CRUD = "R";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucInspectPartListPopupEntity.CRUD = "R";
                _pucInspectPartListPopupEntity.VEND_PART_CODE = _luVEND_PART_CODE.Text.ToString();
                _pucInspectPartListPopupEntity.PART_NAME = _luPART_NAME.Text.ToString();
                _pucInspectPartListPopupEntity.PART_REVISION_NO = _luPART_REVISION_NO.Text.ToString();
                _pucInspectPartListPopupEntity.PART_HIGH = _luPART_HIGH.Text.ToString();
                _pucInspectPartListPopupEntity.PART_MIDDLE = _luPART_MIDDLE.Text.ToString();
                _pucInspectPartListPopupEntity.PART_LOW = _luPART_LOW.Text.ToString();

                _dtList = new ucInspectPartListPopupBusiness().ucInspectPartListPopup_Info_Return(_pucInspectPartListPopupEntity);

                if (_pucInspectPartListPopupEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucInspectPartListPopupEntity.CRUD == ""))
                {
