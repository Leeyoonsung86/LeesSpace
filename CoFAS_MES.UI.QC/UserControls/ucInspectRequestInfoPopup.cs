...
{
    public partial class ucInspectRequestInfoPopup : UserControl
    {
        ...
        private ucInspectRequestInfoPopupEntity _pucInspectRequestInfoPopupEntity = null; // 엔티티 생성
        ...
        public ucInspectRequestInfoPopup()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            ...
            _pucInspectRequestInfoPopupEntity = new ucInspectRequestInfoPopupEntity();
            //그리드 설정 ==고정==
            _pucInspectRequestInfoPopupEntity.PART_TYPE = _pARRAY_CODE[2].ToString();
        ...
        public static event PreviewKeyDownEventHandler _ESC_Click;
        ...
        private void ucInspectRequestInfoPopup_KeyDown(object sender, KeyEventArgs e)
        {
            if (_ESC_Click != null)
                _ESC_Click(sender, null);
        }

        #region 접수_프로시져
        private void _ucbtAccept_Click(object sender, EventArgs e)
        {
            _pucInspectRequestInfoPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucInspectRequestInfoPopupEntity.USER_CODE = _pUSER_CODE;
            int cnt = 0;
            ...
            {
                _pucInspectRequestInfoPopupEntity.CRUD = "U";
                bool isError;
                isError = new ucInspectRequestInfoPopupBusiness().InspectRequeestInfoPopup_Check_Save(_pucInspectRequestInfoPopupEntity, tDataTable);
