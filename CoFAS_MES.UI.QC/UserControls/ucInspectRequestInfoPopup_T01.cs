...
{
    public partial class ucInspectRequestInfoPopup_T01 : UserControl
    {
        ...
        private ucInspectRequestInfoPopup_T01Entity _pucInspectRequestInfoPopup_T01Entity = null; // 엔티티 생성
        ...
        public ucInspectRequestInfoPopup_T01()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            ...
            _pucInspectRequestInfoPopup_T01Entity = new ucInspectRequestInfoPopup_T01Entity();
            //그리드 설정 ==고정==
            _pucInspectRequestInfoPopup_T01Entity.PART_TYPE = _pARRAY_CODE[2].ToString();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                string strPART_TYPE = _pucInspectRequestInfoPopup_T01Entity.PART_TYPE;
                _pCRUD = "R";
                _dtList = new ucInspectRequestInfoPopup_T01Business().ucInspectRequestInfo_Return(_pCRUD, FromDATE, ToDATE, strCODE, strPART_TYPE).Tables[0];
        ...
        {
            _pucInspectRequestInfoPopup_T01Entity.CORP_CODE = _pCORP_CODE;
            _pucInspectRequestInfoPopup_T01Entity.USER_CODE = _pUSER_CODE;
            int cnt = 0;
            DataTable tDataTable = _gdMAIN_VIEW.GridControl.DataSource as DataTable;
            for (int i = 0; i < tDataTable.Rows.Count; i++)
            {
                if (tDataTable.Rows[i]["CHECK_VALUE"].ToString() == "Y")
                {
            ...
            {
                _pucInspectRequestInfoPopup_T01Entity.CRUD = "U";
                bool isError;
                isError = new ucInspectRequestInfoPopup_T01Business().InspectRequeestInfoPopup_Check_Save(_pucInspectRequestInfoPopup_T01Entity, tDataTable);
                ...
                else
                {
                    ...
                    //_pLocation_Code = _pucInspectRequestInfoPopupEntity.RTN_KEY;  //저장 위치 
