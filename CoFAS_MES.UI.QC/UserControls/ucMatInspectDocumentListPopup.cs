...
{
    public partial class ucMatInspectDocumentListPopup : UserControl
    {
        ...
        private ucMatInspectDocumentListPopupEntity _pucMatInspectDocumentListPopupEntity = null; // 엔티티 생성
        ...
        public ucMatInspectDocumentListPopup()
        {
            InitializeComponent();
        ...
        private void ucMatInspectDocumentListPopup_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pucMatInspectDocumentListPopupEntity = new ucMatInspectDocumentListPopupEntity();
            _pucMatInspectDocumentListPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucMatInspectDocumentListPopupEntity.USER_CODE = _pUSER_CODE;
            _pucMatInspectDocumentListPopupEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            ...
            _luMATSTOCK_ID.Text = ARRAY_CODE[0].ToString();
            _luMATSTOCK_DETAIL_SEQ.Text = ARRAY_CODE[1].ToString();
            _luINSPECT_ID.Text = ARRAY_CODE[2].ToString();
            //_luCONTRACT_ID.Text = ARRAY_CODE[0].ToString();
            //_luMATSTOCK_ID2.Text = ARRAY_CODE[0].ToString();
        ...
        private void CoFAS_DevExpressManager__OnButtonPressed(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                case "MATINSPECT_DOCUMENT_VIEW_MAIN_BTN":
                    ...
                    break;
                case "MATINSPECT_DOCUMENT_VIEW_SUB_BTN":
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                if (_pucMatInspectDocumentListPopupEntity.CRUD == "") _dtList.Rows.Clear();
        ...
        private void InputDataMain_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new ucMatInspectDocumentListPopupBusiness().ucMatInspectDocumentListPopup_Info_Save(_pucMatInspectDocumentListPopupEntity, dtSave);
