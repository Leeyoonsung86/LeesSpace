...
{
    public partial class ucProductionOrderInfoPopup_T08 : UserControl
    {
        ...
        private ucProductionOrderInfoPopup_T08_Entity _pucProductionOrderInfoPopup_T08_Entity = null;
        ...
        public ucProductionOrderInfoPopup_T08()
        {
            InitializeComponent();
        ...
        private void ucProductionOrderInfoPopup_T08_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            _pucProductionOrderInfoPopup_T08_Entity = new ucProductionOrderInfoPopup_T08_Entity();
            _pucProductionOrderInfoPopup_T08_Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _luTPROCESS_NAME.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "WORKCENTER", "", "", "").Tables[0], 0, 0, "");
                _luTPROCESS_NAME.ReadOnly = true;
                String ProcessCode1 = _luTPROCESS_NAME.GetValue();
                _luTTERMINAL_LIST.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "POP_TERMINALE_DETAIL3", ProcessCode1, "", "").Tables[0], 0, 0, "", true);
                _luTTERMINAL_LIST.ReadOnly = false;
