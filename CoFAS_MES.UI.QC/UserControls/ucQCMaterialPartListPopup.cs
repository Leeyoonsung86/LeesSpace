...
{
    public partial class ucQCMaterialPartListPopup : UserControl
    {
        ...
        private ucQCMaterialPartListPopupEntity _pucQCMaterialPartListPopupEntity = null; // 엔티티 생성
        ...
        public ucQCMaterialPartListPopup()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            ...
            //메뉴 화면 엔티티 설정
            _pucQCMaterialPartListPopupEntity = new ucQCMaterialPartListPopupEntity();
            _pucQCMaterialPartListPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucQCMaterialPartListPopupEntity.USER_CODE = _pUSER_CODE;
            _pucQCMaterialPartListPopupEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            ...
            _pucQCMaterialPartListPopupEntity.CRUD = "R";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucQCMaterialPartListPopupEntity.CRUD = "R";
                _pucQCMaterialPartListPopupEntity.VEND_PART_CODE = _luVEND_PART_CODE.Text.ToString();
                _pucQCMaterialPartListPopupEntity.PART_NAME = _luPART_NAME.Text.ToString();
                _pucQCMaterialPartListPopupEntity.PART_REVISION_NO = _luPART_REVISION_NO.Text.ToString();
                _pucQCMaterialPartListPopupEntity.PART_HIGH = _luPART_HIGH.Text.ToString();
                _pucQCMaterialPartListPopupEntity.PART_MIDDLE = _luPART_MIDDLE.Text.ToString();
                _pucQCMaterialPartListPopupEntity.PART_LOW = _luPART_LOW.Text.ToString();

                _dtList = new ucMaterialPartListPopupBusiness().ucQCMaterialPartListPopup_Info_Return(_pucQCMaterialPartListPopupEntity);

                if (_pucQCMaterialPartListPopupEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucQCMaterialPartListPopupEntity.CRUD == ""))
                {
