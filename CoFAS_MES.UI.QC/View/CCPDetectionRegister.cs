...
{
    public partial class CCPDetectionRegister : frmBaseNone
    {
        ...
        private CCPDetectionRegisterEntity _pCCPDetectionRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pCCPDetectionRegisterEntity = new CCPDetectionRegisterEntity();
                _pCCPDetectionRegisterEntity.USER_CODE = _pUSER_CODE;
                _pCCPDetectionRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pCCPDetectionRegisterEntity.CRUD = "";
                _pCCPDetectionRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            ...
            try
             {
                ...
                _luDETECTION_VALUE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "BADCODE2", "BC02", "", "").Tables[0], 0, 0, "");
                _luDETECTION_VALUE.ReadOnly = false;

                _luDETECTION.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "common_code", "QC03", "", "").Tables[0], 0, 0, "");
                _luDETECTION.ReadOnly = false;
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                //
                //_pCCPDetectionRegisterEntity.CRUD = "R";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pCCPDetectionRegisterEntity.CRUD = "R";
                _pCCPDetectionRegisterEntity.DATE_FROM = DateTime.Parse(_luTCCP_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                _pCCPDetectionRegisterEntity.DATE_TO = DateTime.Parse(_luTCCP_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                _pCCPDetectionRegisterEntity.PROCESS_NAME = _luTPROCESS.NameText;
                _pCCPDetectionRegisterEntity.PROCESS_CODE = _luTPROCESS.CodeText;
                _pCCPDetectionRegisterEntity.PART_NAME = _luTPART.NameText;
                _pCCPDetectionRegisterEntity.PART_CODE = _luTPART.CodeText;
                _pCCPDetectionRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                //확인
                if (check == 1)
                    _pCCPDetectionRegisterEntity.CRUD = "U";
                else
                    _pCCPDetectionRegisterEntity.CRUD = "C";

                _pCCPDetectionRegisterEntity.CCP_DATE = _luCCP_DATE.DateTime.ToString("yyyyMMdd");
                _pCCPDetectionRegisterEntity.PROCESS_CODE = _luPROCESS.CodeText;
                _pCCPDetectionRegisterEntity.PART_CODE = _luPART.CodeText;
                _pCCPDetectionRegisterEntity.DETECTION_VALUE = _luDETECTION_VALUE.GetValue();
                _pCCPDetectionRegisterEntity.DETECTION = _luDETECTION.GetValue();

                //_pCCPDetectionRegisterEntity.MEASURE = _luMEASURE.Text;
                _pCCPDetectionRegisterEntity.REMARK = _luREMARK.Text.ToString();
                _pCCPDetectionRegisterEntity.USE_YN = _luUSE_YN.GetValue();

                InputData_Save(_pCCPDetectionRegisterEntity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                //{
                //    _pCCPDetectionRegisterEntity.CRUD = "D";
                //}
                //else
                //{
                ...
                //_pCCPDetectionRegisterEntity.INOUT_TYPE = "I";
                //_pCCPDetectionRegisterEntity.INOUT_ID = _luINOUT_ID.Text.ToString();
                //_pCCPDetectionRegisterEntity.INOUT_DATE = _luCCP_DATE.DateTime.ToString("yyyyMMdd");
                //_pCCPDetectionRegisterEntity.INOUT_SEQ = "000000";
                //_pCCPDetectionRegisterEntity.INOUT_CODE = _luINOUT_CODE.GetValue(); //  INOUT_CODE -> TYPE
                //_pCCPDetectionRegisterEntity.VEND_CODE = _luVEND.CodeText;
                //_pCCPDetectionRegisterEntity.PART_CODE = _luPART.CodeText;
                //_pCCPDetectionRegisterEntity.INOUT_QTY = _luINOUT_QTY.Text.ToString().ToString() == "" ? "0" : _luINOUT_QTY.Text.ToString();
                //_pCCPDetectionRegisterEntity.PART_UNIT = _luUNIT_CODE.GetValue();
                //_pCCPDetectionRegisterEntity.UNITCOST = _luUNITCOST.Text.ToString() == "" ? "0" : _luUNITCOST.Text.ToString().ToString();
                //_pCCPDetectionRegisterEntity.COST = _luCOST.Text.ToString() == "" ? "0" : _luCOST.Text.ToString().ToString();
                //_pCCPDetectionRegisterEntity.REFERENCE_ID = _luMOISTURE_VALUE.Text.ToString();
                //_pCCPDetectionRegisterEntity.REMARK = _luREMARK.Text.ToString();
                //_pCCPDetectionRegisterEntity.USE_YN = "N";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new CCPDetectionRegisterBusiness().CCPDetectionRegister_Info(_pCCPDetectionRegisterEntity);

                if (_pCCPDetectionRegisterEntity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pCCPDetectionRegisterEntity.CRUD == ""))
                {
                    //데이터 필드에 맞춰 자동 바인딩
        ...
        private void InputData_Save(CCPDetectionRegisterEntity _pCCPDetectionRegisterEntity)
...

        {
            try
            {
                ...
                bool isError = false;
                    ...
                    isError = new CCPDetectionRegisterBusiness().CCPDetectionRegister_Info_Save(_pCCPDetectionRegisterEntity);
                // 자재입고
                if (isError)
                {
                    //오류 발생.
                ...
                else
                {
                        ...
                        _pLocation_Code = _pCCPDetectionRegisterEntity.RTN_KEY;  //저장 위치
                        ...
                        _pCCPDetectionRegisterEntity.PROCESS_NAME = _luTPROCESS.NameText;
                        _pCCPDetectionRegisterEntity.PROCESS_CODE = _luTPROCESS.CodeText;
                        _pCCPDetectionRegisterEntity.USE_YN = _luTUSE_YN.GetValue();  // _luUSE_YN.GetValue();    
        ...
        private void _luPART__OnOpenClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
