...
{
    public partial class FirstMiddleLastInspectRegister : frmBaseNone
    {
        #region ○ 기본 전역변수
        ...
        private FirstMiddleLastInspectRegisterEntity _pFirstMiddleLastInspectRegisterEntity = null; // 엔티티 생성
        ...
        public FirstMiddleLastInspectRegister()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pFirstMiddleLastInspectRegisterEntity = new FirstMiddleLastInspectRegisterEntity();
                _pFirstMiddleLastInspectRegisterEntity.USER_CODE = _pUSER_CODE;
                _pFirstMiddleLastInspectRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pFirstMiddleLastInspectRegisterEntity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                InitializeControl2();
                _pFirstMiddleLastInspectRegisterEntity.CRUD = "R";
                _pFirstMiddleLastInspectRegisterEntity.DATE_FROM = DateTime.Parse(_luTWORK_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); //Convert.ToString(_luTCONTRACT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                _pFirstMiddleLastInspectRegisterEntity.DATE_TO = DateTime.Parse(_luTWORK_DATE.ToDateTime.ToString()).ToString("yyyyMMdd"); //Convert.ToString(_luTCONTRACT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                _pFirstMiddleLastInspectRegisterEntity.PART_CODE = _luTPART_CODE.Text;
           //     _pFirstMiddleLastInspectRegisterEntity. = _luTVEND.CodeText;
           //     _pFirstMiddleLastInspectRegisterEntity.PART_NAME = _luTPART.NameText;
           //     _pFirstMiddleLastInspectRegisterEntity.PART_CODE = _luTPART.CodeText;
           //     _pFirstMiddleLastInspectRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
                _pFirstMiddleLastInspectRegisterEntity.CONTRACT_ID = _luTPART_CODE.Text;
...
*/
       ...
       /*         if (_luCONTRACT_ID.Text.ToString() != "")
                    _pFirstMiddleLastInspectRegisterEntity.CRUD = "U";
                else
                    _pFirstMiddleLastInspectRegisterEntity.CRUD = "C";

                _pFirstMiddleLastInspectRegisterEntity.CONTRACT_ID = _luCONTRACT_ID.Text;
                _pFirstMiddleLastInspectRegisterEntity.CONTRACT_DATE = _luCONTRACT_DATE.DateTime.ToString("yyyyMMdd");
                _pFirstMiddleLastInspectRegisterEntity.PART_CODE = _luPART.CodeText;
                _pFirstMiddleLastInspectRegisterEntity.VEND_CODE = _luVEND.CodeText;
                _pFirstMiddleLastInspectRegisterEntity.CONTRACT_QTY = _luCONTRACT_QTY.Text == "" ? "0" : _luCONTRACT_QTY.Text.Replace(",", "");
                _pFirstMiddleLastInspectRegisterEntity.UNITCOST = _luUNITCOST.Text == "" ? "0" : _luUNITCOST.Text.Replace(",", "");
                _pFirstMiddleLastInspectRegisterEntity.COST = _luCOST.Text == "" ? "0" : _luCOST.Text.Replace(",", "");
                _pFirstMiddleLastInspectRegisterEntity.DELIVERY_DATE = _luDELIVERY_DATE.DateTime.ToString("yyyyMMdd");
                _pFirstMiddleLastInspectRegisterEntity.DELIVERY_LOCATION = _luDELIVERY_LOCATION.Text;
                _pFirstMiddleLastInspectRegisterEntity.UNIT_CODE = _luUNIT_CODE.GetValue();
                _pFirstMiddleLastInspectRegisterEntity.REMARK = _luREMARK.Text;
                _pFirstMiddleLastInspectRegisterEntity.USE_YN = _luUSE_YN.GetValue();

                InputData_Save(_pFirstMiddleLastInspectRegisterEntity);
                */
            }
            catch (ExceptionManager pExceptionManager)
            {
       ...
       /*         if (_luCONTRACT_ID.Text != "")
                    _pFirstMiddleLastInspectRegisterEntity.CRUD = "D";
                else
                { 
      ...
      //          _pFirstMiddleLastInspectRegisterEntity.PART_CODE = _luPART.CodeText;
      //          _pFirstMiddleLastInspectRegisterEntity.VEND_CODE = _luVEND.CodeText;
      //          _pFirstMiddleLastInspectRegisterEntity.CONTRACT_QTY = _luCONTRACT_QTY.Text == "" ? "0.00" : _luCONTRACT_QTY.Text.Replace(",", "");
      //          _pFirstMiddleLastInspectRegisterEntity.UNITCOST = _luUNITCOST.Text == "" ? "0.00" : _luUNITCOST.Text.Replace(",", "");
      //          _pFirstMiddleLastInspectRegisterEntity.COST = _luCOST.Text == "" ? "0.00" : _luCOST.Text.Replace(",", "");
      //          _pFirstMiddleLastInspectRegisterEntity.DELIVERY_DATE = _luDELIVERY_DATE.DateTime.ToString("yyyyMMdd");
      //          _pFirstMiddleLastInspectRegisterEntity.DELIVERY_LOCATION = _luDELIVERY_LOCATION.Text;
      //          _pFirstMiddleLastInspectRegisterEntity.REMARK = _luREMARK.Text;
                _pFirstMiddleLastInspectRegisterEntity.USE_YN = "N";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new FirstMiddleLastInspectRegisterBusiness().ContractMst_Info(_pFirstMiddleLastInspectRegisterEntity);

                if (_pFirstMiddleLastInspectRegisterEntity.CRUD == "")
                    _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList !=null && _pFirstMiddleLastInspectRegisterEntity.CRUD == ""))
                {
                    //데이터 필드에 맞춰 자동 바인딩
        ...
        private void InputData_Save(FirstMiddleLastInspectRegisterEntity _pFirstMiddleLastInspectRegisterEntity)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                ...
                bool isError = false;
                isError = new FirstMiddleLastInspectRegisterBusiness().ContractMst_Save(_pFirstMiddleLastInspectRegisterEntity);
                if (!isError)
                {
                    //CoFAS_DevExpressManager.ShowInformationMessage("저장 처리 되었습니다.");
                    CoFAS_DevExpressManager.ShowInformationMessage(_pMSG_SAVE);
                    _pLocation_Code = _pFirstMiddleLastInspectRegisterEntity.RTN_KEY;  //저장 위치
                    InitializeControl2();
