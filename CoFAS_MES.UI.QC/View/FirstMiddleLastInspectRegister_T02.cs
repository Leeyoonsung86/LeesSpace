...
{
    public partial class FirstMiddleLastInspectRegister_T02 : frmBaseNone
    {
        ...
        private FirstMiddleLastInspectRegister_T02Entity _pFirstMiddleLastInspectRegister_T02Entity = null; // 엔티티 생성
        ...
        public FirstMiddleLastInspectRegister_T02()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pFirstMiddleLastInspectRegister_T02Entity = new FirstMiddleLastInspectRegister_T02Entity();
                //_pFirstMiddleLastInspectRegister_T02Entity.CORP_CODE = _pCORP_CODE;
                _pFirstMiddleLastInspectRegister_T02Entity.USER_CODE = _pUSER_CODE;
                _pFirstMiddleLastInspectRegister_T02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pFirstMiddleLastInspectRegister_T02Entity.CRUD = "";

                if (_pFirstYN)
                {
                    //MainFind_DisplayData(); //Dev Grid 데이터소스 로 바인딩 작업 처리 할 경우에는 최초 빈 데이터 테이블을 바인딩 해야 됨.
                    // Form_SearchButtonClicked(null, null);
                    //_pFirstMiddleLastInspectRegister_T02Entity.PART_CODE = _luTPART_ALL.CodeText;
                    //_pFirstMiddleLastInspectRegister_T02Entity.PART_NAME = _luTPART_ALL.NameText;
                    _pFirstMiddleLastInspectRegister_T02Entity.CHECK_CYCLE = _luFIRSTMIDDLELAST_GUBN.GetValue();
                    _pFirstMiddleLastInspectRegister_T02Entity.EQUIPMENT_CODE = _luEQUIPMENT_CODE.GetValue();
                    //_pFirstMiddleLastInspectRegister_T02Entity.VEND_PART_CODE = _luTVEND_PART_CODE.Text;
                    _pFirstYN = false;
                }
        ...
        private void InitializeControl(bool bSearch)
        {
            try
            {
                ...
                if (bSearch)
                {
                    ...
                    _luFIRSTMIDDLELAST_GUBN.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "common_code", "QC10", "", "").Tables[0], 0, 0, "",false);
                    _luFIRSTMIDDLELAST_GUBN.ReadOnly = false;// true;
                ...
                //_luFIRSTMIDDLELAST_GUBN.ItemIndex = 1;
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pFirstMiddleLastInspectRegister_T02Entity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pFirstMiddleLastInspectRegister_T02Entity.CRUD = "R";
                _pFirstMiddleLastInspectRegister_T02Entity.PRODUCTION_ORDER_ID = _luORDER_ID.Text.ToString();
                _pFirstMiddleLastInspectRegister_T02Entity.FIRSTMIDDLELAST_GUBN = _luFIRSTMIDDLELAST_GUBN.GetValue();
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new FirstMiddleLastInspectRegister_T02Business().Sample_Info(_pFirstMiddleLastInspectRegister_T02Entity);

                if (_pFirstMiddleLastInspectRegister_T02Entity.CRUD == "") _dtList.Rows.Clear();


                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pFirstMiddleLastInspectRegister_T02Entity.CRUD == ""))
                {
        ...
        private void InputData_Save(DataTable pDataTable)
        {
            try
            {
                ...
                bool isError = false;
                _pFirstMiddleLastInspectRegister_T02Entity.CRUD = "C";
                _pFirstMiddleLastInspectRegister_T02Entity.USER_CODE = _pUSER_CODE;


                isError = new FirstMiddleLastInspectRegister_T02Business().Sample_Info_Save(_pFirstMiddleLastInspectRegister_T02Entity, pDataTable);
