...
{
    public partial class GatheringEquationRegister : frmBaseNone
    {
        ...
        private GatheringEquationRegisterEntity _pGatheringEquationRegisterEntity = null; // 엔티티 생성
        ...
        public GatheringEquationRegister()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pGatheringEquationRegisterEntity = new GatheringEquationRegisterEntity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pGatheringEquationRegisterEntity.USER_CODE = _pUSER_CODE;
                _pGatheringEquationRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pGatheringEquationRegisterEntity.WINDOW_NAME = _pWINDOW_NAME;
                ...
                _pGatheringEquationRegisterEntity.CRUD = "";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                //if (_luT_RESOURCE_DATE.FromDateTime > _luT_RESOURCE_DATE.ToDateTime)
                //{
                ...
                //    _pGatheringEquationRegisterEntity.CRUD = "R";
                //    _pGatheringEquationRegisterEntity.DATE_FROM = DateTime.Parse(_luT_RESOURCE_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                //    _pGatheringEquationRegisterEntity.DATE_TO = DateTime.Parse(_luT_RESOURCE_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                //    _pGatheringEquationRegisterEntity.RESOURCE_CODE = _luT_RESOURCE_CODE.Text;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                InputData_Save(_pGatheringEquationRegisterEntity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void InputData_Save(GatheringEquationRegisterEntity _pGatheringEquationRegisterEntity)
        {
            try
            {
                ...
                {
                    if (_pGatheringEquationRegisterEntity.RESOURCE_CODE == null)
                    {
                        _pGatheringEquationRegisterEntity.CRUD = "C";
                    }
                    else
                    {
                        _pGatheringEquationRegisterEntity.CRUD = "U";
                    }

                    _pGatheringEquationRegisterEntity.RESOURCE_TYPE = "HR";
                    ...
                    /*
                    pGatheringEquationRegisterEntity.PART_CODE
                    pGatheringEquationRegisterEntity.PART_NAME
                    pGatheringEquationRegisterEntity.INSPECT_STATUS
                    pGatheringEquationRegisterEntity.INSPECT_ID
                    pGatheringEquationRegisterEntity.INSPECT__DATE
                    pGatheringEquationRegisterEntity.INSPECT_SEQ
                    pGatheringEquationRegisterEntity.VEND_PART_CODE
                    pGatheringEquationRegisterEntity.PART_TYPE
                    pGatheringEquationRegisterEntity.REFERENCE_ID
                    pGatheringEquationRegisterEntity.MAKE_VEND
                    pGatheringEquationRegisterEntity.MAKE_VEND_NAME
                    pGatheringEquationRegisterEntity.VEND_CODE
                    pGatheringEquationRegisterEntity.VEND_NAME
                    pGatheringEquationRegisterEntity.REQUEST_DEPT
                    pGatheringEquationRegisterEntity.CODE_NAME
                    pGatheringEquationRegisterEntity.INOUT_DATE
                    pGatheringEquationRegisterEntity.INOUT_QTY
                        */
                    //_pGatheringEquationRegisterEntity.PACKING_REMARK  = sheet_1.GetCellValue(4, 6).TextValue;
                    //_pGatheringEquationRegisterEntity.SAMPLE_DATE     = sheet_1.GetCellValue(4, 7).TextValue;
                    //_pGatheringEquationRegisterEntity.SAMPLE_LOCATION = sheet_1.GetCellValue(6, 4).TextValue;
                    //_pGatheringEquationRegisterEntity.SAMPLE_USER     = sheet_1.GetCellValue(6, 5).TextValue;
                    //_pGatheringEquationRegisterEntity.SAMPLE_METHOD   = sheet_1.GetCellValue(6, 6).TextValue;
                    //_pGatheringEquationRegisterEntity.SAMPLE_QTY      = sheet_1.GetCellValue(6, 7).TextValue;
                    /*
                pGatheringEquationRegisterEntity.MAKE_NO
                pGatheringEquationRegisterEntity.STANDARD
                pGatheringEquationRegisterEntity.REQUEST_DATE
                pGatheringEquationRegisterEntity.REQUEST_USER
                pGatheringEquationRegisterEntity.END_DATE
                pGatheringEquationRegisterEntity.TOTAL_RESULT
                pGatheringEquationRegisterEntity.TOTAL_DATE
                pGatheringEquationRegisterEntity.TOTAL_USER
                pGatheringEquationRegisterEntity.COMPLETE_YN
                pGatheringEquationRegisterEntity.REMARK
                pGatheringEquationRegisterEntity.USER_YN
                */
                    ...
                    else
                    {
                        ...
                        isError = new GatheringEquationRegisterBusiness().GatheringEquationRegister_Info_Save(_pGatheringEquationRegisterEntity, sheet_1);
                        if (isError)
                        {
                            //오류 발생.
                            //CoFAS_DevExpressManager.ShowInformationMessage("저장 오류 발생! 데이터를 확인 하세요.");
                        ...
                        {
                            _pLocation_Code = _pGatheringEquationRegisterEntity.RTN_KEY;  //저장 위치
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            _pGatheringEquationRegisterEntity.RESOURCE_CODE = gv.GetFocusedRowCellValue("RESOURCE_CODE").ToString();
        ...
        private void InitializeControl()
        {
            ...
            {
                //데이터 영역
                //_luT_RESOURCE_DATE.FromDateTime = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1);  //조회 시작일, 매월 초 날짜로 설정
                //_luT_RESOURCE_DATE.ToDateTime = DateTime.Today;  //조회 종료일, 당일 설정

                //_luT_RESOURCE_CODE.Text = "";
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new GatheringEquationRegisterBusiness().GatheringEquationRegister_Info(_pGatheringEquationRegisterEntity);

                if (_pGatheringEquationRegisterEntity.CRUD == "")
                    _dtList.Rows.Clear();
                else
                {
                    IWorkbook workbook = _sdMAIN.Document;
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pGatheringEquationRegisterEntity.CRUD == ""))
                {
        ...
        private void SheetFind_DisplayData()
        {
            try
            {
                ...
                //조회할거 프로시져
                _dtList = new GatheringEquationRegisterBusiness().Sheet_Info_Sheet(_pGatheringEquationRegisterEntity);   //엑셀 시트 조회하기
                ...
                /*
                strUSE_TYPE = "VIEW";
                strFILE_NAME = "GatheringEquationRegister_Sample_v1.xlsx";
                */
                switch (strUSE_TYPE)
                {
        ...
        private void Sheet_Info_Sheet_Data()   //추가
        {
            try
            {
               ...
               // _pGatheringEquationRegisterEntity.ORDER_ID = _luORDER_ID.Text.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    // _dtList = new MaterialOrderRegisterProvider(pDBManager).Sheet_Info_Sheet_Data(_pGatheringEquationRegisterEntity);
                    _dsList = new GatheringEquationRegisterProvider(pDBManager).GatheringEquationRegister_info_ExcelBinding(_pGatheringEquationRegisterEntity);
                    //품목정보용
                    _dtList = _dsList.Tables[0];
                    
                    //시험항목검사결과(엑셀바인딩용)
                    _dtList_01 = _dsList.Tables[1];
                    _pGatheringEquationRegisterEntity.dtListCnt = _dtList_01.Rows.Count;
