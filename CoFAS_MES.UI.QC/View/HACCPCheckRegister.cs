...
{
    public partial class HACCPCheckRegister : frmBaseNone
    {
        ...
        private HACCPCheckRegisterEntity _pHACCPCheckRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pHACCPCheckRegisterEntity = new HACCPCheckRegisterEntity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pHACCPCheckRegisterEntity.USER_CODE = _pUSER_CODE;
                _pHACCPCheckRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pHACCPCheckRegisterEntity.WINDOW_NAME = _pWINDOW_NAME;
                ...
                _pHACCPCheckRegisterEntity.CRUD = "";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pHACCPCheckRegisterEntity.CRUD = "R";
                    _pHACCPCheckRegisterEntity.DATE_FROM = DateTime.Parse(_luT_HACCP_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterEntity.DATE_TO = DateTime.Parse(_luT_HACCP_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterEntity.HACCP_ID = _luT_HACCP_ID.Text;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pHACCPCheckRegisterEntity.HACCP_DATE = _lu_HACCP_DATE.DateTime.ToString("yyyyMMdd");

                InputData_Save(_pHACCPCheckRegisterEntity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void InputData_Save(HACCPCheckRegisterEntity _pHACCPCheckRegisterEntity)
        {
            try
            {
                ...
                {
                    if (_pHACCPCheckRegisterEntity.HACCP_ID == null)
                    {
                        _pHACCPCheckRegisterEntity.CRUD = "C";
                    }
                    else
                    {
                        _pHACCPCheckRegisterEntity.CRUD = "U";
                    }

                    _pHACCPCheckRegisterEntity.HACCP_TYPE = "HR";
                    ...
                    /*
                    pHACCPCheckRegisterEntity.PART_CODE
                    pHACCPCheckRegisterEntity.PART_NAME
                    pHACCPCheckRegisterEntity.INSPECT_STATUS
                    pHACCPCheckRegisterEntity.INSPECT_ID
                    pHACCPCheckRegisterEntity.INSPECT__DATE
                    pHACCPCheckRegisterEntity.INSPECT_SEQ
                    pHACCPCheckRegisterEntity.VEND_PART_CODE
                    pHACCPCheckRegisterEntity.PART_TYPE
                    pHACCPCheckRegisterEntity.REFERENCE_ID
                    pHACCPCheckRegisterEntity.MAKE_VEND
                    pHACCPCheckRegisterEntity.MAKE_VEND_NAME
                    pHACCPCheckRegisterEntity.VEND_CODE
                    pHACCPCheckRegisterEntity.VEND_NAME
                    pHACCPCheckRegisterEntity.REQUEST_DEPT
                    pHACCPCheckRegisterEntity.CODE_NAME
                    pHACCPCheckRegisterEntity.INOUT_DATE
                    pHACCPCheckRegisterEntity.INOUT_QTY
                        */
                    //_pHACCPCheckRegisterEntity.PACKING_REMARK  = sheet_1.GetCellValue(4, 6).TextValue;
                    //_pHACCPCheckRegisterEntity.SAMPLE_DATE     = sheet_1.GetCellValue(4, 7).TextValue;
                    //_pHACCPCheckRegisterEntity.SAMPLE_LOCATION = sheet_1.GetCellValue(6, 4).TextValue;
                    //_pHACCPCheckRegisterEntity.SAMPLE_USER     = sheet_1.GetCellValue(6, 5).TextValue;
                    //_pHACCPCheckRegisterEntity.SAMPLE_METHOD   = sheet_1.GetCellValue(6, 6).TextValue;
                    //_pHACCPCheckRegisterEntity.SAMPLE_QTY      = sheet_1.GetCellValue(6, 7).TextValue;
                    /*
                pHACCPCheckRegisterEntity.MAKE_NO
                pHACCPCheckRegisterEntity.STANDARD
                pHACCPCheckRegisterEntity.REQUEST_DATE
                pHACCPCheckRegisterEntity.REQUEST_USER
                pHACCPCheckRegisterEntity.END_DATE
                pHACCPCheckRegisterEntity.TOTAL_RESULT
                pHACCPCheckRegisterEntity.TOTAL_DATE
                pHACCPCheckRegisterEntity.TOTAL_USER
                pHACCPCheckRegisterEntity.COMPLETE_YN
                pHACCPCheckRegisterEntity.REMARK
                pHACCPCheckRegisterEntity.USER_YN
                */

                    isError = new HACCPCheckRegisterBusiness().HACCPCheckRegister_Info_Mst_Save(_pHACCPCheckRegisterEntity, sheet_1);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        isError = new HACCPCheckRegisterBusiness().HACCPCheckRegister_Info_Detail_Save(_pHACCPCheckRegisterEntity, sheet_1);
                        if (isError)
                        {
                            //오류 발생.
                            //CoFAS_DevExpressManager.ShowInformationMessage("저장 오류 발생! 데이터를 확인 하세요.");
                        ...
                        {
                            _pLocation_Code = _pHACCPCheckRegisterEntity.RTN_KEY;  //저장 위치
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            _pHACCPCheckRegisterEntity.HACCP_ID= gv.GetFocusedRowCellValue("HACCP_ID").ToString();
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new HACCPCheckRegisterBusiness().HACCPCheckRegister_Info(_pHACCPCheckRegisterEntity);

                if (_pHACCPCheckRegisterEntity.CRUD == "")
                    _dtList.Rows.Clear();
                else
                {
                    IWorkbook workbook = _sdMAIN.Document;
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pHACCPCheckRegisterEntity.CRUD == ""))
                {
        ...
        private void SheetFind_DisplayData()
        {
            try
            {
                ...
                //조회할거 프로시져
                _dtList = new HACCPCheckRegisterBusiness().Sheet_Info_Sheet(_pHACCPCheckRegisterEntity);   //엑셀 시트 조회하기
                ...
                /*
                strUSE_TYPE = "VIEW";
                strFILE_NAME = "HACCPCheckRegister_Sample_v1.xlsx";
                */
                switch (strUSE_TYPE)
                {
        ...
        private void Sheet_Info_Sheet_Data()   //추가
        {
            try
            {
               ...
               // _pHACCPCheckRegisterEntity.ORDER_ID = _luORDER_ID.Text.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    // _dtList = new MaterialOrderRegisterProvider(pDBManager).Sheet_Info_Sheet_Data(_pHACCPCheckRegisterEntity);
                    _dsList = new HACCPCheckRegisterProvider(pDBManager).HACCPCheckRegister_info_ExcelBinding(_pHACCPCheckRegisterEntity);
                    //품목정보용
                    _dtList = _dsList.Tables[0];
                    
                    //시험항목검사결과(엑셀바인딩용)
                    _dtList_01 = _dsList.Tables[1];
                    _pHACCPCheckRegisterEntity.dtListCnt = _dtList_01.Rows.Count;
