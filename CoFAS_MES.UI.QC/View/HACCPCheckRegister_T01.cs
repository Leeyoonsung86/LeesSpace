...
{
    public partial class HACCPCheckRegister_T01 : frmBaseNone
    {
        ...
        private HACCPCheckRegisterT01Entity _pHACCPCheckRegisterT01Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pHACCPCheckRegisterT01Entity = new HACCPCheckRegisterT01Entity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pHACCPCheckRegisterT01Entity.USER_CODE = _pUSER_CODE;
                _pHACCPCheckRegisterT01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pHACCPCheckRegisterT01Entity.WINDOW_NAME = _pWINDOW_NAME;
                ...
                _pHACCPCheckRegisterT01Entity.CRUD = "";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pHACCPCheckRegisterT01Entity.CRUD = "R";
                    _pHACCPCheckRegisterT01Entity.DATE_FROM = DateTime.Parse(_luT_HACCP_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT01Entity.DATE_TO = DateTime.Parse(_luT_HACCP_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT01Entity.HACCP_ID = _luT_HACCP_ID.Text;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pHACCPCheckRegisterT01Entity.HACCP_DATE = _lu_HACCP_DATE.DateTime.ToString("yyyyMMdd");

                InputData_Save(_pHACCPCheckRegisterT01Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void InputData_Save(HACCPCheckRegisterT01Entity _pHACCPCheckRegisterT01Entity)
        {
            try
            {
                ...
                {
                    if (_pHACCPCheckRegisterT01Entity.HACCP_ID == null)
                    {
                        _pHACCPCheckRegisterT01Entity.CRUD = "C";
                    }
                    else
                    {
                        _pHACCPCheckRegisterT01Entity.CRUD = "U";
                    }

                    _pHACCPCheckRegisterT01Entity.HACCP_TYPE = "HR";
                    ...
                    /*
                    pHACCPCheckRegisterT01Entity.PART_CODE
                    pHACCPCheckRegisterT01Entity.PART_NAME
                    pHACCPCheckRegisterT01Entity.INSPECT_STATUS
                    pHACCPCheckRegisterT01Entity.INSPECT_ID
                    pHACCPCheckRegisterT01Entity.INSPECT__DATE
                    pHACCPCheckRegisterT01Entity.INSPECT_SEQ
                    pHACCPCheckRegisterT01Entity.VEND_PART_CODE
                    pHACCPCheckRegisterT01Entity.PART_TYPE
                    pHACCPCheckRegisterT01Entity.REFERENCE_ID
                    pHACCPCheckRegisterT01Entity.MAKE_VEND
                    pHACCPCheckRegisterT01Entity.MAKE_VEND_NAME
                    pHACCPCheckRegisterT01Entity.VEND_CODE
                    pHACCPCheckRegisterT01Entity.VEND_NAME
                    pHACCPCheckRegisterT01Entity.REQUEST_DEPT
                    pHACCPCheckRegisterT01Entity.CODE_NAME
                    pHACCPCheckRegisterT01Entity.INOUT_DATE
                    pHACCPCheckRegisterT01Entity.INOUT_QTY
                        */
                    //_pHACCPCheckRegisterT01Entity.PACKING_REMARK  = sheet_1.GetCellValue(4, 6).TextValue;
                    //_pHACCPCheckRegisterT01Entity.SAMPLE_DATE     = sheet_1.GetCellValue(4, 7).TextValue;
                    //_pHACCPCheckRegisterT01Entity.SAMPLE_LOCATION = sheet_1.GetCellValue(6, 4).TextValue;
                    //_pHACCPCheckRegisterT01Entity.SAMPLE_USER     = sheet_1.GetCellValue(6, 5).TextValue;
                    //_pHACCPCheckRegisterT01Entity.SAMPLE_METHOD   = sheet_1.GetCellValue(6, 6).TextValue;
                    //_pHACCPCheckRegisterT01Entity.SAMPLE_QTY      = sheet_1.GetCellValue(6, 7).TextValue;
                    /*
                pHACCPCheckRegisterT01Entity.MAKE_NO
                pHACCPCheckRegisterT01Entity.STANDARD
                pHACCPCheckRegisterT01Entity.REQUEST_DATE
                pHACCPCheckRegisterT01Entity.REQUEST_USER
                pHACCPCheckRegisterT01Entity.END_DATE
                pHACCPCheckRegisterT01Entity.TOTAL_RESULT
                pHACCPCheckRegisterT01Entity.TOTAL_DATE
                pHACCPCheckRegisterT01Entity.TOTAL_USER
                pHACCPCheckRegisterT01Entity.COMPLETE_YN
                pHACCPCheckRegisterT01Entity.REMARK
                pHACCPCheckRegisterT01Entity.USER_YN
                */

                    isError = new HACCPCheckRegisterT01Business().HACCPCheckRegister_Info_Mst_Save(_pHACCPCheckRegisterT01Entity, sheet_1);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        isError = new HACCPCheckRegisterT01Business().HACCPCheckRegister_Info_Detail_Save(_pHACCPCheckRegisterT01Entity, sheet_1);
                        if (isError)
                        {
                            //오류 발생.
                            //CoFAS_DevExpressManager.ShowInformationMessage("저장 오류 발생! 데이터를 확인 하세요.");
                        ...
                        {
                            _pLocation_Code = _pHACCPCheckRegisterT01Entity.RTN_KEY;  //저장 위치
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            _pHACCPCheckRegisterT01Entity.HACCP_ID= gv.GetFocusedRowCellValue("HACCP_ID").ToString();
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new HACCPCheckRegisterT01Business().HACCPCheckRegister_Info(_pHACCPCheckRegisterT01Entity);

                if (_pHACCPCheckRegisterT01Entity.CRUD == "")
                    _dtList.Rows.Clear();
                else
                {
                    IWorkbook workbook = _sdMAIN.Document;
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pHACCPCheckRegisterT01Entity.CRUD == ""))
                {
        ...
        private void SheetFind_DisplayData()
        {
            try
            {
                ...
                //조회할거 프로시져
                _dtList = new HACCPCheckRegisterT01Business().Sheet_Info_Sheet(_pHACCPCheckRegisterT01Entity);   //엑셀 시트 조회하기
                ...
                /*
                strUSE_TYPE = "VIEW";
                strFILE_NAME = "HACCPCheckRegister_T01_Sample_v1.xlsx";
                */
                switch (strUSE_TYPE)
                {
        ...
        private void Sheet_Info_Sheet_Data()   //추가
        {
            try
            {
               ...
               // _pHACCPCheckRegisterT01Entity.ORDER_ID = _luORDER_ID.Text.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    // _dtList = new MaterialOrderRegisterProvider(pDBManager).Sheet_Info_Sheet_Data(_pHACCPCheckRegisterT01Entity);
                    _dsList = new HACCPCheckRegisterT01Provider(pDBManager).HACCPCheckRegister_info_ExcelBinding(_pHACCPCheckRegisterT01Entity);
                    //품목정보용
                    _dtList = _dsList.Tables[0];
                    
                    //시험항목검사결과(엑셀바인딩용)
                    _dtList_01 = _dsList.Tables[1];
                    _pHACCPCheckRegisterT01Entity.dtListCnt = _dtList_01.Rows.Count;
