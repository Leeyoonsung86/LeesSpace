...
{
    public partial class HACCPCheckRegister_T02 : frmBaseNone
    {
        ...
        private HACCPCheckRegisterT02Entity _pHACCPCheckRegisterT02Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pHACCPCheckRegisterT02Entity = new HACCPCheckRegisterT02Entity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pHACCPCheckRegisterT02Entity.USER_CODE = _pUSER_CODE;
                _pHACCPCheckRegisterT02Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pHACCPCheckRegisterT02Entity.WINDOW_NAME = _pWINDOW_NAME;
                ...
                _pHACCPCheckRegisterT02Entity.CRUD = "";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pHACCPCheckRegisterT02Entity.CRUD = "R";
                    _pHACCPCheckRegisterT02Entity.DATE_FROM = DateTime.Parse(_luT_HACCP_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT02Entity.DATE_TO = DateTime.Parse(_luT_HACCP_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT02Entity.HACCP_ID = _luT_HACCP_ID.Text;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pHACCPCheckRegisterT02Entity.HACCP_DATE = _lu_HACCP_DATE.DateTime.ToString("yyyyMMdd");

                InputData_Save(_pHACCPCheckRegisterT02Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void InputData_Save(HACCPCheckRegisterT02Entity _pHACCPCheckRegisterT02Entity)
        {
            try
            {
                ...
                {
                    if (_pHACCPCheckRegisterT02Entity.HACCP_ID == null)
                    {
                        _pHACCPCheckRegisterT02Entity.CRUD = "C";
                    }
                    else
                    {
                        _pHACCPCheckRegisterT02Entity.CRUD = "U";
                    }

                    _pHACCPCheckRegisterT02Entity.HACCP_TYPE = "HR";
                    ...
                    /*
                    pHACCPCheckRegisterT02Entity.PART_CODE
                    pHACCPCheckRegisterT02Entity.PART_NAME
                    pHACCPCheckRegisterT02Entity.INSPECT_STATUS
                    pHACCPCheckRegisterT02Entity.INSPECT_ID
                    pHACCPCheckRegisterT02Entity.INSPECT__DATE
                    pHACCPCheckRegisterT02Entity.INSPECT_SEQ
                    pHACCPCheckRegisterT02Entity.VEND_PART_CODE
                    pHACCPCheckRegisterT02Entity.PART_TYPE
                    pHACCPCheckRegisterT02Entity.REFERENCE_ID
                    pHACCPCheckRegisterT02Entity.MAKE_VEND
                    pHACCPCheckRegisterT02Entity.MAKE_VEND_NAME
                    pHACCPCheckRegisterT02Entity.VEND_CODE
                    pHACCPCheckRegisterT02Entity.VEND_NAME
                    pHACCPCheckRegisterT02Entity.REQUEST_DEPT
                    pHACCPCheckRegisterT02Entity.CODE_NAME
                    pHACCPCheckRegisterT02Entity.INOUT_DATE
                    pHACCPCheckRegisterT02Entity.INOUT_QTY
                        */
                    //_pHACCPCheckRegisterT02Entity.PACKING_REMARK  = sheet_1.GetCellValue(4, 6).TextValue;
                    //_pHACCPCheckRegisterT02Entity.SAMPLE_DATE     = sheet_1.GetCellValue(4, 7).TextValue;
                    //_pHACCPCheckRegisterT02Entity.SAMPLE_LOCATION = sheet_1.GetCellValue(6, 4).TextValue;
                    //_pHACCPCheckRegisterT02Entity.SAMPLE_USER     = sheet_1.GetCellValue(6, 5).TextValue;
                    //_pHACCPCheckRegisterT02Entity.SAMPLE_METHOD   = sheet_1.GetCellValue(6, 6).TextValue;
                    //_pHACCPCheckRegisterT02Entity.SAMPLE_QTY      = sheet_1.GetCellValue(6, 7).TextValue;
                    /*
                pHACCPCheckRegisterT02Entity.MAKE_NO
                pHACCPCheckRegisterT02Entity.STANDARD
                pHACCPCheckRegisterT02Entity.REQUEST_DATE
                pHACCPCheckRegisterT02Entity.REQUEST_USER
                pHACCPCheckRegisterT02Entity.END_DATE
                pHACCPCheckRegisterT02Entity.TOTAL_RESULT
                pHACCPCheckRegisterT02Entity.TOTAL_DATE
                pHACCPCheckRegisterT02Entity.TOTAL_USER
                pHACCPCheckRegisterT02Entity.COMPLETE_YN
                pHACCPCheckRegisterT02Entity.REMARK
                pHACCPCheckRegisterT02Entity.USER_YN
                */

                    isError = new HACCPCheckRegisterT02Business().HACCPCheckRegister_Info_Mst_Save(_pHACCPCheckRegisterT02Entity, sheet_1);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        isError = new HACCPCheckRegisterT02Business().HACCPCheckRegister_Info_Detail_Save(_pHACCPCheckRegisterT02Entity, sheet_1);
                        if (isError)
                        {
                            //오류 발생.
                            //CoFAS_DevExpressManager.ShowInformationMessage("저장 오류 발생! 데이터를 확인 하세요.");
                        ...
                        {
                            _pLocation_Code = _pHACCPCheckRegisterT02Entity.RTN_KEY;  //저장 위치
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            _pHACCPCheckRegisterT02Entity.HACCP_ID= gv.GetFocusedRowCellValue("HACCP_ID").ToString();
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new HACCPCheckRegisterT02Business().HACCPCheckRegister_Info(_pHACCPCheckRegisterT02Entity);

                if (_pHACCPCheckRegisterT02Entity.CRUD == "")
                    _dtList.Rows.Clear();
                else
                {
                    IWorkbook workbook = _sdMAIN.Document;
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pHACCPCheckRegisterT02Entity.CRUD == ""))
                {
        ...
        private void SheetFind_DisplayData()
        {
            try
            {
                ...
                //조회할거 프로시져
                _dtList = new HACCPCheckRegisterT02Business().Sheet_Info_Sheet(_pHACCPCheckRegisterT02Entity);   //엑셀 시트 조회하기
                ...
                /*
                strUSE_TYPE = "VIEW";
                strFILE_NAME = "HACCPCheckRegister_T02_Sample_v1.xlsx";
                */
                switch (strUSE_TYPE)
                {
        ...
        private void Sheet_Info_Sheet_Data()   //추가
        {
            try
            {
               ...
               // _pHACCPCheckRegisterT02Entity.ORDER_ID = _luORDER_ID.Text.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    // _dtList = new MaterialOrderRegisterProvider(pDBManager).Sheet_Info_Sheet_Data(_pHACCPCheckRegisterT02Entity);
                    _dsList = new HACCPCheckRegisterT02Provider(pDBManager).HACCPCheckRegister_info_ExcelBinding(_pHACCPCheckRegisterT02Entity);
                    //품목정보용
                    _dtList = _dsList.Tables[0];
                    
                    //시험항목검사결과(엑셀바인딩용)
                    _dtList_01 = _dsList.Tables[1];
                    _pHACCPCheckRegisterT02Entity.dtListCnt = _dtList_01.Rows.Count;
