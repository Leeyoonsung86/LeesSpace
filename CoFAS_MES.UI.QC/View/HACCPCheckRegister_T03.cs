...
{
    public partial class HACCPCheckRegister_T03 : frmBaseNone
    {
        ...
        private HACCPCheckRegisterT03Entity _pHACCPCheckRegisterT03Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pHACCPCheckRegisterT03Entity = new HACCPCheckRegisterT03Entity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pHACCPCheckRegisterT03Entity.USER_CODE = _pUSER_CODE;
                _pHACCPCheckRegisterT03Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pHACCPCheckRegisterT03Entity.WINDOW_NAME = _pWINDOW_NAME;
                ...
                _pHACCPCheckRegisterT03Entity.CRUD = "";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pHACCPCheckRegisterT03Entity.CRUD = "R";
                    _pHACCPCheckRegisterT03Entity.DATE_FROM = DateTime.Parse(_luT_HACCP_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT03Entity.DATE_TO = DateTime.Parse(_luT_HACCP_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT03Entity.HACCP_ID = _luT_HACCP_ID.Text;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pHACCPCheckRegisterT03Entity.HACCP_DATE = _lu_HACCP_DATE.DateTime.ToString("yyyyMMdd");

                InputData_Save(_pHACCPCheckRegisterT03Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void InputData_Save(HACCPCheckRegisterT03Entity _pHACCPCheckRegisterT03Entity)
        {
            try
            {
                ...
                {
                    if (_pHACCPCheckRegisterT03Entity.HACCP_ID == null || _pHACCPCheckRegisterT03Entity.HACCP_ID == "")
                    {
                        _pHACCPCheckRegisterT03Entity.CRUD = "C";
                    }
                    else
                    {
                        _pHACCPCheckRegisterT03Entity.CRUD = "U";
                    }

                    _pHACCPCheckRegisterT03Entity.HACCP_TYPE = "CP";
                    ...
                    /*
                    pHACCPCheckRegisterT03Entity.PART_CODE
                    pHACCPCheckRegisterT03Entity.PART_NAME
                    pHACCPCheckRegisterT03Entity.INSPECT_STATUS
                    pHACCPCheckRegisterT03Entity.INSPECT_ID
                    pHACCPCheckRegisterT03Entity.INSPECT__DATE
                    pHACCPCheckRegisterT03Entity.INSPECT_SEQ
                    pHACCPCheckRegisterT03Entity.VEND_PART_CODE
                    pHACCPCheckRegisterT03Entity.PART_TYPE
                    pHACCPCheckRegisterT03Entity.REFERENCE_ID
                    pHACCPCheckRegisterT03Entity.MAKE_VEND
                    pHACCPCheckRegisterT03Entity.MAKE_VEND_NAME
                    pHACCPCheckRegisterT03Entity.VEND_CODE
                    pHACCPCheckRegisterT03Entity.VEND_NAME
                    pHACCPCheckRegisterT03Entity.REQUEST_DEPT
                    pHACCPCheckRegisterT03Entity.CODE_NAME
                    pHACCPCheckRegisterT03Entity.INOUT_DATE
                    pHACCPCheckRegisterT03Entity.INOUT_QTY
                        */
                    //_pHACCPCheckRegisterT03Entity.PACKING_REMARK  = sheet_1.GetCellValue(4, 6).TextValue;
                    //_pHACCPCheckRegisterT03Entity.SAMPLE_DATE     = sheet_1.GetCellValue(4, 7).TextValue;
                    //_pHACCPCheckRegisterT03Entity.SAMPLE_LOCATION = sheet_1.GetCellValue(6, 4).TextValue;
                    //_pHACCPCheckRegisterT03Entity.SAMPLE_USER     = sheet_1.GetCellValue(6, 5).TextValue;
                    //_pHACCPCheckRegisterT03Entity.SAMPLE_METHOD   = sheet_1.GetCellValue(6, 6).TextValue;
                    //_pHACCPCheckRegisterT03Entity.SAMPLE_QTY      = sheet_1.GetCellValue(6, 7).TextValue;
                    /*
                pHACCPCheckRegisterT03Entity.MAKE_NO
                pHACCPCheckRegisterT03Entity.STANDARD
                pHACCPCheckRegisterT03Entity.REQUEST_DATE
                pHACCPCheckRegisterT03Entity.REQUEST_USER
                pHACCPCheckRegisterT03Entity.END_DATE
                pHACCPCheckRegisterT03Entity.TOTAL_RESULT
                pHACCPCheckRegisterT03Entity.TOTAL_DATE
                pHACCPCheckRegisterT03Entity.TOTAL_USER
                pHACCPCheckRegisterT03Entity.COMPLETE_YN
                pHACCPCheckRegisterT03Entity.REMARK
                pHACCPCheckRegisterT03Entity.USER_YN
                */

                    isError = new HACCPCheckRegisterT03Business().HACCPCheckRegister_Info_Mst_Save(_pHACCPCheckRegisterT03Entity, sheet_1);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        isError = new HACCPCheckRegisterT03Business().HACCPCheckRegister_Info_Detail_Save(_pHACCPCheckRegisterT03Entity, sheet_2);
                        if (isError)
                        {
                            //오류 발생.
                            //CoFAS_DevExpressManager.ShowInformationMessage("저장 오류 발생! 데이터를 확인 하세요.");
                        ...
                        {
                            _pLocation_Code = _pHACCPCheckRegisterT03Entity.RTN_KEY;  //저장 위치
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            _pHACCPCheckRegisterT03Entity.HACCP_ID= gv.GetFocusedRowCellValue("HACCP_ID").ToString();
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new HACCPCheckRegisterT03Business().HACCPCheckRegister_Info(_pHACCPCheckRegisterT03Entity);

                if (_pHACCPCheckRegisterT03Entity.CRUD == "")
                    _dtList.Rows.Clear();
                else
                {
                    IWorkbook workbook = _sdMAIN.Document;
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pHACCPCheckRegisterT03Entity.CRUD == ""))
                {
        ...
        private void SheetFind_DisplayData()
        {
            try
            {
                ...
                //조회할거 프로시져
                _dtList = new HACCPCheckRegisterT03Business().Sheet_Info_Sheet(_pHACCPCheckRegisterT03Entity);   //엑셀 시트 조회하기
                ...
                /*
                strUSE_TYPE = "VIEW";
                strFILE_NAME = "HACCPCheckRegister_T03_Sample_v1.xlsx";
                */
                switch (strUSE_TYPE)
                {
        ...
        private void Sheet_Info_Sheet_Data()   //추가
        {
            try
            {
               ...
               // _pHACCPCheckRegisterT03Entity.ORDER_ID = _luORDER_ID.Text.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    // _dtList = new MaterialOrderRegisterProvider(pDBManager).Sheet_Info_Sheet_Data(_pHACCPCheckRegisterT03Entity);
                    _dsList = new HACCPCheckRegisterT03Provider(pDBManager).HACCPCheckRegister_info_ExcelBinding(_pHACCPCheckRegisterT03Entity);
                    //품목정보용
                    _dtList = _dsList.Tables[0];
                    
                    //시험항목검사결과(엑셀바인딩용)
                    _dtList_01 = _dsList.Tables[1];
                    _pHACCPCheckRegisterT03Entity.dtListCnt = _dtList_01.Rows.Count;
