...
{
    public partial class HACCPCheckRegister_T04 : frmBaseNone
    {
        ...
        private HACCPCheckRegisterT04Entity _pHACCPCheckRegisterT04Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pHACCPCheckRegisterT04Entity = new HACCPCheckRegisterT04Entity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pHACCPCheckRegisterT04Entity.USER_CODE = _pUSER_CODE;
                _pHACCPCheckRegisterT04Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pHACCPCheckRegisterT04Entity.WINDOW_NAME = _pWINDOW_NAME;
                ...
                _pHACCPCheckRegisterT04Entity.CRUD = "";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pHACCPCheckRegisterT04Entity.CRUD = "R";
                    _pHACCPCheckRegisterT04Entity.DATE_FROM = DateTime.Parse(_luT_HACCP_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT04Entity.DATE_TO = DateTime.Parse(_luT_HACCP_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT04Entity.HACCP_ID = _luT_HACCP_ID.Text;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pHACCPCheckRegisterT04Entity.HACCP_DATE = _lu_HACCP_DATE.DateTime.ToString("yyyyMMdd");

                InputData_Save(_pHACCPCheckRegisterT04Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void InputData_Save(HACCPCheckRegisterT04Entity _pHACCPCheckRegisterT04Entity)
        {
            try
            {
                ...
                {
                    if (_pHACCPCheckRegisterT04Entity.HACCP_ID == null || _pHACCPCheckRegisterT04Entity.HACCP_ID == "")
                    {
                        _pHACCPCheckRegisterT04Entity.CRUD = "C";
                    }
                    else
                    {
                        _pHACCPCheckRegisterT04Entity.CRUD = "U";
                    }

                    _pHACCPCheckRegisterT04Entity.HACCP_TYPE = "HP";
                    ...
                    /*
                    pHACCPCheckRegisterT04Entity.PART_CODE
                    pHACCPCheckRegisterT04Entity.PART_NAME
                    pHACCPCheckRegisterT04Entity.INSPECT_STATUS
                    pHACCPCheckRegisterT04Entity.INSPECT_ID
                    pHACCPCheckRegisterT04Entity.INSPECT__DATE
                    pHACCPCheckRegisterT04Entity.INSPECT_SEQ
                    pHACCPCheckRegisterT04Entity.VEND_PART_CODE
                    pHACCPCheckRegisterT04Entity.PART_TYPE
                    pHACCPCheckRegisterT04Entity.REFERENCE_ID
                    pHACCPCheckRegisterT04Entity.MAKE_VEND
                    pHACCPCheckRegisterT04Entity.MAKE_VEND_NAME
                    pHACCPCheckRegisterT04Entity.VEND_CODE
                    pHACCPCheckRegisterT04Entity.VEND_NAME
                    pHACCPCheckRegisterT04Entity.REQUEST_DEPT
                    pHACCPCheckRegisterT04Entity.CODE_NAME
                    pHACCPCheckRegisterT04Entity.INOUT_DATE
                    pHACCPCheckRegisterT04Entity.INOUT_QTY
                        */
                    //_pHACCPCheckRegisterT04Entity.PACKING_REMARK  = sheet_1.GetCellValue(4, 6).TextValue;
                    //_pHACCPCheckRegisterT04Entity.SAMPLE_DATE     = sheet_1.GetCellValue(4, 7).TextValue;
                    //_pHACCPCheckRegisterT04Entity.SAMPLE_LOCATION = sheet_1.GetCellValue(6, 4).TextValue;
                    //_pHACCPCheckRegisterT04Entity.SAMPLE_USER     = sheet_1.GetCellValue(6, 5).TextValue;
                    //_pHACCPCheckRegisterT04Entity.SAMPLE_METHOD   = sheet_1.GetCellValue(6, 6).TextValue;
                    //_pHACCPCheckRegisterT04Entity.SAMPLE_QTY      = sheet_1.GetCellValue(6, 7).TextValue;
                    /*
                pHACCPCheckRegisterT04Entity.MAKE_NO
                pHACCPCheckRegisterT04Entity.STANDARD
                pHACCPCheckRegisterT04Entity.REQUEST_DATE
                pHACCPCheckRegisterT04Entity.REQUEST_USER
                pHACCPCheckRegisterT04Entity.END_DATE
                pHACCPCheckRegisterT04Entity.TOTAL_RESULT
                pHACCPCheckRegisterT04Entity.TOTAL_DATE
                pHACCPCheckRegisterT04Entity.TOTAL_USER
                pHACCPCheckRegisterT04Entity.COMPLETE_YN
                pHACCPCheckRegisterT04Entity.REMARK
                pHACCPCheckRegisterT04Entity.USER_YN
                */

                    isError = new HACCPCheckRegisterT04Business().HACCPCheckRegister_Info_Mst_Save(_pHACCPCheckRegisterT04Entity, sheet_1);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        isError = new HACCPCheckRegisterT04Business().HACCPCheckRegister_Info_Detail_Save(_pHACCPCheckRegisterT04Entity, sheet_2);
                        if (isError)
                        {
                            //오류 발생.
                            //CoFAS_DevExpressManager.ShowInformationMessage("저장 오류 발생! 데이터를 확인 하세요.");
                        ...
                        {
                            _pLocation_Code = _pHACCPCheckRegisterT04Entity.RTN_KEY;  //저장 위치
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            _pHACCPCheckRegisterT04Entity.HACCP_ID= gv.GetFocusedRowCellValue("HACCP_ID").ToString();
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new HACCPCheckRegisterT04Business().HACCPCheckRegister_Info(_pHACCPCheckRegisterT04Entity);

                if (_pHACCPCheckRegisterT04Entity.CRUD == "")
                    _dtList.Rows.Clear();
                else
                {
                    IWorkbook workbook = _sdMAIN.Document;
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pHACCPCheckRegisterT04Entity.CRUD == ""))
                {
        ...
        private void SheetFind_DisplayData()
        {
            try
            {
                ...
                //조회할거 프로시져
                _dtList = new HACCPCheckRegisterT04Business().Sheet_Info_Sheet(_pHACCPCheckRegisterT04Entity);   //엑셀 시트 조회하기
                ...
                /*
                strUSE_TYPE = "VIEW";
                strFILE_NAME = "HACCPCheckRegister_T04_Sample_v1.xlsx";
                */
                switch (strUSE_TYPE)
                {
        ...
        private void Sheet_Info_Sheet_Data()   //추가
        {
            try
            {
               ...
               // _pHACCPCheckRegisterT04Entity.ORDER_ID = _luORDER_ID.Text.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    // _dtList = new MaterialOrderRegisterProvider(pDBManager).Sheet_Info_Sheet_Data(_pHACCPCheckRegisterT04Entity);
                    _dsList = new HACCPCheckRegisterT04Provider(pDBManager).HACCPCheckRegister_info_ExcelBinding(_pHACCPCheckRegisterT04Entity);
                    //품목정보용
                    _dtList = _dsList.Tables[0];
                    
                    //시험항목검사결과(엑셀바인딩용)
                    _dtList_01 = _dsList.Tables[1];
                    _pHACCPCheckRegisterT04Entity.dtListCnt = _dtList_01.Rows.Count;
