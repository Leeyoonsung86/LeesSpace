...
{
    public partial class HACCPCheckRegister_T05 : frmBaseNone
    {
        ...
        private HACCPCheckRegisterT05Entity _pHACCPCheckRegisterT05Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pHACCPCheckRegisterT05Entity = new HACCPCheckRegisterT05Entity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pHACCPCheckRegisterT05Entity.USER_CODE = _pUSER_CODE;
                _pHACCPCheckRegisterT05Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pHACCPCheckRegisterT05Entity.WINDOW_NAME = _pWINDOW_NAME;
                ...
                _pHACCPCheckRegisterT05Entity.CRUD = "";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pHACCPCheckRegisterT05Entity.CRUD = "R";
                    _pHACCPCheckRegisterT05Entity.DATE_FROM = DateTime.Parse(_luT_HACCP_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT05Entity.DATE_TO = DateTime.Parse(_luT_HACCP_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT05Entity.HACCP_ID = _luT_HACCP_ID.Text;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pHACCPCheckRegisterT05Entity.HACCP_DATE = _lu_HACCP_DATE.DateTime.ToString("yyyyMMdd");

                InputData_Save(_pHACCPCheckRegisterT05Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void InputData_Save(HACCPCheckRegisterT05Entity _pHACCPCheckRegisterT05Entity)
        {
            try
            {
                ...
                {
                    if (_pHACCPCheckRegisterT05Entity.HACCP_ID == null || _pHACCPCheckRegisterT05Entity.HACCP_ID == "")
                    {
                        _pHACCPCheckRegisterT05Entity.CRUD = "C";
                    }
                    else
                    {
                        _pHACCPCheckRegisterT05Entity.CRUD = "U";
                    }

                    _pHACCPCheckRegisterT05Entity.HACCP_TYPE = "HB";
                    ...
                    /*
                    pHACCPCheckRegisterT05Entity.PART_CODE
                    pHACCPCheckRegisterT05Entity.PART_NAME
                    pHACCPCheckRegisterT05Entity.INSPECT_STATUS
                    pHACCPCheckRegisterT05Entity.INSPECT_ID
                    pHACCPCheckRegisterT05Entity.INSPECT__DATE
                    pHACCPCheckRegisterT05Entity.INSPECT_SEQ
                    pHACCPCheckRegisterT05Entity.VEND_PART_CODE
                    pHACCPCheckRegisterT05Entity.PART_TYPE
                    pHACCPCheckRegisterT05Entity.REFERENCE_ID
                    pHACCPCheckRegisterT05Entity.MAKE_VEND
                    pHACCPCheckRegisterT05Entity.MAKE_VEND_NAME
                    pHACCPCheckRegisterT05Entity.VEND_CODE
                    pHACCPCheckRegisterT05Entity.VEND_NAME
                    pHACCPCheckRegisterT05Entity.REQUEST_DEPT
                    pHACCPCheckRegisterT05Entity.CODE_NAME
                    pHACCPCheckRegisterT05Entity.INOUT_DATE
                    pHACCPCheckRegisterT05Entity.INOUT_QTY
                        */
                    //_pHACCPCheckRegisterT05Entity.PACKING_REMARK  = sheet_1.GetCellValue(4, 6).TextValue;
                    //_pHACCPCheckRegisterT05Entity.SAMPLE_DATE     = sheet_1.GetCellValue(4, 7).TextValue;
                    //_pHACCPCheckRegisterT05Entity.SAMPLE_LOCATION = sheet_1.GetCellValue(6, 4).TextValue;
                    //_pHACCPCheckRegisterT05Entity.SAMPLE_USER     = sheet_1.GetCellValue(6, 5).TextValue;
                    //_pHACCPCheckRegisterT05Entity.SAMPLE_METHOD   = sheet_1.GetCellValue(6, 6).TextValue;
                    //_pHACCPCheckRegisterT05Entity.SAMPLE_QTY      = sheet_1.GetCellValue(6, 7).TextValue;
                    /*
                pHACCPCheckRegisterT05Entity.MAKE_NO
                pHACCPCheckRegisterT05Entity.STANDARD
                pHACCPCheckRegisterT05Entity.REQUEST_DATE
                pHACCPCheckRegisterT05Entity.REQUEST_USER
                pHACCPCheckRegisterT05Entity.END_DATE
                pHACCPCheckRegisterT05Entity.TOTAL_RESULT
                pHACCPCheckRegisterT05Entity.TOTAL_DATE
                pHACCPCheckRegisterT05Entity.TOTAL_USER
                pHACCPCheckRegisterT05Entity.COMPLETE_YN
                pHACCPCheckRegisterT05Entity.REMARK
                pHACCPCheckRegisterT05Entity.USER_YN
                */

                    isError = new HACCPCheckRegisterT05Business().HACCPCheckRegister_Info_Mst_Save(_pHACCPCheckRegisterT05Entity, sheet_1);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        isError = new HACCPCheckRegisterT05Business().HACCPCheckRegister_Info_Detail_Save(_pHACCPCheckRegisterT05Entity, sheet_2);
                        if (isError)
                        {
                            //오류 발생.
                            //CoFAS_DevExpressManager.ShowInformationMessage("저장 오류 발생! 데이터를 확인 하세요.");
                        ...
                        {
                            _pLocation_Code = _pHACCPCheckRegisterT05Entity.RTN_KEY;  //저장 위치
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            _pHACCPCheckRegisterT05Entity.HACCP_ID= gv.GetFocusedRowCellValue("HACCP_ID").ToString();
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new HACCPCheckRegisterT05Business().HACCPCheckRegister_Info(_pHACCPCheckRegisterT05Entity);

                if (_pHACCPCheckRegisterT05Entity.CRUD == "")
                    _dtList.Rows.Clear();
                else
                {
                    IWorkbook workbook = _sdMAIN.Document;
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pHACCPCheckRegisterT05Entity.CRUD == ""))
                {
        ...
        private void SheetFind_DisplayData()
        {
            try
            {
                ...
                //조회할거 프로시져
                _dtList = new HACCPCheckRegisterT05Business().Sheet_Info_Sheet(_pHACCPCheckRegisterT05Entity);   //엑셀 시트 조회하기
                ...
                /*
                strUSE_TYPE = "VIEW";
                strFILE_NAME = "HACCPCheckRegister_T05_Sample_v1.xlsx";
                */
                switch (strUSE_TYPE)
                {
        ...
        private void Sheet_Info_Sheet_Data()   //추가
        {
            try
            {
               ...
               // _pHACCPCheckRegisterT05Entity.ORDER_ID = _luORDER_ID.Text.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    // _dtList = new MaterialOrderRegisterProvider(pDBManager).Sheet_Info_Sheet_Data(_pHACCPCheckRegisterT05Entity);
                    _dsList = new HACCPCheckRegisterT05Provider(pDBManager).HACCPCheckRegister_info_ExcelBinding(_pHACCPCheckRegisterT05Entity);
                    //품목정보용
                    _dtList = _dsList.Tables[0];
                    
                    //시험항목검사결과(엑셀바인딩용)
                    _dtList_01 = _dsList.Tables[1];
                    _pHACCPCheckRegisterT05Entity.dtListCnt = _dtList_01.Rows.Count;
