...
{
    public partial class HACCPCheckRegister_T06 : frmBaseNone
    {
        ...
        private HACCPCheckRegisterT06Entity _pHACCPCheckRegisterT06Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pHACCPCheckRegisterT06Entity = new HACCPCheckRegisterT06Entity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pHACCPCheckRegisterT06Entity.USER_CODE = _pUSER_CODE;
                _pHACCPCheckRegisterT06Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pHACCPCheckRegisterT06Entity.WINDOW_NAME = _pWINDOW_NAME;
                ...
                _pHACCPCheckRegisterT06Entity.CRUD = "";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pHACCPCheckRegisterT06Entity.CRUD = "R";
                    _pHACCPCheckRegisterT06Entity.DATE_FROM = DateTime.Parse(_luT_HACCP_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT06Entity.DATE_TO = DateTime.Parse(_luT_HACCP_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT06Entity.HACCP_ID = _luT_HACCP_ID.Text;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pHACCPCheckRegisterT06Entity.HACCP_DATE = _lu_HACCP_DATE.DateTime.ToString("yyyyMMdd");

                InputData_Save(_pHACCPCheckRegisterT06Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void InputData_Save(HACCPCheckRegisterT06Entity _pHACCPCheckRegisterT06Entity)
        {
            try
            {
                ...
                {
                    if (_pHACCPCheckRegisterT06Entity.HACCP_ID == null || _pHACCPCheckRegisterT06Entity.HACCP_ID == "")
                    {
                        _pHACCPCheckRegisterT06Entity.CRUD = "C";
                    }
                    else
                    {
                        _pHACCPCheckRegisterT06Entity.CRUD = "U";
                    }

                    _pHACCPCheckRegisterT06Entity.HACCP_TYPE = "HC";
                    ...
                    /*
                    pHACCPCheckRegisterT06Entity.PART_CODE
                    pHACCPCheckRegisterT06Entity.PART_NAME
                    pHACCPCheckRegisterT06Entity.INSPECT_STATUS
                    pHACCPCheckRegisterT06Entity.INSPECT_ID
                    pHACCPCheckRegisterT06Entity.INSPECT__DATE
                    pHACCPCheckRegisterT06Entity.INSPECT_SEQ
                    pHACCPCheckRegisterT06Entity.VEND_PART_CODE
                    pHACCPCheckRegisterT06Entity.PART_TYPE
                    pHACCPCheckRegisterT06Entity.REFERENCE_ID
                    pHACCPCheckRegisterT06Entity.MAKE_VEND
                    pHACCPCheckRegisterT06Entity.MAKE_VEND_NAME
                    pHACCPCheckRegisterT06Entity.VEND_CODE
                    pHACCPCheckRegisterT06Entity.VEND_NAME
                    pHACCPCheckRegisterT06Entity.REQUEST_DEPT
                    pHACCPCheckRegisterT06Entity.CODE_NAME
                    pHACCPCheckRegisterT06Entity.INOUT_DATE
                    pHACCPCheckRegisterT06Entity.INOUT_QTY
                        */
                    //_pHACCPCheckRegisterT06Entity.PACKING_REMARK  = sheet_1.GetCellValue(4, 6).TextValue;
                    //_pHACCPCheckRegisterT06Entity.SAMPLE_DATE     = sheet_1.GetCellValue(4, 7).TextValue;
                    //_pHACCPCheckRegisterT06Entity.SAMPLE_LOCATION = sheet_1.GetCellValue(6, 4).TextValue;
                    //_pHACCPCheckRegisterT06Entity.SAMPLE_USER     = sheet_1.GetCellValue(6, 5).TextValue;
                    //_pHACCPCheckRegisterT06Entity.SAMPLE_METHOD   = sheet_1.GetCellValue(6, 6).TextValue;
                    //_pHACCPCheckRegisterT06Entity.SAMPLE_QTY      = sheet_1.GetCellValue(6, 7).TextValue;
                    /*
                pHACCPCheckRegisterT06Entity.MAKE_NO
                pHACCPCheckRegisterT06Entity.STANDARD
                pHACCPCheckRegisterT06Entity.REQUEST_DATE
                pHACCPCheckRegisterT06Entity.REQUEST_USER
                pHACCPCheckRegisterT06Entity.END_DATE
                pHACCPCheckRegisterT06Entity.TOTAL_RESULT
                pHACCPCheckRegisterT06Entity.TOTAL_DATE
                pHACCPCheckRegisterT06Entity.TOTAL_USER
                pHACCPCheckRegisterT06Entity.COMPLETE_YN
                pHACCPCheckRegisterT06Entity.REMARK
                pHACCPCheckRegisterT06Entity.USER_YN
                */

                    isError = new HACCPCheckRegisterT06Business().HACCPCheckRegister_Info_Mst_Save(_pHACCPCheckRegisterT06Entity, sheet_1);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        isError = new HACCPCheckRegisterT06Business().HACCPCheckRegister_Info_Detail_Save(_pHACCPCheckRegisterT06Entity, sheet_2);
                        if (isError)
                        {
                            //오류 발생.
                            //CoFAS_DevExpressManager.ShowInformationMessage("저장 오류 발생! 데이터를 확인 하세요.");
                        ...
                        {
                            _pLocation_Code = _pHACCPCheckRegisterT06Entity.RTN_KEY;  //저장 위치
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            _pHACCPCheckRegisterT06Entity.HACCP_ID= gv.GetFocusedRowCellValue("HACCP_ID").ToString();
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new HACCPCheckRegisterT06Business().HACCPCheckRegister_Info(_pHACCPCheckRegisterT06Entity);

                if (_pHACCPCheckRegisterT06Entity.CRUD == "")
                    _dtList.Rows.Clear();
                else
                {
                    IWorkbook workbook = _sdMAIN.Document;
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pHACCPCheckRegisterT06Entity.CRUD == ""))
                {
        ...
        private void SheetFind_DisplayData()
        {
            try
            {
                ...
                //조회할거 프로시져
                _dtList = new HACCPCheckRegisterT06Business().Sheet_Info_Sheet(_pHACCPCheckRegisterT06Entity);   //엑셀 시트 조회하기
                ...
                /*
                strUSE_TYPE = "VIEW";
                strFILE_NAME = "HACCPCheckRegister_T06_Sample_v1.xlsx";
                */
                switch (strUSE_TYPE)
                {
        ...
        private void Sheet_Info_Sheet_Data()   //추가
        {
            try
            {
               ...
               // _pHACCPCheckRegisterT06Entity.ORDER_ID = _luORDER_ID.Text.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    // _dtList = new MaterialOrderRegisterProvider(pDBManager).Sheet_Info_Sheet_Data(_pHACCPCheckRegisterT06Entity);
                    _dsList = new HACCPCheckRegisterT06Provider(pDBManager).HACCPCheckRegister_info_ExcelBinding(_pHACCPCheckRegisterT06Entity);
                    //품목정보용
                    _dtList = _dsList.Tables[0];
                    
                    //시험항목검사결과(엑셀바인딩용)
                    _dtList_01 = _dsList.Tables[1];
                    _pHACCPCheckRegisterT06Entity.dtListCnt = _dtList_01.Rows.Count;
