...
{
    public partial class HACCPCheckRegister_T07 : frmBaseNone
    {
        ...
        private HACCPCheckRegisterT07Entity _pHACCPCheckRegisterT07Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pHACCPCheckRegisterT07Entity = new HACCPCheckRegisterT07Entity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pHACCPCheckRegisterT07Entity.USER_CODE = _pUSER_CODE;
                _pHACCPCheckRegisterT07Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pHACCPCheckRegisterT07Entity.WINDOW_NAME = _pWINDOW_NAME;
                ...
                _pHACCPCheckRegisterT07Entity.CRUD = "";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pHACCPCheckRegisterT07Entity.CRUD = "R";
                    _pHACCPCheckRegisterT07Entity.DATE_FROM = DateTime.Parse(_luT_HACCP_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT07Entity.DATE_TO = DateTime.Parse(_luT_HACCP_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT07Entity.HACCP_ID = _luT_HACCP_ID.Text;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pHACCPCheckRegisterT07Entity.HACCP_DATE = _lu_HACCP_DATE.DateTime.ToString("yyyyMMdd");

                InputData_Save(_pHACCPCheckRegisterT07Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void InputData_Save(HACCPCheckRegisterT07Entity _pHACCPCheckRegisterT07Entity)
        {
            try
            {
                ...
                {
                    if (_pHACCPCheckRegisterT07Entity.HACCP_ID == null || _pHACCPCheckRegisterT07Entity.HACCP_ID == "")
                    {
                        _pHACCPCheckRegisterT07Entity.CRUD = "C";
                    }
                    else
                    {
                        _pHACCPCheckRegisterT07Entity.CRUD = "U";
                    }

                    _pHACCPCheckRegisterT07Entity.HACCP_TYPE = "HF";
                    ...
                    /*
                    pHACCPCheckRegisterT07Entity.PART_CODE
                    pHACCPCheckRegisterT07Entity.PART_NAME
                    pHACCPCheckRegisterT07Entity.INSPECT_STATUS
                    pHACCPCheckRegisterT07Entity.INSPECT_ID
                    pHACCPCheckRegisterT07Entity.INSPECT__DATE
                    pHACCPCheckRegisterT07Entity.INSPECT_SEQ
                    pHACCPCheckRegisterT07Entity.VEND_PART_CODE
                    pHACCPCheckRegisterT07Entity.PART_TYPE
                    pHACCPCheckRegisterT07Entity.REFERENCE_ID
                    pHACCPCheckRegisterT07Entity.MAKE_VEND
                    pHACCPCheckRegisterT07Entity.MAKE_VEND_NAME
                    pHACCPCheckRegisterT07Entity.VEND_CODE
                    pHACCPCheckRegisterT07Entity.VEND_NAME
                    pHACCPCheckRegisterT07Entity.REQUEST_DEPT
                    pHACCPCheckRegisterT07Entity.CODE_NAME
                    pHACCPCheckRegisterT07Entity.INOUT_DATE
                    pHACCPCheckRegisterT07Entity.INOUT_QTY
                        */
                    //_pHACCPCheckRegisterT07Entity.PACKING_REMARK  = sheet_1.GetCellValue(4, 6).TextValue;
                    //_pHACCPCheckRegisterT07Entity.SAMPLE_DATE     = sheet_1.GetCellValue(4, 7).TextValue;
                    //_pHACCPCheckRegisterT07Entity.SAMPLE_LOCATION = sheet_1.GetCellValue(6, 4).TextValue;
                    //_pHACCPCheckRegisterT07Entity.SAMPLE_USER     = sheet_1.GetCellValue(6, 5).TextValue;
                    //_pHACCPCheckRegisterT07Entity.SAMPLE_METHOD   = sheet_1.GetCellValue(6, 6).TextValue;
                    //_pHACCPCheckRegisterT07Entity.SAMPLE_QTY      = sheet_1.GetCellValue(6, 7).TextValue;
                    /*
                pHACCPCheckRegisterT07Entity.MAKE_NO
                pHACCPCheckRegisterT07Entity.STANDARD
                pHACCPCheckRegisterT07Entity.REQUEST_DATE
                pHACCPCheckRegisterT07Entity.REQUEST_USER
                pHACCPCheckRegisterT07Entity.END_DATE
                pHACCPCheckRegisterT07Entity.TOTAL_RESULT
                pHACCPCheckRegisterT07Entity.TOTAL_DATE
                pHACCPCheckRegisterT07Entity.TOTAL_USER
                pHACCPCheckRegisterT07Entity.COMPLETE_YN
                pHACCPCheckRegisterT07Entity.REMARK
                pHACCPCheckRegisterT07Entity.USER_YN
                */

                    isError = new HACCPCheckRegisterT07Business().HACCPCheckRegister_Info_Mst_Save(_pHACCPCheckRegisterT07Entity, sheet_1);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        isError = new HACCPCheckRegisterT07Business().HACCPCheckRegister_Info_Detail_Save(_pHACCPCheckRegisterT07Entity, sheet_2);
                        if (isError)
                        {
                            //오류 발생.
                            //CoFAS_DevExpressManager.ShowInformationMessage("저장 오류 발생! 데이터를 확인 하세요.");
                        ...
                        {
                            _pLocation_Code = _pHACCPCheckRegisterT07Entity.RTN_KEY;  //저장 위치
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            _pHACCPCheckRegisterT07Entity.HACCP_ID= gv.GetFocusedRowCellValue("HACCP_ID").ToString();
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new HACCPCheckRegisterT07Business().HACCPCheckRegister_Info(_pHACCPCheckRegisterT07Entity);

                if (_pHACCPCheckRegisterT07Entity.CRUD == "")
                    _dtList.Rows.Clear();
                else
                {
                    IWorkbook workbook = _sdMAIN.Document;
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pHACCPCheckRegisterT07Entity.CRUD == ""))
                {
        ...
        private void SheetFind_DisplayData()
        {
            try
            {
                ...
                //조회할거 프로시져
                _dtList = new HACCPCheckRegisterT07Business().Sheet_Info_Sheet(_pHACCPCheckRegisterT07Entity);   //엑셀 시트 조회하기
        ...
        private void Sheet_Info_Sheet_Data()   //추가
        {
            try
            {
               ...
               // _pHACCPCheckRegisterT07Entity.ORDER_ID = _luORDER_ID.Text.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    // _dtList = new MaterialOrderRegisterProvider(pDBManager).Sheet_Info_Sheet_Data(_pHACCPCheckRegisterT07Entity);
                    _dsList = new HACCPCheckRegisterT07Provider(pDBManager).HACCPCheckRegister_info_ExcelBinding(_pHACCPCheckRegisterT07Entity);
                    //품목정보용
                    _dtList = _dsList.Tables[0];
                    
                    //시험항목검사결과(엑셀바인딩용)
                    _dtList_01 = _dsList.Tables[1];
                    _pHACCPCheckRegisterT07Entity.dtListCnt = _dtList_01.Rows.Count;
