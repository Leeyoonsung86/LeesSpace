...
{
    public partial class HACCPCheckRegister_T09 : frmBaseNone
    {
        ...
        private HACCPCheckRegisterT09Entity _pHACCPCheckRegisterT09Entity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pHACCPCheckRegisterT09Entity = new HACCPCheckRegisterT09Entity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pHACCPCheckRegisterT09Entity.USER_CODE = _pUSER_CODE;
                _pHACCPCheckRegisterT09Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pHACCPCheckRegisterT09Entity.WINDOW_NAME = _pWINDOW_NAME;
                ...
                _pHACCPCheckRegisterT09Entity.CRUD = "";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pHACCPCheckRegisterT09Entity.CRUD = "R";
                    _pHACCPCheckRegisterT09Entity.DATE_FROM = DateTime.Parse(_luT_HACCP_DATE.FromDateTime.ToString()).ToString("yyyyMMdd"); // Convert.ToString(_luTINOUT_DATE.FromDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT09Entity.DATE_TO = DateTime.Parse(_luT_HACCP_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");  //Convert.ToString(_luTINOUT_DATE.ToDateTime).Replace("-", "").Substring(0, 8);
                    _pHACCPCheckRegisterT09Entity.HACCP_ID = _luT_HACCP_ID.Text;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pHACCPCheckRegisterT09Entity.HACCP_DATE = _lu_HACCP_DATE.DateTime.ToString("yyyyMMdd");

                InputData_Save(_pHACCPCheckRegisterT09Entity);
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager.TargetSite.ToString()));
        ...
        private void InputData_Save(HACCPCheckRegisterT09Entity _pHACCPCheckRegisterT09Entity)
        {
            try
            {
                ...
                {
                    if (_pHACCPCheckRegisterT09Entity.HACCP_ID == null || _pHACCPCheckRegisterT09Entity.HACCP_ID == "")
                    {
                        _pHACCPCheckRegisterT09Entity.CRUD = "C";
                    }
                    else
                    {
                        _pHACCPCheckRegisterT09Entity.CRUD = "U";
                    }

                    _pHACCPCheckRegisterT09Entity.HACCP_TYPE = "HF";
                    ...
                    /*
                    pHACCPCheckRegisterT09Entity.PART_CODE
                    pHACCPCheckRegisterT09Entity.PART_NAME
                    pHACCPCheckRegisterT09Entity.INSPECT_STATUS
                    pHACCPCheckRegisterT09Entity.INSPECT_ID
                    pHACCPCheckRegisterT09Entity.INSPECT__DATE
                    pHACCPCheckRegisterT09Entity.INSPECT_SEQ
                    pHACCPCheckRegisterT09Entity.VEND_PART_CODE
                    pHACCPCheckRegisterT09Entity.PART_TYPE
                    pHACCPCheckRegisterT09Entity.REFERENCE_ID
                    pHACCPCheckRegisterT09Entity.MAKE_VEND
                    pHACCPCheckRegisterT09Entity.MAKE_VEND_NAME
                    pHACCPCheckRegisterT09Entity.VEND_CODE
                    pHACCPCheckRegisterT09Entity.VEND_NAME
                    pHACCPCheckRegisterT09Entity.REQUEST_DEPT
                    pHACCPCheckRegisterT09Entity.CODE_NAME
                    pHACCPCheckRegisterT09Entity.INOUT_DATE
                    pHACCPCheckRegisterT09Entity.INOUT_QTY
                        */
                    //_pHACCPCheckRegisterT09Entity.PACKING_REMARK  = sheet_1.GetCellValue(4, 6).TextValue;
                    //_pHACCPCheckRegisterT09Entity.SAMPLE_DATE     = sheet_1.GetCellValue(4, 7).TextValue;
                    //_pHACCPCheckRegisterT09Entity.SAMPLE_LOCATION = sheet_1.GetCellValue(6, 4).TextValue;
                    //_pHACCPCheckRegisterT09Entity.SAMPLE_USER     = sheet_1.GetCellValue(6, 5).TextValue;
                    //_pHACCPCheckRegisterT09Entity.SAMPLE_METHOD   = sheet_1.GetCellValue(6, 6).TextValue;
                    //_pHACCPCheckRegisterT09Entity.SAMPLE_QTY      = sheet_1.GetCellValue(6, 7).TextValue;
                    /*
                pHACCPCheckRegisterT09Entity.MAKE_NO
                pHACCPCheckRegisterT09Entity.STANDARD
                pHACCPCheckRegisterT09Entity.REQUEST_DATE
                pHACCPCheckRegisterT09Entity.REQUEST_USER
                pHACCPCheckRegisterT09Entity.END_DATE
                pHACCPCheckRegisterT09Entity.TOTAL_RESULT
                pHACCPCheckRegisterT09Entity.TOTAL_DATE
                pHACCPCheckRegisterT09Entity.TOTAL_USER
                pHACCPCheckRegisterT09Entity.COMPLETE_YN
                pHACCPCheckRegisterT09Entity.REMARK
                pHACCPCheckRegisterT09Entity.USER_YN
                */

                    isError = new HACCPCheckRegisterT09Business().HACCPCheckRegister_Info_Mst_Save(_pHACCPCheckRegisterT09Entity, sheet_1);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        isError = new HACCPCheckRegisterT09Business().HACCPCheckRegister_Info_Detail_Save(_pHACCPCheckRegisterT09Entity, sheet_2);
                        if (isError)
                        {
                            //오류 발생.
                            //CoFAS_DevExpressManager.ShowInformationMessage("저장 오류 발생! 데이터를 확인 하세요.");
                        ...
                        {
                            _pLocation_Code = _pHACCPCheckRegisterT09Entity.RTN_KEY;  //저장 위치
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            _pHACCPCheckRegisterT09Entity.HACCP_ID= gv.GetFocusedRowCellValue("HACCP_ID").ToString();
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new HACCPCheckRegisterT09Business().HACCPCheckRegister_Info(_pHACCPCheckRegisterT09Entity);

                if (_pHACCPCheckRegisterT09Entity.CRUD == "")
                    _dtList.Rows.Clear();
                else
                {
                    IWorkbook workbook = _sdMAIN.Document;
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pHACCPCheckRegisterT09Entity.CRUD == ""))
                {
        ...
        private void SheetFind_DisplayData()
        {
            try
            {
                ...
                //조회할거 프로시져
                _dtList = new HACCPCheckRegisterT09Business().Sheet_Info_Sheet(_pHACCPCheckRegisterT09Entity);   //엑셀 시트 조회하기
                ...
                /*
                strUSE_TYPE = "VIEW";
                strFILE_NAME = "HACCPCheckRegister_T09_Sample_v1.xlsx";
                */
                switch (strUSE_TYPE)
                {
        ...
        private void Sheet_Info_Sheet_Data()   //추가
        {
            try
            {
               ...
               // _pHACCPCheckRegisterT09Entity.ORDER_ID = _luORDER_ID.Text.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    // _dtList = new MaterialOrderRegisterProvider(pDBManager).Sheet_Info_Sheet_Data(_pHACCPCheckRegisterT09Entity);
                    _dsList = new HACCPCheckRegisterT09Provider(pDBManager).HACCPCheckRegister_info_ExcelBinding(_pHACCPCheckRegisterT09Entity);
                    //품목정보용
                    _dtList = _dsList.Tables[0];
                    
                    //시험항목검사결과(엑셀바인딩용)
                    _dtList_01 = _dsList.Tables[1];
                    _pHACCPCheckRegisterT09Entity.dtListCnt = _dtList_01.Rows.Count;
