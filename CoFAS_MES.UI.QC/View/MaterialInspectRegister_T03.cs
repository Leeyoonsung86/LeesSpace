...
{
    public partial class MaterialInspectRegister_T03 : frmBaseNone
    {
        ...
        private MaterialInspectRegister_T03Entity _pMaterialInspectRegister_T03Entity = null; // 엔티티 생성
        ...
        public MaterialInspectRegister_T03()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMaterialInspectRegister_T03Entity = new MaterialInspectRegister_T03Entity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pMaterialInspectRegister_T03Entity.USER_CODE = _pUSER_CODE;
                _pMaterialInspectRegister_T03Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pMaterialInspectRegister_T03Entity.WINDOW_NAME = _pWINDOW_NAME;
                ...
                _pMaterialInspectRegister_T03Entity.CRUD = "";
                ...
                if (_pFirstYN)
                {
                    ...
                    _gdMAIN_VIEW.RowCellClick += _gdMAIN_VIEW_RowCellClick;
                    _pMaterialInspectRegister_T03Entity.FILE_NAME = "";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pMaterialInspectRegister_T03Entity.CRUD = "R";
                    _pMaterialInspectRegister_T03Entity.DATE_FROM = DateTime.Parse(_luT_ACCEPT_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.FromDateTime).Replace("-", "").Substring(0, 8);//
                    _pMaterialInspectRegister_T03Entity.DATE_TO = DateTime.Parse(_luT_ACCEPT_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Replace("-", "").Substring(0, 8);//
                    _pMaterialInspectRegister_T03Entity.PART_NAME = _luT_PART.NameText;
                    _pMaterialInspectRegister_T03Entity.PART_CODE = _luT_PART.CodeText;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                InputData_Save(_pMaterialInspectRegister_T03Entity);
        ...
        private void Form_AddItemButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                frmCommonPopup.ARRAY = new object[2] { "WorkOrder", "1002" }; //넘기는 파라메터 에 따라 설정, 포장부자재 정보
                frmCommonPopup xfrmCommonPopup = new CORE.UserForm.frmCommonPopup("InputIspectInfo"); //유저컨트롤러 설정 부분
        ...
        private void InputData_Save(MaterialInspectRegister_T03Entity _pMaterialInspectRegister_T03Entity)
        {
            try
            {
                ...
                if(_pMaterialInspectRegister_T03Entity.FILE_NAME == "")
                    _pMaterialInspectRegister_T03Entity.FILE_NAME = "INSPECT/" + _ptime + "_" + _pMaterialInspectRegister_T03Entity.INSPECT_ID + "_부자재시험성적서." + _pFile_Attr;
                ...
                if (CoFAS_DevExpressManager.ShowQuestionMessage(_pMSG_SAVE_QUESTION) == DialogResult.Yes)
                {
                    ...
                    _pMaterialInspectRegister_T03Entity.CRUD = "U";
                    ...
                    /*
                    pMaterialInspectRegister_T03Entity.PART_CODE
                    pMaterialInspectRegister_T03Entity.PART_NAME
                    pMaterialInspectRegister_T03Entity.INSPECT_STATUS
                    pMaterialInspectRegister_T03Entity.INSPECT_ID
                    pMaterialInspectRegister_T03Entity.INSPECT__DATE
                    pMaterialInspectRegister_T03Entity.INSPECT_SEQ
                    pMaterialInspectRegister_T03Entity.VEND_PART_CODE
                    pMaterialInspectRegister_T03Entity.PART_TYPE
                    pMaterialInspectRegister_T03Entity.REFERENCE_ID
                    pMaterialInspectRegister_T03Entity.MAKE_VEND
                    pMaterialInspectRegister_T03Entity.MAKE_VEND_NAME
                    pMaterialInspectRegister_T03Entity.VEND_CODE
                    pMaterialInspectRegister_T03Entity.VEND_NAME
                    pMaterialInspectRegister_T03Entity.REQUEST_DEPT
                    pMaterialInspectRegister_T03Entity.CODE_NAME
                    pMaterialInspectRegister_T03Entity.INOUT_DATE
                    pMaterialInspectRegister_T03Entity.INOUT_QTY
                        */
                    //_pMaterialInspectRegister_T03Entity.PACKING_REMARK  = sheet_1.GetCellValue(4, 6).TextValue;
                    //_pMaterialInspectRegister_T03Entity.SAMPLE_DATE     = sheet_1.GetCellValue(4, 7).TextValue;
                    //_pMaterialInspectRegister_T03Entity.SAMPLE_LOCATION = sheet_1.GetCellValue(6, 4).TextValue;
                    //_pMaterialInspectRegister_T03Entity.SAMPLE_USER     = sheet_1.GetCellValue(6, 5).TextValue;
                    //_pMaterialInspectRegister_T03Entity.SAMPLE_METHOD   = sheet_1.GetCellValue(6, 6).TextValue;
                    //_pMaterialInspectRegister_T03Entity.SAMPLE_QTY      = sheet_1.GetCellValue(6, 7).TextValue;
                    /*
                pMaterialInspectRegister_T03Entity.MAKE_NO
                pMaterialInspectRegister_T03Entity.STANDARD
                pMaterialInspectRegister_T03Entity.REQUEST_DATE
                pMaterialInspectRegister_T03Entity.REQUEST_USER
                pMaterialInspectRegister_T03Entity.END_DATE
                pMaterialInspectRegister_T03Entity.TOTAL_RESULT
                pMaterialInspectRegister_T03Entity.TOTAL_DATE
                pMaterialInspectRegister_T03Entity.TOTAL_USER
                pMaterialInspectRegister_T03Entity.COMPLETE_YN
                pMaterialInspectRegister_T03Entity.REMARK
                pMaterialInspectRegister_T03Entity.USER_YN
                */

                    isError = new MaterialInspectRegister_T03Business().MaterialInspectRegister_T03_Info_Mst_Save(_pMaterialInspectRegister_T03Entity, sheet_1);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        isError = new MaterialInspectRegister_T03Business().MaterialInspectRegister_T03_Info_Detail_Save(_pMaterialInspectRegister_T03Entity, sheet_2);
                        if (isError)
                        {
                            //오류 발생.
                            //CoFAS_DevExpressManager.ShowInformationMessage("저장 오류 발생! 데이터를 확인 하세요.");
                        ...
                        {
                            InspectDoc_Create();
                            _pLocation_Code = _pMaterialInspectRegister_T03Entity.RTN_KEY;  //저장 위치
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            _pMaterialInspectRegister_T03Entity.INSPECT_ID= gv.GetFocusedRowCellValue("INSPECT_ID").ToString();
            _pMaterialInspectRegister_T03Entity.FILE_NAME = _pFILE_NAME;
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new MaterialInspectRegister_T03Business().Sample_Info(_pMaterialInspectRegister_T03Entity);

                if (_pMaterialInspectRegister_T03Entity.CRUD == "")
                    _dtList.Rows.Clear();
                else
                {
                    IWorkbook workbook = _sdMAIN.Document;
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMaterialInspectRegister_T03Entity.CRUD == ""))
                {
        ...
        private void SheetFind_DisplayData()
        {
            try
            {
                ...
                _pMaterialInspectRegister_T03Entity.CRUD = "R";
                //조회할거 프로시져
                _dtList = new MaterialInspectRegister_T03Business().Sheet_Info_Sheet(_pMaterialInspectRegister_T03Entity);   //엑셀 시트 조회하기
                ...
                {
                    //확장자 자르기
                    tmp = _pMaterialInspectRegister_T03Entity.FILE_NAME.Split('.');
                    _pFile_Attr = tmp[tmp.Length - 1];

                    //파일명 자르기
                    tmp2 = _pMaterialInspectRegister_T03Entity.FILE_NAME.Split('/');
        ...
        private void InspectDoc_Create()
        {
            ...
            //
            //파일업로드
            //if (_pMaterialInspectRegister_T03Entity.CRUD == "C") // 업데이트
            //{
            //업데이트는, 이전파일명으로 삭제하기
            ...
            if (CoFAS_FTPManager.FTPDelete(_pMaterialInspectRegister_T03Entity.FILE_NAME, _pFTP_PATH, _pFTP_ID, _pFTP_PW))
            {
                if (CoFAS_FTPManager.FTPUpload_DataofByte_CheckDirectory(_pMaterialInspectRegister_T03Entity.FILE_NAME, _pFTP_ID, _pFTP_PW, _pFTP_PATH, "", data)) // _pListofManagementEntity.WINDOW_NAME + _pListofManagementEntity.RTN_KEY + _pFileName
                {
            ...
            //파일이 없는지 체크
            else if (!qFTPUtil.IsFTPFileExsit(_pFTP_PATH + _pMaterialInspectRegister_T03Entity.FILE_NAME))
            {
                //정상 처리
        ...
        public void InsertSignImage(object sender, EventArgs e)
        {
            ...
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _pMaterialInspectRegister_T03Entity.CRUD = "R";
                _dtList = new InspectFinalApprovalRegisterBusiness().GetUserImage(_pMaterialInspectRegister_T03Entity.CRUD, _pMaterialInspectRegister_T03Entity.USER_CODE);
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMaterialInspectRegister_T03Entity.CRUD == ""))
                {
                    IWorkbook workbook = _sdMAIN.Document;
                    Worksheet sheet_0 = workbook.Worksheets[0];
        ...
        private void Sheet_Info_Sheet_Data()   //추가
        {
            try
            {
                ...
                // _pMaterialInspectRegister_T03Entity.ORDER_ID = _luORDER_ID.Text.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    // _dtList = new MaterialOrderRegisterProvider(pDBManager).Sheet_Info_Sheet_Data(_pMaterialInspectRegister_T03Entity);
                    _dsList = new MaterialInspectRegister_T03Provider(pDBManager).MaterialInspectRegister_T03_info_ExcelBinding(_pMaterialInspectRegister_T03Entity);
                    //품목정보용
                    _dtList = _dsList.Tables[0];
                    //시험항목검사결과(엑셀바인딩용)
                    _dtList_01 = _dsList.Tables[1];
                    _pMaterialInspectRegister_T03Entity.dtListCnt = _dtList_01.Rows.Count;
                    if (_dtList != null && _dtList.Rows.Count > 0)
                    {
                        ...
                        */
                        ...
                        //DataValidation validation = sheet_0.DataValidations.Add(sheet_0["F11:F19"], DataValidationType.List, "적합, 부적합");
                        ////validation = sheet_0.DataValidations.Add(sheet_0["H11:H20"], DataValidationType.List, "적합, 부적합");
                        ////validation = sheet_0.DataValidations.Add(sheet_0["J11:J20"], DataValidationType.List, "적합, 부적합");
                        ////validation = sheet_0.DataValidations.Add(sheet_0["L11:L20"], DataValidationType.List, "적합, 부적합");
                        ////validation = sheet_0.DataValidations.Add(sheet_0["P11:P20"], DataValidationType.List, "적합, 부적합");
                        ////validation = sheet_0.DataValidations.Add(sheet_0["S11:S20"], DataValidationType.List, "적합, 부적합");
                        ...
                        if (name_tmp != "")
                        {
                            _dtList2 = new InspectFinalApprovalRegisterBusiness().GetUserImage(_pMaterialInspectRegister_T03Entity.CRUD, name_tmp);
                            if ((_dtList2 != null && _dtList2.Rows.Count > 0) || (_dtList2 != null && _pMaterialInspectRegister_T03Entity.CRUD == ""))
                            {
                                Image img = null;
