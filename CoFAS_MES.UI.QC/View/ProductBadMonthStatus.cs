...
{
    public partial class ProductBadMonthStatus : frmBaseNone
    {
        ...
        private ProductBadMonthStatusEntity _pProductBadMonthStatusEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductBadMonthStatusEntity = new ProductBadMonthStatusEntity();
                //_pResultStatusPlanResultEntity.CORP_CODE = _pCORP_CODE;
                _pProductBadMonthStatusEntity.USER_CODE = _pUSER_CODE;
                _pProductBadMonthStatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pProductBadMonthStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void InitializeControl()
        {
            ...
            {
                //조회조건 영역 
                _luT_PLAN_DATE.DateTime = DateTime.UtcNow;
                ...
                _pProductBadMonthStatusEntity.CRUD = "";
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pProductBadMonthStatusEntity.CRUD = "R";
            }
            catch (ExceptionManager pExceptionManager)
            {
                CoFAS_DevExpressManager.ShowErrorMessage(string.Format("{0}\n{1}", pExceptionManager.Exception.Message.ToString(), pExceptionManager));
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pProductBadMonthStatusEntity.CRUD = "R";
                _pProductBadMonthStatusEntity.DATE = DateTime.Today.ToString();
