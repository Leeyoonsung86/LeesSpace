...
using DevExpress.XtraGrid.Views.Grid;using CoFAS_MES.UI.QC.Entity;
...
{
    public partial class ProductInspectRegister : frmBaseNone
    {
        ...
        private ProductInspectRegisterEntity _pProductInspectRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pProductInspectRegisterEntity = new ProductInspectRegisterEntity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pProductInspectRegisterEntity.USER_CODE = _pUSER_CODE;
                _pProductInspectRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pProductInspectRegisterEntity.WINDOW_NAME = _pWINDOW_NAME;
                ...
                _pProductInspectRegisterEntity.CRUD = "";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pProductInspectRegisterEntity.CRUD = "R";
                    _pProductInspectRegisterEntity.DATE_FROM = DateTime.Parse(_luT_ACCEPT_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.FromDateTime).Replace("-", "").Substring(0, 8);//
                    _pProductInspectRegisterEntity.DATE_TO = DateTime.Parse(_luT_ACCEPT_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Replace("-", "").Substring(0, 8);//
                    //_pProductInspectRegisterEntity.VEND_NAME = _luTVEND.NameText;
                    //_pProductInspectRegisterEntity.VEND_CODE = _luTVEND.CodeText;
                    _pProductInspectRegisterEntity.PART_NAME = _luT_PART.NameText;
                    _pProductInspectRegisterEntity.PART_CODE = _luT_PART.CodeText;
                    //_pProductInspectRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
                    _pProductInspectRegisterEntity.INSPECT_STATUS = _luT_INSPECT_STATUS.GetValue();
                   //
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                InputData_Save(_pProductInspectRegisterEntity);
        ...
        private void InputData_Save(ProductInspectRegisterEntity _pProductInspectRegisterEntity)
        {
            try
            {
                ...
                if (CoFAS_DevExpressManager.ShowQuestionMessage(_pMSG_SAVE_QUESTION) == DialogResult.Yes)
                {
                    ...
                    _pProductInspectRegisterEntity.CRUD = "U";
                    ...
                    /*
                    pProductInspectRegisterEntity.PART_CODE
                    pProductInspectRegisterEntity.PART_NAME
                    pProductInspectRegisterEntity.INSPECT_STATUS
                    pProductInspectRegisterEntity.INSPECT_ID
                    pProductInspectRegisterEntity.INSPECT__DATE
                    pProductInspectRegisterEntity.INSPECT_SEQ
                    pProductInspectRegisterEntity.VEND_PART_CODE
                    pProductInspectRegisterEntity.PART_TYPE
                    pProductInspectRegisterEntity.REFERENCE_ID
                    pProductInspectRegisterEntity.MAKE_VEND
                    pProductInspectRegisterEntity.MAKE_VEND_NAME
                    pProductInspectRegisterEntity.VEND_CODE
                    pProductInspectRegisterEntity.VEND_NAME
                    pProductInspectRegisterEntity.REQUEST_DEPT
                    pProductInspectRegisterEntity.CODE_NAME
                    pProductInspectRegisterEntity.INOUT_DATE
                    pProductInspectRegisterEntity.INOUT_QTY
                        */
                    //_pProductInspectRegisterEntity.PACKING_REMARK  = sheet_1.GetCellValue(4, 6).TextValue;
                    //_pProductInspectRegisterEntity.SAMPLE_DATE     = sheet_1.GetCellValue(4, 7).TextValue;
                    //_pProductInspectRegisterEntity.SAMPLE_LOCATION = sheet_1.GetCellValue(6, 4).TextValue;
                    //_pProductInspectRegisterEntity.SAMPLE_USER     = sheet_1.GetCellValue(6, 5).TextValue;
                    //_pProductInspectRegisterEntity.SAMPLE_METHOD   = sheet_1.GetCellValue(6, 6).TextValue;
                    //_pProductInspectRegisterEntity.SAMPLE_QTY      = sheet_1.GetCellValue(6, 7).TextValue;
                    /*
                pProductInspectRegisterEntity.MAKE_NO
                pProductInspectRegisterEntity.STANDARD
                pProductInspectRegisterEntity.REQUEST_DATE
                pProductInspectRegisterEntity.REQUEST_USER
                pProductInspectRegisterEntity.END_DATE
                pProductInspectRegisterEntity.TOTAL_RESULT
                pProductInspectRegisterEntity.TOTAL_DATE
                pProductInspectRegisterEntity.TOTAL_USER
                pProductInspectRegisterEntity.COMPLETE_YN
                pProductInspectRegisterEntity.REMARK
                pProductInspectRegisterEntity.USER_YN
                */

                    isError = new ProductInspectRegisterBusiness().ProductInspectRegister_Info_Mst_Save(_pProductInspectRegisterEntity, sheet_1);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        isError = new ProductInspectRegisterBusiness().ProductInspectRegister_Info_Detail_Save(_pProductInspectRegisterEntity, sheet_2);
                        if (isError)
                        {
                            //오류 발생.
                            //CoFAS_DevExpressManager.ShowInformationMessage("저장 오류 발생! 데이터를 확인 하세요.");
                        ...
                        {
                            _pLocation_Code = _pProductInspectRegisterEntity.RTN_KEY;  //저장 위치
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            _pProductInspectRegisterEntity.INSPECT_ID= gv.GetFocusedRowCellValue("INSPECT_ID").ToString();
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new ProductInspectRegisterBusiness().Sample_Info(_pProductInspectRegisterEntity);

                if (_pProductInspectRegisterEntity.CRUD == "")
                    _dtList.Rows.Clear();
                else
                {
                    IWorkbook workbook = _sdMAIN.Document;
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductInspectRegisterEntity.CRUD == ""))
                {
        ...
        private void SheetFind_DisplayData()
        {
            try
            {
                ...
                //조회할거 프로시져
                _dtList = new ProductInspectRegisterBusiness().Sheet_Info_Sheet(_pProductInspectRegisterEntity);   //엑셀 시트 조회하기
                ...
                /*
                strUSE_TYPE = "VIEW";
                strFILE_NAME = "ProductInspectRegister_Sample_v1.xlsx";
                */
                switch (strUSE_TYPE)
                {
                ...
                using (Stream file = File.Open(curfile, FileMode.Open))
                {
                        ...
                        try
                        {
                            ...
                            _sdMAIN.MouseDoubleClick -= _sdMAIN_MouseDoubleClick;
                            _sdMAIN.MouseDoubleClick += _sdMAIN_MouseDoubleClick;

                            _sdMAIN.DoubleClick -= _sdMAIN_DoubleClick;
                            _sdMAIN.DoubleClick += _sdMAIN_DoubleClick;
        ...
        private void _sdMAIN_DoubleClick(object sender, EventArgs e)
        {
           // throw new NotImplementedException();
        }

        private void _sdMAIN_MouseDoubleClick(object sender, MouseEventArgs e)
        {
        //   throw new NotImplementedException();
        ...
        private void _sdMAIN_PopupMenuShowing(object sender, DevExpress.XtraSpreadsheet.PopupMenuShowingEventArgs e)
        {
            ...
            if (e.MenuType == SpreadsheetMenuType.Cell)
            {
                ...
                */
                ...
                //검체채취자
                else if (((7 < click_col) && (click_col < 11)) && (click_row == 6))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
                ...
                //상단 시험자
                else if (((click_row == 3)) && ((12 < click_col) && (click_col <17)))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
                ...
                //하단 시험자
                else if (((9 < click_row) && (click_row < 20)) && ((11 < click_col) && (click_col < 15)))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
                ...
                //판정자
                else if ((click_row == 30) && ((2 < click_col) && (click_col < 7)))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
                ...
                //시험결과
                else if (((9 < click_row) && (click_row < 20)) && ((5 < click_col) && (click_col < 10)))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
                ...
                //판정
                else if (((9 < click_row) && (click_row < 20)) && ((14 < click_col) && (click_col < 17)))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
                ...
                //종합판정
                else if (((click_row == 28)) && ((2 < click_col) && (click_col < 7)))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
        ...
        public void InsertUserList(object sender, EventArgs e)
        {
            try
            {
                ...
                //검체채취자
                if (((7 < click_col) && (click_col < 11)) && (click_row == 6))
                {
                ...
                {
                    sheet_0.Cells[click_row, 12].SetValue(item.Caption);
                }
                //판정자
                else if ((click_row == 30) && ((2 < click_col) && (click_col < 7)))
                {
        ...
        public void InsertResult(object sender, EventArgs e)
        {
            try
            {
                ...
                int click_row = _sdMAIN.ActiveWorksheet[_sdMAIN.ActiveCell.GetReferenceA1()].TopRowIndex;
                //시험결과
                if (((9 < click_row) && (click_row < 20)) && ((5 < click_col) && (click_col < 10)))
                {
        ...
        public void InsertSignImage(object sender, EventArgs e)
        {
            ...
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _pProductInspectRegisterEntity.CRUD = "R";
                _dtList = new InspectFinalApprovalRegisterBusiness().GetUserImage(_pProductInspectRegisterEntity.CRUD, _pProductInspectRegisterEntity.USER_CODE);
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pProductInspectRegisterEntity.CRUD == ""))
                {
                    IWorkbook workbook = _sdMAIN.Document;
                    Worksheet sheet_0 = workbook.Worksheets[0];
                    ...
                    if(signature_user == "total_user")
                    {
                        ...
                        sheet_0.Cells["D31"].SetValue(_pUSER_NAME);
                    }
        ...
        private void _sdMAIN_CellBeginEdit(object sender, SpreadsheetCellCancelEventArgs e)
        {
            ...
            //사용기한
            if (((e.RowIndex == 6)) && ((7 < e.ColumnIndex) && (e.ColumnIndex < 11)))
            {
                IWorkbook workbook = _sdMAIN.Document;
                Worksheet sheet_0 = workbook.Worksheets[0];
            ...
            //포장일
            if (((e.RowIndex == 4)) && ((12 < e.ColumnIndex) && (e.ColumnIndex < 17)))
            {
                IWorkbook workbook = _sdMAIN.Document;
                Worksheet sheet_0 = workbook.Worksheets[0];
            ...
            //시험의뢰일
            if (((e.RowIndex == 5)) && ((12 < e.ColumnIndex) && (e.ColumnIndex < 17)))
            {
                IWorkbook workbook = _sdMAIN.Document;
                Worksheet sheet_0 = workbook.Worksheets[0];
            ...
            //시험일
            if (((9 < e.RowIndex) && (e.RowIndex < 20)) && ((9 < e.ColumnIndex) && (e.ColumnIndex < 12)))
            {
                IWorkbook workbook = _sdMAIN.Document;
                Worksheet sheet_0 = workbook.Worksheets[0];
                ...
                if (xfrmCommonPopup.dtReturn != null && xfrmCommonPopup.dtReturn.Rows.Count > 0)
                {
                    sheet_0.Cells[e.RowIndex, 10].SetValue(xfrmCommonPopup.dtReturn.Rows[0]["DATE"].ToString());
                }

                xfrmCommonPopup.Dispose();
            }
            //판정일자
            if (((e.RowIndex == 29)) && ((2 < e.ColumnIndex) && (e.ColumnIndex < 7)))
            {
                IWorkbook workbook = _sdMAIN.Document;
                Worksheet sheet_0 = workbook.Worksheets[0];
        ...
        private void Sheet_Info_Sheet_Data()   //추가
        {
            try
            {
               ...
               // _pProductInspectRegisterEntity.ORDER_ID = _luORDER_ID.Text.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    // _dtList = new MaterialOrderRegisterProvider(pDBManager).Sheet_Info_Sheet_Data(_pProductInspectRegisterEntity);
                    _dsList = new ProductInspectRegisterProvider(pDBManager).ProductInspectRegister_info_ExcelBinding(_pProductInspectRegisterEntity);
                    //품목정보용
                    ...
                    _pProductInspectRegisterEntity.dtListCnt = _dtList_01.Rows.Count;
                    if (_dtList != null && _dtList.Rows.Count > 0)
                    {
                        ...
                        */
                        ...
                        if (name_tmp != "")
                        {
                            _dtList2 = new InspectFinalApprovalRegisterBusiness().GetUserImage(_pProductInspectRegisterEntity.CRUD, name_tmp);
                            if ((_dtList2 != null && _dtList2.Rows.Count > 0) || (_dtList2 != null && _pProductInspectRegisterEntity.CRUD == ""))
                            {
                                Image img = null;
