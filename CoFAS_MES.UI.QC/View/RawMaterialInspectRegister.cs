...
{
    public partial class RawMaterialInspectRegister : frmBaseNone
    {
        ...
        private RawMaterialInspectRegisterEntity _pRawMaterialInspectRegisterEntity = null; // 엔티티 생성
        ...
        public RawMaterialInspectRegister()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //버튼 폰트색상 및 배경색상
                _ucbtINSPECT_REQUEST.BackColor = Color.LightSalmon;
                ...
                //메뉴 화면 엔티티 설정
                _pRawMaterialInspectRegisterEntity = new RawMaterialInspectRegisterEntity();
                //_pProcessCodeMstRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pRawMaterialInspectRegisterEntity.USER_CODE = _pUSER_CODE;
                _pRawMaterialInspectRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                _pRawMaterialInspectRegisterEntity.WINDOW_NAME = _pWINDOW_NAME;
                //화면 설정 언어 & 명칭 변경.
                ...
                _pRawMaterialInspectRegisterEntity.CRUD = "";
        ...
        //마우스 더블클릭 -> 편집모드 -> 현재 셀위치 가져오기
        private void _sdMAIN_CellBeginEdit1(object sender, SpreadsheetCellCancelEventArgs e)
        {
            //throw new NotImplementedException();
            IWorkbook workbook = _sdMAIN.Document;
            Worksheet sheet_1 = workbook.Worksheets[0];

            sheet_1.ClearContents(_sdMAIN.ActiveCell);
           
            _sdMAIN.ActiveCell.Value = "testtest";
            //sheet_1.SelectedCell[_sdMAIN.ActiveCell]
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    _pRawMaterialInspectRegisterEntity.CRUD = "R";
                    _pRawMaterialInspectRegisterEntity.DATE_FROM = DateTime.Parse(_luT_ACCEPT_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.FromDateTime).Replace("-", "").Substring(0, 8);//
                    _pRawMaterialInspectRegisterEntity.DATE_TO = DateTime.Parse(_luT_ACCEPT_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");//Convert.ToString(_luTORDER_DATE.ToDateTime).Replace("-", "").Substring(0, 8);//
                    ...
                    _pRawMaterialInspectRegisterEntity.PART_NAME = _luT_PART.NameText;
                    _pRawMaterialInspectRegisterEntity.PART_CODE = _luT_PART.CodeText;
                    //_pRawMaterialInspectRegisterEntity.USE_YN = _luTUSE_YN.GetValue();
                    _pRawMaterialInspectRegisterEntity.INSPECT_STATUS = _luT_INSPECT_STATUS.GetValue();
                   //
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                InputData_Save(_pRawMaterialInspectRegisterEntity);
        ...
        private void InputData_Save(RawMaterialInspectRegisterEntity _pRawMaterialInspectRegisterEntity)
        {
            try
            {
                ...
                if (CoFAS_DevExpressManager.ShowQuestionMessage(_pMSG_SAVE_QUESTION) == DialogResult.Yes)
                {
                    ...
                    if(_pApproval_YN)
                    {
                        CoFAS_DevExpressManager.ShowInformationMessage("승인 상태는 수정불가 하며,\n미승인상태에서 수정이 가능합니다.");
                        return;
                    }
                   _pRawMaterialInspectRegisterEntity.CRUD = "U";
                    ...
                    /*
                    pRawMaterialInspectRegisterEntity.PART_CODE
                    pRawMaterialInspectRegisterEntity.PART_NAME
                    pRawMaterialInspectRegisterEntity.INSPECT_STATUS
                    pRawMaterialInspectRegisterEntity.INSPECT_ID
                    pRawMaterialInspectRegisterEntity.INSPECT__DATE
                    pRawMaterialInspectRegisterEntity.INSPECT_SEQ
                    pRawMaterialInspectRegisterEntity.VEND_PART_CODE
                    pRawMaterialInspectRegisterEntity.PART_TYPE
                    pRawMaterialInspectRegisterEntity.REFERENCE_ID
                    pRawMaterialInspectRegisterEntity.MAKE_VEND
                    pRawMaterialInspectRegisterEntity.MAKE_VEND_NAME
                    pRawMaterialInspectRegisterEntity.VEND_CODE
                    pRawMaterialInspectRegisterEntity.VEND_NAME
                    pRawMaterialInspectRegisterEntity.REQUEST_DEPT
                    pRawMaterialInspectRegisterEntity.CODE_NAME
                    pRawMaterialInspectRegisterEntity.INOUT_DATE
                    pRawMaterialInspectRegisterEntity.INOUT_QTY
                        */
                    //_pRawMaterialInspectRegisterEntity.PACKING_REMARK  = sheet_1.GetCellValue(4, 6).TextValue;
                    //_pRawMaterialInspectRegisterEntity.SAMPLE_DATE     = sheet_1.GetCellValue(4, 7).TextValue;
                    //_pRawMaterialInspectRegisterEntity.SAMPLE_LOCATION = sheet_1.GetCellValue(6, 4).TextValue;
                    //_pRawMaterialInspectRegisterEntity.SAMPLE_USER     = sheet_1.GetCellValue(6, 5).TextValue;
                    //_pRawMaterialInspectRegisterEntity.SAMPLE_METHOD   = sheet_1.GetCellValue(6, 6).TextValue;
                    //_pRawMaterialInspectRegisterEntity.SAMPLE_QTY      = sheet_1.GetCellValue(6, 7).TextValue;
                    /*
                pRawMaterialInspectRegisterEntity.MAKE_NO
                pRawMaterialInspectRegisterEntity.STANDARD
                pRawMaterialInspectRegisterEntity.REQUEST_DATE
                pRawMaterialInspectRegisterEntity.REQUEST_USER
                pRawMaterialInspectRegisterEntity.END_DATE
                pRawMaterialInspectRegisterEntity.TOTAL_RESULT
                pRawMaterialInspectRegisterEntity.TOTAL_DATE
                pRawMaterialInspectRegisterEntity.TOTAL_USER
                pRawMaterialInspectRegisterEntity.COMPLETE_YN
                pRawMaterialInspectRegisterEntity.REMARK
                pRawMaterialInspectRegisterEntity.USER_YN
                */

                    isError = new RawMaterialInspectRegisterBusiness().RawMaterialInspectRegister_Info_Mst_Save(_pRawMaterialInspectRegisterEntity, sheet_1);
                    // 자재입고
                    if (isError)
                    {
                        //오류 발생.
                    ...
                    else
                    {
                        ...
                        isError = new RawMaterialInspectRegisterBusiness().RawMaterialInspectRegister_Info_Detail_Save(_pRawMaterialInspectRegisterEntity, sheet_2);
                        if (isError)
                        {
                            //오류 발생.
                            //CoFAS_DevExpressManager.ShowInformationMessage("저장 오류 발생! 데이터를 확인 하세요.");
                        ...
                        {
                            _pLocation_Code = _pRawMaterialInspectRegisterEntity.RTN_KEY;  //저장 위치
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            _pRawMaterialInspectRegisterEntity.INSPECT_ID= gv.GetFocusedRowCellValue("INSPECT_ID").ToString();
            //QC020001 : 승인
            //QC020002 : 미승인
            //승인인경우 수정x
        ...
        private void MainFind_DisplayData()
        {
            ...
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _dtList = new RawMaterialInspectRegisterBusiness().Sample_Info(_pRawMaterialInspectRegisterEntity);

                if (_pRawMaterialInspectRegisterEntity.CRUD == "")
                    _dtList.Rows.Clear();
                else
                {
                    IWorkbook workbook = _sdMAIN.Document;
                ...
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pRawMaterialInspectRegisterEntity.CRUD == ""))
                {
        ...
        private void SheetFind_DisplayData()
        {
            try
            {
                ...
                //조회할거 프로시져
                _dtList = new RawMaterialInspectRegisterBusiness().Sheet_Info_Sheet(_pRawMaterialInspectRegisterEntity);   //엑셀 시트 조회하기
                          ...
                          //  sheet_0.CustomCellInplaceEditors.Add(sheet_0.Range["B28"], CustomCellInplaceEditorType.ComboBox, ValueObject.FromRange(rg));
                           ...
                           // sheet_0.CustomCellInplaceEditors.Add(sheet_0.Range["H11:H22"], CustomCellInplaceEditorType.ComboBox, ValueObject.FromRange(rg));
                            Range rg2 = sheet_2.Range["K2:K3"];//승인여부
                                                               // sheet_0.CustomCellInplaceEditors.Add(sheet_0.Range["H28:I28"], CustomCellInplaceEditorType.ComboBox, ValueObject.FromRange(rg));

                      //  Range dateEditRange = sheet_0.Range["J11:K22"];
                      //  sheet_0.CustomCellInplaceEditors.Add(dateEditRange, CustomCellInplaceEditorType.DateEdit);
                        // sheet_0.Range["A3:L26"].Protection.Locked = false;
                        // sheet_0.Range["B28:G28"].Protection.Locked = false;
                        ...
                        //     _sdMAIN.CellBeginEdit += _sdMAIN_CellBeginEdit;
                        // }
                        //sheet_0.ProtectedRanges.Add("test", sheet_0["L11:L15"]);

                        //_sdMAIN.CellCancelEdit += _sdMAIN_CellCancelEdit;
        ...
        private void _sdMAIN_PopupMenuShowing(object sender, DevExpress.XtraSpreadsheet.PopupMenuShowingEventArgs e)
        {
            ...
            if (e.MenuType == SpreadsheetMenuType.Cell)
            {
                ...
                //if ((_sdMAIN.ActiveCell == activeSheet.Cells["F28"]) || (_sdMAIN.ActiveCell == activeSheet.Cells["G28"]) )
                //판정자
                if ((click_row == 41) && ((2 < click_col) && (click_col < 7)))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
                ...
                //담당자
                else if (((39 < click_row) && (click_row < 43)) && ((7 < click_col) && (click_col < 11)))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
                ...
                else if (((39 < click_row) && (click_row < 43)) && ((10 < click_col) && (click_col < 14)))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
                ...
                //시험결과
                else if (((11 < click_row) && (click_row < 26)) && ((7 < click_col) && (click_col < 11)))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
                ...
                //판정
                else if (((11 < click_row) && (click_row < 25)) && ((14 < click_col) && (click_col < 17)))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
                ...
                //종합판정
                //B28
                else if ((click_row == 39) && ((2 < click_col) && (click_col < 7)))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
                ...
                //검체 채취자
                else if ((click_row == 7) && ((12 < click_col) && (click_col < 17)))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
                ...
                //시험자
                else if (((11 < click_row) && (click_row < 26)) && (click_col == 13 || click_col == 14))
                {
                    _sdMAIN.Options.Behavior.ShowPopupMenu = DevExpress.XtraSpreadsheet.DocumentCapability.Enabled;
        ...
        public void InsertUserList(object sender, EventArgs e)
        {
            try
            {
                ...
                int click_row = _sdMAIN.ActiveWorksheet[_sdMAIN.ActiveCell.GetReferenceA1()].TopRowIndex;
                //시험결과
                if (((9 < click_row) && (click_row < 22)) && (click_col == 11))
                {
                    sheet_0.Cells[click_row, 11].SetValue(item.Caption);
                }
                else if ((click_row == 5) && ((9 < click_col) && (click_col < 12)))
                {
                    sheet_0.Cells[click_row, 10].SetValue(item.Caption);
                }
                //판정자
                else if ((click_row == 41) && ((2 < click_col) && (click_col < 7)))
                {
                    sheet_0.Cells[click_row, 3].SetValue(item.Caption);
                }
                //시험자
                else if (((11 < click_row) && (click_row < 26)) && (click_col == 13 || click_col == 14))
                {
        ...
        public void InsertResult(object sender, EventArgs e)
        {
            try
            {
                ...
                int click_row = _sdMAIN.ActiveWorksheet[_sdMAIN.ActiveCell.GetReferenceA1()].TopRowIndex;
                //시험결과
                if (((9 < click_row) && (click_row < 22)) && ((6 < click_col) && (click_col < 9)))
                {
                    sheet_0.Cells[click_row, 7].SetValue(item.Caption);
                }
                //시험결과
                else if (((11 < click_row) && (click_row < 26)) && ((7 < click_col) && (click_col < 11)))
                {
                ...
                else if (((11 < click_row) && (click_row < 26)) && ((12 < click_col) && (click_col < 17)))
                {
        ...
        public void InsertSignImage(object sender, EventArgs e)
        {
            ...
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                _pRawMaterialInspectRegisterEntity.CRUD = "R";
                _dtList = new InspectFinalApprovalRegisterBusiness().GetUserImage(_pRawMaterialInspectRegisterEntity.CRUD, _pRawMaterialInspectRegisterEntity.USER_CODE);
                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pRawMaterialInspectRegisterEntity.CRUD == ""))
                {
                    IWorkbook workbook = _sdMAIN.Document;
                    Worksheet sheet_0 = workbook.Worksheets[0];
                    ...
                    if (signature_user == "total_user")
                    {
                        ...
                        sheet_0.Cells["I41"].SetValue(_pUSER_CODE);
        ...
        private void _sdMAIN_CellBeginEdit(object sender, SpreadsheetCellCancelEventArgs e)
        {
            ...
            //if (((e.ColumnIndex == 7 && e.RowIndex == 27) || (e.ColumnIndex == 8 && e.RowIndex == 27)))
            if (
            ...
            //검체채취일
            //시험일자
            //if (((e.ColumnIndex == 3 && e.RowIndex == 27) || (e.ColumnIndex == 4 && e.RowIndex == 27)))
            if (((e.ColumnIndex == 8 && e.RowIndex == 9) || (e.ColumnIndex == 9 && e.RowIndex ==9) || (e.ColumnIndex == 10 && e.RowIndex == 9)))
            {
                IWorkbook workbook = _sdMAIN.Document;
                Worksheet sheet_0 = workbook.Worksheets[0];
            ...
            //시험일자
            //if (((e.ColumnIndex == 3 && e.RowIndex == 27) || (e.ColumnIndex == 4 && e.RowIndex == 27)))
            if (((11<e.RowIndex) && (e.RowIndex < 25))  && ((10 < e.ColumnIndex) && (e.ColumnIndex < 13)))
            {
                IWorkbook workbook = _sdMAIN.Document;
                Worksheet sheet_0 = workbook.Worksheets[0];
                ...
                if (xfrmCommonPopup.dtReturn != null && xfrmCommonPopup.dtReturn.Rows.Count > 0)
                {
                    sheet_0.Cells[e.RowIndex, 11].SetValue(xfrmCommonPopup.dtReturn.Rows[0]["DATE"].ToString());
                }
            ...
            //종합판정일
             if (((2 < e.ColumnIndex) && (e.ColumnIndex < 7)) && (e.RowIndex==40))
           // if (((e.ColumnIndex == 3 && e.RowIndex == 27) || (e.ColumnIndex == 4 && e.RowIndex == 27)))
            {
                IWorkbook workbook = _sdMAIN.Document;
                Worksheet sheet_0 = workbook.Worksheets[0];
                ...
                if (xfrmCommonPopup.dtReturn != null && xfrmCommonPopup.dtReturn.Rows.Count > 0)
                {
                    sheet_0.Cells[e.RowIndex, 3].SetValue(xfrmCommonPopup.dtReturn.Rows[0]["DATE"].ToString());
                }
            ...
            //     else
            // {
            //     if ((e.ColumnIndex == 1 && e.RowIndex == 27)||(e.ColumnIndex == 2 && e.RowIndex == 27))
            //     {
            //         
            //         IWorkbook workbook = _sdMAIN.Document;
            //         Worksheet sheet_0 = workbook.Worksheets[0];
            //
            //         if (sheet_0.GetCellValue(e.ColumnIndex, e.RowIndex).ToString()=="" || sheet_0.GetCellValue(e.ColumnIndex, e.RowIndex).ToString() == null)
            //             sheet_0.Cells[e.RowIndex, e.ColumnIndex].SetValue("");
            //     }
            // }
        }
            ...
            try
            {
               ...
               // _pRawMaterialInspectRegisterEntity.ORDER_ID = _luORDER_ID.Text.ToString();
                ...
                using (DBManager pDBManager = new DBManager())
                {
                    ...
                    _dsList = new RawMaterialInspectRegisterProvider(pDBManager).RawMaterialInspectRegister_info_ExcelBinding(_pRawMaterialInspectRegisterEntity);
                    //품목정보용
                    _dtList = _dsList.Tables[0];
                    //시험항목검사결과(엑셀바인딩용)
                    _dtList_01 = _dsList.Tables[1];
                    _dtList_02 = _dsList.Tables[2];
                    _pRawMaterialInspectRegisterEntity.dtListCnt = _dtList_01.Rows.Count;
                    if (_dtList != null && _dtList.Rows.Count > 0)
                    {
                       ...
                       // int user_cnt = _dtList_02.Rows.Count;
                       // sheet_2.DataBindings.BindToDataSource(_dtList_02, 0, 11, dsOptions);
                       // Range rg3 = sheet_2.Range.FromLTRB(11, 1, 11, user_cnt);//시험자
                       // Range rg4 = sheet_2.Range.FromLTRB(11, 1, 11, user_cnt);//검체 채취자

                      //  sheet_0.CustomCellInplaceEditors.Add(sheet_0.Range["L11:L22"], CustomCellInplaceEditorType.ComboBox, ValueObject.FromRange(rg3));
                     //   sheet_0.CustomCellInplaceEditors.Add(sheet_0.Range["K6:L6"], CustomCellInplaceEditorType.ComboBox, ValueObject.FromRange(rg4));

                        //시험결과 데이터만
                        //DataTable result_data = _dtList_01.DefaultView.ToTable(false, new string[] { "시험결과"});
                        //sheet_0.DataBindings.BindToDataSource(result_data, 8, 10, dsOptions);
                        //sheet_0.DataBindings.BindToDataSource(result_data,1, 0, dsOptions);
                        // if ((e.ColumnIndex == 1 && e.RowIndex == 27) || (e.ColumnIndex == 2 && e.RowIndex == 27))
                        // sheet_0.Cells["B28"].SetValue(_dtList.Rows[0]["종합판정"].ToString());
                        sheet_0.Cells[0, 2].Protection.Locked = true;
                        sheet_0.Range["L11:L15"].Protection.Locked = true;
                        Range rg2 = sheet_0.Range["L11:L15"];
                        sheet_0.ProtectedRanges.Add("test", rg2);
                        ...
                        if (name_tmp != "")
                        {
                            _dtList2 = new InspectFinalApprovalRegisterBusiness().GetUserImage(_pRawMaterialInspectRegisterEntity.CRUD, name_tmp);
                            if ((_dtList2 != null && _dtList2.Rows.Count > 0) || (_dtList2 != null && _pRawMaterialInspectRegisterEntity.CRUD == ""))
                            {
                                Image img = null;
                                ...
                                //서명이 없음
                                //sheet_0.Pictures.AddPicture(imageSource, sheet_0.Range["F28:G28"]);
                                sheet_0.Pictures.AddPicture(imageSource, sheet_0.Range["I41:K42"]);
