...
{
    public partial class SampleExcelView1 : frmBaseNone
    {
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                responseStream = CORE.Function.CoFAS_FTPManager.FTPFileBinding(strFTP_PATH, "Sample_Base1.xlsx", _pFTP_ID, _pFTP_PW);
