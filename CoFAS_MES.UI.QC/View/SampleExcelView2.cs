...
{
    public partial class SampleExcelView2 : frmBaseNone
    {
        ...
        private ExcelFormDesignViewEntity _pExcelFormDesignViewEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pExcelFormDesignViewEntity = new ExcelFormDesignViewEntity();
                _pExcelFormDesignViewEntity.USER_CODE = _pUSER_CODE;
                _pExcelFormDesignViewEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pExcelFormDesignViewEntity.CRUD = "";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                responseStream = CORE.Function.CoFAS_FTPManager.FTPFileBinding(strFTP_PATH, "Sample_Base2.xlsx", _pFTP_ID, _pFTP_PW);

                spreadsheetControl1.LoadDocument(responseStream);

                wb = spreadsheetControl1.Document;

                spreadsheetControl1.Options.Print.ShowMarginsWarning = false;
                ...
                para["Year"].Value = _luT_DATE.DateTime.ToString("yyyy");
