...
{
    public partial class DynamicColumnInfoRegister : frmBaseNone
    {
        ...
        private DynamicColumnInfoRegisterEntity _pDynamicColumnInfoRegisterEntity = null; // 엔티티 생성
        ...
        public DynamicColumnInfoRegister()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pDynamicColumnInfoRegisterEntity = new DynamicColumnInfoRegisterEntity();
                //_pDynamicColumnInfoRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pDynamicColumnInfoRegisterEntity.USER_CODE = _pUSER_CODE;
                ...
                _pDynamicColumnInfoRegisterEntity.CRUD = "";
        ...
        private void InitializeControl()
        {
            try
            {
                _luDYNAMIC_TYPE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "COMMON_CODE", "MM01", "", "").Tables[0], 0, 0, "");
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pDynamicColumnInfoRegisterEntity.DYNAMIC_TYPE = _luDYNAMIC_TYPE.GetValue();
                _pDynamicColumnInfoRegisterEntity.USE_YN = _luUSE_YN.GetValue();

                _dtList = new DynamicColumnInfoRegisterBusiness().DynamicColumn_Info(_pDynamicColumnInfoRegisterEntity);

                if (_pDynamicColumnInfoRegisterEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pDynamicColumnInfoRegisterEntity.CRUD == ""))
                {
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new DynamicColumnInfoRegisterBusiness().DynamicColumn_Info_Save(_pDynamicColumnInfoRegisterEntity, dtSave);
