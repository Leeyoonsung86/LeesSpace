...
{
    public partial class LanguageInfoRegister : frmBaseNone
    {
        ...
        private LanguageInfoRegisterEntity _pLanguageInfoRegisterEntity = null; // 엔티티 생성

        private DataTable _dtList = null; //조회 데이터 리스트

        private bool _pFirstYN = true;                  // 최초실행여부 최초 설정 에서만 사용

        public LanguageInfoRegister()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pLanguageInfoRegisterEntity = new LanguageInfoRegisterEntity();
                //_pLanguageInfoRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pLanguageInfoRegisterEntity.USER_CODE = _pUSER_CODE;
                _pLanguageInfoRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pLanguageInfoRegisterEntity.CRUD = "";
        ...
        #region ○콤보박스 상세 세팅- _luWINDOW_GUBN_ValueChanged()

        private void _luWINDOW_GUBN_ValueChanged(object sender, EventArgs e)
        {
            string str = _luWINDOW_GUBN.GetValue().ToString();
            _luWINDOW_NAME.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R",_pLANGUAGE_TYPE, "menu_list_DETAIL", str, "", "").Tables[0], 0, 0, "");
        }
        #endregion
    }
}
