...
{
    public partial class CommonCodeRegister : frmBaseNone
    {
        ...
        private CommonCodeRegisterEntity _pCommonCodeRegisterEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pCommonCodeRegisterEntity = new CommonCodeRegisterEntity();
               //_pCommonCodeRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pCommonCodeRegisterEntity.USER_CODE = _pUSER_CODE;
                _pCommonCodeRegisterEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pCommonCodeRegisterEntity.CRUD = "";
        ...
        private void _gdFIRST_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pCommonCodeRegisterEntity.CRUD = "R";
        ...
        private void Form_DeleteButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        // 수정 데이터는 "CRUD" 처리
                        _pCommonCodeRegisterEntity.CRUD = "D";
        ...
        private void FirstFind_DisplayData()
        {
            try
            {
                ...
                _pCommonCodeRegisterEntity.CODE = _luT_CODE.Text.ToString();
                _pCommonCodeRegisterEntity.USE_YN = _luT_USE_YN.GetValue();

                _dtList = new CommonCodeRegisterBusiness().CommonCode_Info_First(_pCommonCodeRegisterEntity);

                if (_pCommonCodeRegisterEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pCommonCodeRegisterEntity.CRUD == ""))
                {
        ...
        private void SecondFind_DisplayData(string strCODE_TYPE)
        {
            try
            {
                ...
                _pCommonCodeRegisterEntity.CODE_TYPE = strCODE_TYPE;
                _pCommonCodeRegisterEntity.USE_YN = _luT_USE_YN.GetValue();// "Y";

                _dtList = new CommonCodeRegisterBusiness().CommonCode_Info_Second(_pCommonCodeRegisterEntity);
                ...
                else
                {
                    ...
                    _pCommonCodeRegisterEntity.CRUD = "";
                    SecondFind_DisplayData(_pCommonCodeRegisterEntity.CODE_TYPE);
                    ThirdFind_DisplayData(_pCommonCodeRegisterEntity.CODE_TYPE);
                }
            }
            catch (ExceptionManager pExceptionManager)
            {
        ...
        private void ThirdFind_DisplayData(string strCODE_TYPE)
        {
            try
            {
                ...
                _dtList = new CommonCodeRegisterBusiness().CommonCode_Info_Third(_pCommonCodeRegisterEntity);
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                    ...
                    isError = new CommonCodeRegisterBusiness().CommonCode_Info_Save(_pCommonCodeRegisterEntity, dtSave, strCODE_TYPE);
                ...
                else
                {
                    ...
                    if (_pCommonCodeRegisterEntity.CRUD == "D")
                    {
        ...
        private void InputData_Save(DataTable dtFirst , DataTable dtSecond, DataTable dtThird)
        {
            try
            {
                ...
                isError = new CommonCodeRegisterBusiness().CommonCode_Info_Save(_pCommonCodeRegisterEntity, dtFirst, dtSecond, dtThird);
