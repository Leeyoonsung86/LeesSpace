...
{
    public partial class GroupUserMailing : frmBaseNone
    {
        ...
        private CoFAS_DevGridManager _tempGridMain = null;
        private CoFAS_DevGridManager _tempGridSub = null;
        
        private GroupUserMailingEntity _pGroupUserMailingEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pGroupUserMailingEntity = new GroupUserMailingEntity();
                //_pLanguageInfoRegisterEntity.CORP_CODE = _pCORP_CODE;
                _pGroupUserMailingEntity.USER_CODE = _pUSER_CODE;
                _pGroupUserMailingEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void InitializeGrid()
        {
            try
            {
                ...
                if (_pFirstYN)
                {
                    _tempGridMain = new CoFAS_DevGridManager();

                    _gdMAIN_VIEW = _tempGridMain.Grid_Setting(_gdMAIN, _gdMAIN_VIEW, _pFONT_SETTING, _pLANGUAGE_TYPE, new DevGridSettingBusiness().DevGrid_Info(_pLANGUAGE_TYPE, _pWINDOW_NAME, _gdMAIN.Name.ToString()));

                    _tempGridSub = new CoFAS_DevGridManager();

                    _gdSUB_VIEW = _tempGridSub.Grid_Setting(_gdSUB, _gdSUB_VIEW, _pFONT_SETTING, _pLANGUAGE_TYPE, new DevGridSettingBusiness().DevGrid_Info(_pLANGUAGE_TYPE, _pWINDOW_NAME, _gdSUB.Name.ToString()));
                }
        ...
        private void InitializeControl()
        {
            try
            {
                ...
                _pGroupUserMailingEntity.RESOURCE_NAME = "";
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pGroupUserMailingEntity.RESOURCE_CODE = gv.GetFocusedRowCellValue("ID").ToString();
                SubFind_DisplayData();
            }
            catch (ExceptionManager pExceptionManager)
            {
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                //_pGroupUserMailingEntity.LANGUAGE_TYPE = _luLANGUAGE_TYPE.GetValue();
                //_pGroupUserMailingEntity.USE_YN = _luUSE_YN.GetValue();
                _pGroupUserMailingEntity.CRUD = "R";
                _dtList = new GroupUserMailingBusiness().GroupRule_info(_pGroupUserMailingEntity);

                if (_pGroupUserMailingEntity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pGroupUserMailingEntity.CRUD == ""))
                {
                    _tempGridMain.BindGridControl(_gdMAIN, _gdMAIN_VIEW, _dtList);
                }
                else
                {
                    _tempGridMain.BindGridControl(_gdMAIN, _gdMAIN_VIEW, _dtList);
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                //_pGroupUserMailingEntity.USE_YN = _luUSE_YN.GetValue();
                _pGroupUserMailingEntity.CRUD = "R";
                _dtList_sub = new GroupUserMailingBusiness().GroupUserMailing_Rule_info(_pGroupUserMailingEntity);

                if (_pGroupUserMailingEntity.CRUD == "") _dtList_sub.Rows.Clear();

                if ((_dtList_sub != null && _dtList_sub.Rows.Count > 0) || (_dtList_sub != null && _pGroupUserMailingEntity.CRUD == ""))
                {
                    _tempGridMain.BindGridControl(_gdSUB, _gdSUB_VIEW, _dtList_sub);

                    //if (_pLocation_Code != "" && _pLocation_YN)
                    //{
                    //    int rowHandle = _gdMAIN_VIEW.LocateByValue("FIELD_CODE", _pLocation_Code);
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new GroupUserMailingBusiness().GroupUserMailing_Info_Save(_pGroupUserMailingEntity, dtSave);
                ...
                else
                {
                    ...
                    _pLocation_Code = _pGroupUserMailingEntity.RTN_KEY;  //저장 위치 
                    _pGroupUserMailingEntity.CRUD = "R";
                    MainFind_DisplayData();
                    //InitializeControl();
                }
