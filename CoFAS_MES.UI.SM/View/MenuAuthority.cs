...
{
    public partial class MenuAuthority : frmBaseNone
    {
        ...
        private MenuAuthorityEntity _pMenuAuthorityEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMenuAuthorityEntity = new MenuAuthorityEntity();
                //_pMenuAuthorityEntity.CORP_CODE = _pCORP_CODE;
                _pMenuAuthorityEntity.USER_CODE = _pUSER_CODE;
                _pMenuAuthorityEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMenuAuthorityEntity.USER_ACCOUNT = gv.GetFocusedRowCellValue("USER_ACCOUNT").ToString();
                _pMenuAuthorityEntity.CRUD = "R";
                SubFind_DisplayData();
            }
            catch (ExceptionManager pExceptionManager)
            {
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                if (_pMenuAuthorityEntity.CRUD == "") _dtList.Rows.Clear();
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new MenuAuthorityBusiness().MenuAuthority_R20(_pMenuAuthorityEntity);
