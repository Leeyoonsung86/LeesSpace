...
{
    public partial class MenuAuthority_T01 : frmBaseNone
    {
        ...
        private MenuAuthority_T01Entity _pMenuAuthority_T01Entity = null; // 엔티티 생성

        private DataTable _dtList = null; //조회 데이터 리스트

        private bool _pFirstYN = true;                  // 최초실행여부 최초 설정 에서만 사용

        public MenuAuthority_T01()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pMenuAuthority_T01Entity = new MenuAuthority_T01Entity();
                //_pMenuAuthority_T01Entity.CORP_CODE = _pCORP_CODE;
                _pMenuAuthority_T01Entity.USER_CODE = _pUSER_CODE;
                _pMenuAuthority_T01Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pMenuAuthority_T01Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMenuAuthority_T01Entity.USER_ACCOUNT = gv.GetFocusedRowCellValue("USER_ACCOUNT").ToString();
                _pMenuAuthority_T01Entity.CRUD = "R";
                SubFind_DisplayData();
            }
            catch (ExceptionManager pExceptionManager)
            {
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                else
                {
                    ...
                    InputData_Save2(); // 저장 전 menu_authority에 원래 저장되어 있던 메뉴 사용권한 모두 N으로 바꾸기 
        ...
        private void Form_SettingButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                //xfrmPageSetting.PASS_CORP_CODE = _pMenuAuthority_T01Entity.CORP_CODE;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pMenuAuthority_T01Entity.USER_ACCOUNT = _luUSER_MAIL.Text.ToString();
                _pMenuAuthority_T01Entity.USER_NAME = _luUSER_NAME.Text.ToString();

                _dtList = new MenuAuthority_T01Business().MenuAuthority_T01_R10(_pMenuAuthority_T01Entity);

                if (_pMenuAuthority_T01Entity.CRUD == "") _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pMenuAuthority_T01Entity.CRUD == ""))
                {
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new MenuAuthority_T01Business().MenuAuthority_T01_R20(_pMenuAuthority_T01Entity);
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new MenuAuthority_T01Business().MenuAuthority_T01_I10(_pMenuAuthority_T01Entity, dtSave);
        ...
        #region ○ 저장 - InputData_Save2(DataTable dtSave)

        private void InputData_Save2()
        {
            try
            {
                CoFAS_DevExpressManager.SetCursor(this, Cursors.WaitCursor);
                ...
                isError = new MenuAuthority_T01Business().MenuAuthority_T01_I20(_pMenuAuthority_T01Entity);
