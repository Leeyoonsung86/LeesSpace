...
{
    public partial class MenuAuthority_T02 : frmBaseNone
    {
        ...
        private MenuAuthority_T02Entity _pMenuAuthority_T02Entity = null; // 엔티티 생성

        private DataTable _dtList = null; //조회 데이터 리스트

        private bool _pFirstYN = true;                  // 최초실행여부 최초 설정 에서만 사용

        public MenuAuthority_T02()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                _pMenuAuthority_T02Entity.CRUD = "";
                if (_pFirstYN)
                {
        ...
        private void _gdMAIN_VIEW_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            try
            {
                ...
                _pMenuAuthority_T02Entity.USER_ACCOUNT = gv.GetFocusedRowCellValue("USER_ACCOUNT").ToString();
        ...
        private void Form_SettingButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                //xfrmPageSetting.PASS_CORP_CODE = _pMenuAuthority_T02Entity.CORP_CODE;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pMenuAuthority_T02Entity.USER_ACCOUNT = _luUSER_MAIL.Text.ToString();
                _pMenuAuthority_T02Entity.USER_NAME = _luUSER_NAME.Text.ToString();

                _dtList = new MenuAuthority_T02Business().MenuAuthority_T02_R10(_pMenuAuthority_T02Entity);

                if (_pMenuAuthority_T02Entity.CRUD == "") _dtList.Rows.Clear();
        ...
        private void SubFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new MenuAuthority_T02Business().MenuAuthority_T02_R20(_pMenuAuthority_T02Entity);
        ...
        private void InputData_Save(DataTable dtSave)
        {
            try
            {
                ...
                isError = new MenuAuthority_T02Business().MenuAuthority_T02_I10(_pMenuAuthority_T02Entity, dtSave);
        ...
        private void _ucbtCopy_Click(object sender, EventArgs e)
        {
            //VendCostInfo
            
            CoFAS_MES.UI.SM.UserForm.frmCommonPopup.CRUD = "R";
            CoFAS_MES.UI.SM.UserForm.frmCommonPopup.USER_CODE = _pUSER_CODE;
            CoFAS_MES.UI.SM.UserForm.frmCommonPopup.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
            CoFAS_MES.UI.SM.UserForm.frmCommonPopup.FONT_TYPE = _pFONT_SETTING;



            // 0 서비스네임 1 공통코드경우 CODE_TYPE 으로구분자 올린다.
            CoFAS_MES.UI.SM.UserForm.frmCommonPopup.ARRAY = new object[2] { "Vend_Code_I", "" };

            //검색조건 전달 0 코드 1 명칭
            CoFAS_MES.UI.SM.UserForm.frmCommonPopup.ARRAY_CODE = new object[2] { "", ""};

            //ucVendCodeInfoPopup xucVendCodeInfoPopup = new CORE.UserControls.ucVendCodeInfoPopup("PartCodeInfo"); //유저컨트롤러 설정 부분
            CoFAS_MES.UI.SM.UserForm.frmCommonPopup xfrmCommonPopup = new CoFAS_MES.UI.SM.UserForm.frmCommonPopup("ucUserAuthorityCopy"); //유저컨트롤러 설정 부분
