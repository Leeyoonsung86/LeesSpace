...
{
    public partial class ucProductStockInfoPopup : UserControl
    {
        ...
        private ucProductStockInfoPopupEntity _pucProductStockInfoPopupEntity = null; // 엔티티 생성
        ...
        public ucProductStockInfoPopup()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
           ...
           // _luTORDER_DATE.ToDateTime = DateTime.Now;
            ...
            _pucProductStockInfoPopupEntity = new ucProductStockInfoPopupEntity();
            //그리드 설정 ==고정==
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pCRUD = "R";
                _dtList = new ucProductStockInfoPopupBusiness().ucInspectRequestInfo_Return(_pCRUD,strCODE, strNAME).Tables[0];
