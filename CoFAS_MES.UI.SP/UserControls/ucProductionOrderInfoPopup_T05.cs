...
{
    public partial class ucProductionOrderInfoPopup_T05 : UserControl
    {
        ...
        private ucProductionOrderInfoPopup_T05_Entity _pucProductionOrderInfoPopup_T05_Entity = null;
        ...
        public ucProductionOrderInfoPopup_T05()
        {
            InitializeComponent();
        ...
        private void ucProductionOrderInfoPopup_T05_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void InitializeSetting()
        {
            ...
            _pucProductionOrderInfoPopup_T05_Entity = new ucProductionOrderInfoPopup_T05_Entity();
            _pucProductionOrderInfoPopup_T05_Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucProductionOrderInfoPopup_T05_Entity.CRUD = "R";
                _pucProductionOrderInfoPopup_T05_Entity.DATE_FROM = _ucFROMDATE.FromDateTime.ToString("yyyyMMdd");
                _pucProductionOrderInfoPopup_T05_Entity.DATE_TO = _ucFROMDATE.ToDateTime.ToString("yyyyMMdd");
                _pucProductionOrderInfoPopup_T05_Entity.PART_CODE = _luPART.CodeText;
                _pucProductionOrderInfoPopup_T05_Entity.PART_NAME = _luPART.NameText;
                _pucProductionOrderInfoPopup_T05_Entity.VEND_CODE = _luVEND.CodeText;
                _pucProductionOrderInfoPopup_T05_Entity.VEND_NAME = _luVEND.NameText;

                _dtList = new ucProductionOrderInfoPopup_T05Business().ucProductionOrderInfoPopup_T05_Select(_pucProductionOrderInfoPopup_T05_Entity).Tables[0];

                if (_pucProductionOrderInfoPopup_T05_Entity.CRUD == "")
                    _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucProductionOrderInfoPopup_T05_Entity.CRUD == ""))
                {
