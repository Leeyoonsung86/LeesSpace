...
{
    public partial class ucSemiProductStockInfoPopup : UserControl
    {
        ...
        private ucSemiProductStockInfoMaterialPopupEntity _pucSemiProductStockInfoMaterialPopupEntity = null; // 엔티티 생성
        ...
        public ucSemiProductStockInfoPopup()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
           ...
           // _luTORDER_DATE.ToDateTime = DateTime.Now;
            ...
            _pucSemiProductStockInfoMaterialPopupEntity = new ucSemiProductStockInfoMaterialPopupEntity();
            //그리드 설정 ==고정==
            ...
            _luINOUT_CODE.AddValue(new CommonCodeReturnBusiness().CommonCode_Return("R", _pLANGUAGE_TYPE, "COMMON_CODE", "PD04", "", "").Tables[0], 0, 0, "");
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pCRUD = "R";
                _dtList = new ucSemiProductStockInfoPopupBusiness().ucInspectRequestInfo_Return(_pCRUD,strCODE, strNAME).Tables[0];
        ...
        {
            _pucSemiProductStockInfoMaterialPopupEntity.CORP_CODE = _pCORP_CODE;
            _pucSemiProductStockInfoMaterialPopupEntity.USER_CODE = _pUSER_CODE;
            _pucSemiProductStockInfoMaterialPopupEntity.INOUT_CODE = _luINOUT_CODE.GetValue(); //콤보박스로 체크할것
            int cnt = 0;
            ...
            {
                _pucSemiProductStockInfoMaterialPopupEntity.CRUD = "C";
                bool isError;
                isError = new ucSemiProductStockInfoPopupBusiness().ucSemiProductStockInfoPopup_Save(_pucSemiProductStockInfoMaterialPopupEntity, tDataTable);
                ...
                else
                {
                    ...
                    //_pLocation_Code = _pucSemiProductStockInfoMaterialPopupEntity.RTN_KEY;  //저장 위치 
        ...
        private void _luTPART_ALL__OnOpenClick(object sender, EventArgs e)
        {
            ...
            frmCommonPopup.ARRAY = new object[2] { "Product_Code_T02", "" };
