...
{
    public partial class ucShipmentRegisterInfoPopup : UserControl
    {
        #region ○ 메시지
        ...
        private ucShipmentRegisterInfoPopupEntity _pucShipmentRegisterInfoPopupEntity = null;
        ...
        public ucShipmentRegisterInfoPopup()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                _pucShipmentRegisterInfoPopupEntity = new ucShipmentRegisterInfoPopupEntity();
                _pucShipmentRegisterInfoPopupEntity.CRUD = "";
                //그리드 설정 ==고정==
        ...
        private void btnCmd_Click(object pSender, EventArgs pEventArgs)
        {
            ...
            {
                case "SELECT":
                    _pucShipmentRegisterInfoPopupEntity.CRUD = "R";
