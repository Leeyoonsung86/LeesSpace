...
{
    public partial class ucShipmentRegisterInfoPopup_T01 : UserControl
    {
        #region ○ 메시지
        ...
        private ucShipmentRegisterInfoPopup_T01Entity _pucShipmentRegisterInfoPopup_T01Entity = null;
        ...
        public ucShipmentRegisterInfoPopup_T01()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                #region ○ 메인 화면 공통 메세지 처리           _아래애 MainForm지우기
                ...
                _pucShipmentRegisterInfoPopup_T01Entity = new ucShipmentRegisterInfoPopup_T01Entity();
                _pucShipmentRegisterInfoPopup_T01Entity.CRUD = "";
                //그리드 설정 ==고정==
        ...
        {
            ucSimpleButton pCmd = pSender as ucSimpleButton;
            string pCls = pCmd.Name.Substring(5);

            switch (pCls)
            {
                case "SELECT":
                    _pucShipmentRegisterInfoPopup_T01Entity.CRUD = "R";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _pucShipmentRegisterInfoPopup_T01Entity.DATE_FROM = DateTime.Parse(_luCONTRACT_DATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _pucShipmentRegisterInfoPopup_T01Entity.DATE_TO = DateTime.Parse(_luCONTRACT_DATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                _pucShipmentRegisterInfoPopup_T01Entity.PART_NAME = _luPART_NAME.Text;

                _dtList = new ucShipmentRegisterInfoPopup_T01Business().ucShipmentRegisterInfoPopup_T01_Info_Mst(_pucShipmentRegisterInfoPopup_T01Entity);

                if (_pucShipmentRegisterInfoPopup_T01Entity.CRUD == "")
                    _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pucShipmentRegisterInfoPopup_T01Entity.CRUD == ""))
                {
