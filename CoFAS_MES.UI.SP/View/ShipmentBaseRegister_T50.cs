...
{
    public partial class ShipmentBaseRegister_T50 : frmBaseNone
    {
        #region ○ 전역변수
        ...
        private ShipmentBaseRegister_T50Entity _pShipmentBaseRegister_T50Entity = null;
        ...
        public ShipmentBaseRegister_T50()
        {
            InitializeComponent();
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pShipmentBaseRegister_T50Entity = new ShipmentBaseRegister_T50Entity();
                _pShipmentBaseRegister_T50Entity.USER_CODE = _pUSER_CODE;
                _pShipmentBaseRegister_T50Entity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
                ...
                _pShipmentBaseRegister_T50Entity.CRUD = "";
        ...
        private void InitializeControl(bool bSearch)
        {
            try
            {
                ...
                _luTINDATE.FromDateTime = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1);  //조회 시작일, 매월 초 날짜로 설정
                _luTINDATE.ToDateTime = DateTime.Today;  //조회 종료일, 당일 설정
                _luTVEND_NAME.Text = "";
                _luTPART_NAME.Text = "";
                _luTPART_CODE.Text = "";
                _luTTRACKING_NO.Text = "";
        ...
        private void Form_SearchButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                if (_luTINDATE.FromDateTime > _luTINDATE.ToDateTime)
                {
                ...
                _pShipmentBaseRegister_T50Entity.CRUD = "R";
                _pShipmentBaseRegister_T50Entity.DATE_FROM = DateTime.Parse(_luTINDATE.FromDateTime.ToString()).ToString("yyyyMMdd");
                _pShipmentBaseRegister_T50Entity.DATE_TO = DateTime.Parse(_luTINDATE.ToDateTime.ToString()).ToString("yyyyMMdd");
                _pShipmentBaseRegister_T50Entity.TRACKING_NO = _luTTRACKING_NO.Text;
                _pShipmentBaseRegister_T50Entity.PART_CODE = _luTPART_CODE.Text;
                _pShipmentBaseRegister_T50Entity.PART_NAME = _luTPART_NAME.Text;
                _pShipmentBaseRegister_T50Entity.VEND_NAME = _luTVEND_NAME.Text;
        ...
        private void Form_SaveButtonClicked(object pSender, EventArgs pEventArgs)
        {
            try
            {
                ...
                _pShipmentBaseRegister_T50Entity.SHIPMENT_ID = "";
        ...
        private void MainFind_DisplayData()
        {
            try
            {
                ...
                _dtList = new ShipmentBaseRegister_T50Business().ShipmentBaseRegister_T50_Info_Mst(_pShipmentBaseRegister_T50Entity);

                if (_pShipmentBaseRegister_T50Entity.CRUD == "")
                    _dtList.Rows.Clear();

                if ((_dtList != null && _dtList.Rows.Count > 0) || (_dtList != null && _pShipmentBaseRegister_T50Entity.CRUD == ""))
                {
        ...
        private void InputData_Save()
        {
            try
            {
                ...
                {
                    isError = new ShipmentBaseRegister_T50Business().ShipmentBaseRegister_T50_Info_Save(_pShipmentBaseRegister_T50Entity);
                    if (isError)
                    {
                    ...
                    _pLocation_Code = _pShipmentBaseRegister_T50Entity.RTN_KEY;
                    _pShipmentBaseRegister_T50Entity.CRUD = "R";
