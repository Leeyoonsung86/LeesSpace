...
{
    public partial class SampleView : frmBaseDesign
    {
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                _pSampleRegisterEntity.WINDOW_NAME = _pWINDOW_NAME;
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new SampleRegisterBusiness().Sample_Info_Filename(_pSampleRegisterEntity); //Entity에 WINDOW_NAME 추가
