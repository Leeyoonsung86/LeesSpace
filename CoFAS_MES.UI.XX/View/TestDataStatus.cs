...
{
    public partial class TestDataStatus : frmBaseNone
    {
        ...
        private TestDataStatusEntity _pTestDataStatusEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pTestDataStatusEntity = new TestDataStatusEntity();
                //_pTestDataStatusEntity.CORP_CODE = _pCORP_CODE;
                _pTestDataStatusEntity.USER_CODE = _pUSER_CODE;
                _pTestDataStatusEntity.WINDOW_NAME = _pWINDOW_NAME;
                _pTestDataStatusEntity.LANGUAGE_TYPE = _pLANGUAGE_TYPE;
        ...
        private void Dashboard_DisplayData()
        {
            try
            {
                ...
                _dtList = new TestDataStatusBusiness().TestDataStatus_Info_Filename(_pTestDataStatusEntity); //Entity에 WINDOW_NAME 추가
                ...
                strFTP_PATH = string.Format(@"{0}{1}/{2}/{3}/", _pFTP_IP_PORT, "USER", "PROGRAM_VIEW", _pTestDataStatusEntity.WINDOW_NAME);
                ...
                // xml의 parameter 설정
                dashboard.Parameters[0].Value = _pTestDataStatusEntity.CRUD;
