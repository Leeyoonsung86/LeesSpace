...
{
    public partial class WorkResultView2_DY : frmBaseNone
    {
        #region ○ 기본 전역변수
        ...
        private WorkResultView_DYEntity _pWorkResultView_DYEntity = null; // 엔티티 생성
        ...
        private void InitializeSetting()
        {
            try
            {
                ...
                //메뉴 화면 엔티티 설정
                _pWorkResultView_DYEntity = new WorkResultView_DYEntity();
                _pWorkResultView_DYEntity.USER_CODE = _pUSER_CODE;
                ...
                _pWorkResultView_DYEntity.CRUD = "";
